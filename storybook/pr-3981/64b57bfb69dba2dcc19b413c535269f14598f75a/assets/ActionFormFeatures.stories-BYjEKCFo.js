...
/>`}}}};function Oe(){const[t,e]=A.useState({fullName:"Ada Lovelace",yearsExperience:5,isRemote:!0,isFullTime:!0}),{handleStoryError:n,handleStorySubmit:o,submission:u}=O({applyStoryAction:D});return a.jsx(P,{output:a.jsx(I,{idleMessage:"Submit the form to see the action response.",snapshot:u}),children:a.jsxs(a.Fragment,{children:[a.jsxs("div",{className:"osdkFormStorySpacing",children:[a.jsx("strong",{children:"Current form state (JSON):"}),a.jsx("pre",{className:"osdkCodeOutput",children:JSON.stringify(t,null,2)})]}),a.jsx(k,{actionDefinition:Te,formState:t,onError:n,onFormStateChange:e,onSubmit:o})]})})}var W,j,_;y.parameters={...y.parameters,docs:{...(W=y.parameters)==null?void 0:W.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
