import{h as f,j as t}from"./iframe-BYn0Dbkf.js";import{w as l}from"./withOsdkMetrics-C6gKOAoe.js";import{V as w}from"./VideoViewer-CYCKDZBl.js";import{p as h}from"./passthrough-6sm3BHV7.js";import"./preload-helper-Bs3XUXmU.js";import"./index-DAPmu22T.js";import"./useMediaContents-CcIJSA_e.js";import"./spin-zX9FGWGZ.js";import"./svgIconContainer-BVGjJ7Ho.js";import"./error-Ca0TYJkV.js";const o=l(w,"VideoViewer"),{fn:V}=__STORYBOOK_MODULE_TEST__,v="/osdk-ts/storybook/pr-3840/2f4ca64b11abf10bfa5846249f8610f7b1727512/example.mp4";function k(e,p){return{fetchContents:()=>fetch(e),fetchMetadata:()=>Promise.resolve({path:p,sizeBytes:0,mediaType:"video/mp4"}),getMediaReference:()=>({mimeType:"video/mp4",reference:{type:"mediaSetViewItem",mediaSetViewItem:{mediaItemRid:"ri.mio.main.media-item.mock-video",mediaSetRid:"ri.mio.main.media-set.mock-set",mediaSetViewRid:"ri.mio.main.media-set-view.mock-view"}}})}}const S=k(v,"example.mp4"),O={title:"Components/DocumentViewer/Renderers/VideoViewer",component:o,tags:["beta"],args:{media:S},render:e=>t.jsx("div",{style:{height:"400px",width:"600px"},children:t.jsx(o,{media:e.media,onError:e.onError})}),parameters:{controls:{expanded:!0},msw:{handlers:[f.get("*/example.mp4",()=>h())]}},argTypes:{media:{description:"The OSDK Media object to fetch video from",control:!1},className:{description:"Additional CSS class name for the root element",control:"text"},onError:{description:"Callback when the video fails to load",control:!1,table:{category:"Events"}}}},i={parameters:{docs:{source:{code:`import { VideoViewer } from "@osdk/react-components/experimental/video-viewer";
