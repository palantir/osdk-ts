...
/>`}}},render:({objectType:e,objectSet:n,...r})=>{const l=i.useMemo(()=>[K,J],[]);return t.jsx("div",{style:S,children:t.jsx(y,{objectType:p,filterDefinitions:l,...r})})}},ee={parameters:{docs:{description:{story:"Repro for the integer-typed `NUMBER_RANGE` rounding fix. `employeeNumber` is an `integer` property, so histogram bucket boundaries — `(maxValue - minValue) / 20` — are usually fractional. Click any bar in the histogram. The Min/Max boxes must show whole integers (e.g. `657495073`), not fractional values (e.g. `657495073.4`)."}}},render:({objectType:e,objectSet:n,...r})=>{const l=i.useMemo(()=>[Re],[]);return t.jsx("div",{style:S,children:t.jsx(y,{objectType:p,filterDefinitions:l,...r})})}};function Rr(e){const n=Ie(),r=i.useMemo(()=>n(p).where({department:"Marketing"}),[n]),l=i.useMemo(()=>[Oe,J],[]);return t.jsx("div",{style:S,children:t.jsx(y,{objectType:p,objectSet:r,filterDefinitions:l,...e})})}const te={parameters:{docs:{description:{story:"Pass an `objectSet` prop to scope filter aggregations to a subset of objects. Here the object set is filtered to Marketing department employees, so the listogram counts reflect only that subset."},source:{code:`const client = useOsdkClient();
...
/>`}}},render:e=>t.jsx(Ar,{...e})};function Lr(e){const[n,r]=i.useState(void 0),l=e.onFilterClauseChanged,o=i.useCallback(c=>{r(c),l==null||l(c)},[l]);return t.jsxs("div",{style:B,children:[t.jsx("div",{style:S,children:t.jsx(y,{objectType:p,filterDefinitions:O,...e,filterClause:n,onFilterClauseChanged:o})}),t.jsxs("div",{style:H,children:[t.jsx("strong",{children:"Filter Clause (JSON):"}),t.jsx("pre",{style:Q,children:n?JSON.stringify(n,null,2):"(no active filters)"})]})]})}const re={parameters:{docs:{description:{story:"All filter component types with a controlled where clause. Hover filter items to reveal search and exclude actions."},source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
...
/>`}}},render:e=>t.jsx(Lr,{...e})},ie={args:{title:"Employee Filters"},parameters:{docs:{source:{code:`<FilterList
  ...
  titleIcon={<svg>...</svg>}
/>`}}},render:({objectType:e,objectSet:n,...r})=>t.jsx("div",{style:S,children:t.jsx(y,{objectType:p,filterDefinitions:O,titleIcon:Tn,...r})})};function _r(e){const n=e.onReset,r=i.useCallback(()=>{console.log("Reset clicked"),n==null||n()},[n]);return t.jsx("div",{style:S,children:t.jsx(y,{objectType:p,filterDefinitions:O,...e,onReset:r})})}const le={args:{showResetButton:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  showResetButton={true}
  onReset={() => console.log("Reset clicked")}
/>`}}},render:e=>t.jsx(_r,{...e})},oe={args:{showActiveFilterCount:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
...
<FilterList objectType={Employee} filterDefinitions={filterDefinitions} />`}}},render:e=>t.jsx(Mr,{...e})},En={Marketing:"Marketing Dept.",Operations:"Ops Team",Finance:"Finance & Accounting",Product:"Product Group"};function kr(e){const n=i.useMemo(()=>[{type:"PROPERTY",id:"department-default",key:"department",label:"Department (default)",filterComponent:"LISTOGRAM",filterState:{type:"EXACT_MATCH",values:[]}}],[]),r=i.useMemo(()=>[{type:"PROPERTY",id:"department-custom",key:"department",label:"Department (custom render)",filterComponent:"LISTOGRAM",filterState:{type:"EXACT_MATCH",values:[]},renderValue:l=>En[l]??l},{type:"PROPERTY",id:"team-custom",key:"team",label:"Team (custom render)",filterComponent:"MULTI_SELECT",filterState:{type:"SELECT",selectedValues:[]},renderValue:l=>l.toUpperCase()}],[]);return t.jsxs("div",{style:B,children:[t.jsx("div",{style:S,children:t.jsx(y,{objectType:p,filterDefinitions:n,...e})}),t.jsx("div",{style:S,children:t.jsx(y,{objectType:p,filterDefinitions:r,...e})})]})}const ue={parameters:{docs:{description:{story:"Use `renderValue` to customize how filter values are displayed and searched. The returned string replaces the raw value for display and search matching. Works with LISTOGRAM, MULTI_SELECT, and SINGLE_SELECT components."},source:{code:`const DEPARTMENT_LABELS = {
...
</div>`}}},render:e=>t.jsx(Br,{...e})};function Wr(e){const n=Ie(),r=i.useMemo(()=>n(p).where({department:"Marketing"}),[n]),[l,o]=i.useState(void 0),c=e.onFilterClauseChanged,d=i.useCallback(a=>{o(a),c==null||c(a)},[c]);return t.jsxs("div",{style:xe,children:[t.jsx("div",{style:Pe,children:t.jsx(y,{objectType:p,objectSet:r,filterDefinitions:O,...e,filterClause:l,onFilterClauseChanged:d})}),t.jsx("div",{style:H,children:t.jsx(De,{objectType:p,objectSet:r,filter:l})})]})}const he={args:{title:"Marketing Employees",showResetButton:!0,showActiveFilterCount:!0},parameters:{docs:{description:{story:"Demonstrates using a pre-filtered objectSet to scope both FilterList aggregations and ObjectTable data to a subset of employees."},source:{code:`const client = useOsdkClient();
...
<FilterList
  ...
  filterClause={filterClause}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:e=>t.jsx(Ur,{...e})};function Xr({filterState:e,onFilterStateChanged:n}){const r=i.useCallback(o=>{const c=o.target.value;n({type:"custom",customState:{value:c}})},[n]),l=i.useCallback(()=>{n({type:"custom",customState:{value:""}})},[n]);return t.jsxs("div",{style:{padding:"12px 0",display:"flex",gap:"8px"},children:[t.jsx("input",{type:"text",value:e.customState.value,onChange:r,placeholder:"Enter name substring...",style:{flex:1,padding:"6px 8px",fontSize:"14px",border:"1px solid #ccc",borderRadius:"4px"}}),e.customState.value&&t.jsx("button",{onClick:l,style:{padding:"6px 12px",fontSize:"12px",backgroundColor:"#f5f5f5",border:"1px solid #ccc",borderRadius:"4px",cursor:"pointer"},children:"Clear"})]})}function Kr(e){const[n,r]=i.useState(void 0),l=i.useMemo(()=>[{type:"CUSTOM",key:"custom-name-contains",label:"Name Contains",filterComponent:"CUSTOM",filterState:{type:"custom",customState:{value:""}},renderInput:({filterState:d,onFilterStateChanged:a})=>t.jsx(Xr,{filterState:d,onFilterStateChanged:a}),toWhereClause:d=>{var E;const a=(E=d.customState)==null?void 0:E.value;if(a)return{fullName:{$containsAnyTerm:a}}}}],[]),o=e.onFilterClauseChanged,c=i.useCallback(d=>{r(d),o==null||o(d)},[o]);return t.jsxs("div",{style:B,children:[t.jsx("div",{style:S,children:t.jsx(y,{objectType:p,filterDefinitions:l,...e,filterClause:n,onFilterClauseChanged:c})}),t.jsxs("div",{style:H,children:[t.jsx("strong",{children:"Filter Clause (JSON):"}),t.jsx("pre",{style:Q,children:n?JSON.stringify(n,null,2):"(no active filters)"})]})]})}const ge={name:"Custom Filters",parameters:{docs:{description:{story:"Custom filters provide full control over filtering logic and UI. The 'Name Contains' filter uses `renderInput` for a simple custom input. "},source:{code:`// Custom filter with renderInput
...
}`,...(rn=(nn=be.parameters)==null?void 0:nn.docs)==null?void 0:rn.source}}};var ln,on,sn;ge.parameters={...ge.parameters,docs:{...(ln=ge.parameters)==null?void 0:ln.docs,source:{originalSource:`{
  name: "Custom Filters",
  parameters: {
    docs: {
      description: {
...
}`,...(mn=(pn=Fe.parameters)==null?void 0:pn.docs)==null?void 0:mn.source}}};const tl=["Default","IntegerNumberRangeRounding","WithObjectSet","AddFilterMode","WithAllFilterTypes","WithTitleAndIcon","WithResetButton","WithActiveFilterCount","WithSorting","CollapsiblePanel","KeywordSearch","WithColorMap","WithRenderValue","WithRenderValueAsReactNode","WithListogramDisplayModes","WithHiddenCounts","WithCheckbox","CombinedWithObjectTable","CombinedWithFilteredObjectSet","WithRemovableFilters","WithStaticValues","FullFeatured","WithHasLinkFilter","WithCustomFilters","NoValueRendering","WithInitialFilterStates"];export{ne as AddFilterMode,ae as CollapsiblePanel,he as CombinedWithFilteredObjectSet,Ce as CombinedWithObjectTable,Z as Default,Ee as FullFeatured,ee as IntegerNumberRangeRounding,ce as KeywordSearch,ve as NoValueRendering,oe as WithActiveFilterCount,re as WithAllFilterTypes,ye as WithCheckbox,de as WithColorMap,ge as WithCustomFilters,be as WithHasLinkFilter,fe as WithHiddenCounts,Fe as WithInitialFilterStates,me as WithListogramDisplayModes,te as WithObjectSet,Se as WithRemovableFilters,ue as WithRenderValue,pe as WithRenderValueAsReactNode,le as WithResetButton,se as WithSorting,Te as WithStaticValues,ie as WithTitleAndIcon,tl as __namedExportsOrder,el as default};
