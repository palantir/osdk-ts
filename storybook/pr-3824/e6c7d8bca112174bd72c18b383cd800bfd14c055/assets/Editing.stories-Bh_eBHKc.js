...
return (
  ...
  />
);`}}},render:e=>i.jsxs("div",{className:"object-table-container",style:{height:"600px"},children:[i.jsxs("div",{style:{padding:"12px",backgroundColor:"#fff3cd",marginBottom:"8px",borderRadius:"4px"},children:["Try editing cells with invalid values to see validation in action:",i.jsxs("ul",{style:{margin:"8px 0 0 20px"},children:[i.jsx("li",{children:"Name must be at least 2 characters"}),i.jsx("li",{children:"Email must be a valid format"}),i.jsx("li",{children:"Employee number must be positive"}),i.jsx("li",{children:"Job title is required"}),i.jsx("li",{children:"Start date is required"})]})]}),i.jsx(h,{...e,objectType:m})]}),play:async({canvasElement:e})=>{const t=r(e),a=await t.findByDisplayValue(c);await n.click(a),await n.clear(a),await n.type(a,"a"),await n.tab(),await d(()=>o(t.getByText("Validation error")).toBeInTheDocument()),await o(t.getByRole("button",{name:"Submit Edits"})).toBeDisabled(),await n.click(a),await n.clear(a),await n.type(a,"Valid Name"),await n.tab(),await d(()=>o(t.queryByText("Validation error")).not.toBeInTheDocument()),await o(t.getByRole("button",{name:"Submit Edits"})).toBeEnabled(),await n.click(a),await n.clear(a),await n.type(a,c),await n.tab(),await d(()=>o(t.getByDisplayValue(c)).toBeInTheDocument())}},E={args:{objectType:m,columnDefinitions:A,editMode:"manual",onSubmitEdits:v(async e=>(await new Promise(t=>setTimeout(t,1e3)),!0))},parameters:{docs:{source:{code:`const columnDefinitions = [
  {
    locator: { type: "property", id: "fullName" },
    editable: true,
  },
...
return (
  <ObjectTable
    ...
    editMode="always"
  />
);`}}},render:e=>i.jsxs("div",{className:"object-table-container",style:{height:"600px"},children:[i.jsx("div",{style:{padding:"12px",backgroundColor:"#fff3cd",marginBottom:"8px",borderRadius:"4px"},children:'JobTitle is only editable for "Senior Product Manager" rows. Department dropdown shows only 2 options for Operations rows.'}),i.jsx(h,{...e})]}),play:async({canvasElement:e})=>{const t=r(e);await t.findByText(c);const a=r(g(t.getByText("Margaret Jackson"))).getAllByRole("cell");await o(a[1]).toHaveAttribute("data-editable","true");const p=r(g(t.getByText(c))).getAllByRole("cell");await o(p[1]).not.toHaveAttribute("data-editable");const l=g(t.getByText("William Liu"));await n.click(t.getByText("William Liu")),D.click(await r(l).findByRole("combobox")),await o(await u.findAllByRole("option")).toHaveLength(2),await o(u.queryByRole("option",{name:"Finance"})).not.toBeInTheDocument(),await n.keyboard("{Escape}");const s=g(t.getByText(c));await n.click(t.getByText(c)),D.click(await r(s).findByRole("combobox")),await o(await u.findByRole("option",{name:"Finance"})).toBeInTheDocument(),await n.keyboard("{Escape}"),await d(()=>o(u.queryByRole("option",{name:"Finance"})).not.toBeInTheDocument())}};var x,R,S;f.parameters={...f.parameters,docs:{...(x=f.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
...
return (
  ...
  args: {
    ...
    columnDefinitions: [{
      ...
      cellValueType: "string",
      renderCell: (obj, _, value) => <span style={{
        fontStyle: "italic",
        color: "grey"
      }}>
            {value as string}
