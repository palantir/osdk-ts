import{r as T,j as i}from"./iframe-Xc_JH78I.js";import{O as C}from"./object-table-BR6CYbjf.js";import{E as m}from"./Employee-BAk2o20h.js";import{f as A,o as W,T as c,r as g}from"./objectTableStoryHelpers-DuCUOgsO.js";import"./preload-helper-AYl1pujm.js";import"./debounce-DutYdFha.js";import"./useOsdkClient-B2D2VKmh.js";import"./svgIconContainer-CQmggZ37.js";import"./Input-BFx2x6nA.js";import"./useBaseUiId-BI3SiDaB.js";import"./index-BLCrQc9J.js";import"./index-CsuxBpJ0.js";import"./PopoverPopup-Dcn1i5iK.js";import"./ToolbarRootContext-we2pFgZ9.js";import"./index-BeTbant5.js";import"./tick-D1opSoSV.js";import"./CompositeItem-B_3aLVYQ.js";import"./Dialog-DopQ8wFf.js";import"./makeExternalStore-DfyUf4Br.js";import"./PortalContainerContext-BOrecAxh.js";import"./Tooltip-DWx_5x0Q.js";import"./error-D-Pc-XbV.js";import"./CollapsiblePanel-BR5_TCy1.js";import"./Checkbox-DEpZizfX.js";import"./ActionButton-wws9nTvA.js";import"./index-Bp1R9O-s.js";import"./withOsdkMetrics-CzAtW5Pc.js";const{expect:o,fireEvent:D,fn:h,screen:p,userEvent:n,waitFor:d,within:l}=__STORYBOOK_MODULE_TEST__,me={...W,title:"Components/ObjectTable/Features/Editing"},f={args:{objectType:m,columnDefinitions:A,editMode:"manual",onCellValueChanged:h()},parameters:{docs:{source:{code:`const columnDefinitions = [
  {
...
return (
  <ObjectTable
    ...
    editMode="always"
  />
);`}}},render:e=>i.jsxs("div",{className:"object-table-container",style:{height:"600px"},children:[i.jsx("div",{style:{padding:"12px",backgroundColor:"#fff3cd",marginBottom:"8px",borderRadius:"4px"},children:'JobTitle is only editable for "Senior Product Manager" rows. Department dropdown shows only 2 options for Operations rows.'}),i.jsx(C,{...e})]}),play:async({canvasElement:e})=>{const t=l(e);await t.findByText(c);const a=l(g(t.getByText("Margaret Jackson"))).getAllByRole("cell");await o(a[1]).toHaveAttribute("data-editable","true");const u=l(g(t.getByText(c))).getAllByRole("cell");await o(u[1]).not.toHaveAttribute("data-editable");const r=g(t.getByText("William Liu"));await n.click(t.getByText("William Liu")),D.click(await l(r).findByRole("combobox")),await o(await p.findAllByRole("option")).toHaveLength(2),await o(p.queryByRole("option",{name:"Finance"})).not.toBeInTheDocument(),await n.keyboard("{Escape}");const s=g(t.getByText(c));await n.click(t.getByText(c)),D.click(await l(s).findByRole("combobox")),await o(await p.findByRole("option",{name:"Finance"})).toBeInTheDocument(),await n.keyboard("{Escape}"),await d(()=>o(p.queryByRole("option",{name:"Finance"})).not.toBeInTheDocument())}};var x,R,S;f.parameters={...f.parameters,docs:{...(x=f.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
...
}`,...(V=(I=v.parameters)==null?void 0:I.docs)==null?void 0:V.source}}};const ye=["EditableTable","EditableWithValidation","WithSubmitEditsButton","PerRowEditableAndFieldConfig"];export{f as EditableTable,w as EditableWithValidation,v as PerRowEditableAndFieldConfig,E as WithSubmitEditsButton,ye as __namedExportsOrder,me as default};
