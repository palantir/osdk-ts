...
/>`}}},render:e=>n.jsxs("div",{className:"object-table-container",style:{height:"600px"},children:[n.jsx("div",{style:{padding:"12px"},children:"Right click on any cell"}),n.jsx(z,{...e})]}),play:async({canvasElement:e})=>{const l=R(e);await l.findByText(w),ne.contextMenu(l.getByText(w)),await i(await b.findByText("Cell Value:")).toBeInTheDocument(),await u.click(l.getByText("Right click on any cell")),await c(()=>i(b.queryByText("Cell Value:")).not.toBeInTheDocument())}},y={args:{objectType:L,columnDefinitions:N,selectionMode:"multiple",selectedRows:[],orderBy:[{property:"fullName",direction:"asc"}],onRowClick:s(),onColumnHeaderClick:s(),onRowSelectionChanged:s(),onOrderByChanged:s(),onColumnVisibilityChanged:s(),onColumnsPinnedChanged:s(),onColumnResize:s(),onFocusedRowChanged:s(),onLoadedObjectsChanged:s()},parameters:{docs:{source:{code:`<ObjectTable
  objectType={Employee}
...
/>`}}},render:e=>{const[l,d]=a.useState(null),[m,v]=a.useState(null),[h,x]=a.useState([]),[V,A]=a.useState(!1),[C,M]=a.useState([{property:"fullName",direction:"asc"}]),[I,r]=a.useState(""),[P,D]=a.useState(0),[F,W]=a.useState(void 0),_=a.useCallback(o=>{var t;(t=e.onRowClick)==null||t.call(e,o),d(o),r("onRowClick")},[e]),$=a.useCallback(o=>{var t;(t=e.onColumnHeaderClick)==null||t.call(e,o),v(o),r("onColumnHeaderClick")},[e]),G=a.useCallback(o=>{var t;(t=e.onRowSelectionChanged)==null||t.call(e,o),x(o.selectedRows.map(g=>g.$primaryKey)),A(o.isSelectAll),r("onRowSelectionChanged")},[e]),K=a.useCallback(o=>{var t;(t=e.onOrderByChanged)==null||t.call(e,o),M(o),r("onOrderByChanged")},[e]),q=a.useCallback(o=>{var t;(t=e.onColumnVisibilityChanged)==null||t.call(e,o),r("onColumnVisibilityChanged")},[e]),U=a.useCallback(o=>{var t;(t=e.onColumnsPinnedChanged)==null||t.call(e,o),r("onColumnsPinnedChanged")},[e]),Y=a.useCallback((o,t)=>{var g;(g=e.onColumnResize)==null||g.call(e,o,t),r(`onColumnResize (${o})`)},[e]),J=a.useCallback(o=>{var t;(t=e.onLoadedObjectsChanged)==null||t.call(e,o),D(o.loadedObjects.length),W(o.totalCount),r("onLoadedObjectsChanged")},[e]);return n.jsxs("div",{children:[n.jsxs("div",{style:{marginBottom:"16px",padding:"12px",backgroundColor:"#f0f9ff",borderRadius:"4px",border:"1px solid #bfdbfe"},children:[n.jsx("div",{style:{marginBottom:"8px",fontWeight:"bold"},children:"Event Monitor:"}),n.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[n.jsx("strong",{children:"Last event:"})," ",I||"None"]}),n.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[n.jsx("strong",{children:"Row clicked:"})," ",l?n.jsx("code",{children:l.fullName}):"None"]}),n.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[n.jsx("strong",{children:"Column clicked:"})," ",m?n.jsx("code",{children:m}):"None"]}),n.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[n.jsx("strong",{children:"Selected rows:"})," ",V?"All employees":`${h.length} employees`]}),n.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[n.jsx("strong",{children:"Current sort:"})," ",C!=null&&C[0]?`${C[0].property} (${C[0].direction})`:"None"]}),n.jsxs("div",{style:{fontSize:"12px"},children:[n.jsx("strong",{children:"Loaded objects:"})," ",n.jsxs("code",{children:[P," of ",F??"unknown"]})]})]}),n.jsx("div",{className:"object-table-container",style:{height:"300px"},children:n.jsx(z,{...e,selectedRows:h,orderBy:C,pageSize:10,onRowClick:_,onColumnHeaderClick:$,onRowSelectionChanged:G,onOrderByChanged:K,onColumnVisibilityChanged:q,onColumnsPinnedChanged:U,onColumnResize:Y,onLoadedObjectsChanged:J})})]})},play:async({canvasElement:e,args:l})=>{const d=R(e),m=ee(d);await d.findByText(w),await c(()=>i(l.onLoadedObjectsChanged).toHaveBeenCalledWith(i.objectContaining({loadedObjects:i.arrayContaining([i.anything()])}))),await u.click(d.getByText(w)),await c(()=>i(l.onRowClick).toHaveBeenCalled()),await i(l.onFocusedRowChanged).toHaveBeenCalled();const v=await S(d,"fullName");await u.click(R(v).getByText("Name")),await c(()=>i(l.onColumnHeaderClick).toHaveBeenCalledWith("fullName")),await u.click((await m())[0]),await c(()=>i(l.onRowSelectionChanged).toHaveBeenCalled()),await k(d,"fullName"),await f("Sort descending"),await c(()=>i(l.onOrderByChanged).toHaveBeenCalled()),await k(d,"fullName"),await f("Pin column"),await c(()=>i(l.onColumnsPinnedChanged).toHaveBeenCalled()),await X(await S(d,"fullName"),100),await c(()=>i(l.onColumnResize).toHaveBeenCalled()),await k(d,"fullName"),await f("Configure Columns");const h=await b.findAllByRole("button",{name:/^Remove /u});await u.click(h[0]),await u.click(await b.findByRole("button",{name:"Apply"})),await c(()=>i(l.onColumnVisibilityChanged).toHaveBeenCalled()),await u.click(await Z(d)),await c(async()=>{for(const x of await m())i(x).not.toBeChecked()})}};var B,j,O;p.parameters={...p.parameters,docs:{...(B=p.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
...
}`,...(H=(E=y.parameters)==null?void 0:E.docs)==null?void 0:H.source}}};const Ee=["WithContextMenu","EventListeners"];export{y as EventListeners,p as WithContextMenu,Ee as __namedExportsOrder,Te as default};
