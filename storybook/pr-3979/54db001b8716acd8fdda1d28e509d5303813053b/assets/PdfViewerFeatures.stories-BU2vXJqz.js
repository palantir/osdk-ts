import{m as he,h as le,j as n,r as x}from"./iframe-Xc_JH78I.js";import{P as v}from"./pdf-viewer-C33F1GDH.js";import{B as r}from"./PdfViewer-DFM3n76K.js";import"./preload-helper-AYl1pujm.js";import"./withOsdkMetrics-CzAtW5Pc.js";import"./svgIconContainer-CQmggZ37.js";import"./useBaseUiId-BI3SiDaB.js";import"./Input-BFx2x6nA.js";import"./index-BLCrQc9J.js";import"./index-CsuxBpJ0.js";import"./CompositeRoot-DQx8BA1N.js";import"./CompositeItem-B_3aLVYQ.js";import"./ToolbarRootContext-we2pFgZ9.js";import"./index-Bp1R9O-s.js";import"./chevron-right-B5er9inO.js";import"./spin-BsDWnG40.js";import"./error-D-Pc-XbV.js";const pe=2147483647,k=100,ue=400,ge=5;function fe(){return he()?ge:Math.floor(Math.random()*(ue-k)+k)}async function be(e){let t;switch(e){case"infinite":{t=pe;break}case"real":{t=fe();break}default:throw new Error(`Failed to delay a response: unknown delay mode "${e}". Please make sure you provide one of the supported modes ("real", "infinite") or a number.`)}return new Promise(a=>setTimeout(a,t))}const{fn:o}=__STORYBOOK_MODULE_TEST__,y="/osdk-ts/storybook/pr-3979/54db001b8716acd8fdda1d28e509d5303813053b/compressed.tracemonkey-pldi-09.pdf",we="/osdk-ts/storybook/pr-3979/54db001b8716acd8fdda1d28e509d5303813053b/nested_outline.pdf";function me(e,t){return{fetchContents:()=>fetch(e),fetchMetadata:()=>Promise.resolve({path:t,sizeBytes:1024e3,mediaType:"application/pdf"}),getMediaReference:()=>({mimeType:"application/pdf",reference:{type:"mediaSetViewItem",mediaSetViewItem:{mediaItemRid:"ri.mio.main.media-item.mock-pdf",mediaSetRid:"ri.mio.main.media-set.mock-set",mediaSetViewRid:"ri.mio.main.media-set-view.mock-view"}}})}}const ye=me(y,"compressed.tracemonkey-pldi-09.pdf"),Pe=me(we,"pdf-example-bookmarks.pdf"),Le={title:"Components/DocumentViewer/Renderers/PdfViewer/Features",component:v,tags:["beta"],args:{media:ye},render:e=>n.jsx("div",{style:{height:"600px"},children:n.jsx(v,{...e})}),parameters:{controls:{expanded:!0}},argTypes:{media:{description:"The Media object to fetch PDF contents from",control:!1},annotations:{description:"Annotations to overlay on the PDF",control:"object"},onAnnotationClick:{description:"Callback fired when an annotation is clicked",control:!1,table:{category:"Events"}},defaultPage:{description:"Page to display on first render (1-indexed)",control:"number",table:{defaultValue:{summary:"1"}}},defaultScale:{description:"Initial zoom scale",control:"number",table:{defaultValue:{summary:"1.0"}}},defaultSidebarOpen:{description:"Whether the thumbnail sidebar is initially open",control:"boolean",table:{defaultValue:{summary:"false"}}},enableDownload:{description:"Whether the download button is shown in the toolbar",control:"boolean",table:{defaultValue:{summary:"false"}}},sidebarMode:{description:"Which sidebar panel to show when the sidebar is open",control:"radio",options:["thumbnails","outline"],table:{defaultValue:{summary:'"thumbnails"'}}},outlineIcons:{description:"Custom icon components for each outline depth level (0-indexed)",control:!1},className:{description:"Additional CSS class name for the root element",control:"text"}}},i={args:{src:y},render:e=>n.jsx("div",{style:{height:"600px"},children:n.jsx(r,{...e})}),parameters:{docs:{source:{code:'<BasePdfViewer src="/compressed.tracemonkey-pldi-09.pdf" />'}}}};function Se({url:e}){const[t,a]=x.useState(void 0);return x.useEffect(()=>{let S=!1;return fetch(e).then(P=>P.blob()).then(P=>{S||a(P)}),()=>{S=!0}},[e]),n.jsx("div",{style:{height:"600px"},children:t==null?"Fetching PDF into a Blob…":n.jsx(r,{src:t})})}const s={render:()=>n.jsx(Se,{url:y}),parameters:{docs:{source:{code:`// src also accepts in-memory bytes: Blob, ArrayBuffer, or Uint8Array
...
/>`}}}},c={args:{defaultSidebarOpen:!0},parameters:{docs:{source:{code:"<PdfViewer media={myMediaObject} defaultSidebarOpen />"}}}},l={args:{defaultScale:1.5},parameters:{docs:{source:{code:"<PdfViewer media={myMediaObject} defaultScale={1.5} />"}}}},m={args:{defaultAutoSize:!0},parameters:{docs:{source:{code:"<PdfViewer media={myMediaObject} defaultAutoSize />"}}}},h={args:{enableDownload:!0},parameters:{docs:{source:{code:"<PdfViewer media={myMediaObject} enableDownload />"}}}},p={args:{defaultSidebarOpen:!0,sidebarMode:"outline"},parameters:{docs:{source:{code:'<PdfViewer media={myMediaObject} defaultSidebarOpen sidebarMode="outline" />'}}}},u={args:{src:"/loading.pdf"},render:e=>n.jsx("div",{style:{height:"600px"},children:n.jsx(r,{...e})}),parameters:{msw:{handlers:[le.get("/loading.pdf",async()=>{await be("infinite")})]},docs:{source:{code:`// Loading state handling is built-in
...
<BasePdfViewer src="/does-not-load.pdf" />`}}}};function xe({src:e,onTextHighlight:t,onHighlightDelete:a}){return n.jsx("div",{style:{height:"600px"},children:n.jsx(r,{src:e,enableHighlight:!0,onTextHighlight:t,onHighlightDelete:a})})}const f={args:{onTextHighlight:o(),onHighlightDelete:o()},render:e=>n.jsx(xe,{src:y,onTextHighlight:e.onTextHighlight,onHighlightDelete:e.onHighlightDelete}),parameters:{docs:{source:{code:`function MyPdfViewer({ src }: { src: string }) {
...
<PdfViewer
  ...
  defaultSidebarOpen
  sidebarMode="outline"
/>`}}}},w={args:{src:"/osdk-ts/storybook/pr-3979/54db001b8716acd8fdda1d28e509d5303813053b/interactive-form-pdf.pdf",onFormSubmit:o(),onFormChange:o()},render:e=>n.jsx("div",{style:{height:"600px"},children:n.jsx(r,{...e})}),parameters:{docs:{source:{code:`const handleFormChange = useCallback(
...
}`,...(I=(U=m.parameters)==null?void 0:U.docs)==null?void 0:I.source}}};var N,z,$;h.parameters={...h.parameters,docs:{...(N=h.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    enableDownload: true
  },
  parameters: {
...
}`,...($=(z=h.parameters)==null?void 0:z.docs)==null?void 0:$.source}}};var K,X,Y;p.parameters={...p.parameters,docs:{...(K=p.parameters)==null?void 0:K.docs,source:{originalSource:`{
  args: {
    defaultSidebarOpen: true,
    sidebarMode: "outline"
  },
...
}`,...(Y=(X=p.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};var q,G,J;u.parameters={...u.parameters,docs:{...(q=u.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    src: "/loading.pdf"
  },
  render: (args: BasePdfViewerProps) => <div style={{
...
}`,...(re=(te=f.parameters)==null?void 0:te.docs)==null?void 0:re.source}}};var ae,oe,ie;b.parameters={...b.parameters,docs:{...(ae=b.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  args: {
...
}`,...(ie=(oe=b.parameters)==null?void 0:oe.docs)==null?void 0:ie.source}}};var se,de,ce;w.parameters={...w.parameters,docs:{...(se=w.parameters)==null?void 0:se.docs,source:{originalSource:`{
  args: {
...
}`,...(ce=(de=w.parameters)==null?void 0:de.docs)==null?void 0:ce.source}}};const Ue=["WithPdfUrl","WithBlob","WithAnnotations","WithSidebar","CustomScale","WithAutoSize","WithDownload","WithOutlineSidebar","Loading","Error","WithHighlightMode","WithEmbeddedOutline","InteractiveForm"];export{l as CustomScale,g as Error,w as InteractiveForm,u as Loading,d as WithAnnotations,m as WithAutoSize,s as WithBlob,h as WithDownload,b as WithEmbeddedOutline,f as WithHighlightMode,p as WithOutlineSidebar,i as WithPdfUrl,c as WithSidebar,Ue as __namedExportsOrder,Le as default};
