import{R as a,O as Ee,i as Oe,r as b,k as ve,j as r,M as Ve}from"./iframe-BZU9bLsw.js";import{c as Me}from"./index-YojNNhCR.js";import{B as u}from"./PdfViewer-CILOT3fL.js";import{s as f,S as je}from"./PdfViewer.module.css-J2JF9SyD.js";import{E as Te}from"./error-BFG9jZ6s.js";import{w as De}from"./withOsdkMetrics-79iRjA7G.js";import{E as Ce}from"./Employee-BAk2o20h.js";import{m as R,d as N}from"./makeExternalStore-BQZSXPJq.js";import"./preload-helper-Dp1pzeXC.js";import"./index-CdpBY8AZ.js";import"./index-BSYZr_Su.js";import"./PdfViewerAnnotationLayer-BlymXbXl.js";import"./PdfViewerOutlineSidebar-BnbxyRtP.js";import"./PdfViewerSidebarHeader-C4DbfRKv.js";import"./useBaseUiId-CwOlRU25.js";import"./useControlled-CI0wXwPl.js";import"./CompositeRoot-CoxazsuV.js";import"./CompositeItem-Bq1PpBiN.js";import"./ToolbarRootContext-ChXgfMB1.js";import"./composite-BnPjvoOx.js";import"./svgIconContainer-Dm_tqUVb.js";import"./PdfViewerSearchBar-cI1KHiFt.js";import"./chevron-up-CG2uB2e5.js";import"./chevron-down-Dk74dcI0.js";import"./cross-CqnzaylW.js";import"./PdfViewerSidebar-BmcJz9Oe.js";import"./index-BJcoXTvz.js";import"./constants-rggtfkKZ.js";import"./PdfViewerToolbar-CJazM__x.js";import"./Button-Br_GgMkU.js";import"./chevron-right-BuBBODJR.js";import"./Input-C1OOaoLR.js";import"./minus-CodepCsQ.js";import"./usePdfDocument-Y8v5U4Fg.js";import"./useRegisterUserAgent-BjJGYsHH.js";function Ae(...e){const{observableClient:n}=a.useContext(Ee),i="$objectType"in e[0],o=!i&&e[2]!=null&&typeof e[2]=="object"?e[2]:void 0,l=i?typeof e[1]=="boolean"?e[1]:!0:o?o.enabled??!0:typeof e[2]=="boolean"?e[2]:!0,w=o==null?void 0:o.$select,m=o==null?void 0:o.$loadPropertySecurityMetadata,g=i?"offline":void 0,d=i?e[0].$objectType:e[0],c=i?e[0].$primaryKey:e[1],p=typeof d=="string"?d:d.apiName,s=a.useMemo(()=>w,[JSON.stringify(w)]),{subscribe:Se,getSnapShot:ke}=a.useMemo(()=>l?R(h=>n.observeObject(d,c,{mode:g,...s?{select:s}:{},...m?{$loadPropertySecurityMetadata:m}:{}},h),N({hookType:"useOsdkObject",objectType:p,primaryKey:String(c)})):R(()=>({unsubscribe:()=>{}}),N({hookType:"useOsdkObject",objectType:p,primaryKey:String(c)})),[l,n,d,p,c,g,s,m]),t=a.useSyncExternalStore(Se,ke),H=a.useCallback(()=>{throw new Error("not implemented")},[]);return a.useMemo(()=>{let h;return t&&"error"in t&&t.error?h=t.error:(t==null?void 0:t.status)==="error"&&(h=new Error("Failed to load object")),{object:t==null?void 0:t.object,isLoading:l&&h==null?(t==null?void 0:t.status)==="loading"||(t==null?void 0:t.status)==="init"||!t:!1,isOptimistic:!!(t!=null&&t.isOptimistic),error:h,forceUpdate:H}},[t,l,H])}const _e=2147483647,B=100,He=400,Re=5;function Ne(){return Oe()?Re:Math.floor(Math.random()*(He-B)+B)}async function Be(e){let n;switch(e){case"infinite":{n=_e;break}case"real":{n=Ne();break}default:throw new Error(`Failed to delay a response: unknown delay mode "${e}". Please make sure you provide one of the supported modes ("real", "infinite") or a number.`)}return new Promise(i=>setTimeout(i,n))}function C(){return C=Object.assign?Object.assign.bind():function(e){for(var n=1;n<arguments.length;n++){var i=arguments[n];for(var o in i)({}).hasOwnProperty.call(i,o)&&(e[o]=i[o])}return e},C.apply(null,arguments)}async function Fe(e){return(await e.fetchContents()).arrayBuffer()}function Le({media:e,className:n,...i}){const[o,l]=b.useState(void 0),[w,m]=b.useState(!0),[g,d]=b.useState(void 0);b.useEffect(function(){let p=!1;return m(!0),d(void 0),l(void 0),Fe(e).then(s=>{p||(l(s),m(!1))}).catch(s=>{p||(d(s instanceof Error?s:new Error(String(s))),m(!1))}),()=>{p=!0}},[e]);const c=Me(f.pdfViewer,n);return w?a.createElement("div",{className:c},a.createElement("div",{className:f.loadingContainer},a.createElement(je,{className:f.spinnerIcon}),"Loading…")):g!=null?a.createElement("div",{className:c},a.createElement("div",{className:f.errorContainer},a.createElement(Te,{className:f.errorIcon}),"Failed to load PDF: ",g.message)):o==null?a.createElement("div",{className:c},a.createElement("div",{className:f.loadingContainer},"No document")):a.createElement(u,C({src:o,className:n},i))}const A=De(Le,"PdfViewer"),{fn:y}=__STORYBOOK_MODULE_TEST__,_="./compressed.tracemonkey-pldi-09.pdf",Ie="./nested_outline.pdf";function Pe(e,n){return{fetchContents:()=>fetch(e),fetchMetadata:()=>Promise.resolve({path:n,sizeBytes:1024e3,mediaType:"application/pdf"}),getMediaReference:()=>({mimeType:"application/pdf",reference:{type:"mediaSetViewItem",mediaSetViewItem:{mediaItemRid:"ri.mio.main.media-item.mock-pdf",mediaSetRid:"ri.mio.main.media-set.mock-set",mediaSetViewRid:"ri.mio.main.media-set-view.mock-view"}}})}}const We=Pe(_,"compressed.tracemonkey-pldi-09.pdf"),Ue=Pe(Ie,"pdf-example-bookmarks.pdf"),Ot={title:"Experimental/PdfViewer/Features",tags:["experimental"],component:A,args:{media:We},render:e=>r.jsx("div",{style:{height:"600px"},children:r.jsx(A,{...e})}),parameters:{controls:{expanded:!0}},argTypes:{media:{description:"The Media object to fetch PDF contents from",control:!1},annotations:{description:"Annotations to overlay on the PDF",control:"object"},onAnnotationClick:{description:"Callback fired when an annotation is clicked",control:!1,table:{category:"Events"}},initialPage:{description:"Page to display on first render (1-indexed)",control:"number",table:{defaultValue:{summary:"1"}}},initialScale:{description:"Initial zoom scale",control:"number",table:{defaultValue:{summary:"1.0"}}},initialSidebarOpen:{description:"Whether the thumbnail sidebar is initially open",control:"boolean",table:{defaultValue:{summary:"false"}}},enableDownload:{description:"Whether the download button is shown in the toolbar",control:"boolean",table:{defaultValue:{summary:"false"}}},sidebarMode:{description:"Which sidebar panel to show when the sidebar is open",control:"radio",options:["thumbnails","outline"],table:{defaultValue:{summary:'"thumbnails"'}}},outlineIcons:{description:"Custom icon components for each outline depth level (0-indexed)",control:!1},className:{description:"Additional CSS class name for the root element",control:"text"}}},x={args:{src:_},render:e=>r.jsx("div",{style:{height:"600px"},children:r.jsx(u,{...e})}),parameters:{docs:{source:{code:`import { BasePdfViewer } from "@osdk/react-components/experimental/pdf-viewer";
...
<PdfViewer media={myMediaObject} initialSidebarOpen sidebarMode="outline" />`}}}},O={args:{src:"/loading.pdf"},render:e=>r.jsx("div",{style:{height:"600px"},children:r.jsx(u,{...e})}),parameters:{msw:{handlers:[ve.get("/loading.pdf",async()=>{await Be("infinite")})]}}},V={args:{src:"/error.pdf"},render:e=>r.jsx("div",{style:{height:"600px"},children:r.jsx(u,{...e})}),parameters:{msw:{handlers:[ve.get("/error.pdf",()=>new Response("Server Error",{status:500}))]}}};function $e({src:e,onTextHighlight:n,onHighlightDelete:i}){return r.jsx("div",{style:{height:"600px"},children:r.jsx(u,{src:e,enableHighlight:!0,onTextHighlight:n,onHighlightDelete:i})})}const M={args:{onTextHighlight:y(),onHighlightDelete:y()},render:e=>r.jsx($e,{src:_,onTextHighlight:e.onTextHighlight,onHighlightDelete:e.onHighlightDelete}),parameters:{docs:{source:{code:`import { useState, useCallback } from "react";
...
}`}}}},j={args:{media:Ue,initialSidebarOpen:!0,sidebarMode:"outline"}},T={args:{src:"./interactive-form-pdf.pdf",onFormSubmit:y(),onFormChange:y()},render:e=>r.jsx("div",{style:{height:"600px"},children:r.jsx(u,{...e})}),parameters:{docs:{source:{code:`import { BasePdfViewer } from "@osdk/react-components/experimental/pdf-viewer";
...
}`,...(de=(se=V.parameters)==null?void 0:se.docs)==null?void 0:de.source}}};var ce,le,me;M.parameters={...M.parameters,docs:{...(ce=M.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  args: {
    onTextHighlight: fn(),
...
}`,...(me=(le=M.parameters)==null?void 0:le.docs)==null?void 0:me.source}}};var pe,he,fe;j.parameters={...j.parameters,docs:{...(pe=j.parameters)==null?void 0:pe.docs,source:{originalSource:`{
  args: {
