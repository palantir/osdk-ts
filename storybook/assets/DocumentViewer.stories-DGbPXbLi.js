import{j as t,h as i,H as k}from"./iframe-9OpC_N8y.js";import{D as n}from"./document-viewer-BTsLzTDY.js";import{u as S,w as le}from"./SpreadsheetViewer-Bd9biGLm.js";import{p as b}from"./passthrough-6sm3BHV7.js";import"./preload-helper-Dp1pzeXC.js";import"./index-DSxditmY.js";import"./EmailViewer-BI6U93bR.js";import"./useMediaContents-BrPu109X.js";import"./spin-Ducn1lgj.js";import"./svgIconContainer-oJMft6mx.js";import"./error-BFjtkE9z.js";import"./ImageViewer-DmyKcVkj.js";import"./BaseImageViewer-DdAUP2iA.js";import"./BaseTiffViewer-Ba-bsne2.js";import"./index-YkV0U4e7.js";import"./BaseMarkdownViewer-DWl5BU0w.js";import"./PdfViewer-BlrXvEOT.js";import"./BasePdfViewer-C-1QLu3-.js";import"./BasePdfViewer.module.css-CepyKiQc.js";import"./PdfViewerAnnotationLayer-6YC8aZTm.js";import"./constants-DsXMS3N3.js";import"./usePdfDocument-CJhIW27f.js";import"./PdfViewerOutlineSidebar-B5sF3GoM.js";import"./PdfViewerSidebarHeader-Dc8DlHtB.js";import"./useBaseUiId-DBqP-0QL.js";import"./useControlled-B9BwmRqN.js";import"./CompositeRoot-48755dZU.js";import"./CompositeItem-BQvPBjhd.js";import"./ToolbarRootContext-D8Su1VOS.js";import"./composite-CrXso5kT.js";import"./PdfViewerSearchBar-Dl71wjT2.js";import"./chevron-up-Bp1xpvGi.js";import"./chevron-down-DRK_INXA.js";import"./cross-BfZJOFYH.js";import"./PdfViewerSidebar-Do2d1caL.js";import"./index-BDwZVFt2.js";import"./index-BYheStGz.js";import"./index-BWMAAzDl.js";import"./PdfViewerToolbar-DvlSHxjS.js";import"./Button-CEDTBjQ9.js";import"./chevron-right-Bc6WY_SH.js";import"./Input-22pjcFCD.js";import"./search-TnHR6DGv.js";import"./assertUnreachable-tCT10eXl.js";import"./VideoViewer-CmTjxhDy.js";import"./XmlViewer-4BY1hoUf.js";import"./useOsdkClient-nTvUHUDa.js";import"./withOsdkMetrics-BMtD0lPR.js";const de="./compressed.tracemonkey-pldi-09.pdf",fe="./example.mp4",ue="./multi-page-tiff.tiff";function he(){const e=document.createElement("canvas");e.width=200,e.height=200;const r=e.getContext("2d"),a=r.createLinearGradient(0,0,200,200);a.addColorStop(0,"#3b82f6"),a.addColorStop(.5,"#8b5cf6"),a.addColorStop(1,"#ec4899"),r.fillStyle=a,r.fillRect(0,0,200,200),r.fillStyle="white",r.font="bold 24px sans-serif",r.textAlign="center",r.textBaseline="middle",r.fillText("Sample",100,90),r.fillText("Image",100,120);const m=e.toDataURL("image/png"),s=atob(m.split(",")[1]),D=new Uint8Array(s.length);for(let d=0;d<s.length;d++)D[d]=s.charCodeAt(d);return new Blob([D],{type:"image/png"})}const ce=`# Sample Document
...
<DocumentViewer media={record.rawAttachment} />`}}}},h={args:{media:Ve},parameters:{docs:{source:{code:`// message/rfc822 media renders with EmailViewer
...
<DocumentViewer media={quarter.headcountReport} />`}}}},g={args:{media:ke},render:e=>t.jsx("div",{style:{height:"400px",width:"600px"},children:t.jsx(n,{...e})}),parameters:{docs:{source:{code:`// application/xml media renders with the collapsible-tree XmlViewer
...
<DocumentViewer media={myMedia} mimeTypeOverride="text/markdown" />`}}}},V={args:{media:v,pdfViewerProps:{initialSidebarOpen:!0,enableDownload:!0}},parameters:{docs:{source:{code:`<DocumentViewer
  media={myMedia}
  pdfViewerProps={{
...
}`,...(ie=(oe=y.parameters)==null?void 0:oe.docs)==null?void 0:ie.source}}};var ne,se,me;V.parameters={...V.parameters,docs:{...(ne=V.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  args: {
    media: mockPdfMedia,
    pdfViewerProps: {
      initialSidebarOpen: true,
...
}`,...(me=(se=V.parameters)==null?void 0:se.docs)==null?void 0:me.source}}};const Sr=["Pdf","Image","Markdown","Video","UnsupportedType","Email","Spreadsheet","Xml","Tiff","TiffWithPdfConversion","WithMimeTypeOverride","WithPdfViewerProps"];export{h as Email,p as Image,l as Markdown,c as Pdf,w as Spreadsheet,x as Tiff,M as TiffWithPdfConversion,u as UnsupportedType,f as Video,y as WithMimeTypeOverride,V as WithPdfViewerProps,g as Xml,Sr as __namedExportsOrder,kr as default};
