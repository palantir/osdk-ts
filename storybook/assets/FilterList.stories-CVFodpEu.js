...
/>`}}},render:({objectType:t,objectSet:n,...i})=>{const r=o.useMemo(()=>[g,v],[]);return e.jsx("div",{style:u,children:e.jsx(a,{objectType:s,filterDefinitions:r,...i})})}},F={parameters:{docs:{description:{story:"Repro for the integer-typed `NUMBER_RANGE` rounding fix. `employeeNumber` is an `integer` property, so histogram bucket boundaries — `(maxValue - minValue) / 20` — are usually fractional. Click any bar in the histogram. The Min/Max boxes must show whole integers (e.g. `657495073`), not fractional values (e.g. `657495073.4`)."},source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={[
    {
      type: "PROPERTY",
...
/>`}}},render:({objectType:t,objectSet:n,...i})=>{const r=o.useMemo(()=>[te],[]);return e.jsx("div",{style:u,children:e.jsx(a,{objectType:s,filterDefinitions:r,...i})})}};function $t(t){const n=ee(),i=o.useMemo(()=>n(s).where({department:"Marketing"}),[n]),r=o.useMemo(()=>[ne,v],[]);return e.jsx("div",{style:u,children:e.jsx(a,{objectType:s,objectSet:i,filterDefinitions:r,...t})})}const M={parameters:{docs:{description:{story:"Pass an `objectSet` prop to scope filter aggregations to a subset of objects. Here the object set is filtered to Marketing department employees, so the listogram counts reflect only that subset."},source:{code:`const client = useOsdkClient();
...
/>`}}},render:t=>e.jsx($t,{...t})};function Qt(t){const n=o.useMemo(()=>[g,ne,{...Wt,isVisible:!1},{...Ht,isVisible:!1},{...te,isVisible:!1},{...v,isVisible:!1}],[]);return e.jsx("div",{style:u,children:e.jsx(a,{objectType:s,filterDefinitions:n,addFilterMode:"uncontrolled",...t})})}const j={args:{showResetButton:!0},parameters:{docs:{source:{code:`const filterDefinitions = [
  { type: "PROPERTY", key: "department", label: "Department", filterComponent: "LISTOGRAM", filterState: { type: "EXACT_MATCH", values: [] } },
  { type: "PROPERTY", key: "team", label: "Team", filterComponent: "LISTOGRAM", filterState: { type: "EXACT_MATCH", values: [] } },
...
/>`}}},render:t=>e.jsx(Zt,{...t})},k={args:{title:"Employee Filters"},parameters:{docs:{source:{code:`<FilterList
  ...
  titleIcon={<svg>...</svg>}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:u,children:e.jsx(a,{objectType:s,filterDefinitions:E,titleIcon:Xt,...i})})};function en(t){const n=t.onReset,i=o.useCallback(()=>{console.log("Reset clicked"),n==null||n()},[n]);return e.jsx("div",{style:u,children:e.jsx(a,{objectType:s,filterDefinitions:E,...t,onReset:i})})}const O={args:{showResetButton:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  showResetButton={true}
  onReset={() => console.log("Reset clicked")}
/>`}}},render:t=>e.jsx(en,{...t})},P={args:{showActiveFilterCount:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  showActiveFilterCount={true}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:u,children:e.jsx(a,{objectType:s,filterDefinitions:E,...i})})},_={args:{enableSorting:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  enableSorting={true}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:u,children:e.jsx(a,{objectType:s,filterDefinitions:E,...i})})};function tn(t){return e.jsx("div",{style:u,children:e.jsx(a,{objectType:s,filterDefinitions:E,...t})})}const I={args:{title:"Employee Filters",showActiveFilterCount:!0},parameters:{docs:{description:{story:"Click the collapse button to minimize the filter panel. Active filter count is shown in the collapsed state."},source:{code:`const [collapsed, setCollapsed] = useState(false);
...
<FilterList
  ...
  filterClause={filterClause}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(yn,{...t})};function Cn(t){const[n,i]=o.useState(void 0),[r,l]=o.useState(E),c=t.onFilterRemoved,p=o.useCallback(T=>{l(L=>L.filter(re=>"key"in re?re.key!==T:!0)),c==null||c(T)},[c]),d=t.onReset,f=o.useCallback(()=>{l(E),d==null||d()},[d]),m=t.onFilterClauseChanged,y=o.useCallback(T=>{i(T),m==null||m(T)},[m]);return e.jsxs("div",{style:Bt,children:[e.jsx("div",{style:Ut,children:e.jsx(a,{objectType:s,filterDefinitions:r,titleIcon:Xt,...t,onReset:f,onFilterRemoved:p,filterClause:n,onFilterClauseChanged:y})}),e.jsx("div",{style:S,children:e.jsx(Yt,{objectType:s,filter:n})})]})}const X={name:"Full Featured",args:{title:"Employee Filters",showResetButton:!0,showActiveFilterCount:!0,enableSorting:!0},parameters:{docs:{description:{story:"Demonstrates all filter list features together: collapse, reset, active count, sorting, removable filters, per-filter search, exclude toggle, and controlled where clause driving an ObjectTable."},source:{code:`// All features combined: collapse, sort, search, exclude, remove, reset
...
<FilterList
  ...
  filterClause={filterClause}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>{const[,n]=Gt(),i=t.onCollapsedChange,r=o.useCallback(l=>{n({collapsed:l}),i==null||i(l)},[n,i]);return e.jsx(Cn,{...t,onCollapsedChange:r})}};function Tn(t){const n=ee(),i=o.useMemo(()=>n(s),[n]),[r,l]=o.useState(void 0),c=o.useMemo(()=>[{type:"HAS_LINK",linkName:"lead",label:"Has Manager",filterState:{type:"hasLink",hasLink:!1}},{type:"LINKED_PROPERTY",linkName:"lead",reverseLinkName:"peeps",linkedPropertyKey:"department",linkedFilterComponent:"MULTI_SELECT",linkedFilterState:{type:"SELECT",selectedValues:[]},filterState:{type:"linkedProperty",linkedFilterState:{type:"SELECT",selectedValues:[]}},label:"Manager Department"}],[]),p=t.onFilterClauseChanged,d=o.useCallback(f=>{l(f),p==null||p(f)},[p]);return e.jsxs("div",{style:C,children:[e.jsx("div",{style:u,children:e.jsx(a,{objectType:s,objectSet:i,filterDefinitions:c,...t,filterClause:r,onFilterClauseChanged:d})}),e.jsxs("div",{style:S,children:[e.jsx("strong",{children:"Filter Clause (JSON):"}),e.jsx("p",{children:"Note: LINKED_PROPERTY filter is not applied through where clause"}),e.jsx("pre",{style:b,children:r?JSON.stringify(r,null,2):"(no active filters)"})]})]})}const K={name:"Linked Property Filters",parameters:{docs:{description:{story:"Demonstrates filtering on properties of linked objects. HAS_LINK filters objects based on whether they have a linked object. LINKED_PROPERTY filters on a property of the linked object and exposes the same overflow (…) controls as direct property filters — the inline Keeping/Excluding dropdown and Clear all."},source:{code:`// HAS_LINK and LINKED_PROPERTY filter definitions
const filterDefinitions = [
  {
    type: "HAS_LINK",
    linkName: "lead",
...
<FilterList
  ...
  filterClause={filterClause}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(Ln,{...t})},An={type:"PROPERTY",id:"department-multi",key:"department",label:"Department",filterComponent:"MULTI_SELECT",filterState:{type:"SELECT",selectedValues:[]}},Fn={type:"PROPERTY",id:"department-single",key:"department",label:"Department (single)",filterComponent:"SINGLE_SELECT",filterState:{type:"SELECT",selectedValues:[]}},Mn=[g,An,Fn,te],q={name:"No value rendering",parameters:{docs:{description:{story:"Empty/null filter values render via the canonical `<NoValueLabel />` component — italic, muted, with the literal text 'No value' — across listogram buckets, single-select dropdown options, multi-select dropdown options, and multi-select chips. The mock dataset includes one Employee with `department: \"\"` so the No value row is visible in the listogram."},source:{code:`// Empty/null values render via <NoValueLabel /> across every filter type.
<FilterList
  objectType={Employee}
  filterDefinitions={[
    {
...
/>`}}},render:t=>e.jsx(_n,{...t})},ae=[g,ie],In=new Map([["department",{type:"EXACT_MATCH",values:["Engineering"]}],["jobTitle-multi",{type:"SELECT",selectedValues:["Software Engineer"]}]]);function ce(t){const n=[...t.keys()].sort(),i={};for(const r of n){const l=t.get(r);l!==void 0&&(i[r]=l)}return JSON.stringify(i,null,2)}function Jt({initialFilterStates:t,storyArgs:n}){const i=o.useMemo(()=>{const m=new Map;for(const y of ae)y.type==="PROPERTY"&&y.filterState&&m.set(oe(y),y.filterState);if(t)for(const[y,T]of t)m.set(y,T);return m},[t]),[r,l]=o.useState(()=>new Map(i)),c=n.onFilterStateChanged,p=o.useCallback((m,y)=>{l(T=>{const L=new Map(T);return L.set(oe(m),y),L}),c==null||c(m,y)},[c]),d=n.onReset,f=o.useCallback(()=>{l(new Map(i)),d==null||d()},[d,i]);return e.jsxs("div",{style:C,children:[e.jsx("div",{style:u,children:e.jsx(a,{...n,objectType:s,filterDefinitions:ae,initialFilterStates:t,showResetButton:!0,onFilterStateChanged:p,onReset:f})}),e.jsxs("div",{style:S,children:[e.jsx("h4",{children:"Filter state dump"}),e.jsx("pre",{"data-testid":"filter-state-dump",style:b,children:ce(r)}),e.jsx("h4",{children:"Initial snapshot"}),e.jsx("pre",{"data-testid":"filter-state-initial",style:b,children:ce(i)})]})]})}function Nn(t){return e.jsx(Jt,{storyArgs:t})}const Q={args:{showResetButton:!0},parameters:{docs:{description:{story:"Reset button is disabled-by-default until the user diverges from the initial (empty string) snapshot. After clicking reset the filter state returns to the initial snapshot and the button disables itself again."},source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  showResetButton={true}
/>`}}},render:t=>e.jsx(Nn,{...t})};function xn(t){return e.jsx(Jt,{storyArgs:t,initialFilterStates:In})}const Z={args:{showResetButton:!0},parameters:{docs:{description:{story:"Reset button stays disabled on mount even though there are active selections, because the live filter state matches the initial snapshot. Changing a selection enables the button; clicking it restores the initial snapshot, not an empty state."},source:{code:`const savedStates = new Map([
...
<FilterList
  ...
  initialFilterStates={savedStates}
  showResetButton={true}
/>`}}},render:t=>e.jsx(xn,{...t})};var pe,de,ue;A.parameters={...A.parameters,docs:{...(pe=A.parameters)==null?void 0:pe.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`<FilterList
...
}`,...(ue=(de=A.parameters)==null?void 0:de.docs)==null?void 0:ue.source}}};var me,fe,ye;F.parameters={...F.parameters,docs:{...(me=F.parameters)==null?void 0:me.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(ye=(fe=F.parameters)==null?void 0:fe.docs)==null?void 0:ye.source}}};var Ce,Te,Ee;M.parameters={...M.parameters,docs:{...(Ce=M.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(Ee=(Te=M.parameters)==null?void 0:Te.docs)==null?void 0:Ee.source}}};var Se,he,be;j.parameters={...j.parameters,docs:{...(Se=j.parameters)==null?void 0:Se.docs,source:{originalSource:`{
  args: {
    showResetButton: true
  },
  parameters: {
...
}`,...(be=(he=j.parameters)==null?void 0:he.docs)==null?void 0:be.source}}};var ge,Re,ve;D.parameters={...D.parameters,docs:{...(ge=D.parameters)==null?void 0:ge.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(ve=(Re=D.parameters)==null?void 0:Re.docs)==null?void 0:ve.source}}};var Le,Ae,Fe;k.parameters={...k.parameters,docs:{...(Le=k.parameters)==null?void 0:Le.docs,source:{originalSource:`{
  args: {
    title: "Employee Filters"
  },
  parameters: {
...
}`,...(Fe=(Ae=k.parameters)==null?void 0:Ae.docs)==null?void 0:Fe.source}}};var Me,je,De;O.parameters={...O.parameters,docs:{...(Me=O.parameters)==null?void 0:Me.docs,source:{originalSource:`{
  args: {
    showResetButton: true
  },
  parameters: {
...
}`,...(De=(je=O.parameters)==null?void 0:je.docs)==null?void 0:De.source}}};var ke,Oe,Pe;P.parameters={...P.parameters,docs:{...(ke=P.parameters)==null?void 0:ke.docs,source:{originalSource:`{
  args: {
    showActiveFilterCount: true
  },
  parameters: {
...
}`,...(Pe=(Oe=P.parameters)==null?void 0:Oe.docs)==null?void 0:Pe.source}}};var _e,Ie,Ne;_.parameters={..._.parameters,docs:{...(_e=_.parameters)==null?void 0:_e.docs,source:{originalSource:`{
  args: {
    enableSorting: true
  },
  parameters: {
...
}`,...(Ne=(Ie=_.parameters)==null?void 0:Ie.docs)==null?void 0:Ne.source}}};var xe,we,Ve;I.parameters={...I.parameters,docs:{...(xe=I.parameters)==null?void 0:xe.docs,source:{originalSource:`{
  args: {
    title: "Employee Filters",
    showActiveFilterCount: true
  },
...
}`,...(Ve=(we=I.parameters)==null?void 0:we.docs)==null?void 0:Ve.source}}};var Ye,Ge,We;N.parameters={...N.parameters,docs:{...(Ye=N.parameters)==null?void 0:Ye.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`const filterDefinitions = [
...
}`,...(We=(Ge=N.parameters)==null?void 0:Ge.docs)==null?void 0:We.source}}};var He,Be,Ue;x.parameters={...x.parameters,docs:{...(He=x.parameters)==null?void 0:He.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,...(Ue=(Be=x.parameters)==null?void 0:Be.docs)==null?void 0:Ue.source}}};var Xe,Ke,Je;w.parameters={...w.parameters,docs:{...(Xe=w.parameters)==null?void 0:Xe.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...($e=(qe=V.parameters)==null?void 0:qe.docs)==null?void 0:$e.source}}};var Qe,Ze,et;Y.parameters={...Y.parameters,docs:{...(Qe=Y.parameters)==null?void 0:Qe.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,...(et=(Ze=Y.parameters)==null?void 0:Ze.docs)==null?void 0:et.source}}};var tt,nt,it;G.parameters={...G.parameters,docs:{...(tt=G.parameters)==null?void 0:tt.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(it=(nt=G.parameters)==null?void 0:nt.docs)==null?void 0:it.source}}};var rt,ot,lt;W.parameters={...W.parameters,docs:{...(rt=W.parameters)==null?void 0:rt.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(lt=(ot=W.parameters)==null?void 0:ot.docs)==null?void 0:lt.source}}};var st,at,ct;H.parameters={...H.parameters,docs:{...(st=H.parameters)==null?void 0:st.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(ct=(at=H.parameters)==null?void 0:at.docs)==null?void 0:ct.source}}};var pt,dt,ut;B.parameters={...B.parameters,docs:{...(pt=B.parameters)==null?void 0:pt.docs,source:{originalSource:`{
...
}`,...(ut=(dt=B.parameters)==null?void 0:dt.docs)==null?void 0:ut.source}}};var mt,ft,yt;U.parameters={...U.parameters,docs:{...(mt=U.parameters)==null?void 0:mt.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(yt=(ft=U.parameters)==null?void 0:ft.docs)==null?void 0:yt.source}}};var Ct,Tt,Et;X.parameters={...X.parameters,docs:{...(Ct=X.parameters)==null?void 0:Ct.docs,source:{originalSource:`{
  name: "Full Featured",
  args: {
    title: "Employee Filters",
    showResetButton: true,
...
}`,...(Et=(Tt=X.parameters)==null?void 0:Tt.docs)==null?void 0:Et.source}}};var St,ht,bt;K.parameters={...K.parameters,docs:{...(St=K.parameters)==null?void 0:St.docs,source:{originalSource:`{
...
}`,...(bt=(ht=K.parameters)==null?void 0:ht.docs)==null?void 0:bt.source}}};var gt,Rt,vt;J.parameters={...J.parameters,docs:{...(gt=J.parameters)==null?void 0:gt.docs,source:{originalSource:`{
...
}`,...(vt=(Rt=J.parameters)==null?void 0:Rt.docs)==null?void 0:vt.source}}};var Lt,At,Ft;z.parameters={...z.parameters,docs:{...(Lt=z.parameters)==null?void 0:Lt.docs,source:{originalSource:`{
  name: "Custom Filters",
  parameters: {
    docs: {
      description: {
...
}`,...(Ft=(At=z.parameters)==null?void 0:At.docs)==null?void 0:Ft.source}}};var Mt,jt,Dt;q.parameters={...q.parameters,docs:{...(Mt=q.parameters)==null?void 0:Mt.docs,source:{originalSource:`{
...
}`,...(Dt=(jt=q.parameters)==null?void 0:jt.docs)==null?void 0:Dt.source}}};var kt,Ot,Pt;$.parameters={...$.parameters,docs:{...(kt=$.parameters)==null?void 0:kt.docs,source:{originalSource:`{
...
}`,...(Pt=(Ot=$.parameters)==null?void 0:Ot.docs)==null?void 0:Pt.source}}};var _t,It,Nt;Q.parameters={...Q.parameters,docs:{...(_t=Q.parameters)==null?void 0:_t.docs,source:{originalSource:`{
  args: {
    showResetButton: true
  },
  parameters: {
...
}`,...(Nt=(It=Q.parameters)==null?void 0:It.docs)==null?void 0:Nt.source}}};var xt,wt,Vt;Z.parameters={...Z.parameters,docs:{...(xt=Z.parameters)==null?void 0:xt.docs,source:{originalSource:`{
  args: {
    showResetButton: true
  },
  parameters: {
...
}`,...(Vt=(wt=Z.parameters)==null?void 0:wt.docs)==null?void 0:Vt.source}}};const wi=["Default","IntegerNumberRangeRounding","WithObjectSet","AddFilterMode","WithAllFilterTypes","WithTitleAndIcon","WithResetButton","WithActiveFilterCount","WithSorting","CollapsiblePanel","KeywordSearch","WithColorMap","WithRenderValue","WithRenderValueAsReactNode","WithListogramDisplayModes","WithHiddenCounts","WithCheckbox","WithBelowFoldSelection","WithRemovableFilters","WithStaticValues","FullFeatured","WithLinkedPropertyFilters","CombinedWithObjectTable","WithCustomFilters","NoValueRendering","WithInitialFilterStates","WithResetButtonEmptyInitial","WithResetButtonNonEmptyInitial"];export{j as AddFilterMode,I as CollapsiblePanel,J as CombinedWithObjectTable,A as Default,X as FullFeatured,F as IntegerNumberRangeRounding,N as KeywordSearch,q as NoValueRendering,P as WithActiveFilterCount,D as WithAllFilterTypes,H as WithBelowFoldSelection,W as WithCheckbox,x as WithColorMap,z as WithCustomFilters,G as WithHiddenCounts,$ as WithInitialFilterStates,K as WithLinkedPropertyFilters,Y as WithListogramDisplayModes,M as WithObjectSet,B as WithRemovableFilters,w as WithRenderValue,V as WithRenderValueAsReactNode,O as WithResetButton,Q as WithResetButtonEmptyInitial,Z as WithResetButtonNonEmptyInitial,_ as WithSorting,U as WithStaticValues,k as WithTitleAndIcon,wi as __namedExportsOrder,xi as default};
