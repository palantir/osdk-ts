...
</catalog>`,yt=f("application/xml",()=>Promise.resolve(new Response(St)),"data.xml");function bt(){const e=H.aoa_to_sheet([["Name","Department","Salary"],["Alice","Engineering","$145,000"],["Bob","Marketing","$120,000"]]),t=H.book_new();H.book_append_sheet(t,e,"Sheet1");const r=He(t,{type:"array",bookType:"xlsx"});return f("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",()=>Promise.resolve(new Response(r)),"report.xlsx")}const _t=bt(),Ae=f("image/tiff",()=>fetch(ft),"multi-page-tiff.tiff"),Le=f("application/octet-stream",()=>Promise.resolve(new Response("")),"data.bin"),vr={title:"Beta/DocumentViewer",component:g,args:{media:z},render:e=>d.jsx("div",{style:{height:"600px",width:"100%"},children:d.jsx(g,{...e})}),parameters:{controls:{expanded:!0}},argTypes:{media:{description:"The OSDK Media object to render",control:!1},className:{description:"Additional CSS class name for the root element",control:"text"},mimeTypeOverride:{description:"Override the auto-detected MIME type",control:"text"}}},b={args:{media:z},parameters:{docs:{source:{code:`import { DocumentViewer } from "@osdk/react-components/experimental/document-viewer";

<DocumentViewer media={employee.trainingMaterial} />`}}}},_={args:{media:ht},render:e=>d.jsx("div",{style:{height:"400px",width:"400px"},children:d.jsx(g,{...e})})},k={args:{media:xt}},T={args:{media:Mt},render:e=>d.jsx("div",{style:{height:"400px",width:"600px"},children:d.jsx(g,{...e})}),parameters:{msw:{handlers:[u.get("*/example.mp4",()=>j())]}}},D={args:{media:Le},render:e=>d.jsx("div",{style:{height:"200px",width:"400px"},children:d.jsx(g,{...e})})},P={args:{media:Et}},V={args:{media:_t}},I={args:{media:yt},render:e=>d.jsx("div",{style:{height:"400px",width:"600px"},children:d.jsx(g,{...e})})},C={args:{media:Ae},parameters:{msw:{handlers:[u.get("*/multi-page-tiff.tiff",()=>j())]}}},R={args:{media:Ae,enableTiffToPdf:!0,fileName:"multi-page-tiff.tiff"},parameters:{msw:{handlers:[u.get("*/multi-page-tiff.tiff",()=>j()),u.get("*/compressed.tracemonkey-pldi-09.pdf",()=>j()),u.post("*/api/v2/mediasets/*/items/*/transform",()=>B.json({jobId:"mock-job-id",status:"SUCCESSFUL"})),u.get("*/api/v2/mediasets/*/items/*/transformationJobs/*/result",async()=>{const t=await(await fetch(je)).arrayBuffer();return new B(t,{headers:{"Content-Type":"application/pdf"}})}),u.get("*/api/v2/mediasets/*/items/*/transformationJobs/*",()=>B.json({status:"SUCCESSFUL"}))]},docs:{source:{code:`import { DocumentViewer } from "@osdk/react-components/experimental/document-viewer";
