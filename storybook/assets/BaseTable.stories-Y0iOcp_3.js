...
}`}}},render:e=>{const n=r({data:c,columns:a,getCoreRowModel:s(),columnResizeMode:"onChange",columnResizeDirection:"ltr"});return t.jsx(o,{...e,table:n})}},u={args:{headerMenuFeatureFlags:{showSortingItems:!0}},parameters:{docs:{source:{code:`
import { BaseTable } from "@osdk/react-components/experimental";
import {
  getCoreRowModel,
  getSortedRowModel,
...
`}}},render:e=>{const[n,l]=R.useState([]),i=r({data:c,columns:a,getCoreRowModel:s(),getSortedRowModel:O(),state:{sorting:n},enableSorting:!0,onSortingChange:l});return t.jsx("div",{style:{height:"400px"},children:t.jsx(o,{...e,table:i})})}},m={args:{headerMenuFeatureFlags:{showPinningItems:!0}},parameters:{docs:{source:{code:`
import { BaseTable } from "@osdk/react-components/experimental";
import {
  getCoreRowModel,
  useReactTable,
...
return <BaseTable table={table} headerMenuFeatureFlags={headerMenuFeatureFlags} />;
`}}},render:e=>{const[n,l]=R.useState({left:[],right:[]}),i=r({data:c,columns:a,getCoreRowModel:s(),state:{columnPinning:n},enableColumnResizing:!1,onColumnPinningChange:l});return t.jsx("div",{style:{height:"400px"},children:t.jsx(o,{...e,table:i})})}},g={args:{headerMenuFeatureFlags:{showResizeItem:!0}},parameters:{docs:{source:{code:`
import { BaseTable } from "@osdk/react-components/experimental";
import {
  getCoreRowModel,
  useReactTable,
...
return <BaseTable table={table} headerMenuFeatureFlags={headerMenuFeatureFlags} />;
`}}},render:e=>{const[n,l]=R.useState({}),i=r({data:c,columns:a,getCoreRowModel:s(),state:{columnSizing:n},columnResizeMode:"onChange",columnResizeDirection:"ltr",onColumnSizingChange:l});return t.jsx("div",{style:{height:"400px"},children:t.jsx(o,{...e,table:i})})}},b={args:{headerMenuFeatureFlags:{showConfigItem:!0}},parameters:{docs:{source:{code:`
import { BaseTable } from "@osdk/react-components/experimental";
import {
  getCoreRowModel,
  getSortedRowModel,
...
return <BaseTable table={table} headerMenuFeatureFlags={headerMenuFeatureFlags} />;
`}}},render:e=>{const[n,l]=R.useState(a.reduce((_,H)=>({..._,[H.accessorKey]:!0}),{})),i=r({data:c,columns:a,getCoreRowModel:s(),getSortedRowModel:O(),state:{columnVisibility:n},onColumnVisibilityChange:l});return t.jsx("div",{style:{height:"400px"},children:t.jsx(o,{...e,table:i})})}},h={args:{isLoading:!0},parameters:{docs:{source:{code:`
const table = useReactTable({
  data: [], // No data
  columns,
  getCoreRowModel: getCoreRowModel(),
...
}`}}},render:e=>{const n=r({data:[],columns:a,getCoreRowModel:s()});return t.jsx("div",{style:{height:"400px"},children:t.jsx(o,{...e,table:n})})}},p={args:{},parameters:{docs:{source:{code:`
const table = useReactTable({
  data: [], // No data
  columns,
  getCoreRowModel: getCoreRowModel(),
...
return <BaseTable table={table} />;
`}}},render:e=>{const n=r({data:[],columns:a,getCoreRowModel:s()});return t.jsx("div",{style:{height:"400px"},children:t.jsx(o,{...e,table:n})})}},C={args:{error:new Error("Example error")},parameters:{docs:{source:{code:'<BaseTable table={table} error={new Error("Example error")} />'}}},render:e=>{const n=r({data:[],columns:a,getCoreRowModel:s()});return t.jsx("div",{style:{height:"400px"},children:t.jsx(o,{...e,table:n})})}};var S,M,w;d.parameters={...d.parameters,docs:{...(S=d.parameters)==null?void 0:S.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`
...
}`,...(J=(A=C.parameters)==null?void 0:A.docs)==null?void 0:J.source}}};const $=["Default","WithSorting","WithColumnPinning","WithColumnResizing","WithColumnConfig","LoadingState","EmptyState","ErrorState"];export{d as Default,p as EmptyState,C as ErrorState,h as LoadingState,b as WithColumnConfig,m as WithColumnPinning,g as WithColumnResizing,u as WithSorting,$ as __namedExportsOrder,Z as default};
