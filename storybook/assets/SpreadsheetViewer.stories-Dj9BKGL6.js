...
<BaseSpreadsheetViewer content={parsedSpreadsheet} />`}}}},o={args:{content:{sheets:[d.sheets[0]]}}},i={args:{media:_(P,"notional-spreadsheet-example.xlsx")},render:e=>t.jsx("div",{style:{height:"600px"},children:t.jsx(k,{media:e.media})}),parameters:{msw:{handlers:[M.get("*/notional-spreadsheet-example.xlsx",()=>D())]}}};var c,h,l;s.parameters={...s.parameters,docs:{...(c=s.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
...
}`,...(l=(h=s.parameters)==null?void 0:h.docs)==null?void 0:l.source}}};var S,g,w;n.parameters={...n.parameters,docs:{...(S=n.parameters)==null?void 0:S.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,...(w=(g=n.parameters)==null?void 0:g.docs)==null?void 0:w.source}}};var x,f,u;o.parameters={...o.parameters,docs:{...(x=o.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    content: {
      sheets: [SAMPLE_SPREADSHEET.sheets[0]!]
    }
  }
}`,...(u=(f=o.parameters)==null?void 0:f.docs)==null?void 0:u.source}}};var E,v,y;i.parameters={...i.parameters,docs:{...(E=i.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
...
}`,...(y=(v=i.parameters)==null?void 0:v.docs)==null?void 0:y.source}}};const z=["Default","WithSpreadsheet","SingleSheet","WithRealFile"];export{s as Default,o as SingleSheet,i as WithRealFile,n as WithSpreadsheet,z as __namedExportsOrder,U as default};
