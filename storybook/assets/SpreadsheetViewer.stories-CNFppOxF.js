...
/>`}}}},i={args:{media:b($,"notional-spreadsheet-example.xlsx")},render:e=>t.jsx("div",{style:{height:"600px"},children:t.jsx(k,{media:e.media})}),parameters:{msw:{handlers:[v.get("*/notional-spreadsheet-example.xlsx",()=>A())]},docs:{source:{code:`// SpreadsheetViewer fetches and parses the xlsx workbook itself, so a real
...
}`,...(u=(g=n.parameters)==null?void 0:g.docs)==null?void 0:u.source}}};var w,x,f;o.parameters={...o.parameters,docs:{...(w=o.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    content: {
...
}`,...(f=(x=o.parameters)==null?void 0:x.docs)==null?void 0:f.source}}};var E,y,V;i.parameters={...i.parameters,docs:{...(E=i.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
...
}`,...(V=(y=i.parameters)==null?void 0:y.docs)==null?void 0:V.source}}};const O=["Default","WithSpreadsheet","SingleSheet","WithRealFile"];export{a as Default,o as SingleSheet,i as WithRealFile,n as WithSpreadsheet,O as __namedExportsOrder,N as default};
