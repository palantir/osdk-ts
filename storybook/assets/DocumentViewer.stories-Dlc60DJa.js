...
`,Et=f("message/rfc822",()=>Promise.resolve(new Response(vt)),"message.eml"),St=`<?xml version="1.0"?>
<catalog>
  <book id="1">
    <title>XML Developer's Guide</title>
    <price>44.95</price>
  </book>
</catalog>`,yt=f("application/xml",()=>Promise.resolve(new Response(St)),"data.xml");function bt(){const e=$.aoa_to_sheet([["Name","Department","Salary"],["Alice","Engineering","$145,000"],["Bob","Marketing","$120,000"]]),t=$.book_new();$.book_append_sheet(t,e,"Sheet1");const r=$e(t,{type:"array",bookType:"xlsx"});return f("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",()=>Promise.resolve(new Response(r)),"report.xlsx")}const kt=bt(),Ae=f("image/tiff",()=>fetch(ft),"multi-page-tiff.tiff"),Le=f("application/octet-stream",()=>Promise.resolve(new Response("")),"data.bin"),vr={title:"Components/DocumentViewer",component:g,tags:["beta"],args:{media:z},render:e=>d.jsx("div",{style:{height:"600px",width:"100%"},children:d.jsx(g,{...e})}),parameters:{controls:{expanded:!0}},argTypes:{media:{description:"The OSDK Media object to render",control:!1},className:{description:"Additional CSS class name for the root element",control:"text"},mimeTypeOverride:{description:"Override the auto-detected MIME type",control:"text"}}},b={args:{media:z},parameters:{docs:{source:{code:`import { DocumentViewer } from "@osdk/react-components/experimental/document-viewer";

<DocumentViewer media={employee.trainingMaterial} />`}}}},k={args:{media:ht},render:e=>d.jsx("div",{style:{height:"400px",width:"400px"},children:d.jsx(g,{...e})})},_={args:{media:xt}},T={args:{media:Mt},render:e=>d.jsx("div",{style:{height:"400px",width:"600px"},children:d.jsx(g,{...e})}),parameters:{msw:{handlers:[u.get("*/example.mp4",()=>j())]}}},D={args:{media:Le},render:e=>d.jsx("div",{style:{height:"200px",width:"400px"},children:d.jsx(g,{...e})})},P={args:{media:Et}},V={args:{media:kt}},I={args:{media:yt},render:e=>d.jsx("div",{style:{height:"400px",width:"600px"},children:d.jsx(g,{...e})})},C={args:{media:Ae},parameters:{msw:{handlers:[u.get("*/multi-page-tiff.tiff",()=>j())]}}},R={args:{media:Ae,enableTiffToPdf:!0,fileName:"multi-page-tiff.tiff"},parameters:{msw:{handlers:[u.get("*/multi-page-tiff.tiff",()=>j()),u.get("*/compressed.tracemonkey-pldi-09.pdf",()=>j()),u.post("*/api/v2/mediasets/*/items/*/transform",()=>B.json({jobId:"mock-job-id",status:"SUCCESSFUL"})),u.get("*/api/v2/mediasets/*/items/*/transformationJobs/*/result",async()=>{const t=await(await fetch(je)).arrayBuffer();return new B(t,{headers:{"Content-Type":"application/pdf"}})}),u.get("*/api/v2/mediasets/*/items/*/transformationJobs/*",()=>B.json({status:"SUCCESSFUL"}))]},docs:{source:{code:`import { DocumentViewer } from "@osdk/react-components/experimental/document-viewer";
...
}`,...(K=(Y=b.parameters)==null?void 0:Y.docs)==null?void 0:K.source}}};var Z,Q,ee;k.parameters={...k.parameters,docs:{...(Z=k.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  args: {
...
}`,...(ee=(Q=k.parameters)==null?void 0:Q.docs)==null?void 0:ee.source}}};var te,re,ne;_.parameters={..._.parameters,docs:{...(te=_.parameters)==null?void 0:te.docs,source:{originalSource:`{
  args: {
...
}`,...(Ee=(ve=C.parameters)==null?void 0:ve.docs)==null?void 0:Ee.source}}};var Se,ye,be;R.parameters={...R.parameters,docs:{...(Se=R.parameters)==null?void 0:Se.docs,source:{originalSource:`{
  args: {
    media: mockTiffMedia,
...
}`,...(be=(ye=R.parameters)==null?void 0:ye.docs)==null?void 0:be.source}}};var ke,_e,Te;O.parameters={...O.parameters,docs:{...(ke=O.parameters)==null?void 0:ke.docs,source:{originalSource:`{
  args: {
    media: mockUnsupportedMedia,
...
}`,...(Ve=(Pe=N.parameters)==null?void 0:Pe.docs)==null?void 0:Ve.source}}};const Er=["Pdf","Image","Markdown","Video","UnsupportedType","Email","Excel","Xml","Tiff","TiffWithPdfConversion","WithMimeTypeOverride","WithPdfViewerProps"];export{P as Email,V as Excel,k as Image,_ as Markdown,b as Pdf,C as Tiff,R as TiffWithPdfConversion,D as UnsupportedType,T as Video,O as WithMimeTypeOverride,N as WithPdfViewerProps,I as Xml,Er as __namedExportsOrder,vr as default};
