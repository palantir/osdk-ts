...
/>`}}}},N={args:{formFieldDefinitions:Ue},parameters:{docs:{source:{code:`const fields = [
  {
    fieldKey: "fullName",
...
<ActionForm
  ...
  showFormTitle={true}
/>`}}}},x={render:()=>n.jsx(Me,{}),parameters:{docs:{source:{code:`const [formState, setFormState] = useState({
...
/>`}}}};function Me(){const[t,e]=D.useState({fullName:"Ada Lovelace",yearsExperience:5,isRemote:!0,isFullTime:!0}),{handleStoryError:o,handleStorySubmit:a,submission:p}=R({applyStoryAction:B});return n.jsx(j,{output:n.jsx(O,{idleMessage:"Submit the form to see the action response.",snapshot:p}),children:n.jsxs(n.Fragment,{children:[n.jsxs("div",{className:"osdkFormStorySpacing",children:[n.jsx("strong",{children:"Current form state (JSON):"}),n.jsx("pre",{className:"osdkCodeOutput",children:JSON.stringify(t,null,2)})]}),n.jsx(E,{actionDefinition:Ne,formState:t,onError:o,onFormStateChange:e,onSubmit:a})]})})}var W,_,L;f.parameters={...f.parameters,docs:{...(W=f.parameters)==null?void 0:W.docs,source:{originalSource:`{
...
}`,...(fe=(ye=C.parameters)==null?void 0:ye.docs)==null?void 0:fe.source}}};var he,be,Se;N.parameters={...N.parameters,docs:{...(he=N.parameters)==null?void 0:he.docs,source:{originalSource:`{
  args: {
...
}`,...(Se=(be=N.parameters)==null?void 0:be.docs)==null?void 0:Se.source}}};var we,Fe,Te;A.parameters={...A.parameters,docs:{...(we=A.parameters)==null?void 0:we.docs,source:{originalSource:`{
...
}`,...(Te=(Fe=A.parameters)==null?void 0:Fe.docs)==null?void 0:Te.source}}};var ve,ge,Ce;x.parameters={...x.parameters,docs:{...(ve=x.parameters)==null?void 0:ve.docs,source:{originalSource:`{
...
}`,...(Ce=(ge=x.parameters)==null?void 0:ge.docs)==null?void 0:Ce.source}}};const Ot=["Default","SubmitSuccess","SubmitFailure","ValidationErrors","SubmitDisabled","SlowCustomSubmit","CustomSubmitHandler","WithTitle","WithCustomTitle","WithDefaultValues","WithFieldOverrides","WithUnsupportedFields","ControlledFormState"];export{x as ControlledFormState,T as CustomSubmitHandler,f as Default,F as SlowCustomSubmit,w as SubmitDisabled,b as SubmitFailure,h as SubmitSuccess,S as ValidationErrors,g as WithCustomTitle,C as WithDefaultValues,N as WithFieldOverrides,v as WithTitle,A as WithUnsupportedFields,Ot as __namedExportsOrder,jt as default};
