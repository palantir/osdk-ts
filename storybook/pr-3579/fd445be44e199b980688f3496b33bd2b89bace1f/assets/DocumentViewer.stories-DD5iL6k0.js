...
`,vt=f("message/rfc822",()=>Promise.resolve(new Response(bt)),"message.eml"),Et=`<?xml version="1.0"?>
<catalog>
  <book id="1">
    <title>XML Developer's Guide</title>
    <price>44.95</price>
  </book>
</catalog>`,kt=f("application/xml",()=>Promise.resolve(new Response(Et)),"data.xml");function yt(){const e=$.aoa_to_sheet([["Name","Department","Salary"],["Alice","Engineering","$145,000"],["Bob","Marketing","$120,000"]]),t=$.book_new();$.book_append_sheet(t,e,"Sheet1");const r=$e(t,{type:"array",bookType:"xlsx"});return f("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",()=>Promise.resolve(new Response(r)),"report.xlsx")}const St=yt(),Ae=f("image/tiff",()=>fetch(ft),"multi-page-tiff.tiff"),Le=f("application/octet-stream",()=>Promise.resolve(new Response("")),"data.bin"),br={title:"Components/DocumentViewer",component:g,tags:["beta"],args:{media:z},render:e=>d.jsx("div",{style:{height:"600px",width:"100%"},children:d.jsx(g,{...e})}),parameters:{controls:{expanded:!0}},argTypes:{media:{description:"The OSDK Media object to render",control:!1},className:{description:"Additional CSS class name for the root element",control:"text"},mimeTypeOverride:{description:"Override the auto-detected MIME type",control:"text"}}},y={args:{media:z},parameters:{docs:{source:{code:`import { DocumentViewer } from "@osdk/react-components/experimental/document-viewer";

<DocumentViewer media={employee.trainingMaterial} />`}}}},S={args:{media:ht},render:e=>d.jsx("div",{style:{height:"400px",width:"400px"},children:d.jsx(g,{...e})})},_={args:{media:xt}},T={args:{media:Mt},render:e=>d.jsx("div",{style:{height:"400px",width:"600px"},children:d.jsx(g,{...e})}),parameters:{msw:{handlers:[u.get("*/example.mp4",()=>j())]}}},D={args:{media:Le},render:e=>d.jsx("div",{style:{height:"200px",width:"400px"},children:d.jsx(g,{...e})})},P={args:{media:vt}},V={args:{media:St}},I={args:{media:kt},render:e=>d.jsx("div",{style:{height:"400px",width:"600px"},children:d.jsx(g,{...e})})},C={args:{media:Ae},parameters:{msw:{handlers:[u.get("*/multi-page-tiff.tiff",()=>j())]}}},R={args:{media:Ae,enableTiffToPdf:!0,fileName:"multi-page-tiff.tiff"},parameters:{msw:{handlers:[u.get("*/multi-page-tiff.tiff",()=>j()),u.get("*/compressed.tracemonkey-pldi-09.pdf",()=>j()),u.post("*/api/v2/mediasets/*/items/*/transform",()=>B.json({jobId:"mock-job-id",status:"SUCCESSFUL"})),u.get("*/api/v2/mediasets/*/items/*/transformationJobs/*/result",async()=>{const t=await(await fetch(je)).arrayBuffer();return new B(t,{headers:{"Content-Type":"application/pdf"}})}),u.get("*/api/v2/mediasets/*/items/*/transformationJobs/*",()=>B.json({status:"SUCCESSFUL"}))]},docs:{source:{code:`import { DocumentViewer } from "@osdk/react-components/experimental/document-viewer";
...
}`,...(xe=(he=I.parameters)==null?void 0:he.docs)==null?void 0:xe.source}}};var Me,be,ve;C.parameters={...C.parameters,docs:{...(Me=C.parameters)==null?void 0:Me.docs,source:{originalSource:`{
  args: {
    media: mockTiffMedia
  },
  parameters: {
...
}`,...(ve=(be=C.parameters)==null?void 0:be.docs)==null?void 0:ve.source}}};var Ee,ke,ye;R.parameters={...R.parameters,docs:{...(Ee=R.parameters)==null?void 0:Ee.docs,source:{originalSource:`{
  args: {
    media: mockTiffMedia,
