...
/>`}}},render:t=>e.jsx(Zt,{...t})},w={args:{title:"Employee Filters"},parameters:{docs:{source:{code:`<FilterList
  ...
  titleIcon={<svg>...</svg>}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:u,children:e.jsx(p,{objectType:a,filterDefinitions:S,titleIcon:Kt,...i})})};function en(t){const n=t.onReset,i=o.useCallback(()=>{console.log("Reset clicked"),n==null||n()},[n]);return e.jsx("div",{style:u,children:e.jsx(p,{objectType:a,filterDefinitions:S,...t,onReset:i})})}const P={args:{showResetButton:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  showResetButton={true}
...
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:u,children:e.jsx(p,{objectType:a,filterDefinitions:S,...i})})},I={args:{enableSorting:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  enableSorting={true}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:u,children:e.jsx(p,{objectType:a,filterDefinitions:S,...i})})};function tn(t){return e.jsx("div",{style:u,children:e.jsx(p,{objectType:a,filterDefinitions:S,...t})})}const N={args:{title:"Employee Filters",showActiveFilterCount:!0},parameters:{docs:{description:{story:"Click the collapse button to minimize the filter panel. Active filter count is shown in the collapsed state."},source:{code:`const [collapsed, setCollapsed] = useState(false);
...
<FilterList
  ...
  filterDefinitions={filterDefinitions}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(fn,{...t})};function Cn(t){const[n,i]=o.useState(void 0),[r,l]=o.useState(S),s=t.onFilterRemoved,d=o.useCallback(h=>{l(F=>F.filter(le=>"key"in le?le.key!==h:!0)),s==null||s(h)},[s]),c=t.onReset,y=o.useCallback(()=>{l(S),c==null||c()},[c]),m=t.onFilterClauseChanged,f=o.useCallback(h=>{i(h),m==null||m(h)},[m]);return e.jsxs("div",{style:Ut,children:[e.jsx("div",{style:Xt,children:e.jsx(p,{objectType:a,filterDefinitions:r,titleIcon:Kt,...t,onReset:y,onFilterRemoved:d,onFilterClauseChanged:f})}),e.jsx("div",{style:E,children:e.jsx(Bt,{objectType:a,filter:n})})]})}const J={name:"Full Featured",args:{title:"Employee Filters",showResetButton:!0,showActiveFilterCount:!0,enableSorting:!0},parameters:{docs:{description:{story:"Demonstrates all filter list features together: collapse, reset, active count, sorting, removable filters, per-filter search, exclude toggle, and the emitted where clause driving an ObjectTable."},source:{code:`// All features combined: collapse, sort, search, exclude, remove, reset
...
}`,...(he=(Te=j.parameters)==null?void 0:Te.docs)==null?void 0:he.source}}};var Se,Ee,be;k.parameters={...k.parameters,docs:{...(Se=k.parameters)==null?void 0:Se.docs,source:{originalSource:`{
  args: {
    showResetButton: true
  },
  parameters: {
...
}`,...(ft=(yt=K.parameters)==null?void 0:yt.docs)==null?void 0:ft.source}}};var Ct,Tt,ht;J.parameters={...J.parameters,docs:{...(Ct=J.parameters)==null?void 0:Ct.docs,source:{originalSource:`{
  name: "Full Featured",
  args: {
    title: "Employee Filters",
    showResetButton: true,
...
}`,...(ht=(Tt=J.parameters)==null?void 0:Tt.docs)==null?void 0:ht.source}}};var St,Et,bt;q.parameters={...q.parameters,docs:{...(St=q.parameters)==null?void 0:St.docs,source:{originalSource:`{
