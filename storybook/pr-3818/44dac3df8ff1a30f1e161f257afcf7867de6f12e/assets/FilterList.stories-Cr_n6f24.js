...
/>`}}},render:({objectType:t,objectSet:n,...i})=>{const r=o.useMemo(()=>[R,A],[]);return e.jsx("div",{style:p,children:e.jsx(c,{objectType:a,filterDefinitions:r,...i})})}},D={parameters:{docs:{description:{story:"Repro for the integer-typed `NUMBER_RANGE` rounding fix. `employeeNumber` is an `integer` property, so histogram bucket boundaries — `(maxValue - minValue) / 20` — are usually fractional. Click any bar in the histogram. The Min/Max boxes must show whole integers (e.g. `657495073`), not fractional values (e.g. `657495073.4`)."},source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={[
    {
      type: "PROPERTY",
...
/>`}}},render:t=>e.jsx($t,{...t})};function Qt(t){const n=o.useMemo(()=>[R,re,{...Wt,isVisible:!1},{...Ht,isVisible:!1},{...ie,isVisible:!1},{...A,isVisible:!1}],[]);return e.jsx("div",{style:p,children:e.jsx(c,{objectType:a,filterDefinitions:n,addFilterMode:"uncontrolled",...t})})}const k={args:{showResetButton:!0},parameters:{docs:{source:{code:`const filterDefinitions = [
  { type: "PROPERTY", key: "department", label: "Department", filterComponent: "LISTOGRAM", filterState: { type: "EXACT_MATCH", values: [] } },
  { type: "PROPERTY", key: "team", label: "Team", filterComponent: "LISTOGRAM", filterState: { type: "EXACT_MATCH", values: [] } },
...
/>`}}},render:t=>e.jsx(Zt,{...t})},w={args:{title:"Employee Filters"},parameters:{docs:{source:{code:`<FilterList
  ...
  titleIcon={<svg>...</svg>}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:p,children:e.jsx(c,{objectType:a,filterDefinitions:S,titleIcon:Kt,...i})})};function en(t){const n=t.onReset,i=o.useCallback(()=>{console.log("Reset clicked"),n==null||n()},[n]);return e.jsx("div",{style:p,children:e.jsx(c,{objectType:a,filterDefinitions:S,...t,onReset:i})})}const P={args:{showResetButton:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  showResetButton={true}
...
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:p,children:e.jsx(c,{objectType:a,filterDefinitions:S,...i})})},I={args:{enableSorting:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  enableSorting={true}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:p,children:e.jsx(c,{objectType:a,filterDefinitions:S,...i})})};function tn(t){return e.jsx("div",{style:p,children:e.jsx(c,{objectType:a,filterDefinitions:S,...t})})}const N={args:{title:"Employee Filters",showActiveFilterCount:!0},parameters:{docs:{description:{story:"Click the collapse button to minimize the filter panel. Active filter count is shown in the collapsed state."},source:{code:`const [collapsed, setCollapsed] = useState(false);
...
<FilterList objectType={Employee} filterDefinitions={filterDefinitions} />`}}},render:({objectType:t,objectSet:n,...i})=>{const r=o.useMemo(()=>[{type:"KEYWORD_SEARCH",properties:["fullName","department","jobTitle","locationCity"],label:"Search"},R,A],[]);return e.jsx("div",{style:p,children:e.jsx(c,{objectType:a,filterDefinitions:r,...i})})}};function nn(t){const n=o.useMemo(()=>[{type:"PROPERTY",id:"department-no-color",key:"department",label:"Department (default colors)",filterComponent:"LISTOGRAM",filterState:{type:"EXACT_MATCH",values:[]}}],[]),i=o.useMemo(()=>[{type:"PROPERTY",id:"department-color",key:"department",label:"Department (custom colors)",filterComponent:"LISTOGRAM",filterState:{type:"EXACT_MATCH",values:[]},colorMap:{Marketing:"#e74c3c",Operations:"#2ecc71",Finance:"#3498db",Product:"#f39c12"}}],[]);return e.jsxs("div",{style:C,children:[e.jsx("div",{style:p,children:e.jsx(c,{objectType:a,filterDefinitions:n,...t})}),e.jsx("div",{style:p,children:e.jsx(c,{objectType:a,filterDefinitions:i,...t})})]})}const V={parameters:{docs:{source:{code:`// Without colorMap: all bars use the default theme color
...
<FilterList objectType={Employee} filterDefinitions={filterDefinitions} />`}}},render:t=>e.jsx(nn,{...t})},Jt={Marketing:"Marketing Dept.",Operations:"Ops Team",Finance:"Finance & Accounting",Product:"Product Group"};function rn(t){const n=o.useMemo(()=>[{type:"PROPERTY",id:"department-default",key:"department",label:"Department (default)",filterComponent:"LISTOGRAM",filterState:{type:"EXACT_MATCH",values:[]}}],[]),i=o.useMemo(()=>[{type:"PROPERTY",id:"department-custom",key:"department",label:"Department (custom render)",filterComponent:"LISTOGRAM",filterState:{type:"EXACT_MATCH",values:[]},renderValue:r=>Jt[r]??r},{type:"PROPERTY",id:"team-custom",key:"team",label:"Team (custom render)",filterComponent:"MULTI_SELECT",filterState:{type:"SELECT",selectedValues:[]},renderValue:r=>r.toUpperCase()}],[]);return e.jsxs("div",{style:C,children:[e.jsx("div",{style:p,children:e.jsx(c,{objectType:a,filterDefinitions:n,...t})}),e.jsx("div",{style:p,children:e.jsx(c,{objectType:a,filterDefinitions:i,...t})})]})}const B={parameters:{docs:{description:{story:"Use `renderValue` to customize how filter values are displayed and searched. The returned string replaces the raw value for display and search matching. Works with LISTOGRAM, MULTI_SELECT, and SINGLE_SELECT components."},source:{code:`const DEPARTMENT_LABELS = {
...
<FilterList
  ...
  filterDefinitions={filterDefinitions}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(fn,{...t})};function Tn(t){const[n,i]=o.useState(void 0),[r,l]=o.useState(S),s=t.onFilterRemoved,d=o.useCallback(h=>{l(F=>F.filter(le=>"key"in le?le.key!==h:!0)),s==null||s(h)},[s]),u=t.onReset,f=o.useCallback(()=>{l(S),u==null||u()},[u]),m=t.onFilterClauseChanged,y=o.useCallback(h=>{i(h),m==null||m(h)},[m]);return e.jsxs("div",{style:Ut,children:[e.jsx("div",{style:Xt,children:e.jsx(c,{objectType:a,filterDefinitions:r,titleIcon:Kt,...t,onReset:f,onFilterRemoved:d,onFilterClauseChanged:y})}),e.jsx("div",{style:E,children:e.jsx(Bt,{objectType:a,filter:n})})]})}const J={name:"Full Featured",args:{title:"Employee Filters",showResetButton:!0,showActiveFilterCount:!0,enableSorting:!0},parameters:{docs:{description:{story:"Demonstrates all filter list features together: collapse, reset, active count, sorting, removable filters, per-filter search, exclude toggle, and the emitted where clause driving an ObjectTable."},source:{code:`// All features combined: collapse, sort, search, exclude, remove, reset
...
<FilterList
  ...
  enableSorting={true}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>{const[,n]=Yt(),i=t.onCollapsedChange,r=o.useCallback(l=>{n({collapsed:l}),i==null||i(l)},[n,i]);return e.jsx(Tn,{...t,onCollapsedChange:r})}};function Cn(t){const n=ne(),i=o.useMemo(()=>n(a),[n]),[r,l]=o.useState(void 0),s=o.useMemo(()=>[{type:"HAS_LINK",linkName:"lead",label:"Has Manager",filterState:{type:"hasLink",hasLink:!1}},{type:"LINKED_PROPERTY",linkName:"lead",reverseLinkName:"peeps",linkedPropertyKey:"department",linkedFilterComponent:"MULTI_SELECT",linkedFilterState:{type:"SELECT",selectedValues:[]},filterState:{type:"linkedProperty",linkedFilterState:{type:"SELECT",selectedValues:[]}},label:"Manager Department"}],[]),d=t.onFilterClauseChanged,u=o.useCallback(f=>{l(f),d==null||d(f)},[d]);return e.jsxs("div",{style:C,children:[e.jsx("div",{style:p,children:e.jsx(c,{objectType:a,objectSet:i,filterDefinitions:s,...t,onFilterClauseChanged:u})}),e.jsxs("div",{style:E,children:[e.jsx("strong",{children:"Filter Clause (JSON):"}),e.jsx("p",{children:"Note: LINKED_PROPERTY filter is not applied through where clause"}),e.jsx("pre",{style:g,children:r?JSON.stringify(r,null,2):"(no active filters)"})]})]})}const q={name:"Linked Property Filters",parameters:{docs:{description:{story:"Demonstrates filtering on properties of linked objects. HAS_LINK filters objects based on whether they have a linked object. LINKED_PROPERTY filters on a property of the linked object and exposes the same overflow (…) controls as direct property filters — the inline Keeping/Excluding dropdown and Clear all."},source:{code:`// HAS_LINK and LINKED_PROPERTY filter definitions
const filterDefinitions = [
  {
    type: "HAS_LINK",
    linkName: "lead",
...
/>`}}},render:t=>e.jsx(Pn,{...t})},se=[R,oe],_n=new Map([["department",{type:"EXACT_MATCH",values:["Engineering"]}],["jobTitle-multi",{type:"SELECT",selectedValues:["Software Engineer"]}]]);function ce(t){const n=[...t.keys()].sort(),i={};for(const r of n){const l=t.get(r);l!==void 0&&(i[r]=l)}return JSON.stringify(i,null,2)}function qt({initialFilterStates:t,storyArgs:n}){const i=o.useMemo(()=>{const m=new Map;for(const y of se)y.type==="PROPERTY"&&y.filterState&&m.set(ae(y),y.filterState);if(t)for(const[y,h]of t)m.set(y,h);return m},[t]),[r,l]=o.useState(()=>new Map(i)),s=n.onFilterStateChanged,d=o.useCallback((m,y)=>{l(h=>{const F=new Map(h);return F.set(ae(m),y),F}),s==null||s(m,y)},[s]),u=n.onReset,f=o.useCallback(()=>{l(new Map(i)),u==null||u()},[u,i]);return e.jsxs("div",{style:C,children:[e.jsx("div",{style:p,children:e.jsx(c,{...n,objectType:a,filterDefinitions:se,initialFilterStates:t,showResetButton:!0,onFilterStateChanged:d,onReset:f})}),e.jsxs("div",{style:E,children:[e.jsx("h4",{children:"Filter state dump"}),e.jsx("pre",{"data-testid":"filter-state-dump",style:g,children:ce(r)}),e.jsx("h4",{children:"Initial snapshot"}),e.jsx("pre",{"data-testid":"filter-state-initial",style:g,children:ce(i)})]})]})}function In(t){return e.jsx(qt,{storyArgs:t})}const ee={args:{showResetButton:!0},parameters:{docs:{description:{story:"Reset button is disabled-by-default until the user diverges from the initial (empty string) snapshot. After clicking reset the filter state returns to the initial snapshot and the button disables itself again."},source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  showResetButton={true}
