import{h as f,j as t}from"./iframe-DMxx2zRm.js";import{w as l}from"./withOsdkMetrics-CfNDL2Pn.js";import{V as w}from"./VideoViewer-BzPdQB0p.js";import{p as h}from"./passthrough-6sm3BHV7.js";import"./preload-helper-CZp4bVzU.js";import"./useRegisterUserAgent-CtQYmoBc.js";import"./index-DrfViuQB.js";import"./useMediaContents-BioyrBD_.js";import"./spin-O7JiZSCe.js";import"./svgIconContainer-Cxr5K9bz.js";import"./error-GPXFTwG4.js";const o=l(w,"VideoViewer"),{fn:V}=__STORYBOOK_MODULE_TEST__,v="/osdk-ts/storybook/pr-3430/e0bf0debdf4606b777e038e0107fee525eff4ce6/example.mp4";function k(e,p){return{fetchContents:()=>fetch(e),fetchMetadata:()=>Promise.resolve({path:p,sizeBytes:0,mediaType:"video/mp4"}),getMediaReference:()=>({mimeType:"video/mp4",reference:{type:"mediaSetViewItem",mediaSetViewItem:{mediaItemRid:"ri.mio.main.media-item.mock-video",mediaSetRid:"ri.mio.main.media-set.mock-set",mediaSetViewRid:"ri.mio.main.media-set-view.mock-view"}}})}}const S=k(v,"example.mp4"),_={title:"Components/DocumentViewer/Renderers/VideoViewer",component:o,tags:["beta"],args:{media:S},render:e=>t.jsx("div",{style:{height:"400px",width:"600px"},children:t.jsx(o,{media:e.media,onError:e.onError})}),parameters:{controls:{expanded:!0},msw:{handlers:[f.get("*/example.mp4",()=>h())]}},argTypes:{media:{description:"The OSDK Media object to fetch video from",control:!1},className:{description:"Additional CSS class name for the root element",control:"text"},onError:{description:"Callback when the video fails to load",control:!1,table:{category:"Events"}}}},i={parameters:{docs:{source:{code:`import { VideoViewer } from "@osdk/react-components/experimental/video-viewer";
...
}`,...(c=(s=r.parameters)==null?void 0:s.docs)==null?void 0:c.source}}};const C=["Default","WithErrorCallback"];export{i as Default,r as WithErrorCallback,C as __namedExportsOrder,_ as default};
