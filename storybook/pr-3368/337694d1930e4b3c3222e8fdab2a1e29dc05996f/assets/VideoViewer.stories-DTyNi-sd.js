import{h as l,j as t}from"./iframe-sEvLPolU.js";import{w as f}from"./withOsdkMetrics-Ca05WppM.js";import{V as w}from"./VideoViewer-BssCNnKs.js";import{p as h}from"./passthrough-6sm3BHV7.js";import"./preload-helper-Bj-XLBLi.js";import"./useRegisterUserAgent-C5-Tzo77.js";import"./index-B2k8cSeY.js";import"./useMediaContents-Cpi8ztlx.js";import"./spin-7TMyUGou.js";import"./svgIconContainer-B0E6OCJM.js";import"./error-D4_SCDen.js";const o=f(w,"VideoViewer"),{fn:V}=__STORYBOOK_MODULE_TEST__,v="/osdk-ts/storybook/pr-3368/337694d1930e4b3c3222e8fdab2a1e29dc05996f/example.mp4";function k(e,p){return{fetchContents:()=>fetch(e),fetchMetadata:()=>Promise.resolve({path:p,sizeBytes:0,mediaType:"video/mp4"}),getMediaReference:()=>({mimeType:"video/mp4",reference:{type:"mediaSetViewItem",mediaSetViewItem:{mediaItemRid:"ri.mio.main.media-item.mock-video",mediaSetRid:"ri.mio.main.media-set.mock-set",mediaSetViewRid:"ri.mio.main.media-set-view.mock-view"}}})}}const S=k(v,"example.mp4"),_={title:"Beta/DocumentViewer/Renderers/VideoViewer",component:o,args:{media:S},render:e=>t.jsx("div",{style:{height:"400px",width:"600px"},children:t.jsx(o,{media:e.media,onError:e.onError})}),parameters:{controls:{expanded:!0},msw:{handlers:[l.get("*/example.mp4",()=>h())]}},argTypes:{media:{description:"The OSDK Media object to fetch video from",control:!1},className:{description:"Additional CSS class name for the root element",control:"text"},onError:{description:"Callback when the video fails to load",control:!1,table:{category:"Events"}}}},i={parameters:{docs:{source:{code:`import { VideoViewer } from "@osdk/react-components/experimental/video-viewer";
