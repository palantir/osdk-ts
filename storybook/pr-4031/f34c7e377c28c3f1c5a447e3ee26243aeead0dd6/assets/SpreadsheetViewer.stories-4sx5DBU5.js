...
/>`}}}},i={args:{media:$(A,"notional-spreadsheet-example.xlsx")},render:e=>t.jsx("div",{style:{height:"600px"},children:t.jsx(V,{media:e.media})}),parameters:{msw:{handlers:[v.get("*/notional-spreadsheet-example.xlsx",()=>b())]},docs:{source:{code:`// SpreadsheetViewer fetches and parses the xlsx workbook itself, so a real
