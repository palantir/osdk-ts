...
/>`}}},render:({objectType:t,objectSet:n,...i})=>{const o=r.useMemo(()=>[R,F],[]);return e.jsx("div",{style:c,children:e.jsx(s,{objectType:a,filterDefinitions:o,...i})})}},k={parameters:{docs:{description:{story:"Repro for the integer-typed `NUMBER_RANGE` rounding fix. `employeeNumber` is an `integer` property, so histogram bucket boundaries — `(maxValue - minValue) / 20` — are usually fractional. Click any bar in the histogram. The Min/Max boxes must show whole integers (e.g. `657495073`), not fractional values (e.g. `657495073.4`)."},source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={[
    {
      type: "PROPERTY",
...
<FilterList
  ...
  filterDefinitions={filterDefinitions}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(vn,{...t})};function Ln(t){const[n,i]=r.useState(void 0),[o,l]=r.useState(T),d=t.onFilterRemoved,p=r.useCallback(S=>{l(D=>D.filter(se=>"key"in se?se.key!==S:!0)),d==null||d(S)},[d]),u=t.onReset,f=r.useCallback(()=>{l(T),u==null||u()},[u]),m=t.onFilterClauseChanged,y=r.useCallback(S=>{i(S),m==null||m(S)},[m]);return e.jsxs("div",{style:Qt,children:[e.jsx("div",{style:Zt,children:e.jsx(s,{objectType:a,filterDefinitions:o,titleIcon:en,...t,onReset:f,onFilterRemoved:p,onFilterClauseChanged:y})}),e.jsx("div",{style:C,children:e.jsx(Jt,{objectType:a,filter:n})})]})}const q={name:"Full Featured",args:{title:"Employee Filters",showResetButton:!0,showActiveFilterCount:!0,enableSorting:!0},parameters:{docs:{description:{story:"Demonstrates all filter list features together: collapse, reset, active count, sorting, removable filters, per-filter search, exclude toggle, and the emitted where clause driving an ObjectTable."},source:{code:`// All features combined: collapse, sort, search, exclude, remove, reset
...
/>`}}},render:t=>e.jsx(_n,{...t})},Yn={type:"PROPERTY",id:"locationCity-single",key:"locationCity",label:"Location City (single)",filterComponent:"SINGLE_SELECT"},Wn={type:"LINKED_PROPERTY",linkName:"lead",reverseLinkName:"peeps",linkedPropertyKey:"department",filterComponent:"MULTI_SELECT",label:"Manager Department (linked multi)"},Bn={type:"LINKED_PROPERTY",linkName:"lead",reverseLinkName:"peeps",linkedPropertyKey:"locationCity",filterComponent:"SINGLE_SELECT",label:"Manager City (linked single)"},Vn=new Map([["department",{type:"EXACT_MATCH",values:["Marketing","Research"]}],["jobTitle-multi",{type:"SELECT",selectedValues:["Marketing Manager","Chief Scientist"]}],["locationCity-single",{type:"SELECT",selectedValues:["Berlin"]}],["linkedProperty:lead:department",{type:"linkedProperty",linkedFilterState:{type:"SELECT",selectedValues:["Marketing","Research"]}}],["linkedProperty:lead:locationCity",{type:"linkedProperty",linkedFilterState:{type:"SELECT",selectedValues:["Berlin"]}}]]),Gn=[R,le,Yn,Wn,Bn];function Un(t){const n=oe(),i=r.useMemo(()=>n(a),[n]),[o,l]=r.useState(void 0),d=r.useCallback(p=>{l(p)},[]);return e.jsxs("div",{style:b,children:[e.jsx("div",{style:c,children:e.jsx(s,{...t,objectType:a,objectSet:i,filterDefinitions:Gn,defaultFilterStates:Vn,onFilterClauseChanged:d})}),e.jsxs("div",{style:C,children:[e.jsx("h4",{children:"Active where clause"}),e.jsx("pre",{style:E,children:o?JSON.stringify(o,null,2):"(none)"})]})]})}const te={name:"With Top-level Default Filter States",parameters:{docs:{description:{story:"Pass `defaultFilterStates` to hydrate filters from saved state (e.g. localStorage or URL params). Selections are restored on mount, including values that currently have zero matching rows — they appear with a count of 0 so users can see and clear them. Demonstrated across LISTOGRAM, MULTI_SELECT, SINGLE_SELECT, and LINKED_PROPERTY filters."},source:{code:`// "Research", "Chief Scientist", and "Berlin" are not in the current
...
<FilterList
  ...
  onFilterClauseChanged={handleFilterClauseChanged}
/>`}}},render:t=>e.jsx(Un,{...t})},de=[R,le],Hn=new Map([["department",{type:"EXACT_MATCH",values:["Engineering"]}],["jobTitle-multi",{type:"SELECT",selectedValues:["Software Engineer"]}]]);function pe(t){const n=[...t.keys()].sort(),i={};for(const o of n){const l=t.get(o);l!==void 0&&(i[o]=l)}return JSON.stringify(i,null,2)}function on({defaultFilterStates:t,storyArgs:n}){const i=r.useMemo(()=>{const m=new Map;for(const y of de)y.type==="PROPERTY"&&y.defaultFilterState&&m.set(ce(y),y.defaultFilterState);if(t)for(const[y,S]of t)m.set(y,S);return m},[t]),[o,l]=r.useState(()=>new Map(i)),d=n.onFilterStateChanged,p=r.useCallback((m,y)=>{l(S=>{const D=new Map(S);return D.set(ce(m),y),D}),d==null||d(m,y)},[d]),u=n.onReset,f=r.useCallback(()=>{l(new Map(i)),u==null||u()},[u,i]);return e.jsxs("div",{style:b,children:[e.jsx("div",{style:c,children:e.jsx(s,{...n,objectType:a,filterDefinitions:de,defaultFilterStates:t,showResetButton:!0,onFilterStateChanged:p,onReset:f})}),e.jsxs("div",{style:C,children:[e.jsx("h4",{children:"Filter state dump"}),e.jsx("pre",{"data-testid":"filter-state-dump",style:E,children:pe(o)}),e.jsx("h4",{children:"Initial snapshot"}),e.jsx("pre",{"data-testid":"filter-state-initial",style:E,children:pe(i)})]})]})}function Kn(t){return e.jsx(on,{storyArgs:t})}const ne={args:{showResetButton:!0},parameters:{docs:{description:{story:"Reset button is disabled-by-default until the user diverges from the initial (empty string) snapshot. After clicking reset the filter state returns to the initial snapshot and the button disables itself again."},source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  showResetButton={true}
/>`}}},render:t=>e.jsx(Kn,{...t})};function Xn(t){return e.jsx(on,{storyArgs:t,defaultFilterStates:Hn})}const ie={args:{showResetButton:!0},parameters:{docs:{description:{story:"Reset button stays disabled on mount even though there are active selections, because the live filter state matches the initial snapshot. Changing a selection enables the button; clicking it restores the initial snapshot, not an empty state."},source:{code:`const savedStates = new Map([
...
<FilterList
  ...
  defaultFilterStates={savedStates}
  showResetButton={true}
/>`}}},render:t=>e.jsx(Xn,{...t})};var ue,me,fe;j.parameters={...j.parameters,docs:{...(ue=j.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`<FilterList
...
}`,...(fe=(me=j.parameters)==null?void 0:me.docs)==null?void 0:fe.source}}};var ye,he,be;k.parameters={...k.parameters,docs:{...(ye=k.parameters)==null?void 0:ye.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(be=(he=k.parameters)==null?void 0:he.docs)==null?void 0:be.source}}};var Te,Se,Ce;O.parameters={...O.parameters,docs:{...(Te=O.parameters)==null?void 0:Te.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(Ce=(Se=O.parameters)==null?void 0:Se.docs)==null?void 0:Ce.source}}};var Ee,ge,Re;w.parameters={...w.parameters,docs:{...(Ee=w.parameters)==null?void 0:Ee.docs,source:{originalSource:`{
  args: {
    showResetButton: true
  },
  parameters: {
...
}`,...(Re=(ge=w.parameters)==null?void 0:ge.docs)==null?void 0:Re.source}}};var ve,Le,Fe;M.parameters={...M.parameters,docs:{...(ve=M.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(Fe=(Le=M.parameters)==null?void 0:Le.docs)==null?void 0:Fe.source}}};var De,je,ke;A.parameters={...A.parameters,docs:{...(De=A.parameters)==null?void 0:De.docs,source:{originalSource:`{
  args: {
    title: "Employee Filters"
  },
  parameters: {
...
}`,...(ke=(je=A.parameters)==null?void 0:je.docs)==null?void 0:ke.source}}};var Oe,we,Me;P.parameters={...P.parameters,docs:{...(Oe=P.parameters)==null?void 0:Oe.docs,source:{originalSource:`{
  args: {
    showResetButton: true
  },
  parameters: {
...
}`,...(Me=(we=P.parameters)==null?void 0:we.docs)==null?void 0:Me.source}}};var Ae,Pe,Ie;I.parameters={...I.parameters,docs:{...(Ae=I.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
  args: {
    showActiveFilterCount: true
  },
  parameters: {
...
}`,...(_e=(Ne=x.parameters)==null?void 0:Ne.docs)==null?void 0:_e.source}}};var Ye,We,Be;N.parameters={...N.parameters,docs:{...(Ye=N.parameters)==null?void 0:Ye.docs,source:{originalSource:`{
  args: {
    title: "Employee Filters",
    showActiveFilterCount: true
  },
...
}`,...(Be=(We=N.parameters)==null?void 0:We.docs)==null?void 0:Be.source}}};var Ve,Ge,Ue;_.parameters={..._.parameters,docs:{...(Ve=_.parameters)==null?void 0:Ve.docs,source:{originalSource:`{
  args: {
    title: "Employee Filters"
  },
  parameters: {
...
}`,...(Ue=(Ge=_.parameters)==null?void 0:Ge.docs)==null?void 0:Ue.source}}};var He,Ke,Xe;Y.parameters={...Y.parameters,docs:{...(He=Y.parameters)==null?void 0:He.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`const filterDefinitions = [
...
}`,...(Xe=(Ke=Y.parameters)==null?void 0:Ke.docs)==null?void 0:Xe.source}}};var Je,qe,ze;W.parameters={...W.parameters,docs:{...(Je=W.parameters)==null?void 0:Je.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,...(ze=(qe=W.parameters)==null?void 0:qe.docs)==null?void 0:ze.source}}};var $e,Qe,Ze;B.parameters={...B.parameters,docs:{...($e=B.parameters)==null?void 0:$e.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(Ze=(Qe=B.parameters)==null?void 0:Qe.docs)==null?void 0:Ze.source}}};var et,tt,nt;V.parameters={...V.parameters,docs:{...(et=V.parameters)==null?void 0:et.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(nt=(tt=V.parameters)==null?void 0:tt.docs)==null?void 0:nt.source}}};var it,ot,rt;G.parameters={...G.parameters,docs:{...(it=G.parameters)==null?void 0:it.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,...(rt=(ot=G.parameters)==null?void 0:ot.docs)==null?void 0:rt.source}}};var at,lt,st;U.parameters={...U.parameters,docs:{...(at=U.parameters)==null?void 0:at.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(st=(lt=U.parameters)==null?void 0:lt.docs)==null?void 0:st.source}}};var ct,dt,pt;H.parameters={...H.parameters,docs:{...(ct=H.parameters)==null?void 0:ct.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(bt=(ht=X.parameters)==null?void 0:ht.docs)==null?void 0:bt.source}}};var Tt,St,Ct;J.parameters={...J.parameters,docs:{...(Tt=J.parameters)==null?void 0:Tt.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(Ct=(St=J.parameters)==null?void 0:St.docs)==null?void 0:Ct.source}}};var Et,gt,Rt;q.parameters={...q.parameters,docs:{...(Et=q.parameters)==null?void 0:Et.docs,source:{originalSource:`{
  name: "Full Featured",
  args: {
    title: "Employee Filters",
    showResetButton: true,
...
}`,...(Rt=(gt=q.parameters)==null?void 0:gt.docs)==null?void 0:Rt.source}}};var vt,Lt,Ft;z.parameters={...z.parameters,docs:{...(vt=z.parameters)==null?void 0:vt.docs,source:{originalSource:`{
...
}`,...(Ft=(Lt=z.parameters)==null?void 0:Lt.docs)==null?void 0:Ft.source}}};var Dt,jt,kt;$.parameters={...$.parameters,docs:{...(Dt=$.parameters)==null?void 0:Dt.docs,source:{originalSource:`{
...
}`,...(kt=(jt=$.parameters)==null?void 0:jt.docs)==null?void 0:kt.source}}};var Ot,wt,Mt;Q.parameters={...Q.parameters,docs:{...(Ot=Q.parameters)==null?void 0:Ot.docs,source:{originalSource:`{
  name: "Custom Filters",
  parameters: {
    docs: {
      description: {
...
}`,...(Mt=(wt=Q.parameters)==null?void 0:wt.docs)==null?void 0:Mt.source}}};var At,Pt,It;Z.parameters={...Z.parameters,docs:{...(At=Z.parameters)==null?void 0:At.docs,source:{originalSource:`{
...
}`,...(_t=(Nt=ee.parameters)==null?void 0:Nt.docs)==null?void 0:_t.source}}};var Yt,Wt,Bt;te.parameters={...te.parameters,docs:{...(Yt=te.parameters)==null?void 0:Yt.docs,source:{originalSource:`{
...
}`,...(Bt=(Wt=te.parameters)==null?void 0:Wt.docs)==null?void 0:Bt.source}}};var Vt,Gt,Ut;ne.parameters={...ne.parameters,docs:{...(Vt=ne.parameters)==null?void 0:Vt.docs,source:{originalSource:`{
  args: {
    showResetButton: true
  },
  parameters: {
