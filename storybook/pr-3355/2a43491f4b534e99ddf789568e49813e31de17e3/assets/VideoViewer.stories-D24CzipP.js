import{h as l,j as t}from"./iframe-Bxjk0MIU.js";import{w as f}from"./withOsdkMetrics-aeANrjsm.js";import{V as w}from"./VideoViewer-DI3inP2-.js";import{p as h}from"./passthrough-6sm3BHV7.js";import"./preload-helper-CAu4VSwH.js";import"./useRegisterUserAgent-DAD_wSEu.js";import"./index-CvQXSN1P.js";import"./useMediaContents-B407F8vd.js";import"./spin-D-veAYsX.js";import"./svgIconContainer-Bmm2fo-V.js";import"./error-DzvqTm1X.js";const o=f(w,"VideoViewer"),{fn:V}=__STORYBOOK_MODULE_TEST__,v="/osdk-ts/storybook/pr-3355/2a43491f4b534e99ddf789568e49813e31de17e3/example.mp4";function k(e,p){return{fetchContents:()=>fetch(e),fetchMetadata:()=>Promise.resolve({path:p,sizeBytes:0,mediaType:"video/mp4"}),getMediaReference:()=>({mimeType:"video/mp4",reference:{type:"mediaSetViewItem",mediaSetViewItem:{mediaItemRid:"ri.mio.main.media-item.mock-video",mediaSetRid:"ri.mio.main.media-set.mock-set",mediaSetViewRid:"ri.mio.main.media-set-view.mock-view"}}})}}const S=k(v,"example.mp4"),b={title:"Beta/DocumentViewer/Renderers/VideoViewer",component:o,args:{media:S},render:e=>t.jsx("div",{style:{height:"400px",width:"600px"},children:t.jsx(o,{media:e.media,onError:e.onError})}),parameters:{controls:{expanded:!0},msw:{handlers:[l.get("*/example.mp4",()=>h())]}},argTypes:{media:{description:"The OSDK Media object to fetch video from",control:!1},className:{description:"Additional CSS class name for the root element",control:"text"},onError:{description:"Callback when the video fails to load",control:!1,table:{category:"Events"}}}},i={parameters:{docs:{source:{code:`import { VideoViewer } from "@osdk/react-components/experimental/video-viewer";
...
}`,...(c=(s=r.parameters)==null?void 0:s.docs)==null?void 0:c.source}}};const j=["Default","WithErrorCallback"];export{i as Default,r as WithErrorCallback,j as __namedExportsOrder,b as default};
