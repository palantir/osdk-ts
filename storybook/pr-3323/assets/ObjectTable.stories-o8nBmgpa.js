...
/>`}}},render:e=>n.jsxs("div",{className:"object-table-container",style:{height:"600px"},children:[n.jsx("div",{style:{padding:"12px"},children:"Right click on any cell"}),n.jsx(i,{...e})]})},N={args:{objectType:o,columnDefinitions:gn.map((e,t)=>({...e,width:t===0?250:t===1?300:150}))},parameters:{docs:{source:{code:`const columnDefinitions = [
...
<ObjectTable
  objectType={Employee}
  columnDefinitions={columnDefinitions}
/>`}}},render:e=>n.jsx("div",{className:"object-table-container",style:{height:"600px"},children:n.jsx(i,{...e})})},R={args:{objectType:o,columnDefinitions:m,defaultOrderBy:[{property:"fullName",direction:"desc"}]},parameters:{docs:{source:{code:`<ObjectTable
  objectType={Employee}
  defaultOrderBy={[{
    property: "fullName",
    direction: "desc",
  }]}
/>`}}},render:e=>n.jsx("div",{className:"object-table-container",style:{height:"600px"},children:n.jsx(i,{...e})})},O={args:{objectType:o,columnDefinitions:[{locator:{type:"property",id:"fullName"},pinned:"left"},{locator:{type:"property",id:"emailPrimaryWork"}},{locator:{type:"property",id:"jobTitle"}},{locator:{type:"property",id:"department"},pinned:"right"},{locator:{type:"property",id:"firstFullTimeStartDate"}}]},parameters:{docs:{source:{code:`const columnDefinitions = [
  {
    locator: { type: "property", id: "fullName" },
    pinned: "left",
  },
...
<ObjectTable
  objectType={Employee}
  columnDefinitions={columnDefinitions}
/>`}}},render:e=>n.jsx("div",{className:"object-table-container",style:{height:"600px"},children:n.jsx(i,{...e})})},k={parameters:{docs:{source:{code:`const customColumnDefinition = [
      ...columnDefinitions,
      {
        locator: {
          type: "custom",
    ...
    `}}},args:{objectType:o,columnDefinitions:[...gn.slice(0,3),{locator:{type:"custom",id:"actions"},renderHeader:()=>"Actions",renderCell:e=>n.jsxs("div",{style:{display:"flex",gap:"8px"},children:[n.jsx("button",{style:{padding:"4px 8px",fontSize:"12px",border:"1px solid #d1d5db",borderRadius:"4px",background:"white",cursor:"pointer"},onClick:()=>alert(`View ${e.fullName}`),children:"View"}),n.jsx("button",{style:{padding:"4px 8px",fontSize:"12px",border:"1px solid #d1d5db",borderRadius:"4px",background:"white",cursor:"pointer"},onClick:()=>alert(`Edit ${e.fullName}`),children:"Edit"})]}),orderable:!1,width:120}]},render:e=>n.jsx("div",{className:"object-table-container",style:{height:"600px"},children:n.jsx(i,{...e})})},P={args:{objectType:o,columnDefinitions:m,selectionMode:"multiple",selectedRows:[],orderBy:[{property:"fullName",direction:"asc"}],onRowClick:p(),onColumnHeaderClick:p(),onRowSelectionChanged:p(),onOrderByChanged:p(),onColumnVisibilityChanged:p(),onColumnsPinnedChanged:p(),onColumnResize:p()},parameters:{docs:{source:{code:`<ObjectTable
  objectType={Employee}
...
/>`}}},render:e=>{const[t,r]=a.useState(null),[u,d]=a.useState(null),[c,g]=a.useState([]),[b,h]=a.useState(!1),[y,fn]=a.useState([{property:"fullName",direction:"asc"}]),[hn,f]=a.useState(""),Cn=a.useCallback(l=>{var s;(s=e.onRowClick)==null||s.call(e,l),r(l),f("onRowClick")},[e]),jn=a.useCallback(l=>{var s;(s=e.onColumnHeaderClick)==null||s.call(e,l),d(l),f("onColumnHeaderClick")},[e]),Sn=a.useCallback(l=>{var s;(s=e.onRowSelectionChanged)==null||s.call(e,l),g(l.selectedRows.map(C=>C.$primaryKey)),h(l.isSelectAll),f("onRowSelectionChanged")},[e]),wn=a.useCallback(l=>{var s;(s=e.onOrderByChanged)==null||s.call(e,l),fn(l),f("onOrderByChanged")},[e]),vn=a.useCallback(l=>{var s;(s=e.onColumnVisibilityChanged)==null||s.call(e,l),f("onColumnVisibilityChanged")},[e]),Dn=a.useCallback(l=>{var s;(s=e.onColumnsPinnedChanged)==null||s.call(e,l),f("onColumnsPinnedChanged")},[e]),En=a.useCallback((l,s)=>{var C;(C=e.onColumnResize)==null||C.call(e,l,s),f(`onColumnResize (${l})`)},[e]);return n.jsxs("div",{children:[n.jsxs("div",{style:{marginBottom:"16px",padding:"12px",backgroundColor:"#f0f9ff",borderRadius:"4px",border:"1px solid #bfdbfe"},children:[n.jsx("div",{style:{marginBottom:"8px",fontWeight:"bold"},children:"Event Monitor:"}),n.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[n.jsx("strong",{children:"Last event:"})," ",hn||"None"]}),n.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[n.jsx("strong",{children:"Row clicked:"})," ",t?n.jsx("code",{children:t.fullName}):"None"]}),n.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[n.jsx("strong",{children:"Column clicked:"})," ",u?n.jsx("code",{children:u}):"None"]}),n.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[n.jsx("strong",{children:"Selected rows:"})," ",b?"All employees":`${c.length} employees`]}),n.jsxs("div",{style:{fontSize:"12px"},children:[n.jsx("strong",{children:"Current sort:"})," ",y!=null&&y[0]?`${y[0].property} (${y[0].direction})`:"None"]})]}),n.jsx("div",{className:"object-table-container",style:{height:"600px"},children:n.jsx(i,{...e,selectedRows:c,orderBy:y,onRowClick:Cn,onColumnHeaderClick:jn,onRowSelectionChanged:Sn,onOrderByChanged:wn,onColumnVisibilityChanged:vn,onColumnsPinnedChanged:Dn,onColumnResize:En})})]})}},F={args:{objectType:o,columnDefinitions:m,orderBy:[{property:"fullName",direction:"asc"}],onOrderByChanged:p()},parameters:{docs:{source:{code:`const [orderBy, setOrderBy] = useState<any>([
...
return (
  ...
  />
);`}}},render:e=>{const[t,r]=a.useState(e.orderBy??[{property:"fullName",direction:"asc"}]),u=a.useCallback(d=>{var c;(c=e.onOrderByChanged)==null||c.call(e,d),r(d)},[e]);return n.jsxs("div",{children:[n.jsxs("div",{style:{marginBottom:"16px"},children:[n.jsx("strong",{children:"Current Sort:"})," ",t.map((d,c)=>n.jsxs("span",{children:[d.property," (",d.direction,")",c<t.length-1&&", "]},c))]}),n.jsx("div",{className:"object-table-container",style:{height:"600px"},children:n.jsx(i,{...e,orderBy:t,onOrderByChanged:u})})]})}},B={args:{objectType:o,columnDefinitions:m,selectionMode:"multiple",selectedRows:[],onRowSelectionChanged:p()},parameters:{docs:{source:{code:`const [selectedRows, setSelectedRows] = useState<any[]>([]);
...
return (
  ...
  />
);`}}},render:e=>{const[t,r]=a.useState(e.selectedRows??[]),[u,d]=a.useState(!1),c=a.useCallback(g=>{var b;(b=e.onRowSelectionChanged)==null||b.call(e,g),r(g.selectedRows.map(h=>h.$primaryKey)),d(g.isSelectAll)},[e]);return n.jsxs("div",{children:[n.jsxs("div",{style:{marginBottom:"16px"},children:[n.jsx("strong",{children:"Selected:"})," ",u?"All Employees":`${t.length} employees`,t.length>0&&n.jsx("button",{style:{marginLeft:"16px",padding:"4px 8px",fontSize:"12px",border:"1px solid #d1d5db",borderRadius:"4px",background:"white",cursor:"pointer"},onClick:()=>{r([]),d(!1)},children:"Clear Selection"})]}),n.jsx("div",{className:"object-table-container",style:{height:"600px"},children:n.jsx(i,{...e,selectedRows:t,isAllSelected:u,onRowSelectionChanged:c})})]})}},M={args:{objectType:o,columnDefinitions:m,enableOrdering:!1,enableColumnPinning:!1,enableColumnResizing:!1,enableColumnConfig:!1},parameters:{docs:{source:{code:`<ObjectTable
  objectType={Employee}
  enableOrdering={false}
  enableColumnPinning={false}
  enableColumnResizing={false}
  enableColumnConfig={false}
/>`}}},render:e=>n.jsx("div",{className:"object-table-container",style:{height:"600px"},children:n.jsx(i,{...e})})},A={args:{objectType:o,columnDefinitions:m,rowHeight:56},parameters:{docs:{source:{code:"<ObjectTable objectType={Employee} rowHeight={56} />"}}},render:e=>n.jsx("div",{className:"object-table-container",style:{height:"600px"},children:n.jsx(i,{...e})})},I={args:{objectType:o,columnDefinitions:[{locator:{type:"property",id:"fullName"},renderHeader:()=>n.jsx("a",{href:"#",className:"header-link",onClick:e=>{e.preventDefault(),alert("Employee Name column clicked!")},children:"Employee Name"})},{locator:{type:"property",id:"emailPrimaryWork"}},{locator:{type:"property",id:"jobTitle"},renderHeader:()=>"Job Title"},{locator:{type:"custom",id:"employment-status"},renderHeader:()=>"Employment Status",renderCell:e=>{const t=e.firstFullTimeStartDate,r=t&&new Date(t)<=new Date;return n.jsx("span",{className:`status-tag ${r?"active":"inactive"}`,children:r?"Active":"Inactive"})},width:140},{locator:{type:"property",id:"department"}}]},parameters:{docs:{source:{code:`const columnDefinitions = [
  {
    locator: { type: "property", id: "fullName" },
    renderHeader: () => (
      <a
...
<ObjectTable objectType={Employee} columnDefinitions={columnDefinitions} />`}}},render:e=>n.jsx("div",{className:"object-table-container",style:{height:"600px"},children:n.jsx(i,{...e})})},W={args:{objectType:o,columnDefinitions:yn,editMode:"manual",onCellValueChanged:p()},parameters:{docs:{source:{code:`const columnDefinitions = [
  {
    locator: { type: "property", id: "fullName" },
    editable: true,
  },
...
return (
  <ObjectTable
    ...
    editMode="manual"
  />
);`}}},render:e=>{const[t,r]=a.useState(),u=a.useCallback(d=>{var c;(c=e.onCellValueChanged)==null||c.call(e,d),r(d)},[e]);return n.jsxs("div",{className:"object-table-container",style:{height:"600px"},children:[n.jsx("div",{style:{padding:"12px",backgroundColor:"#fff3cd",marginBottom:"8px",borderRadius:"4px"},children:'Try changing showEditFooter to false to hide the edit footer bar. Change edit mode to "manual" to enable inline editing with an Edit Table button.'}),t!=null&&n.jsxs("div",{style:{padding:"12px",backgroundColor:"#d1ecf1",marginBottom:"8px",borderRadius:"4px",fontFamily:"monospace",fontSize:"13px"},children:[n.jsx("strong",{children:"Last cell edit:"})," ",'Column "',t.columnId,'" changed from "',String(t.oldValue),'" to "',String(t.newValue),'"']}),n.jsx(i,{...e,onCellValueChanged:u})]})}},V={args:{objectType:o,columnDefinitions:yn,editMode:"manual",onSubmitEdits:p(async e=>(await new Promise(t=>setTimeout(t,1e3)),!0))},parameters:{docs:{source:{code:`const columnDefinitions = [
  {
    locator: { type: "property", id: "fullName" },
    editable: true,
  },
...
return (
  ...
  />
);`}}},render:e=>{const t=a.useCallback(r=>({"data-highlight-row":r.locationCity==="New York"?"true":void 0}),[]);return n.jsxs("div",{className:"object-table-container",style:{height:"600px"},children:[n.jsxs("div",{style:{padding:"12px",backgroundColor:"#fff3cd",marginBottom:"8px",borderRadius:"4px"},children:[n.jsx("strong",{children:"Row attributes + className for CSS override:"})," ","New York employees have a light blue background via"," ",n.jsx("code",{children:'tr[data-highlight-row="true"]'})," scoped under"," ",n.jsx("code",{children:".customTableStyling"}),"."]}),n.jsx(i,{...e,getRowAttributes:t,className:"customTableStyling"})]})}},L={args:{objectType:o,columnDefinitions:m,renderEmptyState:()=>n.jsx(un,{icon:"folder-close",title:"No saved views found."})},parameters:{docs:{description:{story:"Override the default empty state with a custom render function. Useful for matching product copy or visuals (here a Blueprint `NonIdealState`)."},source:{code:`
...
`}}},render:e=>{const r=mn()(o).where({jobProfile:"Nonexistent Role"});return n.jsx("div",{className:"object-table-container",style:{height:"600px"},children:n.jsx(i,{...e,objectSet:r})})}};var Y,J,U;j.parameters={...j.parameters,docs:{...(Y=j.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns
  },
...
}`,...(U=(J=j.parameters)==null?void 0:J.docs)==null?void 0:U.source}}};var X,Z,Q;S.parameters={...S.parameters,docs:{...(X=S.parameters)==null?void 0:X.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns
  },
...
}`,...(Q=(Z=S.parameters)==null?void 0:Z.docs)==null?void 0:Q.source}}};var G,ee,ne;w.parameters={...w.parameters,docs:{...(G=w.parameters)==null?void 0:G.docs,source:{originalSource:`{
  args: {
...
}`,...(ne=(ee=w.parameters)==null?void 0:ee.docs)==null?void 0:ne.source}}};var te,oe,re;v.parameters={...v.parameters,docs:{...(te=v.parameters)==null?void 0:te.docs,source:{originalSource:`{
  render: () => {
    type RDPs = {
      managerName: "string";
    };
...
}`,...(re=(oe=v.parameters)==null?void 0:oe.docs)==null?void 0:re.source}}};var ie,ae,le;D.parameters={...D.parameters,docs:{...(ie=D.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: [{
      locator: {
...
}`,...(le=(ae=D.parameters)==null?void 0:ae.docs)==null?void 0:le.source}}};var se,de,ce;E.parameters={...E.parameters,docs:{...(se=E.parameters)==null?void 0:se.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
...
}`,...(ce=(de=E.parameters)==null?void 0:de.docs)==null?void 0:ce.source}}};var pe,me,ue;T.parameters={...T.parameters,docs:{...(pe=T.parameters)==null?void 0:pe.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
    selectionMode: "multiple",
...
}`,...(ue=(me=T.parameters)==null?void 0:me.docs)==null?void 0:ue.source}}};var ye,be,ge;x.parameters={...x.parameters,docs:{...(ye=x.parameters)==null?void 0:ye.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
...
}`,...(ge=(be=x.parameters)==null?void 0:be.docs)==null?void 0:ge.source}}};var fe,he,Ce;N.parameters={...N.parameters,docs:{...(fe=N.parameters)==null?void 0:fe.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
...
}`,...(Ce=(he=N.parameters)==null?void 0:he.docs)==null?void 0:Ce.source}}};var je,Se,we;R.parameters={...R.parameters,docs:{...(je=R.parameters)==null?void 0:je.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
    defaultOrderBy: [{
...
}`,...(we=(Se=R.parameters)==null?void 0:Se.docs)==null?void 0:we.source}}};var ve,De,Ee;O.parameters={...O.parameters,docs:{...(ve=O.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: [{
      locator: {
...
}`,...(Ee=(De=O.parameters)==null?void 0:De.docs)==null?void 0:Ee.source}}};var Te,xe,Ne;k.parameters={...k.parameters,docs:{...(Te=k.parameters)==null?void 0:Te.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,...(Ne=(xe=k.parameters)==null?void 0:xe.docs)==null?void 0:Ne.source}}};var Re,Oe,ke;P.parameters={...P.parameters,docs:{...(Re=P.parameters)==null?void 0:Re.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
...
}`,...(ke=(Oe=P.parameters)==null?void 0:Oe.docs)==null?void 0:ke.source}}};var Pe,Fe,Be;F.parameters={...F.parameters,docs:{...(Pe=F.parameters)==null?void 0:Pe.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
    orderBy: [{
...
}`,...(Be=(Fe=F.parameters)==null?void 0:Fe.docs)==null?void 0:Be.source}}};var Me,Ae,Ie;B.parameters={...B.parameters,docs:{...(Me=B.parameters)==null?void 0:Me.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
    selectionMode: "multiple" as const,
...
}`,...(Ie=(Ae=B.parameters)==null?void 0:Ae.docs)==null?void 0:Ie.source}}};var We,Ve,He;M.parameters={...M.parameters,docs:{...(We=M.parameters)==null?void 0:We.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
    enableOrdering: false,
...
}`,...(He=(Ve=M.parameters)==null?void 0:Ve.docs)==null?void 0:He.source}}};var ze,$e,Le;A.parameters={...A.parameters,docs:{...(ze=A.parameters)==null?void 0:ze.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
    rowHeight: 56
...
}`,...(Le=($e=A.parameters)==null?void 0:$e.docs)==null?void 0:Le.source}}};var _e,Ke,qe;I.parameters={...I.parameters,docs:{...(_e=I.parameters)==null?void 0:_e.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: [{
      locator: {
...
}`,...(qe=(Ke=I.parameters)==null?void 0:Ke.docs)==null?void 0:qe.source}}};var Ye,Je,Ue;W.parameters={...W.parameters,docs:{...(Ye=W.parameters)==null?void 0:Ye.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
...
}`,...(Ue=(Je=W.parameters)==null?void 0:Je.docs)==null?void 0:Ue.source}}};var Xe,Ze,Qe;V.parameters={...V.parameters,docs:{...(Xe=V.parameters)==null?void 0:Xe.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: editableColumnDefinitions,
    editMode: "manual",
...
}`,...(Qe=(Ze=V.parameters)==null?void 0:Ze.docs)==null?void 0:Qe.source}}};var Ge,en,nn;H.parameters={...H.parameters,docs:{...(Ge=H.parameters)==null?void 0:Ge.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: [{
      locator: {
...
}`,...(nn=(en=H.parameters)==null?void 0:en.docs)==null?void 0:nn.source}}};var tn,on,rn;z.parameters={...z.parameters,docs:{...(tn=z.parameters)==null?void 0:tn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: [{
      locator: {
...
}`,...(rn=(on=z.parameters)==null?void 0:on.docs)==null?void 0:rn.source}}};var an,ln,sn;$.parameters={...$.parameters,docs:{...(an=$.parameters)==null?void 0:an.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: [{
      locator: {
...
}`,...(sn=(ln=$.parameters)==null?void 0:ln.docs)==null?void 0:sn.source}}};var dn,cn,pn;L.parameters={...L.parameters,docs:{...(dn=L.parameters)==null?void 0:dn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
...
}`,...(pn=(cn=L.parameters)==null?void 0:cn.docs)==null?void 0:pn.source}}};const Ot=["Default","WithObjectSet","WithInterfaceType","WithDerivedPropertyOrderingAndFilter","WithFunctionColumn","SingleSelection","MultipleSelection","WithContextMenu","CustomColumnWidths","WithDefaultSorting","WithDefaultColumnPinning","WithCustomColumn","EventListeners","ControlledSorting","ControlledSelection","DisableAllHeaderMenuFeatures","CustomRowHeight","WithCustomRenderers","EditableTable","WithSubmitEditsButton","EditableWithValidation","PerRowEditableAndFieldConfig","RowAttributesForStyling","CustomEmptyState"];export{B as ControlledSelection,F as ControlledSorting,N as CustomColumnWidths,L as CustomEmptyState,A as CustomRowHeight,j as Default,M as DisableAllHeaderMenuFeatures,W as EditableTable,H as EditableWithValidation,P as EventListeners,T as MultipleSelection,z as PerRowEditableAndFieldConfig,$ as RowAttributesForStyling,E as SingleSelection,x as WithContextMenu,k as WithCustomColumn,I as WithCustomRenderers,O as WithDefaultColumnPinning,R as WithDefaultSorting,v as WithDerivedPropertyOrderingAndFilter,D as WithFunctionColumn,w as WithInterfaceType,S as WithObjectSet,V as WithSubmitEditsButton,Ot as __namedExportsOrder,Rt as default};
