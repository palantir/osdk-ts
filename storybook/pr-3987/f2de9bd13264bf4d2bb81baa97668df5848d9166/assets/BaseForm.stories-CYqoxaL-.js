...
/>`}}}},ro=[e({fieldKey:"isRemote",fieldComponent:"SWITCH",label:"Remote employee",helperText:"Use a switch for boolean settings that map to on/off state.",fieldComponentProps:{}})],E={args:{formTitle:"Update employee",formContent:ro,onSubmit:r},parameters:{docs:{source:{code:`const formContent = [
  {
    fieldKey: "isRemote",
...
<BaseForm
  ...
  formContent={formContent}
  onSubmit={(formState) => console.log("Submitted:", formState)}
/>`}}}},lo=[e({fieldKey:"structPayload",fieldComponent:"UNSUPPORTED",label:"Struct payload",isRequired:!0,fieldComponentProps:{}}),e({fieldKey:"geoshape",fieldComponent:"UNSUPPORTED",label:"Geoshape",fieldComponentProps:{}})],P={args:{formTitle:"Unsupported field types",formContent:lo,onSubmit:r},parameters:{docs:{source:{code:`const formContent = [
  {
...
<BaseForm
  ...
  formContent={formContent}
  onSubmit={(formState) => console.log("Submitted:", formState)}
/>`}}}},ao=[e({fieldKey:"name",fieldComponent:"TEXT_INPUT",label:"Name",isRequired:!0,fieldComponentProps:{placeholder:"Required field"}}),e({fieldKey:"username",fieldComponent:"TEXT_INPUT",label:"Username",fieldComponentProps:{minLength:3,maxLength:20,placeholder:"3-20 characters"}}),e({fieldKey:"quantity",fieldComponent:"NUMBER_INPUT",label:"Quantity",fieldComponentProps:{min:0,max:100,step:1,placeholder:"0-100"}}),e({fieldKey:"startDate",fieldComponent:"DATETIME_PICKER",label:"Start Date",fieldComponentProps:{min:new Date(2024,0,1),max:new Date(2026,11,31),placeholder:"2024-2026 only"}}),e({fieldKey:"document",fieldComponent:"FILE_PICKER",label:"Document",fieldComponentProps:{maxSize:1048576}})],D={args:{formContent:ao,onSubmit:r},parameters:{docs:{source:{code:`const formContent = [
  {
    fieldKey: "name",
    fieldComponent: "TEXT_INPUT",
    label: "Name",
...
<BaseForm
  formContent={formContent}
  onSubmit={(formState) => console.log("Submitted:", formState)}
/>`}}}},io=/^[^\s@]+@[^\s@]+\.[^\s@]+$/u,so=[e({fieldKey:"email",fieldComponent:"TEXT_INPUT",label:"Email",isRequired:!0,validate:async n=>{if(!(typeof n!="string"||n.length===0))return io.test(n)?void 0:"Enter a valid email address"},fieldComponentProps:{placeholder:"user@example.com"}})],F={args:{formContent:so,onSubmit:r},parameters:{docs:{source:{code:`const formContent = [
  {
    fieldKey: "email",
    fieldComponent: "TEXT_INPUT",
    label: "Email",
...
<BaseForm
  formContent={formContent}
  onSubmit={(formState) => console.log("Submitted:", formState)}
/>`}}}},mo=[e({fieldKey:"name",fieldComponent:"TEXT_INPUT",label:"Name",isRequired:!0,onValidationError:n=>{if(n.type==="required")return"Please provide your name"},fieldComponentProps:{placeholder:"Your name"}}),e({fieldKey:"age",fieldComponent:"NUMBER_INPUT",label:"Age",onValidationError:n=>{if(n.type==="min")return`You must be at least ${String(n.min)} years old`;if(n.type==="max")return`Age cannot exceed ${String(n.max)}`},fieldComponentProps:{min:18,max:120,placeholder:"18-120"}})],_={args:{formContent:mo,onSubmit:r},parameters:{docs:{source:{code:`const formContent = [
  {
    fieldKey: "name",
    fieldComponent: "TEXT_INPUT",
    label: "Name",
...
<BaseForm
  formContent={formContent}
  onSubmit={(formState) => console.log("Submitted:", formState)}
/>`}}},render:()=>o.jsx(po,{})};function po(){const n=Y(),t=a.useMemo(()=>n($),[n]),l=a.useMemo(()=>[e({fieldKey:"name",fieldComponent:"TEXT_INPUT",label:"Name",isRequired:!0,fieldComponentProps:{placeholder:"Enter a name"}}),e({fieldKey:"employees",fieldComponent:"OBJECT_SET",label:"Employees",fieldComponentProps:{value:t}})],[t]);return o.jsx(p,{formContent:l,onSubmit:r})}const co=[e({fieldKey:"department",fieldComponent:"DROPDOWN",label:"Department (Select)",fieldComponentProps:{items:m,placeholder:"Select department..."}}),e({fieldKey:"team",fieldComponent:"DROPDOWN",label:"Team (Searchable)",fieldComponentProps:{items:m,isSearchable:!0,placeholder:"Search teams..."}})],R={args:{formContent:co,onSubmit:r},parameters:{docs:{source:{code:`const formContent = [
  {
    fieldKey: "department",
    fieldComponent: "DROPDOWN",
...
<BaseForm
  formContent={formContent}
  onSubmit={(formState) => console.log("Submitted:", formState)}
/>`}}}},uo=[e({fieldKey:"categories",fieldComponent:"DROPDOWN",label:"Categories (Select)",isRequired:!0,fieldComponentProps:{items:q,isMultiple:!0,placeholder:"Select categories..."}}),e({fieldKey:"tags",fieldComponent:"DROPDOWN",label:"Tags (Searchable)",fieldComponentProps:{items:q,isMultiple:!0,isSearchable:!0,placeholder:"Search tags..."}})],N={args:{formContent:uo,onSubmit:r},parameters:{docs:{source:{code:`const formContent = [
  {
    fieldKey: "categories",
    fieldComponent: "DROPDOWN",
...
<BaseForm
  formContent={formContent}
  onSubmit={(formState) => console.log("Submitted:", formState)}
/>`}}}},Co=[e({fieldKey:"scheduledAt",fieldComponent:"DATETIME_PICKER",label:"Scheduled At (date + time)",fieldComponentProps:{showTime:!0,placeholder:"Select date and time"}}),e({fieldKey:"deadline",fieldComponent:"DATETIME_PICKER",label:"Deadline (date only)",fieldComponentProps:{placeholder:"Select date"}})],O={args:{formContent:Co,onSubmit:r},parameters:{docs:{source:{code:`const formContent = [
  {
...
</Dialog>`}}}},To=[e({fieldKey:"vacationDates",fieldComponent:"DATE_RANGE_INPUT",label:"Vacation Dates (date only)",fieldComponentProps:{placeholderStart:"Start date",placeholderEnd:"End date"}}),e({fieldKey:"meetingWindow",fieldComponent:"DATE_RANGE_INPUT",label:"Meeting Window (date + time)",fieldComponentProps:{showTime:!0,placeholderStart:"Start",placeholderEnd:"End"}})],B={args:{formContent:To,onSubmit:r},parameters:{docs:{source:{code:`const formContent = [
  {
...
<BaseForm
  formContent={formContent}
  onSubmit={(formState) => console.log("Submitted:", formState)}
/>`}}}},go=[e({fieldKey:"attachments",fieldComponent:"FILE_PICKER",label:"Attachments",fieldComponentProps:{isMulti:!0,accept:[".pdf",".png",".jpg"],maxSize:5242880,text:"No files selected",buttonText:"Choose Files"}}),e({fieldKey:"singleFile",fieldComponent:"FILE_PICKER",label:"Cover Image (single file)",fieldComponentProps:{accept:".png,.jpg",text:"No file chosen"}})],A={args:{formContent:go,onSubmit:r},parameters:{docs:{source:{code:`const formContent = [
  {
...
<BaseForm
  formContent={formContent}
  onSubmit={(formState) => console.log("Submitted:", formState)}
/>`}}}},Po=[e({fieldKey:"name",fieldComponent:"TEXT_INPUT",label:"Name",isRequired:!0,fieldComponentProps:{placeholder:"Enter a name",defaultValue:"Jane Doe"}}),e({fieldKey:"quantity",fieldComponent:"NUMBER_INPUT",label:"Quantity",fieldComponentProps:{min:0,max:1e3,step:1,defaultValue:42}}),e({fieldKey:"priority",fieldComponent:"DROPDOWN",label:"Priority",fieldComponentProps:{items:u,placeholder:"Select priority"}})],w={args:{formContent:Po,onSubmit:r},parameters:{docs:{source:{code:`const formContent = [
  {
    fieldKey: "name",
    fieldComponent: "TEXT_INPUT",
    label: "Name",
...
<BaseForm
  formContent={formContent}
  onSubmit={(formState) => console.log("Submitted:", formState)}
/>`}}}};function _o(){const n=Y(),t=a.useMemo(()=>n($).where({department:"Marketing"}),[n]),l=a.useMemo(()=>[e({fieldKey:"employee",fieldComponent:"OBJECT_SELECT",label:"Marketing employee",helperText:"This selector is scoped by an ObjectSet.",fieldComponentProps:{objectSet:t,placeholder:"Search Marketing employees…"}})],[t]);return o.jsx(p,{formContent:l,onSubmit:r})}const W={render:()=>o.jsx(_o,{}),parameters:{docs:{source:{code:`function ScopedEmployeeForm() {
...
}`,...(Ke=(Ne=P.parameters)==null?void 0:Ne.docs)==null?void 0:Ke.source}}};var Oe,Ue,xe;D.parameters={...D.parameters,docs:{...(Oe=D.parameters)==null?void 0:Oe.docs,source:{originalSource:`{
  args: {
...
}`,...(xe=(Ue=D.parameters)==null?void 0:Ue.docs)==null?void 0:xe.source}}};var Be,Ae,ve;F.parameters={...F.parameters,docs:{...(Be=F.parameters)==null?void 0:Be.docs,source:{originalSource:`{
  args: {
...
}`,...(Ge=(He=N.parameters)==null?void 0:He.docs)==null?void 0:Ge.source}}};var $e,Ye,ze;K.parameters={...K.parameters,docs:{...($e=K.parameters)==null?void 0:$e.docs,source:{originalSource:`{
  args: {
...
}`,...(ze=(Ye=K.parameters)==null?void 0:Ye.docs)==null?void 0:ze.source}}};var Qe,Ze,en;O.parameters={...O.parameters,docs:{...(Qe=O.parameters)==null?void 0:Qe.docs,source:{originalSource:`{
  args: {
...
}`,...(en=(Ze=O.parameters)==null?void 0:Ze.docs)==null?void 0:en.source}}};var nn,on,tn;U.parameters={...U.parameters,docs:{...(nn=U.parameters)==null?void 0:nn.docs,source:{originalSource:`{
...
}`,...(tn=(on=U.parameters)==null?void 0:on.docs)==null?void 0:tn.source}}};var rn,ln,an;x.parameters={...x.parameters,docs:{...(rn=x.parameters)==null?void 0:rn.docs,source:{originalSource:`{
...
}`,...(an=(ln=x.parameters)==null?void 0:ln.docs)==null?void 0:an.source}}};var sn,mn,dn;B.parameters={...B.parameters,docs:{...(sn=B.parameters)==null?void 0:sn.docs,source:{originalSource:`{
  args: {
...
}`,...(On=(Kn=k.parameters)==null?void 0:Kn.docs)==null?void 0:On.source}}};var Un,xn,Bn;j.parameters={...j.parameters,docs:{...(Un=j.parameters)==null?void 0:Un.docs,source:{originalSource:`{
  args: {
    formContent: gridSectionFormContent,
    onSubmit: handleSubmit
  }
}`,...(Bn=(xn=j.parameters)==null?void 0:xn.docs)==null?void 0:Bn.source}}};const gt=["Default","Controlled","WithCustomTitle","Loading","SubmitDisabled","DisabledFields","Pending","WithCustomSubmitButton","WithSwitch","WithUnsupportedFields","WithValidation","WithCustomValidation","WithCustomErrorMessages","WithObjectSetField","WithDropdown","WithMultiSelectDropdown","WithRichDropdownLabels","WithDateTimePicker","InsideBlueprintDialog","ScrollableDialogForm","WithDateRangePicker","WithMultiFilePicker","WithHelperText","WithDefaultValues","WithObjectSelect","WithScopedObjectSelect","WithSections","WithMinimalSections","WithGridSection"];export{C as Controlled,f as Default,y as DisabledFields,U as InsideBlueprintDialog,b as Loading,T as Pending,x as ScrollableDialogForm,h as SubmitDisabled,_ as WithCustomErrorMessages,g as WithCustomSubmitButton,S as WithCustomTitle,F as WithCustomValidation,B as WithDateRangePicker,O as WithDateTimePicker,w as WithDefaultValues,R as WithDropdown,j as WithGridSection,v as WithHelperText,k as WithMinimalSections,A as WithMultiFilePicker,N as WithMultiSelectDropdown,M as WithObjectSelect,I as WithObjectSetField,K as WithRichDropdownLabels,W as WithScopedObjectSelect,L as WithSections,E as WithSwitch,P as WithUnsupportedFields,D as WithValidation,gt as __namedExportsOrder,Tt as default};
