...
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:p,children:e.jsx(s,{objectType:l,filterDefinitions:h,...i})})},N={args:{enableSorting:!0},parameters:{docs:{source:{code:`<FilterList
  ...
  filterDefinitions={filterDefinitions}
  enableSorting={true}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:p,children:e.jsx(s,{objectType:l,filterDefinitions:h,...i})})};function on(t){return e.jsx("div",{style:p,children:e.jsx(s,{objectType:l,filterDefinitions:h,...t})})}const I={args:{title:"Employee Filters",enableCollapse:!0,showActiveFilterCount:!0},parameters:{docs:{description:{story:"Opt in with `enableCollapse`, then click the collapse button to minimize the panel. Collapse is uncontrolled — no state wiring required. Active filter count is shown in the collapsed state."},source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  title="Employee Filters"
  enableCollapse={true}
  showActiveFilterCount={true}
/>`}}},render:t=>e.jsx(on,{...t})};function ln(t){const[n,i]=o.useState(!1);return e.jsxs("div",{style:{display:"flex",gap:16,alignItems:"flex-start"},children:[e.jsx("div",{style:p,children:e.jsx(s,{objectType:l,filterDefinitions:h,...t,collapsed:n,onCollapsedChange:i})}),e.jsx("button",{type:"button",onClick:()=>i(r=>!r),children:n?"Expand from outside":"Collapse from outside"})]})}const x={args:{title:"Employee Filters",enableCollapse:!0},parameters:{docs:{description:{story:"Controlled mode: `collapsed` is the source of truth, so the panel only moves when the caller re-renders with a new value. The external button drives the same state as the header control."},source:{code:`const [collapsed, setCollapsed] = useState(false);
...
<FilterList
  ...
  filterDefinitions={filterDefinitions}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(Sn,{...t})};function En(t){const[n,i]=o.useState(void 0),[r,a]=o.useState(h),c=t.onFilterRemoved,d=o.useCallback(S=>{a(F=>F.filter(ae=>"key"in ae?ae.key!==S:!0)),c==null||c(S)},[c]),u=t.onReset,y=o.useCallback(()=>{a(h),u==null||u()},[u]),m=t.onFilterClauseChanged,f=o.useCallback(S=>{i(S),m==null||m(S)},[m]);return e.jsxs("div",{style:qt,children:[e.jsx("div",{style:Jt,children:e.jsx(s,{objectType:l,filterDefinitions:r,titleIcon:zt,...t,onReset:y,onFilterRemoved:d,onFilterClauseChanged:f})}),e.jsx("div",{style:E,children:e.jsx(Ht,{objectType:l,filter:n})})]})}const J={name:"Full Featured",args:{title:"Employee Filters",enableCollapse:!0,showResetButton:!0,showActiveFilterCount:!0,enableSorting:!0},parameters:{docs:{description:{story:"Demonstrates all filter list features together: collapse, reset, active count, sorting, removable filters, per-filter search, exclude toggle, and the emitted where clause driving an ObjectTable."},source:{code:`// All features combined: collapse, sort, search, exclude, remove, reset
...
<FilterList
  ...
  enableSorting={true}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(En,{...t})};function bn(t){const n=ie(),i=o.useMemo(()=>n(l),[n]),[r,a]=o.useState(void 0),c=o.useMemo(()=>[{type:"HAS_LINK",linkName:"lead",label:"Has Manager",filterState:{type:"hasLink",hasLink:!1}},{type:"LINKED_PROPERTY",linkName:"lead",reverseLinkName:"peeps",linkedPropertyKey:"department",linkedFilterComponent:"MULTI_SELECT",linkedFilterState:{type:"SELECT",selectedValues:[]},filterState:{type:"linkedProperty",linkedFilterState:{type:"SELECT",selectedValues:[]}},label:"Manager Department"}],[]),d=t.onFilterClauseChanged,u=o.useCallback(y=>{a(y),d==null||d(y)},[d]);return e.jsxs("div",{style:C,children:[e.jsx("div",{style:p,children:e.jsx(s,{objectType:l,objectSet:i,filterDefinitions:c,...t,onFilterClauseChanged:u})}),e.jsxs("div",{style:E,children:[e.jsx("strong",{children:"Filter Clause (JSON):"}),e.jsx("p",{children:"Note: LINKED_PROPERTY filter is not applied through where clause"}),e.jsx("pre",{style:g,children:r?JSON.stringify(r,null,2):"(no active filters)"})]})]})}const z={name:"Linked Property Filters",parameters:{docs:{description:{story:"Demonstrates filtering on properties of linked objects. HAS_LINK filters objects based on whether they have a linked object. LINKED_PROPERTY filters on a property of the linked object and exposes the same overflow (…) controls as direct property filters — the inline Keeping/Excluding dropdown and Clear all."},source:{code:`// HAS_LINK and LINKED_PROPERTY filter definitions
const filterDefinitions = [
  {
    type: "HAS_LINK",
    linkName: "lead",
...
<FilterList
  ...
  filterDefinitions={filterDefinitions}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(bn,{...t})},gn={type:"PROPERTY",id:"combined-department",key:"department",label:"Department",filterComponent:"LISTOGRAM",filterState:{type:"EXACT_MATCH",values:[]}},Rn={type:"PROPERTY",id:"combined-locationCity",key:"locationCity",label:"Location City",filterComponent:"MULTI_SELECT",filterState:{type:"SELECT",selectedValues:[]}},vn={type:"LINKED_PROPERTY",id:"combined-lead-name",linkName:"lead",reverseLinkName:"peeps",linkedPropertyKey:"fullName",linkedFilterComponent:"MULTI_SELECT",linkedFilterState:{type:"SELECT",selectedValues:[]},filterState:{type:"linkedProperty",linkedFilterState:{type:"SELECT",selectedValues:[]}},searchField:!1,label:"Manager Name"},Ln=[vn,gn,Rn],An=[{locator:{type:"property",id:"fullName"}},{locator:{type:"property",id:"department"}},{locator:{type:"property",id:"locationCity"}},{locator:{type:"rdp",id:"managerName",creator:t=>t.pivotTo("lead").selectProperty("fullName")},renderHeader:()=>"Manager Name",renderCell:t=>"managerName"in t?e.jsx("span",{children:t.managerName}):e.jsx("span",{style:{color:"#999"},children:"No Manager"})}];function Fn(t){const n=ie(),i=o.useMemo(()=>n(l),[n]),[r,a]=o.useState(i);return e.jsxs("div",{style:qt,children:[e.jsx("div",{style:Jt,children:e.jsx(s,{...t,objectType:l,objectSet:i,filterDefinitions:Ln,onFilterClauseChanged:t.onFilterClauseChanged,onEffectiveObjectSet:a,showFilteredOutValues:!0})}),e.jsx("div",{style:E,children:e.jsx(Ht,{objectType:l,objectSet:r,columnDefinitions:An})})]})}const $={name:"Combined with Object Table",parameters:{docs:{description:{story:'A linked filter (Manager Name) and direct property filters coexist in one FilterList alongside an ObjectTable. Pass the unfiltered scope as `objectSet`; FilterList applies the linked-filter narrowing internally and emits the fully-narrowed `ObjectSet` via `onEffectiveObjectSet` for the table. The table surfaces the linked manager via a derived-property `Manager Name` column (`pivotTo("lead").selectProperty("fullName")`). With `showFilteredOutValues`, direct-facet values absent under the active linked filter render as greyed-out count=0 filtered-out rows.'},source:{code:`const baseObjectSet = useMemo(() => client(Employee), [client]);
...
<FilterList
  ...
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(Mn,{...t})},jn={type:"PROPERTY",id:"department-multi",key:"department",label:"Department",filterComponent:"MULTI_SELECT",filterState:{type:"SELECT",selectedValues:[]}},kn={type:"PROPERTY",id:"department-single",key:"department",label:"Department (single)",filterComponent:"SINGLE_SELECT",filterState:{type:"SELECT",selectedValues:[]}},On=[R,jn,kn,re],Z={name:"No value rendering",parameters:{docs:{description:{story:"Empty/null filter values render via the canonical `<NoValueLabel />` component — italic, muted, with the literal text 'No value' — across listogram buckets, single-select dropdown options, multi-select dropdown options, and multi-select chips. The mock dataset includes one Employee with `department: \"\"` so the No value row is visible in the listogram."},source:{code:`// Empty/null values render via <NoValueLabel /> across every filter type.
<FilterList
  objectType={Employee}
  filterDefinitions={[
    {
...
}`,...(Te=(fe=M.parameters)==null?void 0:fe.docs)==null?void 0:Te.source}}};var he,Ce,Se;j.parameters={...j.parameters,docs:{...(he=j.parameters)==null?void 0:he.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(Se=(Ce=j.parameters)==null?void 0:Ce.docs)==null?void 0:Se.source}}};var Ee,be,ge;k.parameters={...k.parameters,docs:{...(Ee=k.parameters)==null?void 0:Ee.docs,source:{originalSource:`{
  args: {
    showResetButton: true
  },
  parameters: {
...
}`,...(ge=(be=k.parameters)==null?void 0:be.docs)==null?void 0:ge.source}}};var Re,ve,Le;O.parameters={...O.parameters,docs:{...(Re=O.parameters)==null?void 0:Re.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(Le=(ve=O.parameters)==null?void 0:ve.docs)==null?void 0:Le.source}}};var Ae,Fe,De;w.parameters={...w.parameters,docs:{...(Ae=w.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
  args: {
    title: "Employee Filters"
  },
  parameters: {
...
}`,...(Tt=(ft=K.parameters)==null?void 0:ft.docs)==null?void 0:Tt.source}}};var ht,Ct,St;q.parameters={...q.parameters,docs:{...(ht=q.parameters)==null?void 0:ht.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(St=(Ct=q.parameters)==null?void 0:Ct.docs)==null?void 0:St.source}}};var Et,bt,gt;J.parameters={...J.parameters,docs:{...(Et=J.parameters)==null?void 0:Et.docs,source:{originalSource:`{
  name: "Full Featured",
  args: {
    title: "Employee Filters",
    enableCollapse: true,
...
}`,...(gt=(bt=J.parameters)==null?void 0:bt.docs)==null?void 0:gt.source}}};var Rt,vt,Lt;z.parameters={...z.parameters,docs:{...(Rt=z.parameters)==null?void 0:Rt.docs,source:{originalSource:`{
...
}`,...(Lt=(vt=z.parameters)==null?void 0:vt.docs)==null?void 0:Lt.source}}};var At,Ft,Dt;$.parameters={...$.parameters,docs:{...(At=$.parameters)==null?void 0:At.docs,source:{originalSource:`{
