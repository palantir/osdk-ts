...
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,filterDefinitions:h,...i})})},N={args:{enableSorting:!0},parameters:{docs:{source:{code:`<FilterList
  ...
  filterDefinitions={filterDefinitions}
  enableSorting={true}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,filterDefinitions:h,...i})})};function en(t){return e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,filterDefinitions:h,...t})})}const I={args:{title:"Employee Filters",showActiveFilterCount:!0},parameters:{docs:{description:{story:"Click the collapse button to minimize the filter panel. Collapse is uncontrolled — no state wiring required. Active filter count is shown in the collapsed state."},source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  title="Employee Filters"
  showActiveFilterCount={true}
...
/>\`
  ...
  parameters: {
    docs: {
      description: {
        story: "Click the collapse button to minimize the filter panel. Collapse is " + "uncontrolled — no state wiring required. Active filter count is " + "shown in the collapsed state."
      },
      source: {
        code: \`<FilterList
  objectType={Employee}
