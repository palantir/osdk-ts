import{h as l,j as t}from"./iframe-6JVXeTWS.js";import{w as f}from"./withOsdkMetrics-BS6Er7Nk.js";import{V as w}from"./VideoViewer-ByrXTGZR.js";import{p as h}from"./passthrough-6sm3BHV7.js";import"./preload-helper-Cw1MFz_c.js";import"./index-CCRcN1k8.js";import"./useMediaContents-CNG3dMxY.js";import"./spin-Xgq0HAuN.js";import"./svgIconContainer-D_jRBUY4.js";import"./error-dc7Jmoqx.js";const o=f(w,"VideoViewer"),{fn:V}=__STORYBOOK_MODULE_TEST__,v="/osdk-ts/storybook/pr-3633/70e1afda8885d6a8293c53de5efd67a296656ed5/example.mp4";function k(e,p){return{fetchContents:()=>fetch(e),fetchMetadata:()=>Promise.resolve({path:p,sizeBytes:0,mediaType:"video/mp4"}),getMediaReference:()=>({mimeType:"video/mp4",reference:{type:"mediaSetViewItem",mediaSetViewItem:{mediaItemRid:"ri.mio.main.media-item.mock-video",mediaSetRid:"ri.mio.main.media-set.mock-set",mediaSetViewRid:"ri.mio.main.media-set-view.mock-view"}}})}}const S=k(v,"example.mp4"),_={title:"Components/DocumentViewer/Renderers/VideoViewer",component:o,tags:["beta"],args:{media:S},render:e=>t.jsx("div",{style:{height:"400px",width:"600px"},children:t.jsx(o,{media:e.media,onError:e.onError})}),parameters:{controls:{expanded:!0},msw:{handlers:[l.get("*/example.mp4",()=>h())]}},argTypes:{media:{description:"The OSDK Media object to fetch video from",control:!1},className:{description:"Additional CSS class name for the root element",control:"text"},onError:{description:"Callback when the video fails to load",control:!1,table:{category:"Events"}}}},i={parameters:{docs:{source:{code:`import { VideoViewer } from "@osdk/react-components/experimental/video-viewer";
...
}`,...(c=(s=r.parameters)==null?void 0:s.docs)==null?void 0:c.source}}};const b=["Default","WithErrorCallback"];export{i as Default,r as WithErrorCallback,b as __namedExportsOrder,_ as default};
