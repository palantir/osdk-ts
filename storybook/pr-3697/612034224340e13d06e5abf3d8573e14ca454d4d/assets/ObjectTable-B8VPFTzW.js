import{j as e}from"./iframe-CYldCnGD.js";import{useMDXComponents as r}from"./index-Ds8mKJis.js";import{b as a,c as i}from"./blocks-CDlRv2zW.js";import"./preload-helper-D83jK9dp.js";import"./index-oSG7gC6J.js";import"./index-DKy92Rhg.js";import"./index-7jWJhwgw.js";const l=`# ObjectTable
...
| \`className\`                 | \`string\`                                                                                                                                 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| \`labels\`                    | \`Partial<ObjectTableLabels>\`                                                                                                             | Overrides for the table's user-facing strings (edit footer, column-config and multi-sort dialogs, header menu, empty/error states, function-cell states, and selection aria-labels). Provide any subset; unset keys fall back to the built-in English defaults. Use this to localize the table or adjust wording. See \`ObjectTableLabels\`.<br /><br />Prefer a stable reference (a module-level constant or a \`useMemo\`ed object). A new object identity on every render re-computes the merged labels and re-renders the table's sub-components. |
