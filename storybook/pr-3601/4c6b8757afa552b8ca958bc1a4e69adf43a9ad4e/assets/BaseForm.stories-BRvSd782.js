...
<BaseForm
  formContent={formContent}
  onSubmit={(formState) => console.log("Submitted:", formState)}
/>`}}}},ao=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,io=[e({fieldKey:"email",fieldComponent:"TEXT_INPUT",label:"Email",isRequired:!0,validate:async n=>{if(!(typeof n!="string"||n.length===0))return ao.test(n)?void 0:"Enter a valid email address"},fieldComponentProps:{placeholder:"user@example.com"}})],F={args:{formContent:io,onSubmit:r},parameters:{docs:{source:{code:`const formContent = [
  {
    fieldKey: "email",
    fieldComponent: "TEXT_INPUT",
    label: "Email",
...
}`,...(Bn=(Un=j.parameters)==null?void 0:Un.docs)==null?void 0:Bn.source}}};const Pt=["Default","Controlled","WithCustomTitle","Loading","SubmitDisabled","DisabledFields","Pending","WithCustomSubmitButton","WithSwitch","WithUnsupportedFields","WithValidation","WithCustomValidation","WithCustomErrorMessages","WithObjectSetField","WithDropdown","WithMultiSelectDropdown","WithRichDropdownLabels","WithDateTimePicker","InsideBlueprintDialog","ScrollableDialogForm","WithDateRangePicker","WithMultiFilePicker","WithHelperText","WithDefaultValues","WithObjectSelect","WithScopedObjectSelect","WithSections","WithMinimalSections","WithGridSection"];export{C as Controlled,f as Default,y as DisabledFields,x as InsideBlueprintDialog,b as Loading,T as Pending,U as ScrollableDialogForm,h as SubmitDisabled,_ as WithCustomErrorMessages,g as WithCustomSubmitButton,S as WithCustomTitle,F as WithCustomValidation,B as WithDateRangePicker,O as WithDateTimePicker,w as WithDefaultValues,R as WithDropdown,j as WithGridSection,v as WithHelperText,k as WithMinimalSections,A as WithMultiFilePicker,N as WithMultiSelectDropdown,M as WithObjectSelect,I as WithObjectSetField,K as WithRichDropdownLabels,W as WithScopedObjectSelect,L as WithSections,E as WithSwitch,P as WithUnsupportedFields,D as WithValidation,Pt as __namedExportsOrder,Et as default};
