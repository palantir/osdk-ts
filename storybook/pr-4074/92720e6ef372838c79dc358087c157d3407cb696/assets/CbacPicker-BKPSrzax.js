import{j as n}from"./iframe-Cav9-PmA.js";import{useMDXComponents as t}from"./index-K9_Kb4DT.js";import{b as r,c as s}from"./blocks-BUSeXCUE.js";import"./preload-helper-C5qWD71s.js";import"./index-B3WsbxUl.js";import"./index-CB0DImnr.js";import"./index-BK2mdNIa.js";const o=`# CbacPicker
...
\`CbacPicker\`, \`CbacPickerDialog\`, and \`CbacBannerPopover\` accept \`autoFetchMore\`.
The default is \`undefined\`, which loads only the first page of markings and
categories. Set it to \`true\` to include every page, or a number to load at least
that many items from each catalogue (or all available items if fewer exist).

\`\`\`tsx
<CbacPicker onChange={setMarkingIds} autoFetchMore={true} />
\`\`\`

The banner popover passes this setting to its edit dialog. These components do
not expose a manual load-more control; use \`BaseCbacPicker\` with the platform
hooks when you need manual pagination.

## Props Reference

### CbacPicker

<!-- AUTOGEN:props START src=src/cbac-picker/CbacPickerApi.ts interface=CbacPickerProps — generated by scripts/gen-props.mjs; run \`pnpm --filter @osdk/react-components gen-props\` -->

| Name                          | Type                             | Description                                                                                                                                                                                                 |
| ----------------------------- | -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| \`autoFetchMore\`               | \`boolean \\| number\`              | Automatically load additional marking and category pages. \`true\` loads all pages; a number sets the minimum items per catalogue. \`false\` or \`undefined\` loads only the first page. Defaults to \`undefined\`. |
| \`initialMarkingIds\`           | \`string[]\`                       | Initial set of selected marking IDs. Defaults to \`[]\`.                                                                                                                                                      |
...
\`autoFetchMore\` also controls catalogue pagination for the dialog (default: \`undefined\`), as described above.
...
Displays applied markings and opens a picker dialog for editing. Its
\`autoFetchMore\` setting applies to both the popover and that dialog.

<!-- AUTOGEN:props START src=src/cbac-picker/CbacPickerApi.ts interface=CbacBannerPopoverProps — generated by scripts/gen-props.mjs; run \`pnpm --filter @osdk/react-components gen-props\` -->

| Name                          | Type                             | Description                                                                                                                                                                                                 |
| ----------------------------- | -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| \`autoFetchMore\`               | \`boolean \\| number\`              | Automatically load additional marking and category pages. \`true\` loads all pages; a number sets the minimum items per catalogue. \`false\` or \`undefined\` loads only the first page. Defaults to \`undefined\`. |
| \`markingIds\`                  | \`string[]\`                       | **Required.**                                                                                                                                                                                               |
| \`onChange\`                    | \`(markingIds: string[]) => void\` | **Required.**                                                                                                                                                                                               |
