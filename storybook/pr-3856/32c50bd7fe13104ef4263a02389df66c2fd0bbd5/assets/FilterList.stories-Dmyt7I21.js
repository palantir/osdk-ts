...
/>`}}},render:({objectType:t,objectSet:n,...i})=>{const r=o.useMemo(()=>[ie],[]);return e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,filterDefinitions:r,...i})})}};function $t(t){const n=ne(),i=o.useMemo(()=>n(l).where({department:"Marketing"}),[n]),r=o.useMemo(()=>[re,A],[]);return e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,objectSet:i,filterDefinitions:r,...t})})}const j={parameters:{docs:{description:{story:"Pass an `objectSet` prop to scope filter aggregations to a subset of objects. Here the object set is filtered to Marketing department employees, so the listogram counts reflect only that subset."},source:{code:`const client = useOsdkClient();
...
/>`}}},render:t=>e.jsx(Zt,{...t})},w={args:{title:"Employee Filters"},parameters:{docs:{source:{code:`<FilterList
  ...
  titleIcon={<svg>...</svg>}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,filterDefinitions:E,titleIcon:Kt,...i})})};function en(t){const n=t.onReset,i=o.useCallback(()=>{console.log("Reset clicked"),n==null||n()},[n]);return e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,filterDefinitions:E,...t,onReset:i})})}const P={args:{showResetButton:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  showResetButton={true}
...
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,filterDefinitions:E,...i})})},I={args:{enableSorting:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  enableSorting={true}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,filterDefinitions:E,...i})})};function tn(t){return e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,filterDefinitions:E,...t})})}const N={args:{title:"Employee Filters",showActiveFilterCount:!0},parameters:{docs:{description:{story:"Click the collapse button to minimize the filter panel. Active filter count is shown in the collapsed state."},source:{code:`const [collapsed, setCollapsed] = useState(false);
...
<FilterList
  ...
  filterDefinitions={filterDefinitions}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(fn,{...t})};function Tn(t){const[n,i]=o.useState(void 0),[r,a]=o.useState(E),c=t.onFilterRemoved,p=o.useCallback(h=>{a(M=>M.filter(ae=>"key"in ae?ae.key!==h:!0)),c==null||c(h)},[c]),u=t.onReset,y=o.useCallback(()=>{a(E),u==null||u()},[u]),m=t.onFilterClauseChanged,f=o.useCallback(h=>{i(h),m==null||m(h)},[m]);return e.jsxs("div",{style:Ut,children:[e.jsx("div",{style:Xt,children:e.jsx(s,{objectType:l,filterDefinitions:r,titleIcon:Kt,...t,onReset:y,onFilterRemoved:p,onFilterClauseChanged:f})}),e.jsx("div",{style:S,children:e.jsx(Bt,{objectType:l,filter:n})})]})}const J={name:"Full Featured",args:{title:"Employee Filters",showResetButton:!0,showActiveFilterCount:!0,enableSorting:!0},parameters:{docs:{description:{story:"Demonstrates all filter list features together: collapse, reset, active count, sorting, removable filters, per-filter search, exclude toggle, and the emitted where clause driving an ObjectTable."},source:{code:`// All features combined: collapse, sort, search, exclude, remove, reset
...
<FilterList
  ...
  enableSorting={true}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>{const[,n]=Yt(),i=t.onCollapsedChange,r=o.useCallback(a=>{n({collapsed:a}),i==null||i(a)},[n,i]);return e.jsx(Tn,{...t,onCollapsedChange:r})}};function Cn(t){const n=ne(),i=o.useMemo(()=>n(l),[n]),[r,a]=o.useState(void 0),c=o.useMemo(()=>[{type:"HAS_LINK",linkName:"lead",label:"Has Manager",filterState:{type:"hasLink",hasLink:!1}},{type:"LINKED_PROPERTY",linkName:"lead",reverseLinkName:"peeps",linkedPropertyKey:"department",filterComponent:"MULTI_SELECT",defaultFilterState:{type:"SELECT",selectedValues:[]},label:"Manager Department"}],[]),p=t.onFilterClauseChanged,u=o.useCallback(y=>{a(y),p==null||p(y)},[p]);return e.jsxs("div",{style:C,children:[e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,objectSet:i,filterDefinitions:c,...t,onFilterClauseChanged:u})}),e.jsxs("div",{style:S,children:[e.jsx("strong",{children:"Filter Clause (JSON):"}),e.jsx("p",{children:"Note: LINKED_PROPERTY filter is not applied through where clause"}),e.jsx("pre",{style:g,children:r?JSON.stringify(r,null,2):"(no active filters)"})]})]})}const q={name:"Linked Property Filters",parameters:{docs:{description:{story:"Demonstrates filtering on properties of linked objects. HAS_LINK filters objects based on whether they have a linked object. LINKED_PROPERTY filters on a property of the linked object and exposes the same overflow (…) controls as direct property filters — the inline Keeping/Excluding dropdown and Clear all."},source:{code:`// HAS_LINK and LINKED_PROPERTY filter definitions
const filterDefinitions = [
  {
    type: "HAS_LINK",
    linkName: "lead",
...
<FilterList
  ...
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(Ln,{...t})},An={type:"PROPERTY",id:"department-multi",key:"department",label:"Department",filterComponent:"MULTI_SELECT",filterState:{type:"SELECT",selectedValues:[]}},Mn={type:"PROPERTY",id:"department-single",key:"department",label:"Department (single)",filterComponent:"SINGLE_SELECT",filterState:{type:"SELECT",selectedValues:[]}},Fn=[R,An,Mn,ie],Q={name:"No value rendering",parameters:{docs:{description:{story:"Empty/null filter values render via the canonical `<NoValueLabel />` component — italic, muted, with the literal text 'No value' — across listogram buckets, single-select dropdown options, multi-select dropdown options, and multi-select chips. The mock dataset includes one Employee with `department: \"\"` so the No value row is visible in the listogram."},source:{code:`// Empty/null values render via <NoValueLabel /> across every filter type.
<FilterList
  objectType={Employee}
  filterDefinitions={[
    {
...
<FilterList
  ...
  initialFilterStates={savedStates}
  showResetButton={true}
/>`}}},render:t=>e.jsx(Nn,{...t})};var pe,de,ue;F.parameters={...F.parameters,docs:{...(pe=F.parameters)==null?void 0:pe.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`<FilterList
...
}`,...(ue=(de=F.parameters)==null?void 0:de.docs)==null?void 0:ue.source}}};var me,ye,fe;D.parameters={...D.parameters,docs:{...(me=D.parameters)==null?void 0:me.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(ve=(Re=O.parameters)==null?void 0:Re.docs)==null?void 0:ve.source}}};var Le,Ae,Me;w.parameters={...w.parameters,docs:{...(Le=w.parameters)==null?void 0:Le.docs,source:{originalSource:`{
  args: {
    title: "Employee Filters"
  },
  parameters: {
...
}`,...(Me=(Ae=w.parameters)==null?void 0:Ae.docs)==null?void 0:Me.source}}};var Fe,De,je;P.parameters={...P.parameters,docs:{...(Fe=P.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
  args: {
    showResetButton: true
  },
  parameters: {
...
}`,...(vt=(Rt=z.parameters)==null?void 0:Rt.docs)==null?void 0:vt.source}}};var Lt,At,Mt;$.parameters={...$.parameters,docs:{...(Lt=$.parameters)==null?void 0:Lt.docs,source:{originalSource:`{
  name: "Custom Filters",
  parameters: {
    docs: {
      description: {
...
}`,...(Mt=(At=$.parameters)==null?void 0:At.docs)==null?void 0:Mt.source}}};var Ft,Dt,jt;Q.parameters={...Q.parameters,docs:{...(Ft=Q.parameters)==null?void 0:Ft.docs,source:{originalSource:`{
...
}`,...(Vt=(xt=te.parameters)==null?void 0:xt.docs)==null?void 0:Vt.source}}};const xi=["Default","IntegerNumberRangeRounding","WithObjectSet","AddFilterMode","WithAllFilterTypes","WithTitleAndIcon","WithResetButton","WithActiveFilterCount","WithSorting","CollapsiblePanel","KeywordSearch","WithColorMap","WithRenderValue","WithRenderValueAsReactNode","WithListogramDisplayModes","WithHiddenCounts","WithCheckbox","WithBelowFoldSelection","WithRemovableFilters","WithStaticValues","FullFeatured","WithLinkedPropertyFilters","CombinedWithObjectTable","WithCustomFilters","NoValueRendering","WithInitialFilterStates","WithResetButtonEmptyInitial","WithResetButtonNonEmptyInitial"];export{k as AddFilterMode,N as CollapsiblePanel,z as CombinedWithObjectTable,F as Default,J as FullFeatured,D as IntegerNumberRangeRounding,x as KeywordSearch,Q as NoValueRendering,_ as WithActiveFilterCount,O as WithAllFilterTypes,U as WithBelowFoldSelection,H as WithCheckbox,V as WithColorMap,$ as WithCustomFilters,W as WithHiddenCounts,Z as WithInitialFilterStates,q as WithLinkedPropertyFilters,G as WithListogramDisplayModes,j as WithObjectSet,X as WithRemovableFilters,B as WithRenderValue,Y as WithRenderValueAsReactNode,P as WithResetButton,ee as WithResetButtonEmptyInitial,te as WithResetButtonNonEmptyInitial,I as WithSorting,K as WithStaticValues,w as WithTitleAndIcon,xi as __namedExportsOrder,Ni as default};
