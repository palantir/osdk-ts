...
/>`}}},render:e=>t.jsxs("div",{className:"object-table-container",style:{height:"600px"},children:[t.jsx("div",{style:{padding:"12px"},children:"Right click on any cell"}),t.jsx(p,{...e})]}),play:async({canvasElement:e})=>{const n=u(e);await n.findByText("Ahmed Williams"),be.contextMenu(n.getByText("Ahmed Williams")),await o(await y.findByText("Cell Value:")).toBeInTheDocument(),await r.click(n.getByText("Right click on any cell")),await c(()=>o(y.queryByText("Cell Value:")).not.toBeInTheDocument())}},_={args:{objectType:m,columnDefinitions:ct.map((e,n)=>({...e,width:n===0?250:n===1?300:150})),onColumnResize:f()},parameters:{docs:{source:{code:`const columnDefinitions = [
...
<ObjectTable
  objectType={Employee}
  columnDefinitions={columnDefinitions}
/>`}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e,args:n})=>{const a=u(e),i=await R(a,"fullName");await o(de(i)).toBe(250),await ut(i,120),await c(()=>o(de(i)).toBeGreaterThan(250)),await o(n.onColumnResize).toHaveBeenCalledWith("fullName",o.any(Number)),n.onColumnResize.mockClear(),await r.dblClick(dt(i)),await c(()=>o(de(i)).toBe(250)),await o(n.onColumnResize).toHaveBeenCalledWith("fullName",null)}},z={args:{objectType:m,columnDefinitions:C,defaultOrderBy:[{property:"fullName",direction:"desc"}]},parameters:{docs:{source:{code:`<ObjectTable
  objectType={Employee}
  defaultOrderBy={[{
    property: "fullName",
    direction: "desc",
  }]}
/>`}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e})=>{const n=u(e);await R(n,"fullName"),await c(()=>o(N(n,"fullName")).toBe("desc")),await v(n,"fullName"),await E("Sort ascending"),await c(()=>o(N(n,"fullName")).toBe("asc")),await v(n,"fullName"),await E("Sort descending"),await c(()=>o(N(n,"fullName")).toBe("desc"))}},L={args:{objectType:m,columnDefinitions:[{locator:{type:"property",id:"fullName"},pinned:"left"},{locator:{type:"property",id:"emailPrimaryWork"}},{locator:{type:"property",id:"jobTitle"}},{locator:{type:"property",id:"department"},pinned:"right"},{locator:{type:"property",id:"firstFullTimeStartDate"}}],onColumnsPinnedChanged:f()},parameters:{docs:{source:{code:`const columnDefinitions = [
  {
    locator: { type: "property", id: "fullName" },
    pinned: "left",
  },
...
/>`}}},render:e=>{const[n,a]=d.useState(null),[i,l]=d.useState(null),[s,h]=d.useState([]),[x,D]=d.useState(!1),[T,ce]=d.useState([{property:"fullName",direction:"asc"}]),[mt,k]=d.useState(""),pt=d.useCallback(b=>{var g;(g=e.onRowClick)==null||g.call(e,b),a(b),k("onRowClick")},[e]),yt=d.useCallback(b=>{var g;(g=e.onColumnHeaderClick)==null||g.call(e,b),l(b),k("onColumnHeaderClick")},[e]),ht=d.useCallback(b=>{var g;(g=e.onRowSelectionChanged)==null||g.call(e,b),h(b.selectedRows.map(O=>O.$primaryKey)),D(b.isSelectAll),k("onRowSelectionChanged")},[e]),bt=d.useCallback(b=>{var g;(g=e.onOrderByChanged)==null||g.call(e,b),ce(b),k("onOrderByChanged")},[e]),gt=d.useCallback(b=>{var g;(g=e.onColumnVisibilityChanged)==null||g.call(e,b),k("onColumnVisibilityChanged")},[e]),wt=d.useCallback(b=>{var g;(g=e.onColumnsPinnedChanged)==null||g.call(e,b),k("onColumnsPinnedChanged")},[e]),ft=d.useCallback((b,g)=>{var O;(O=e.onColumnResize)==null||O.call(e,b,g),k(`onColumnResize (${b})`)},[e]);return t.jsxs("div",{children:[t.jsxs("div",{style:{marginBottom:"16px",padding:"12px",backgroundColor:"#f0f9ff",borderRadius:"4px",border:"1px solid #bfdbfe"},children:[t.jsx("div",{style:{marginBottom:"8px",fontWeight:"bold"},children:"Event Monitor:"}),t.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[t.jsx("strong",{children:"Last event:"})," ",mt||"None"]}),t.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[t.jsx("strong",{children:"Row clicked:"})," ",n?t.jsx("code",{children:n.fullName}):"None"]}),t.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[t.jsx("strong",{children:"Column clicked:"})," ",i?t.jsx("code",{children:i}):"None"]}),t.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[t.jsx("strong",{children:"Selected rows:"})," ",x?"All employees":`${s.length} employees`]}),t.jsxs("div",{style:{fontSize:"12px"},children:[t.jsx("strong",{children:"Current sort:"})," ",T!=null&&T[0]?`${T[0].property} (${T[0].direction})`:"None"]})]}),t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e,selectedRows:s,orderBy:T,onRowClick:pt,onColumnHeaderClick:yt,onRowSelectionChanged:ht,onOrderByChanged:bt,onColumnVisibilityChanged:gt,onColumnsPinnedChanged:wt,onColumnResize:ft})})]})},play:async({canvasElement:e,args:n})=>{const a=u(e);await a.findByText("Ahmed Williams"),await r.click(a.getByText("Ahmed Williams")),await c(()=>o(n.onRowClick).toHaveBeenCalled()),await o(n.onFocusedRowChanged).toHaveBeenCalled();const i=await R(a,"fullName");await r.click(u(i).getByText("Name")),await c(()=>o(n.onColumnHeaderClick).toHaveBeenCalledWith("fullName")),await r.click((await a.findAllByRole("checkbox",{name:/select row/iu}))[0]),await c(()=>o(n.onRowSelectionChanged).toHaveBeenCalled()),await v(a,"fullName"),await E("Sort descending"),await c(()=>o(n.onOrderByChanged).toHaveBeenCalled()),await v(a,"fullName"),await E("Pin column"),await c(()=>o(n.onColumnsPinnedChanged).toHaveBeenCalled()),await ut(await R(a,"fullName"),100),await c(()=>o(n.onColumnResize).toHaveBeenCalled()),await v(a,"fullName"),await E("Configure Columns");const l=await y.findAllByRole("button",{name:/^Remove /u});await r.click(l[0]),await r.click(await y.findByRole("button",{name:"Apply"})),await c(()=>o(n.onColumnVisibilityChanged).toHaveBeenCalled())}},U={args:{objectType:m,columnDefinitions:C,orderBy:[{property:"fullName",direction:"asc"}],onOrderByChanged:f()},parameters:{docs:{source:{code:`const [orderBy, setOrderBy] = useState<any>([
...
return (
  ...
  />
);`}}},render:e=>{const[n,a]=d.useState(e.selectedRows??[]),[i,l]=d.useState(!1),s=d.useCallback(h=>{var x;(x=e.onRowSelectionChanged)==null||x.call(e,h),a(h.selectedRows.map(D=>D.$primaryKey)),l(h.isSelectAll)},[e]);return t.jsxs("div",{children:[t.jsxs("div",{style:{marginBottom:"16px"},children:[t.jsx("strong",{children:"Selected:"})," ",i?"All Employees":`${n.length} employees`,n.length>0&&t.jsx("button",{style:{marginLeft:"16px",padding:"4px 8px",fontSize:"12px",border:"1px solid #d1d5db",borderRadius:"4px",background:"white",cursor:"pointer"},onClick:()=>{a([]),l(!1)},children:"Clear Selection"})]}),t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e,selectedRows:n,isAllSelected:i,onRowSelectionChanged:s})})]})},play:async({canvasElement:e,args:n})=>{const a=u(e),i=()=>a.findAllByRole("checkbox",{name:/select row/iu});await i(),await r.click((await i())[0]),await c(()=>o(n.onRowSelectionChanged).toHaveBeenCalled()),await c(()=>o(a.getByText("1 employees")).toBeInTheDocument()),await r.click((await i())[1]),await c(()=>o(a.getByText("2 employees")).toBeInTheDocument()),await r.click(a.getByRole("button",{name:"Clear Selection"})),await c(()=>o(a.getByText("0 employees")).toBeInTheDocument()),await o(a.queryByRole("button",{name:"Clear Selection"})).not.toBeInTheDocument()}},G={args:{objectType:m,columnDefinitions:C,onFocusedRowChanged:f()},parameters:{docs:{description:{story:"Demonstrates the `focusedRow` / `onFocusedRowChanged` API. Click any row to focus it; the focused employee is shown in the banner above and persists until cleared by the caller. Because focus is controlled, outside clicks no longer auto-clear — the caller owns clearing."},source:{code:`const [focusedRow, setFocusedRow] = useState<Osdk.Instance<Employee> | null>(null);
...
return (
  <ObjectTable
    ...
    editMode="always"
  />
);`}}},render:e=>t.jsxs("div",{className:"object-table-container",style:{height:"600px"},children:[t.jsx("div",{style:{padding:"12px",backgroundColor:"#fff3cd",marginBottom:"8px",borderRadius:"4px"},children:'JobTitle is only editable for "Senior Product Manager" rows. Department dropdown shows only 2 options for Operations rows.'}),t.jsx(p,{...e})]}),play:async({canvasElement:e})=>{const n=u(e);await n.findByText("Ahmed Williams");const a=u(B(n.getByText("Margaret Jackson"))).getAllByRole("cell");await o(a[1]).toHaveAttribute("data-editable","true");const i=u(B(n.getByText("Ahmed Williams"))).getAllByRole("cell");await o(i[1]).not.toHaveAttribute("data-editable");const l=B(n.getByText("Yuki Torres"));await r.click(n.getByText("Yuki Torres")),be.click(await u(l).findByRole("combobox")),await o(await y.findAllByRole("option")).toHaveLength(2),await o(y.queryByRole("option",{name:"Finance"})).not.toBeInTheDocument(),await r.keyboard("{Escape}");const s=B(n.getByText("Ahmed Williams"));await r.click(n.getByText("Ahmed Williams")),be.click(await u(s).findByRole("combobox")),await o(await y.findByRole("option",{name:"Finance"})).toBeInTheDocument()}},ie={args:{objectType:m,columnDefinitions:[{locator:{type:"property",id:"fullName"}},{locator:{type:"property",id:"jobTitle"}},{locator:{type:"property",id:"department"}},{locator:{type:"property",id:"locationCity"}}]},parameters:{docs:{description:{story:'Demonstrates using `getRowAttributes` to set data attributes on rows and a `className` on the table to scope CSS overrides via the data attribute selector. New York employees get a light blue background through the `[data-highlight-row="true"]` CSS selector scoped under the table\'s className.'},source:{code:`/* CSS (imported stylesheet):
.customTableStyling {
...
`}}},render:e=>{const a=it()(m).where({jobProfile:"Nonexistent Role"});return t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e,objectSet:a})})},play:async({canvasElement:e})=>{const n=u(e);await o(await n.findByText("No saved views found.")).toBeInTheDocument(),await o(n.queryByText("Ahmed Williams")).not.toBeInTheDocument()}};var Be,Se,Ee;I.parameters={...I.parameters,docs:{...(Be=I.parameters)==null?void 0:Be.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns
  },
...
}`,...(pn=(mn=U.parameters)==null?void 0:mn.docs)==null?void 0:pn.source}}};var yn,hn,bn;K.parameters={...K.parameters,docs:{...(yn=K.parameters)==null?void 0:yn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
    selectionMode: "multiple" as const,
...
}`,...(bn=(hn=K.parameters)==null?void 0:hn.docs)==null?void 0:bn.source}}};var gn,wn,fn;G.parameters={...G.parameters,docs:{...(gn=G.parameters)==null?void 0:gn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
    onFocusedRowChanged: fn()
...
}`,...(xn=(vn=Y.parameters)==null?void 0:vn.docs)==null?void 0:xn.source}}};var Tn,jn,Bn;J.parameters={...J.parameters,docs:{...(Tn=J.parameters)==null?void 0:Tn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns
  },
...
}`,...(Bn=(jn=J.parameters)==null?void 0:jn.docs)==null?void 0:Bn.source}}};var Sn,En,Dn;X.parameters={...X.parameters,docs:{...(Sn=X.parameters)==null?void 0:Sn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns
  },
