...
<ObjectTable objectType={Employee} columnDefinitions={columnDefinitions} />`}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e})=>{const n=u(e);await n.findByText("Seniority"),await c(()=>a(n.getAllByText(/^(Senior|Mid|Junior|Unknown)$/u).length).toBeGreaterThan(0))}},W={args:{objectType:m,columnDefinitions:v,selectionMode:"single",onRowSelectionChanged:f()},parameters:{docs:{source:{code:'<ObjectTable objectType={Employee} selectionMode="single" />'}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e,args:n})=>{const o=u(e),i=()=>o.findAllByRole("checkbox",{name:/select row/iu});await i(),await a(o.queryByRole("checkbox",{name:/select all rows/iu})).not.toBeInTheDocument(),await r.click((await i())[0]),await c(()=>a(n.onRowSelectionChanged).toHaveBeenCalled()),await a((await i())[0]).toBeChecked(),await r.click((await i())[1]),await a((await i())[1]).toBeChecked(),await a((await i())[0]).not.toBeChecked()}},M={args:{objectType:m,columnDefinitions:v,selectionMode:"multiple",onRowSelectionChanged:f()},parameters:{docs:{source:{code:'<ObjectTable objectType={Employee} selectionMode="multiple" />'}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e,args:n})=>{const o=u(e),i=()=>o.findAllByRole("checkbox",{name:/select row/iu}),l=()=>o.findByRole("checkbox",{name:/deselect all rows/iu}),[s,h]=await i();await r.click(s),await a(s).toBeChecked(),await c(()=>a(n.onRowSelectionChanged).toHaveBeenCalled()),await r.click(h),await a(s).toBeChecked(),await a(h).toBeChecked(),await r.click(await l());for(const C of await i())await a(C).not.toBeChecked();await r.click(await o.findByRole("checkbox",{name:"Select all rows"}));for(const C of await i())await a(C).toBeChecked();await r.click(await l());for(const C of await i())await a(C).not.toBeChecked()}},V={args:{objectType:m,columnDefinitions:v,renderCellContextMenu:(e,n)=>t.jsxs("div",{style:{background:"white",padding:8,border:"1px solid #d1d5db",boxShadow:"0 2px 8px 0 rgba(0, 0, 0, 0.1)",fontSize:13,borderRadius:4},children:[t.jsx("div",{style:{fontWeight:"bold",marginBottom:4},children:"Cell Value:"}),t.jsx("div",{children:n?String(n):"No Value"})]})},parameters:{docs:{source:{code:`<ObjectTable
  objectType={Employee}
...
/>`}}},render:e=>t.jsxs("div",{className:"object-table-container",style:{height:"600px"},children:[t.jsx("div",{style:{padding:"12px"},children:"Right click on any cell"}),t.jsx(p,{...e})]}),play:async({canvasElement:e})=>{const n=u(e);await n.findByText("Ahmed Williams"),be.contextMenu(n.getByText("Ahmed Williams")),await a(await y.findByText("Cell Value:")).toBeInTheDocument(),await r.click(n.getByText("Right click on any cell")),await c(()=>a(y.queryByText("Cell Value:")).not.toBeInTheDocument())}},_={args:{objectType:m,columnDefinitions:st.map((e,n)=>({...e,width:n===0?250:n===1?300:150})),onColumnResize:f()},parameters:{docs:{source:{code:`const columnDefinitions = [
...
<ObjectTable
  objectType={Employee}
  columnDefinitions={columnDefinitions}
/>`}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e,args:n})=>{const o=u(e),i=await R(o,"fullName");await a(de(i)).toBe(250),await dt(i,120),await c(()=>a(de(i)).toBeGreaterThan(250)),await a(n.onColumnResize).toHaveBeenCalledWith("fullName",a.any(Number)),n.onColumnResize.mockClear(),await r.dblClick(ct(i)),await c(()=>a(de(i)).toBe(250)),await a(n.onColumnResize).toHaveBeenCalledWith("fullName",null)}},z={args:{objectType:m,columnDefinitions:v,defaultOrderBy:[{property:"fullName",direction:"desc"}]},parameters:{docs:{source:{code:`<ObjectTable
  objectType={Employee}
  defaultOrderBy={[{
    property: "fullName",
    direction: "desc",
  }]}
/>`}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e})=>{const n=u(e);await R(n,"fullName"),await c(()=>a(N(n,"fullName")).toBe("desc")),await T(n,"fullName"),await E("Sort ascending"),await c(()=>a(N(n,"fullName")).toBe("asc")),await T(n,"fullName"),await E("Sort descending"),await c(()=>a(N(n,"fullName")).toBe("desc"))}},L={args:{objectType:m,columnDefinitions:[{locator:{type:"property",id:"fullName"},pinned:"left"},{locator:{type:"property",id:"emailPrimaryWork"}},{locator:{type:"property",id:"jobTitle"}},{locator:{type:"property",id:"department"},pinned:"right"},{locator:{type:"property",id:"firstFullTimeStartDate"}}],onColumnsPinnedChanged:f()},parameters:{docs:{source:{code:`const columnDefinitions = [
  {
    locator: { type: "property", id: "fullName" },
    pinned: "left",
  },
...
<ObjectTable
  objectType={Employee}
  columnDefinitions={columnDefinitions}
/>`}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e,args:n})=>{const o=u(e),i=await R(o,"fullName"),l=await R(o,"department");await a(i).toHaveAttribute("data-pinned","left"),await a(l).toHaveAttribute("data-pinned","right"),await T(o,"fullName"),await E("Unpin Column"),await c(()=>a(i).toHaveAttribute("data-pinned","false")),await a(n.onColumnsPinnedChanged).toHaveBeenCalled(),await T(o,"fullName"),await E("Pin column"),await c(()=>a(i).toHaveAttribute("data-pinned","left"))}},$={parameters:{docs:{source:{code:`const customColumnDefinition = [
      ...columnDefinitions,
      {
        locator: {
          type: "custom",
...
/>`}}},render:e=>{const[n,o]=d.useState(null),[i,l]=d.useState(null),[s,h]=d.useState([]),[C,D]=d.useState(!1),[x,ce]=d.useState([{property:"fullName",direction:"asc"}]),[ut,k]=d.useState(""),mt=d.useCallback(b=>{var g;(g=e.onRowClick)==null||g.call(e,b),o(b),k("onRowClick")},[e]),pt=d.useCallback(b=>{var g;(g=e.onColumnHeaderClick)==null||g.call(e,b),l(b),k("onColumnHeaderClick")},[e]),yt=d.useCallback(b=>{var g;(g=e.onRowSelectionChanged)==null||g.call(e,b),h(b.selectedRows.map(O=>O.$primaryKey)),D(b.isSelectAll),k("onRowSelectionChanged")},[e]),ht=d.useCallback(b=>{var g;(g=e.onOrderByChanged)==null||g.call(e,b),ce(b),k("onOrderByChanged")},[e]),bt=d.useCallback(b=>{var g;(g=e.onColumnVisibilityChanged)==null||g.call(e,b),k("onColumnVisibilityChanged")},[e]),gt=d.useCallback(b=>{var g;(g=e.onColumnsPinnedChanged)==null||g.call(e,b),k("onColumnsPinnedChanged")},[e]),wt=d.useCallback((b,g)=>{var O;(O=e.onColumnResize)==null||O.call(e,b,g),k(`onColumnResize (${b})`)},[e]);return t.jsxs("div",{children:[t.jsxs("div",{style:{marginBottom:"16px",padding:"12px",backgroundColor:"#f0f9ff",borderRadius:"4px",border:"1px solid #bfdbfe"},children:[t.jsx("div",{style:{marginBottom:"8px",fontWeight:"bold"},children:"Event Monitor:"}),t.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[t.jsx("strong",{children:"Last event:"})," ",ut||"None"]}),t.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[t.jsx("strong",{children:"Row clicked:"})," ",n?t.jsx("code",{children:n.fullName}):"None"]}),t.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[t.jsx("strong",{children:"Column clicked:"})," ",i?t.jsx("code",{children:i}):"None"]}),t.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[t.jsx("strong",{children:"Selected rows:"})," ",C?"All employees":`${s.length} employees`]}),t.jsxs("div",{style:{fontSize:"12px"},children:[t.jsx("strong",{children:"Current sort:"})," ",x!=null&&x[0]?`${x[0].property} (${x[0].direction})`:"None"]})]}),t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e,selectedRows:s,orderBy:x,onRowClick:mt,onColumnHeaderClick:pt,onRowSelectionChanged:yt,onOrderByChanged:ht,onColumnVisibilityChanged:bt,onColumnsPinnedChanged:gt,onColumnResize:wt})})]})},play:async({canvasElement:e,args:n})=>{const o=u(e);await o.findByText("Ahmed Williams"),await r.click(o.getByText("Ahmed Williams")),await c(()=>a(n.onRowClick).toHaveBeenCalled()),await a(n.onFocusedRowChanged).toHaveBeenCalled();const i=await R(o,"fullName");await r.click(u(i).getByText("Name")),await c(()=>a(n.onColumnHeaderClick).toHaveBeenCalledWith("fullName")),await r.click((await o.findAllByRole("checkbox",{name:/select row/iu}))[0]),await c(()=>a(n.onRowSelectionChanged).toHaveBeenCalled()),await T(o,"fullName"),await E("Sort descending"),await c(()=>a(n.onOrderByChanged).toHaveBeenCalled()),await T(o,"fullName"),await E("Pin column"),await c(()=>a(n.onColumnsPinnedChanged).toHaveBeenCalled()),await dt(await R(o,"fullName"),100),await c(()=>a(n.onColumnResize).toHaveBeenCalled()),await T(o,"fullName"),await E("Configure Columns");const l=await y.findAllByRole("button",{name:/^Remove /u});await r.click(l[0]),await r.click(await y.findByRole("button",{name:"Apply"})),await c(()=>a(n.onColumnVisibilityChanged).toHaveBeenCalled())}},U={args:{objectType:m,columnDefinitions:v,orderBy:[{property:"fullName",direction:"asc"}],onOrderByChanged:f()},parameters:{docs:{source:{code:`const [orderBy, setOrderBy] = useState<any>([
...
return (
  ...
  />
);`}}},render:e=>{const[n,o]=d.useState(e.orderBy??[{property:"fullName",direction:"asc"}]),i=d.useCallback(l=>{var s;(s=e.onOrderByChanged)==null||s.call(e,l),o(l)},[e]);return t.jsxs("div",{children:[t.jsxs("div",{style:{marginBottom:"16px"},children:[t.jsx("strong",{children:"Current Sort:"})," ",n.map((l,s)=>t.jsxs("span",{children:[l.property," (",l.direction,")",s<n.length-1&&", "]},s))]}),t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e,orderBy:n,onOrderByChanged:i})})]})},play:async({canvasElement:e,args:n})=>{const o=u(e);await R(o,"fullName"),await a(o.getByText("fullName (asc)")).toBeInTheDocument(),await T(o,"fullName"),await E("Sort descending"),await c(()=>a(n.onOrderByChanged).toHaveBeenCalled()),await c(()=>a(o.getByText("fullName (desc)")).toBeInTheDocument())}},K={args:{objectType:m,columnDefinitions:v,selectionMode:"multiple",selectedRows:[],onRowSelectionChanged:f()},parameters:{docs:{source:{code:`const [selectedRows, setSelectedRows] = useState<any[]>([]);
...
return (
  ...
  />
);`}}},render:e=>{const[n,o]=d.useState(e.selectedRows??[]),[i,l]=d.useState(!1),s=d.useCallback(h=>{var C;(C=e.onRowSelectionChanged)==null||C.call(e,h),o(h.selectedRows.map(D=>D.$primaryKey)),l(h.isSelectAll)},[e]);return t.jsxs("div",{children:[t.jsxs("div",{style:{marginBottom:"16px"},children:[t.jsx("strong",{children:"Selected:"})," ",i?"All Employees":`${n.length} employees`,n.length>0&&t.jsx("button",{style:{marginLeft:"16px",padding:"4px 8px",fontSize:"12px",border:"1px solid #d1d5db",borderRadius:"4px",background:"white",cursor:"pointer"},onClick:()=>{o([]),l(!1)},children:"Clear Selection"})]}),t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e,selectedRows:n,isAllSelected:i,onRowSelectionChanged:s})})]})},play:async({canvasElement:e,args:n})=>{const o=u(e),i=()=>o.findAllByRole("checkbox",{name:/select row/iu});await i(),await r.click((await i())[0]),await c(()=>a(n.onRowSelectionChanged).toHaveBeenCalled()),await c(()=>a(o.getByText("1 employees")).toBeInTheDocument()),await r.click((await i())[1]),await c(()=>a(o.getByText("2 employees")).toBeInTheDocument()),await r.click(o.getByRole("button",{name:"Clear Selection"})),await c(()=>a(o.getByText("0 employees")).toBeInTheDocument()),await a(o.queryByRole("button",{name:"Clear Selection"})).not.toBeInTheDocument()}},G={args:{objectType:m,columnDefinitions:v,onFocusedRowChanged:f()},parameters:{docs:{description:{story:"Demonstrates the `focusedRow` / `onFocusedRowChanged` API. Click any row to focus it; the focused employee is shown in the banner above and persists until cleared by the caller. Because focus is controlled, outside clicks no longer auto-clear — the caller owns clearing."},source:{code:`const [focusedRow, setFocusedRow] = useState<Osdk.Instance<Employee> | null>(null);
...
);`}}},render:e=>{const[n,o]=d.useState(null),i=d.useCallback(l=>{var s;(s=e.onFocusedRowChanged)==null||s.call(e,l),o(l)},[e]);return t.jsxs("div",{children:[t.jsxs("div",{style:{marginBottom:"16px",padding:"12px",backgroundColor:"#f0f9ff",borderRadius:"4px",border:"1px solid #bfdbfe",display:"flex",alignItems:"center",gap:"12px"},children:[t.jsxs("span",{children:[t.jsx("strong",{children:"Focused employee:"})," ",n==null?"none":`${n.fullName} (#${n.employeeNumber})`]}),t.jsx("button",{type:"button",style:{padding:"4px 8px",fontSize:"12px",border:"1px solid #d1d5db",borderRadius:"4px",background:"white",cursor:n==null?"not-allowed":"pointer"},onClick:()=>o(null),disabled:n==null,children:"Clear focus"})]}),t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e,focusedRow:(n==null?void 0:n.$primaryKey)??null,onFocusedRowChanged:i})})]})},play:async({canvasElement:e,args:n})=>{const o=u(e);await o.findByText("Ahmed Williams"),await r.click(o.getByText("Ahmed Williams")),await c(()=>a(n.onFocusedRowChanged).toHaveBeenCalled()),await c(()=>a(o.getByText(/Ahmed Williams \(#\d+\)/u)).toBeInTheDocument()),await c(()=>a(j(o.getByText("Ahmed Williams"))).toHaveAttribute("data-focused","true")),await r.click(o.getByText(/Focused employee:/u)),await c(()=>a(j(o.getByText("Ahmed Williams"))).toHaveAttribute("data-focused","false")),await r.click(o.getByText("Ahmed Williams")),await c(()=>a(j(o.getByText("Ahmed Williams"))).toHaveAttribute("data-focused","true")),await r.click(o.getByRole("button",{name:"Clear focus"})),await c(()=>a(j(o.getByText("Ahmed Williams"))).toHaveAttribute("data-focused","false"))}},Y={args:{objectType:m,columnDefinitions:v,enableOrdering:!1,enableColumnPinning:!1,enableColumnResizing:!1,enableColumnConfig:!1},parameters:{docs:{source:{code:`<ObjectTable
  objectType={Employee}
  enableOrdering={false}
  enableColumnPinning={false}
  enableColumnResizing={false}
  enableColumnConfig={false}
/>`}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e})=>{const n=u(e);await n.findByText("Ahmed Williams"),await a(n.queryByRole("button",{name:/Open header menu/iu})).not.toBeInTheDocument()}},J={args:{objectType:m,columnDefinitions:v},parameters:{docs:{description:{story:"Scenario for the header menu dropdown when ObjectTable is rendered inside a Blueprint Drawer. Open the drawer and click any column header chevron; the menu should appear above the drawer."},source:{code:`<Drawer isOpen={true} title="ObjectTable in Blueprint Drawer">
  <ObjectTable objectType={Employee} columnDefinitions={defaultEmployeeColumns} />
</Drawer>`}}},render:e=>t.jsx(pe,{tableProps:e}),play:async()=>{await y.findByText("Ahmed Williams"),await T(y,"fullName"),await a(await y.findByRole("menuitem",{name:"Configure Columns"})).toBeInTheDocument(),await r.keyboard("{Escape}")}},X={args:{objectType:m,columnDefinitions:v},parameters:{docs:{description:{story:"Scenario for the header menu dropdown when ObjectTable is rendered inside a Blueprint Dialog. Open the dialog and click any column header chevron; the menu should appear above the dialog."},source:{code:`<Dialog isOpen={true} title="ObjectTable in Blueprint Dialog">
  <ObjectTable objectType={Employee} columnDefinitions={defaultEmployeeColumns} />
</Dialog>`}}},render:e=>t.jsx(ye,{tableProps:e}),play:async()=>{await y.findByText("Ahmed Williams"),await T(y,"fullName"),await a(await y.findByRole("menuitem",{name:"Configure Columns"})).toBeInTheDocument(),await r.keyboard("{Escape}")}},Z={args:{objectType:m,columnDefinitions:v},parameters:{docs:{description:{story:"Scenario for the header menu dropdown when ObjectTable is rendered inside the OSDK Base UI Dialog primitive. Open the dialog and click any column header chevron; the menu should appear above the dialog."},source:{code:`<Dialog isOpen={true} title="ObjectTable in Base UI Dialog" onOpenChange={setIsOpen}>
  <ObjectTable objectType={Employee} columnDefinitions={defaultEmployeeColumns} />
</Dialog>`}}},render:e=>t.jsx(he,{tableProps:e}),play:async()=>{await y.findByText("Ahmed Williams"),await T(y,"fullName"),await a(await y.findByRole("menuitem",{name:"Configure Columns"})).toBeInTheDocument(),await r.keyboard("{Escape}")}},Q={args:{objectType:m,columnDefinitions:v,rowHeight:56},parameters:{docs:{source:{code:"<ObjectTable objectType={Employee} rowHeight={56} />"}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e})=>{const n=u(e);await n.findByText("Ahmed Williams"),await a(j(n.getByText("Ahmed Williams"))).toHaveStyle({height:"56px"})}},ee={args:{objectType:m,columnDefinitions:[{locator:{type:"property",id:"fullName"},renderHeader:()=>t.jsx("a",{href:"#",className:"header-link",onClick:e=>{e.preventDefault(),alert("Employee Name column clicked!")},children:"Employee Name"})},{locator:{type:"property",id:"emailPrimaryWork"}},{locator:{type:"property",id:"jobTitle"},renderHeader:()=>"Job Title"},{locator:{type:"custom",id:"employment-status"},renderHeader:()=>"Employment Status",renderCell:e=>{const n=e.firstFullTimeStartDate,o=n&&new Date(n)<=new Date;return t.jsx("span",{className:`status-tag ${o?"active":"inactive"}`,children:o?"Active":"Inactive"})},width:140},{locator:{type:"property",id:"department"}}]},parameters:{docs:{source:{code:`const columnDefinitions = [
  {
    locator: { type: "property", id: "fullName" },
    renderHeader: () => (
      <a
...
return (
  <ObjectTable
    ...
    editMode="manual"
  />
);`}}},render:e=>{const[n,o]=d.useState(),i=d.useCallback(l=>{var s;(s=e.onCellValueChanged)==null||s.call(e,l),o(l)},[e]);return t.jsxs("div",{className:"object-table-container",style:{height:"600px"},children:[t.jsx("div",{style:{padding:"12px",backgroundColor:"#fff3cd",marginBottom:"8px",borderRadius:"4px"},children:'Try changing showEditFooter to false to hide the edit footer bar. Change edit mode to "manual" to enable inline editing with an Edit Table button.'}),n!=null&&t.jsxs("div",{style:{padding:"12px",backgroundColor:"#d1ecf1",marginBottom:"8px",borderRadius:"4px",fontFamily:"monospace",fontSize:"13px"},children:[t.jsx("strong",{children:"Last cell edit:"}),' Column "',n.columnId,'" changed from "',String(n.oldValue),'" to "',String(n.newValue),'"']}),t.jsx(p,{...e,onCellValueChanged:i})]})},play:async({canvasElement:e,args:n})=>{const o=u(e);await o.findByText("Ahmed Williams"),await r.click(o.getByRole("button",{name:"Edit Table"}));const i=o.getAllByRole("row")[1],l=()=>u(i).getAllByRole("cell"),s=u(l()[0]).getByRole("textbox");await r.click(s),await r.clear(s),await r.type(s,"Ahmed Williamson"),await r.tab(),await c(()=>a(n.onCellValueChanged).toHaveBeenCalledWith(a.objectContaining({columnId:"fullName",newValue:"Ahmed Williamson"})));const h=await u(l()[3]).findByRole("combobox");await r.click(h),await r.click(await y.findByRole("option",{name:"Engineering"})),await c(()=>a(n.onCellValueChanged).toHaveBeenCalledWith(a.objectContaining({columnId:"department",newValue:"Engineering"})));const C=u(l()[5]).getByRole("combobox");await r.click(C),await r.click(await y.findByRole("button",{name:"Today"})),await c(()=>a(n.onCellValueChanged).toHaveBeenCalledWith(a.objectContaining({columnId:"firstFullTimeStartDate"}))),await r.click(o.getByRole("button",{name:"Cancel"})),await a(await o.findByRole("button",{name:"Edit Table"})).toBeInTheDocument()}},te={args:{objectType:m,columnDefinitions:rt,editMode:"manual",onSubmitEdits:f(async e=>(await new Promise(n=>setTimeout(n,1e3)),!0))},parameters:{docs:{source:{code:`const columnDefinitions = [
  {
    locator: { type: "property", id: "fullName" },
    editable: true,
  },
...
return (
  <ObjectTable
    ...
    editMode="always"
  />
);`}}},render:e=>t.jsxs("div",{className:"object-table-container",style:{height:"600px"},children:[t.jsx("div",{style:{padding:"12px",backgroundColor:"#fff3cd",marginBottom:"8px",borderRadius:"4px"},children:'JobTitle is only editable for "Senior Product Manager" rows. Department dropdown shows only 2 options for Operations rows.'}),t.jsx(p,{...e})]}),play:async({canvasElement:e})=>{const n=u(e);await n.findByText("Ahmed Williams");const o=u(j(n.getByText("Margaret Jackson"))).getAllByRole("cell");await a(o[1]).toHaveAttribute("data-editable","true");const i=u(j(n.getByText("Ahmed Williams"))).getAllByRole("cell");await a(i[1]).not.toHaveAttribute("data-editable");const l=j(n.getByText("Yuki Torres"));await r.click(n.getByText("Yuki Torres")),be.click(await u(l).findByRole("combobox")),await a(await y.findAllByRole("option")).toHaveLength(2),await a(y.queryByRole("option",{name:"Finance"})).not.toBeInTheDocument(),await r.keyboard("{Escape}");const s=j(n.getByText("Ahmed Williams"));await r.click(n.getByText("Ahmed Williams")),be.click(await u(s).findByRole("combobox")),await a(await y.findByRole("option",{name:"Finance"})).toBeInTheDocument()}},ie={args:{objectType:m,columnDefinitions:[{locator:{type:"property",id:"fullName"}},{locator:{type:"property",id:"jobTitle"}},{locator:{type:"property",id:"department"}},{locator:{type:"property",id:"locationCity"}}]},parameters:{docs:{description:{story:'Demonstrates using `getRowAttributes` to set data attributes on rows and a `className` on the table to scope CSS overrides via the data attribute selector. New York employees get a light blue background through the `[data-highlight-row="true"]` CSS selector scoped under the table\'s className.'},source:{code:`/* CSS (imported stylesheet):
.customTableStyling {
...
`}}},render:e=>{const o=at()(m).where({jobProfile:"Nonexistent Role"});return t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e,objectSet:o})})},play:async({canvasElement:e})=>{const n=u(e);await a(await n.findByText("No saved views found.")).toBeInTheDocument(),await a(n.queryByText("Ahmed Williams")).not.toBeInTheDocument()}};var Be,je,Se;I.parameters={...I.parameters,docs:{...(Be=I.parameters)==null?void 0:Be.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns
  },
...
}`,...(_e=(Ve=W.parameters)==null?void 0:Ve.docs)==null?void 0:_e.source}}};var ze,Le,$e;M.parameters={...M.parameters,docs:{...(ze=M.parameters)==null?void 0:ze.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
    selectionMode: "multiple",
...
}`,...($e=(Le=M.parameters)==null?void 0:Le.docs)==null?void 0:$e.source}}};var qe,Ue,Ke;V.parameters={...V.parameters,docs:{...(qe=V.parameters)==null?void 0:qe.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
...
}`,...(tn=(nn=L.parameters)==null?void 0:nn.docs)==null?void 0:tn.source}}};var on,an,rn;$.parameters={...$.parameters,docs:{...(on=$.parameters)==null?void 0:on.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,...(rn=(an=$.parameters)==null?void 0:an.docs)==null?void 0:rn.source}}};var ln,sn,cn;q.parameters={...q.parameters,docs:{...(ln=q.parameters)==null?void 0:ln.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
...
}`,...(cn=(sn=q.parameters)==null?void 0:sn.docs)==null?void 0:cn.source}}};var dn,un,mn;U.parameters={...U.parameters,docs:{...(dn=U.parameters)==null?void 0:dn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
    orderBy: [{
...
}`,...(vn=(Cn=Y.parameters)==null?void 0:Cn.docs)==null?void 0:vn.source}}};var Tn,xn,Bn;J.parameters={...J.parameters,docs:{...(Tn=J.parameters)==null?void 0:Tn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns
  },
...
}`,...(Bn=(xn=J.parameters)==null?void 0:xn.docs)==null?void 0:Bn.source}}};var jn,Sn,En;X.parameters={...X.parameters,docs:{...(jn=X.parameters)==null?void 0:jn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns
  },
...
}`,...(zn=(_n=te.parameters)==null?void 0:_n.docs)==null?void 0:zn.source}}};var Ln,$n,qn;oe.parameters={...oe.parameters,docs:{...(Ln=oe.parameters)==null?void 0:Ln.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: [{
      locator: {
...
}`,...(qn=($n=oe.parameters)==null?void 0:$n.docs)==null?void 0:qn.source}}};var Un,Kn,Gn;ae.parameters={...ae.parameters,docs:{...(Un=ae.parameters)==null?void 0:Un.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: [{
      locator: {
...
}`,...(Gn=(Kn=ae.parameters)==null?void 0:Kn.docs)==null?void 0:Gn.source}}};var Yn,Jn,Xn;ie.parameters={...ie.parameters,docs:{...(Yn=ie.parameters)==null?void 0:Yn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: [{
      locator: {
...
}`,...(et=(Qn=re.parameters)==null?void 0:Qn.docs)==null?void 0:et.source}}};const Go=["Default","WithObjectSet","WithInterfaceType","WithDerivedPropertyOrderingAndFilter","WithFunctionColumn","SingleSelection","MultipleSelection","WithContextMenu","CustomColumnWidths","WithDefaultSorting","WithDefaultColumnPinning","WithCustomColumn","EventListeners","ControlledSorting","ControlledSelection","ControlledFocusedRow","DisableAllHeaderMenuFeatures","HeaderMenuInsideBlueprintDrawer","HeaderMenuInsideBlueprintDialog","HeaderMenuInsideBaseUIDialog","CustomRowHeight","WithCustomRenderers","EditableTable","WithSubmitEditsButton","EditableWithValidation","PerRowEditableAndFieldConfig","RowAttributesForStyling","CustomEmptyState"];export{G as ControlledFocusedRow,K as ControlledSelection,U as ControlledSorting,_ as CustomColumnWidths,re as CustomEmptyState,Q as CustomRowHeight,I as Default,Y as DisableAllHeaderMenuFeatures,ne as EditableTable,oe as EditableWithValidation,q as EventListeners,Z as HeaderMenuInsideBaseUIDialog,X as HeaderMenuInsideBlueprintDialog,J as HeaderMenuInsideBlueprintDrawer,M as MultipleSelection,ae as PerRowEditableAndFieldConfig,ie as RowAttributesForStyling,W as SingleSelection,V as WithContextMenu,$ as WithCustomColumn,ee as WithCustomRenderers,L as WithDefaultColumnPinning,z as WithDefaultSorting,F as WithDerivedPropertyOrderingAndFilter,H as WithFunctionColumn,P as WithInterfaceType,A as WithObjectSet,te as WithSubmitEditsButton,Go as __namedExportsOrder,Ko as default};
