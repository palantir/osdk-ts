...
<ObjectTable objectType={Employee} columnDefinitions={columnDefinitions} />`}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e})=>{const n=u(e);await n.findByText("Seniority"),await s(()=>o(n.getAllByText(/^(Senior|Mid|Junior|Unknown)$/u).length).toBeGreaterThan(0))}},W={args:{objectType:m,columnDefinitions:C,selectionMode:"single",onRowSelectionChanged:f()},parameters:{docs:{source:{code:'<ObjectTable objectType={Employee} selectionMode="single" />'}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e,args:n})=>{const a=u(e),i=()=>a.findAllByRole("checkbox",{name:/select row/iu});await i(),await o(a.queryByRole("checkbox",{name:/select all rows/iu})).not.toBeInTheDocument(),await r.click((await i())[0]),await s(()=>o(n.onRowSelectionChanged).toHaveBeenCalled()),await o((await i())[0]).toBeChecked(),await r.click((await i())[1]),await o((await i())[1]).toBeChecked(),await o((await i())[0]).not.toBeChecked(),await r.click((await i())[1]),await o((await i())[1]).not.toBeChecked()}},M={args:{objectType:m,columnDefinitions:C,selectionMode:"multiple",onRowSelectionChanged:f()},parameters:{docs:{source:{code:'<ObjectTable objectType={Employee} selectionMode="multiple" />'}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e,args:n})=>{const a=u(e),i=Xt(a),[l,c]=await i();await r.click(l),await o(l).toBeChecked(),await s(()=>o(n.onRowSelectionChanged).toHaveBeenCalled()),await r.click(c),await o(l).toBeChecked(),await o(c).toBeChecked(),await r.click(await Be(a));for(const h of await i())await o(h).not.toBeChecked();await r.click(await Zt(a));for(const h of await i())await o(h).toBeChecked();await r.click(await Be(a));for(const h of await i())await o(h).not.toBeChecked()}},V={args:{objectType:m,columnDefinitions:C,renderCellContextMenu:(e,n)=>t.jsxs("div",{style:{background:"white",padding:8,border:"1px solid #d1d5db",boxShadow:"0 2px 8px 0 rgba(0, 0, 0, 0.1)",fontSize:13,borderRadius:4},children:[t.jsx("div",{style:{fontWeight:"bold",marginBottom:4},children:"Cell Value:"}),t.jsx("div",{children:n?String(n):"No Value"})]})},parameters:{docs:{source:{code:`<ObjectTable
  objectType={Employee}
...
/>`}}},render:e=>t.jsxs("div",{className:"object-table-container",style:{height:"600px"},children:[t.jsx("div",{style:{padding:"12px"},children:"Right click on any cell"}),t.jsx(p,{...e})]}),play:async({canvasElement:e})=>{const n=u(e);await n.findByText("Ahmed Williams"),ge.contextMenu(n.getByText("Ahmed Williams")),await o(await y.findByText("Cell Value:")).toBeInTheDocument(),await r.click(n.getByText("Right click on any cell")),await s(()=>o(y.queryByText("Cell Value:")).not.toBeInTheDocument())}},_={args:{objectType:m,columnDefinitions:ct.map((e,n)=>({...e,width:n===0?250:n===1?300:150})),onColumnResize:f()},parameters:{docs:{source:{code:`const columnDefinitions = [
...
<ObjectTable
  objectType={Employee}
  columnDefinitions={columnDefinitions}
/>`}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e,args:n})=>{const a=u(e),i=await R(a,"fullName");await o(de(i)).toBe(250),await ut(i,120),await s(()=>o(de(i)).toBeGreaterThan(250)),await o(n.onColumnResize).toHaveBeenCalledWith("fullName",o.any(Number)),n.onColumnResize.mockClear(),await r.dblClick(dt(i)),await s(()=>o(de(i)).toBe(250)),await o(n.onColumnResize).toHaveBeenCalledWith("fullName",null)}},z={args:{objectType:m,columnDefinitions:C,defaultOrderBy:[{property:"fullName",direction:"desc"}]},parameters:{docs:{source:{code:`<ObjectTable
  objectType={Employee}
  defaultOrderBy={[{
    property: "fullName",
    direction: "desc",
  }]}
/>`}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e})=>{const n=u(e);await R(n,"fullName"),await s(()=>o(N(n,"fullName")).toBe("desc")),await v(n,"fullName"),await S("Sort ascending"),await s(()=>o(N(n,"fullName")).toBe("asc")),await v(n,"fullName"),await S("Sort descending"),await s(()=>o(N(n,"fullName")).toBe("desc"))}},L={args:{objectType:m,columnDefinitions:[{locator:{type:"property",id:"fullName"},pinned:"left"},{locator:{type:"property",id:"emailPrimaryWork"}},{locator:{type:"property",id:"jobTitle"}},{locator:{type:"property",id:"department"},pinned:"right"},{locator:{type:"property",id:"firstFullTimeStartDate"}}],onColumnsPinnedChanged:f()},parameters:{docs:{source:{code:`const columnDefinitions = [
  {
    locator: { type: "property", id: "fullName" },
    pinned: "left",
  },
...
<ObjectTable
  objectType={Employee}
  columnDefinitions={columnDefinitions}
/>`}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e,args:n})=>{const a=u(e),i=await R(a,"fullName"),l=await R(a,"department");await o(i).toHaveAttribute("data-pinned","left"),await o(l).toHaveAttribute("data-pinned","right"),await v(a,"fullName"),await S("Unpin Column"),await s(()=>o(i).toHaveAttribute("data-pinned","false")),await o(n.onColumnsPinnedChanged).toHaveBeenCalled(),await v(a,"fullName"),await S("Pin column"),await s(()=>o(i).toHaveAttribute("data-pinned","left"))}},q={parameters:{docs:{source:{code:`const customColumnDefinition = [
      ...columnDefinitions,
      {
        locator: {
          type: "custom",
    ...
    `}}},args:{objectType:m,columnDefinitions:[...ct.slice(0,3),{locator:{type:"custom",id:"actions"},renderHeader:()=>"Actions",renderCell:e=>t.jsxs("div",{style:{display:"flex",gap:"8px"},children:[t.jsx("button",{style:{padding:"4px 8px",fontSize:"12px",border:"1px solid #d1d5db",borderRadius:"4px",background:"white",cursor:"pointer"},onClick:()=>alert(`View ${e.fullName}`),children:"View"}),t.jsx("button",{style:{padding:"4px 8px",fontSize:"12px",border:"1px solid #d1d5db",borderRadius:"4px",background:"white",cursor:"pointer"},onClick:()=>alert(`Edit ${e.fullName}`),children:"Edit"})]}),orderable:!1,width:120}]},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e})=>{const n=u(e);await o((await n.findAllByRole("button",{name:"View"})).length).toBeGreaterThan(0),await o(n.getByText("Actions")).toBeInTheDocument(),await o(n.getAllByRole("button",{name:"Edit"}).length).toBeGreaterThan(0)}},$={args:{objectType:m,columnDefinitions:C,selectionMode:"multiple",selectedRows:[],orderBy:[{property:"fullName",direction:"asc"}],onRowClick:f(),onColumnHeaderClick:f(),onRowSelectionChanged:f(),onOrderByChanged:f(),onColumnVisibilityChanged:f(),onColumnsPinnedChanged:f(),onColumnResize:f(),onFocusedRowChanged:f()},parameters:{docs:{source:{code:`<ObjectTable
  objectType={Employee}
...
/>`}}},render:e=>{const[n,a]=d.useState(null),[i,l]=d.useState(null),[c,h]=d.useState([]),[x,D]=d.useState(!1),[T,ce]=d.useState([{property:"fullName",direction:"asc"}]),[mt,k]=d.useState(""),pt=d.useCallback(g=>{var b;(b=e.onRowClick)==null||b.call(e,g),a(g),k("onRowClick")},[e]),yt=d.useCallback(g=>{var b;(b=e.onColumnHeaderClick)==null||b.call(e,g),l(g),k("onColumnHeaderClick")},[e]),ht=d.useCallback(g=>{var b;(b=e.onRowSelectionChanged)==null||b.call(e,g),h(g.selectedRows.map(O=>O.$primaryKey)),D(g.isSelectAll),k("onRowSelectionChanged")},[e]),gt=d.useCallback(g=>{var b;(b=e.onOrderByChanged)==null||b.call(e,g),ce(g),k("onOrderByChanged")},[e]),bt=d.useCallback(g=>{var b;(b=e.onColumnVisibilityChanged)==null||b.call(e,g),k("onColumnVisibilityChanged")},[e]),wt=d.useCallback(g=>{var b;(b=e.onColumnsPinnedChanged)==null||b.call(e,g),k("onColumnsPinnedChanged")},[e]),ft=d.useCallback((g,b)=>{var O;(O=e.onColumnResize)==null||O.call(e,g,b),k(`onColumnResize (${g})`)},[e]);return t.jsxs("div",{children:[t.jsxs("div",{style:{marginBottom:"16px",padding:"12px",backgroundColor:"#f0f9ff",borderRadius:"4px",border:"1px solid #bfdbfe"},children:[t.jsx("div",{style:{marginBottom:"8px",fontWeight:"bold"},children:"Event Monitor:"}),t.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[t.jsx("strong",{children:"Last event:"})," ",mt||"None"]}),t.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[t.jsx("strong",{children:"Row clicked:"})," ",n?t.jsx("code",{children:n.fullName}):"None"]}),t.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[t.jsx("strong",{children:"Column clicked:"})," ",i?t.jsx("code",{children:i}):"None"]}),t.jsxs("div",{style:{marginBottom:"8px",fontSize:"12px"},children:[t.jsx("strong",{children:"Selected rows:"})," ",x?"All employees":`${c.length} employees`]}),t.jsxs("div",{style:{fontSize:"12px"},children:[t.jsx("strong",{children:"Current sort:"})," ",T!=null&&T[0]?`${T[0].property} (${T[0].direction})`:"None"]})]}),t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e,selectedRows:c,orderBy:T,onRowClick:pt,onColumnHeaderClick:yt,onRowSelectionChanged:ht,onOrderByChanged:gt,onColumnVisibilityChanged:bt,onColumnsPinnedChanged:wt,onColumnResize:ft})})]})},play:async({canvasElement:e,args:n})=>{const a=u(e);await a.findByText("Ahmed Williams"),await r.click(a.getByText("Ahmed Williams")),await s(()=>o(n.onRowClick).toHaveBeenCalled()),await o(n.onFocusedRowChanged).toHaveBeenCalled();const i=await R(a,"fullName");await r.click(u(i).getByText("Name")),await s(()=>o(n.onColumnHeaderClick).toHaveBeenCalledWith("fullName")),await r.click((await a.findAllByRole("checkbox",{name:/select row/iu}))[0]),await s(()=>o(n.onRowSelectionChanged).toHaveBeenCalled()),await v(a,"fullName"),await S("Sort descending"),await s(()=>o(n.onOrderByChanged).toHaveBeenCalled()),await v(a,"fullName"),await S("Pin column"),await s(()=>o(n.onColumnsPinnedChanged).toHaveBeenCalled()),await ut(await R(a,"fullName"),100),await s(()=>o(n.onColumnResize).toHaveBeenCalled()),await v(a,"fullName"),await S("Configure Columns");const l=await y.findAllByRole("button",{name:/^Remove /u});await r.click(l[0]),await r.click(await y.findByRole("button",{name:"Apply"})),await s(()=>o(n.onColumnVisibilityChanged).toHaveBeenCalled())}},U={args:{objectType:m,columnDefinitions:C,orderBy:[{property:"fullName",direction:"asc"}],onOrderByChanged:f()},parameters:{docs:{source:{code:`const [orderBy, setOrderBy] = useState<any>([
...
return (
  ...
  />
);`}}},render:e=>{const[n,a]=d.useState(e.orderBy??[{property:"fullName",direction:"asc"}]),i=d.useCallback(l=>{var c;(c=e.onOrderByChanged)==null||c.call(e,l),a(l)},[e]);return t.jsxs("div",{children:[t.jsxs("div",{style:{marginBottom:"16px"},children:[t.jsx("strong",{children:"Current Sort:"})," ",n.map((l,c)=>t.jsxs("span",{children:[l.property," (",l.direction,")",c<n.length-1&&", "]},c))]}),t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e,orderBy:n,onOrderByChanged:i})})]})},play:async({canvasElement:e,args:n})=>{const a=u(e);await R(a,"fullName"),await o(a.getByText("fullName (asc)")).toBeInTheDocument(),await v(a,"fullName"),await S("Sort descending"),await s(()=>o(n.onOrderByChanged).toHaveBeenCalled()),await s(()=>o(a.getByText("fullName (desc)")).toBeInTheDocument()),await v(a,"fullName"),await S("Sort ascending"),await s(()=>o(a.getByText("fullName (asc)")).toBeInTheDocument())}},K={args:{objectType:m,columnDefinitions:C,selectionMode:"multiple",selectedRows:[],onRowSelectionChanged:f()},parameters:{docs:{source:{code:`const [selectedRows, setSelectedRows] = useState<any[]>([]);
...
return (
  ...
  />
);`}}},render:e=>{const[n,a]=d.useState(e.selectedRows??[]),[i,l]=d.useState(!1),c=d.useCallback(h=>{var x;(x=e.onRowSelectionChanged)==null||x.call(e,h),a(h.selectedRows.map(D=>D.$primaryKey)),l(h.isSelectAll)},[e]);return t.jsxs("div",{children:[t.jsxs("div",{style:{marginBottom:"16px"},children:[t.jsx("strong",{children:"Selected:"})," ",i?"All Employees":`${n.length} employees`,n.length>0&&t.jsx("button",{style:{marginLeft:"16px",padding:"4px 8px",fontSize:"12px",border:"1px solid #d1d5db",borderRadius:"4px",background:"white",cursor:"pointer"},onClick:()=>{a([]),l(!1)},children:"Clear Selection"})]}),t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e,selectedRows:n,isAllSelected:i,onRowSelectionChanged:c})})]})},play:async({canvasElement:e,args:n})=>{const a=u(e),i=()=>a.findAllByRole("checkbox",{name:/select row/iu});await i(),await r.click((await i())[0]),await s(()=>o(n.onRowSelectionChanged).toHaveBeenCalled()),await s(()=>o(a.getByText("1 employees")).toBeInTheDocument()),await r.click((await i())[1]),await s(()=>o(a.getByText("2 employees")).toBeInTheDocument()),await r.click(a.getByRole("button",{name:"Clear Selection"})),await s(()=>o(a.getByText("0 employees")).toBeInTheDocument()),await o(a.queryByRole("button",{name:"Clear Selection"})).not.toBeInTheDocument()}},G={args:{objectType:m,columnDefinitions:C,onFocusedRowChanged:f()},parameters:{docs:{description:{story:"Demonstrates the `focusedRow` / `onFocusedRowChanged` API. Click any row to focus it; the focused employee is shown in the banner above and persists until cleared by the caller. Because focus is controlled, outside clicks no longer auto-clear — the caller owns clearing."},source:{code:`const [focusedRow, setFocusedRow] = useState<Osdk.Instance<Employee> | null>(null);
...
);`}}},render:e=>{const[n,a]=d.useState(null),i=d.useCallback(l=>{var c;(c=e.onFocusedRowChanged)==null||c.call(e,l),a(l)},[e]);return t.jsxs("div",{children:[t.jsxs("div",{style:{marginBottom:"16px",padding:"12px",backgroundColor:"#f0f9ff",borderRadius:"4px",border:"1px solid #bfdbfe",display:"flex",alignItems:"center",gap:"12px"},children:[t.jsxs("span",{children:[t.jsx("strong",{children:"Focused employee:"})," ",n==null?"none":`${n.fullName} (#${n.employeeNumber})`]}),t.jsx("button",{type:"button",style:{padding:"4px 8px",fontSize:"12px",border:"1px solid #d1d5db",borderRadius:"4px",background:"white",cursor:n==null?"not-allowed":"pointer"},onClick:()=>a(null),disabled:n==null,children:"Clear focus"})]}),t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e,focusedRow:(n==null?void 0:n.$primaryKey)??null,onFocusedRowChanged:i})})]})},play:async({canvasElement:e,args:n})=>{const a=u(e);await a.findByText("Ahmed Williams"),await r.click(a.getByText("Ahmed Williams")),await s(()=>o(n.onFocusedRowChanged).toHaveBeenCalled()),await s(()=>o(a.getByText(/Ahmed Williams \(#\d+\)/u)).toBeInTheDocument()),await s(()=>o(j(a.getByText("Ahmed Williams"))).toHaveAttribute("data-focused","true")),await r.click(a.getByText(/Focused employee:/u)),await s(()=>o(j(a.getByText("Ahmed Williams"))).toHaveAttribute("data-focused","false")),await r.click(a.getByText("Ahmed Williams")),await s(()=>o(j(a.getByText("Ahmed Williams"))).toHaveAttribute("data-focused","true")),await r.click(a.getByRole("button",{name:"Clear focus"})),await s(()=>o(j(a.getByText("Ahmed Williams"))).toHaveAttribute("data-focused","false"))}},Y={args:{objectType:m,columnDefinitions:C,enableOrdering:!1,enableColumnPinning:!1,enableColumnResizing:!1,enableColumnConfig:!1},parameters:{docs:{source:{code:`<ObjectTable
  objectType={Employee}
  enableOrdering={false}
  enableColumnPinning={false}
  enableColumnResizing={false}
  enableColumnConfig={false}
/>`}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e})=>{const n=u(e);await n.findByText("Ahmed Williams"),await o(n.queryByRole("button",{name:/Open header menu/iu})).not.toBeInTheDocument()}},J={args:{objectType:m,columnDefinitions:C},parameters:{docs:{description:{story:"Scenario for the header menu dropdown when ObjectTable is rendered inside a Blueprint Drawer. Open the drawer and click any column header chevron; the menu should appear above the drawer."},source:{code:`<Drawer isOpen={true} title="ObjectTable in Blueprint Drawer">
  <ObjectTable objectType={Employee} columnDefinitions={defaultEmployeeColumns} />
</Drawer>`}}},render:e=>t.jsx(pe,{tableProps:e}),play:async()=>{await y.findByText("Ahmed Williams"),await v(y,"fullName"),await o(await y.findByRole("menuitem",{name:"Configure Columns"})).toBeInTheDocument(),await r.keyboard("{Escape}")}},X={args:{objectType:m,columnDefinitions:C},parameters:{docs:{description:{story:"Scenario for the header menu dropdown when ObjectTable is rendered inside a Blueprint Dialog. Open the dialog and click any column header chevron; the menu should appear above the dialog."},source:{code:`<Dialog isOpen={true} title="ObjectTable in Blueprint Dialog">
  <ObjectTable objectType={Employee} columnDefinitions={defaultEmployeeColumns} />
</Dialog>`}}},render:e=>t.jsx(ye,{tableProps:e}),play:async()=>{await y.findByText("Ahmed Williams"),await v(y,"fullName"),await o(await y.findByRole("menuitem",{name:"Configure Columns"})).toBeInTheDocument(),await r.keyboard("{Escape}")}},Z={args:{objectType:m,columnDefinitions:C},parameters:{docs:{description:{story:"Scenario for the header menu dropdown when ObjectTable is rendered inside the OSDK Base UI Dialog primitive. Open the dialog and click any column header chevron; the menu should appear above the dialog."},source:{code:`<Dialog isOpen={true} title="ObjectTable in Base UI Dialog" onOpenChange={setIsOpen}>
  <ObjectTable objectType={Employee} columnDefinitions={defaultEmployeeColumns} />
</Dialog>`}}},render:e=>t.jsx(he,{tableProps:e}),play:async()=>{await y.findByText("Ahmed Williams"),await v(y,"fullName"),await o(await y.findByRole("menuitem",{name:"Configure Columns"})).toBeInTheDocument(),await r.keyboard("{Escape}")}},Q={args:{objectType:m,columnDefinitions:C,rowHeight:56},parameters:{docs:{source:{code:"<ObjectTable objectType={Employee} rowHeight={56} />"}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e})=>{const n=u(e);await n.findByText("Ahmed Williams"),await o(j(n.getByText("Ahmed Williams"))).toHaveStyle({height:"56px"})}},ee={args:{objectType:m,columnDefinitions:[{locator:{type:"property",id:"fullName"},renderHeader:()=>t.jsx("a",{href:"#",className:"header-link",onClick:e=>{e.preventDefault(),alert("Employee Name column clicked!")},children:"Employee Name"})},{locator:{type:"property",id:"emailPrimaryWork"}},{locator:{type:"property",id:"jobTitle"},renderHeader:()=>"Job Title"},{locator:{type:"custom",id:"employment-status"},renderHeader:()=>"Employment Status",renderCell:e=>{const n=e.firstFullTimeStartDate,a=n&&new Date(n)<=new Date;return t.jsx("span",{className:`status-tag ${a?"active":"inactive"}`,children:a?"Active":"Inactive"})},width:140},{locator:{type:"property",id:"department"}}]},parameters:{docs:{source:{code:`const columnDefinitions = [
  {
    locator: { type: "property", id: "fullName" },
    renderHeader: () => (
      <a
...
<ObjectTable objectType={Employee} columnDefinitions={columnDefinitions} />`}}},render:e=>t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e})}),play:async({canvasElement:e})=>{const n=u(e);await n.findByText("Ahmed Williams"),await o(n.getByRole("link",{name:"Employee Name"})).toBeInTheDocument(),await o(n.getByText("Employment Status")).toBeInTheDocument(),await o(n.getAllByText(/^(Active|Inactive)$/u).length).toBeGreaterThan(0)}},ne={args:{objectType:m,columnDefinitions:lt,editMode:"manual",onCellValueChanged:f()},parameters:{docs:{source:{code:`const columnDefinitions = [
  {
    locator: { type: "property", id: "fullName" },
    editable: true,
  },
...
return (
  <ObjectTable
    ...
    editMode="always"
  />
);`}}},render:e=>t.jsxs("div",{className:"object-table-container",style:{height:"600px"},children:[t.jsx("div",{style:{padding:"12px",backgroundColor:"#fff3cd",marginBottom:"8px",borderRadius:"4px"},children:'JobTitle is only editable for "Senior Product Manager" rows. Department dropdown shows only 2 options for Operations rows.'}),t.jsx(p,{...e})]}),play:async({canvasElement:e})=>{const n=u(e);await n.findByText("Ahmed Williams");const a=u(j(n.getByText("Margaret Jackson"))).getAllByRole("cell");await o(a[1]).toHaveAttribute("data-editable","true");const i=u(j(n.getByText("Ahmed Williams"))).getAllByRole("cell");await o(i[1]).not.toHaveAttribute("data-editable");const l=j(n.getByText("Yuki Torres"));await r.click(n.getByText("Yuki Torres")),ge.click(await u(l).findByRole("combobox")),await o(await y.findAllByRole("option")).toHaveLength(2),await o(y.queryByRole("option",{name:"Finance"})).not.toBeInTheDocument(),await r.keyboard("{Escape}");const c=j(n.getByText("Ahmed Williams"));await r.click(n.getByText("Ahmed Williams")),ge.click(await u(c).findByRole("combobox")),await o(await y.findByRole("option",{name:"Finance"})).toBeInTheDocument(),await r.keyboard("{Escape}"),await s(()=>o(y.queryByRole("option",{name:"Finance"})).not.toBeInTheDocument())}},ie={args:{objectType:m,columnDefinitions:[{locator:{type:"property",id:"fullName"}},{locator:{type:"property",id:"jobTitle"}},{locator:{type:"property",id:"department"}},{locator:{type:"property",id:"locationCity"}}]},parameters:{docs:{description:{story:'Demonstrates using `getRowAttributes` to set data attributes on rows and a `className` on the table to scope CSS overrides via the data attribute selector. New York employees get a light blue background through the `[data-highlight-row="true"]` CSS selector scoped under the table\'s className.'},source:{code:`/* CSS (imported stylesheet):
.customTableStyling {
...
`}}},render:e=>{const a=it()(m).where({jobProfile:"Nonexistent Role"});return t.jsx("div",{className:"object-table-container",style:{height:"600px"},children:t.jsx(p,{...e,objectSet:a})})},play:async({canvasElement:e})=>{const n=u(e);await o(await n.findByText("No saved views found.")).toBeInTheDocument(),await o(n.queryByText("Ahmed Williams")).not.toBeInTheDocument()}};var je,Se,Ee;I.parameters={...I.parameters,docs:{...(je=I.parameters)==null?void 0:je.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns
  },
...
}`,...(Ee=(Se=I.parameters)==null?void 0:Se.docs)==null?void 0:Ee.source}}};var De,Re,ke;A.parameters={...A.parameters,docs:{...(De=A.parameters)==null?void 0:De.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns
  },
...
}`,...(ke=(Re=A.parameters)==null?void 0:Re.docs)==null?void 0:ke.source}}};var Ne,Oe,Ie;P.parameters={...P.parameters,docs:{...(Ne=P.parameters)==null?void 0:Ne.docs,source:{originalSource:`{
  args: {
...
}`,...(Ie=(Oe=P.parameters)==null?void 0:Oe.docs)==null?void 0:Ie.source}}};var Ae,Pe,Fe;F.parameters={...F.parameters,docs:{...(Ae=F.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
  render: () => {
    type RDPs = {
      managerName: "string";
    };
...
}`,...(Fe=(Pe=F.parameters)==null?void 0:Pe.docs)==null?void 0:Fe.source}}};var He,We,Me;H.parameters={...H.parameters,docs:{...(He=H.parameters)==null?void 0:He.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: [{
      locator: {
...
<ObjectTable objectType={Employee} columnDefinitions={columnDefinitions} />\`
...
}`,...(Me=(We=H.parameters)==null?void 0:We.docs)==null?void 0:Me.source}}};var Ve,_e,ze;W.parameters={...W.parameters,docs:{...(Ve=W.parameters)==null?void 0:Ve.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
  ...
  play: async ({
    ...
    // Clicking the selected row again clears it, leaving the story unselected.
    await userEvent.click((await rowCheckboxes())[1]);
    await expect((await rowCheckboxes())[1]).not.toBeChecked();
  }
}`,...(ze=(_e=W.parameters)==null?void 0:_e.docs)==null?void 0:ze.source}}};var Le,qe,$e;M.parameters={...M.parameters,docs:{...(Le=M.parameters)==null?void 0:Le.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
    selectionMode: "multiple",
...
}`,...($e=(qe=M.parameters)==null?void 0:qe.docs)==null?void 0:$e.source}}};var Ue,Ke,Ge;V.parameters={...V.parameters,docs:{...(Ue=V.parameters)==null?void 0:Ue.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
...
}`,...(Ge=(Ke=V.parameters)==null?void 0:Ke.docs)==null?void 0:Ge.source}}};var Ye,Je,Xe;_.parameters={..._.parameters,docs:{...(Ye=_.parameters)==null?void 0:Ye.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
...
}`,...(Xe=(Je=_.parameters)==null?void 0:Je.docs)==null?void 0:Xe.source}}};var Ze,Qe,en;z.parameters={...z.parameters,docs:{...(Ze=z.parameters)==null?void 0:Ze.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
    defaultOrderBy: [{
...
}`,...(en=(Qe=z.parameters)==null?void 0:Qe.docs)==null?void 0:en.source}}};var nn,tn,an;L.parameters={...L.parameters,docs:{...(nn=L.parameters)==null?void 0:nn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: [{
      locator: {
...
}`,...(an=(tn=L.parameters)==null?void 0:tn.docs)==null?void 0:an.source}}};var on,rn,ln;q.parameters={...q.parameters,docs:{...(on=q.parameters)==null?void 0:on.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,...(ln=(rn=q.parameters)==null?void 0:rn.docs)==null?void 0:ln.source}}};var sn,cn,dn;$.parameters={...$.parameters,docs:{...(sn=$.parameters)==null?void 0:sn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
...
/>\`
  ...
  //
  // Unlike the other stories, this one intentionally leaves the table mutated
  // (sorted, pinned, resized, a row selected/focused and a column removed):
  // reversing every listener would double the test for no added coverage, and
  // Storybook remounts the story fresh before each run.
  play: async ({
    canvasElement,
    args
  }) => {
...
}`,...(dn=(cn=$.parameters)==null?void 0:cn.docs)==null?void 0:dn.source}}};var un,mn,pn;U.parameters={...U.parameters,docs:{...(un=U.parameters)==null?void 0:un.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
    orderBy: [{
...
}`,...(pn=(mn=U.parameters)==null?void 0:mn.docs)==null?void 0:pn.source}}};var yn,hn,gn;K.parameters={...K.parameters,docs:{...(yn=K.parameters)==null?void 0:yn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
    selectionMode: "multiple" as const,
...
}`,...(gn=(hn=K.parameters)==null?void 0:hn.docs)==null?void 0:gn.source}}};var bn,wn,fn;G.parameters={...G.parameters,docs:{...(bn=G.parameters)==null?void 0:bn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
    onFocusedRowChanged: fn()
...
}`,...(fn=(wn=G.parameters)==null?void 0:wn.docs)==null?void 0:fn.source}}};var Cn,vn,xn;Y.parameters={...Y.parameters,docs:{...(Cn=Y.parameters)==null?void 0:Cn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
    enableOrdering: false,
...
}`,...(xn=(vn=Y.parameters)==null?void 0:vn.docs)==null?void 0:xn.source}}};var Tn,Bn,jn;J.parameters={...J.parameters,docs:{...(Tn=J.parameters)==null?void 0:Tn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns
  },
...
}`,...(jn=(Bn=J.parameters)==null?void 0:Bn.docs)==null?void 0:jn.source}}};var Sn,En,Dn;X.parameters={...X.parameters,docs:{...(Sn=X.parameters)==null?void 0:Sn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns
  },
...
}`,...(Dn=(En=X.parameters)==null?void 0:En.docs)==null?void 0:Dn.source}}};var Rn,kn,Nn;Z.parameters={...Z.parameters,docs:{...(Rn=Z.parameters)==null?void 0:Rn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns
  },
...
}`,...(Nn=(kn=Z.parameters)==null?void 0:kn.docs)==null?void 0:Nn.source}}};var On,In,An;Q.parameters={...Q.parameters,docs:{...(On=Q.parameters)==null?void 0:On.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
    rowHeight: 56
...
}`,...(An=(In=Q.parameters)==null?void 0:In.docs)==null?void 0:An.source}}};var Pn,Fn,Hn;ee.parameters={...ee.parameters,docs:{...(Pn=ee.parameters)==null?void 0:Pn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: [{
      locator: {
...
}`,...(Hn=(Fn=ee.parameters)==null?void 0:Fn.docs)==null?void 0:Hn.source}}};var Wn,Mn,Vn;ne.parameters={...ne.parameters,docs:{...(Wn=ne.parameters)==null?void 0:Wn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
...
}`,...(Vn=(Mn=ne.parameters)==null?void 0:Mn.docs)==null?void 0:Vn.source}}};var _n,zn,Ln;te.parameters={...te.parameters,docs:{...(_n=te.parameters)==null?void 0:_n.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: editableColumnDefinitions,
    editMode: "manual",
...
}`,...(Ln=(zn=te.parameters)==null?void 0:zn.docs)==null?void 0:Ln.source}}};var qn,$n,Un;ae.parameters={...ae.parameters,docs:{...(qn=ae.parameters)==null?void 0:qn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: [{
      locator: {
...
return (
  ...
  play: async ({
    ...
    // Restore the original value so the story ends showing "Ahmed Williams".
    await userEvent.click(nameInput);
    await userEvent.clear(nameInput);
    await userEvent.type(nameInput, "Ahmed Williams");
    await userEvent.tab();
    await waitFor(() => expect(canvas.getByDisplayValue("Ahmed Williams")).toBeInTheDocument());
  }
}`,...(Un=($n=ae.parameters)==null?void 0:$n.docs)==null?void 0:Un.source}}};var Kn,Gn,Yn;oe.parameters={...oe.parameters,docs:{...(Kn=oe.parameters)==null?void 0:Kn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: [{
      locator: {
...
}`,...(Yn=(Gn=oe.parameters)==null?void 0:Gn.docs)==null?void 0:Yn.source}}};var Jn,Xn,Zn;ie.parameters={...ie.parameters,docs:{...(Jn=ie.parameters)==null?void 0:Jn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: [{
      locator: {
...
}`,...(Zn=(Xn=ie.parameters)==null?void 0:Xn.docs)==null?void 0:Zn.source}}};var Qn,et,nt;re.parameters={...re.parameters,docs:{...(Qn=re.parameters)==null?void 0:Qn.docs,source:{originalSource:`{
  args: {
    objectType: Employee,
    columnDefinitions: defaultEmployeeColumns,
