import{j as t}from"./iframe-6_PdXmnj.js";import{E as g,B as s}from"./EmailViewer-BhCDL7Cr.js";import{w as u}from"./withOsdkMetrics-o_fK_wW6.js";import"./preload-helper-DTzdCamx.js";import"./index-Cm-uv-1g.js";import"./useMediaContents-B9ITRVvw.js";import"./spin-BipLxD-L.js";import"./svgIconContainer-BjOHCe48.js";import"./error-YhuEdGT6.js";import"./useRegisterUserAgent-DV2Gtsu0.js";const x=u(g,"EmailViewer"),w={subject:"Q3 Project Update - Action Items",from:{name:"Alice Johnson",address:"alice@example.com"},to:[{name:"Bob Smith",address:"bob@example.com"},{name:"Carol Davis",address:"carol@example.com"}],cc:[{name:"Dave Wilson",address:"dave@example.com"}],date:"2026-03-15T14:30:00Z",html:`
...
`;function v(e){return{fetchContents:()=>Promise.resolve(new Response(e)),fetchMetadata:()=>Promise.resolve({path:"email.eml",sizeBytes:e.length,mediaType:"message/rfc822"}),getMediaReference:()=>({mimeType:"message/rfc822",reference:{type:"mediaSetViewItem",mediaSetViewItem:{mediaItemRid:"ri.mio.main.media-item.mock-email",mediaSetRid:"ri.mio.main.media-set.mock-set",mediaSetViewRid:"ri.mio.main.media-set-view.mock-view"}}})}}const _={title:"Beta/DocumentViewer/Renderers/EmailViewer",component:s,args:{email:w},render:e=>t.jsx("div",{style:{height:"500px"},children:t.jsx(s,{...e})}),parameters:{controls:{expanded:!0}},argTypes:{email:{description:"Parsed email data",control:!1},className:{description:"Additional CSS class name for the root element",control:"text"}}},a={args:{media:v(M)},render:e=>t.jsx("div",{style:{height:"500px"},children:t.jsx(x,{...e})}),parameters:{docs:{source:{code:`import { EmailViewer } from "@osdk/react-components/experimental/email-viewer";
...
}`,...(h=(E=r.parameters)==null?void 0:E.docs)==null?void 0:h.source}}};const L=["Default","HtmlEmail","PlainTextEmail"];export{a as Default,i as HtmlEmail,r as PlainTextEmail,L as __namedExportsOrder,_ as default};
