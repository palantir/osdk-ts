import{j as t,h as i,H as V}from"./iframe-CKQO8Vx8.js";import{D as n}from"./document-viewer-6hsGo7iR.js";import{u as S,w as le}from"./SpreadsheetViewer-BizqOPq7.js";import{p as k}from"./passthrough-6sm3BHV7.js";import"./preload-helper-CwEBdSMT.js";import"./index-CdmnUnhF.js";import"./EmailViewer-D9SbQco2.js";import"./useMediaContents-CLLnzfvq.js";import"./spin-BQgLLRwK.js";import"./svgIconContainer-8H3QdML_.js";import"./error-BJLkldHu.js";import"./ImageViewer-CXDaa5CA.js";import"./BaseImageViewer-CaaOsFq_.js";import"./BaseTiffViewer-DnE8lqqy.js";import"./index-YkV0U4e7.js";import"./BaseMarkdownViewer-Dt8q0QnL.js";import"./PdfViewer-DCPtqHvZ.js";import"./BasePdfViewer-CTa6K6LU.js";import"./BasePdfViewer.module.css-CL9bTq-g.js";import"./PdfViewerAnnotationLayer-CPDjyMB4.js";import"./constants-DsXMS3N3.js";import"./usePdfDocument-uilYqCue.js";import"./PdfViewerOutlineSidebar-C2dADIMx.js";import"./PdfViewerSidebarHeader-BuBqcUy1.js";import"./useBaseUiId-q6qw1H5x.js";import"./useControlled-BG6xoYyK.js";import"./CompositeRoot-BlXx2j_R.js";import"./CompositeItem-DNmbzFT9.js";import"./ToolbarRootContext-C-XgkwmF.js";import"./composite-DUJXG-6e.js";import"./PdfViewerSearchBar-DWNCsD2e.js";import"./chevron-up-Ch1WKNmy.js";import"./chevron-down-Di9IPq2H.js";import"./cross-DO9NTRmS.js";import"./PdfViewerSidebar-6bkHD8Jr.js";import"./index-Bw61tY6z.js";import"./index-C6tRhyNC.js";import"./index-DyVj7mZ2.js";import"./PdfViewerToolbar-eh6mIR1v.js";import"./Button-C_uhqqdD.js";import"./chevron-right-BVMr4rER.js";import"./Input-DbZHyI8w.js";import"./search-DzGwW1te.js";import"./assertUnreachable-tCT10eXl.js";import"./VideoViewer-C9tntpYi.js";import"./XmlViewer-CeVobzav.js";import"./useOsdkClient-Dkk6CBBB.js";import"./withOsdkMetrics-CV_1aUYl.js";const de="/osdk-ts/storybook/pr-3925/1860778bb6004f0aeb6c48bc149df77304f5bfc8/compressed.tracemonkey-pldi-09.pdf",fe="/osdk-ts/storybook/pr-3925/1860778bb6004f0aeb6c48bc149df77304f5bfc8/example.mp4",ue="/osdk-ts/storybook/pr-3925/1860778bb6004f0aeb6c48bc149df77304f5bfc8/multi-page-tiff.tiff";function he(){const e=document.createElement("canvas");e.width=200,e.height=200;const r=e.getContext("2d"),o=r.createLinearGradient(0,0,200,200);o.addColorStop(0,"#3b82f6"),o.addColorStop(.5,"#8b5cf6"),o.addColorStop(1,"#ec4899"),r.fillStyle=o,r.fillRect(0,0,200,200),r.fillStyle="white",r.font="bold 24px sans-serif",r.textAlign="center",r.textBaseline="middle",r.fillText("Sample",100,90),r.fillText("Image",100,120);const m=e.toDataURL("image/png"),s=atob(m.split(",")[1]),D=new Uint8Array(s.length);for(let d=0;d<s.length;d++)D[d]=s.charCodeAt(d);return new Blob([D],{type:"image/png"})}const ce=`# Sample Document
...
- Item 2
- Item 3
`;function a(e,r,o){return{fetchContents:r,fetchMetadata:()=>Promise.resolve({path:o,sizeBytes:1024,mediaType:e}),getMediaReference:()=>({mimeType:e,reference:{type:"mediaSetViewItem",mediaSetViewItem:{mediaItemRid:"ri.mio.main.media-item.mock",mediaSetRid:"ri.mio.main.media-set.mock-set",mediaSetViewRid:"ri.mio.main.media-set-view.mock-view"}}})}}const we=he(),v=a("application/pdf",()=>fetch(de),"document.pdf"),ge=a("image/png",()=>Promise.resolve(new Response(we)),"photo.png"),xe=a("text/markdown",()=>Promise.resolve(new Response(ce)),"readme.md"),be=a("video/mp4",()=>fetch(fe),"example.mp4"),Me=`From: Alice <alice@example.com>
...
`,ye=a("message/rfc822",()=>Promise.resolve(new Response(Me)),"message.eml"),ke=`<?xml version="1.0"?>
<catalog>
  <book id="1">
...
<DocumentViewer media={project.readme} />`}}}},f={args:{media:be},render:e=>t.jsx("div",{style:{height:"400px",width:"600px"},children:t.jsx(n,{...e})}),parameters:{msw:{handlers:[i.get("*/example.mp4",()=>k())]},docs:{source:{code:`// video/* media renders with VideoViewer
...
<DocumentViewer media={myMedia} mimeTypeOverride="text/markdown" />`}}}},y={args:{media:v,pdfViewerProps:{initialSidebarOpen:!0,enableDownload:!0}},parameters:{docs:{source:{code:`<DocumentViewer
  media={myMedia}
  pdfViewerProps={{
...
}`,...(Z=(Y=x.parameters)==null?void 0:Y.docs)==null?void 0:Z.source}}};var ee,re,te;b.parameters={...b.parameters,docs:{...(ee=b.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  args: {
    media: mockTiffMedia,
...
}`,...(te=(re=b.parameters)==null?void 0:re.docs)==null?void 0:te.source}}};var oe,ae,ie;M.parameters={...M.parameters,docs:{...(oe=M.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  args: {
...
}`,...(ie=(ae=M.parameters)==null?void 0:ae.docs)==null?void 0:ie.source}}};var ne,se,me;y.parameters={...y.parameters,docs:{...(ne=y.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  args: {
    media: mockPdfMedia,
    pdfViewerProps: {
      initialSidebarOpen: true,
...
}`,...(me=(se=y.parameters)==null?void 0:se.docs)==null?void 0:me.source}}};const Sr=["Pdf","Image","Markdown","Video","UnsupportedType","Email","Spreadsheet","Xml","Tiff","TiffWithPdfConversion","WithMimeTypeOverride","WithPdfViewerProps"];export{h as Email,p as Image,l as Markdown,c as Pdf,w as Spreadsheet,x as Tiff,b as TiffWithPdfConversion,u as UnsupportedType,f as Video,M as WithMimeTypeOverride,y as WithPdfViewerProps,g as Xml,Sr as __namedExportsOrder,Vr as default};
