import{P as p}from"./PdfViewerSearchBar-B8z5cHMJ.js";import"./iframe-uWQw-aoo.js";import"./preload-helper-DVjylv8h.js";import"./chevron-up-CbGYwo0a.js";import"./svgIconContainer-DmbccLJt.js";import"./index-00plDTMi.js";import"./chevron-down-CbHcQ9sT.js";import"./cross-BoNTQ4Rv.js";const{fn:e}=__STORYBOOK_MODULE_TEST__,S={title:"Components/DocumentViewer/Renderers/PdfViewer/Building Blocks/SearchBar",component:p,tags:["beta"],args:{query:"",totalMatches:0,currentMatchIndex:0,onQueryChange:e(),onNext:e(),onPrev:e(),onClose:e()},argTypes:{query:{description:"Current search query text",control:"text"},totalMatches:{description:"Total number of matches found",control:{type:"number",min:0}},currentMatchIndex:{description:"Index of the currently highlighted match (0-indexed)",control:{type:"number",min:0}}}},r={parameters:{docs:{source:{code:`import { PdfViewerSearchBar } from "@osdk/react-components/experimental/pdf-viewer";
