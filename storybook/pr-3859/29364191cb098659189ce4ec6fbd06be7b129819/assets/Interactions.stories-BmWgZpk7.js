...
/>`}}},render:e=>n.jsxs("div",{className:"object-table-container",style:{height:"600px"},children:[n.jsx("div",{style:{padding:"12px"},children:"Right click on any cell"}),n.jsx(L,{...e})]}),play:async({canvasElement:e})=>{const l=R(e);await l.findByText(w),ne.contextMenu(l.getByText(w)),await i(await b.findByText("Cell Value:")).toBeInTheDocument(),await m.click(l.getByText("Right click on any cell")),await c(()=>i(b.queryByText("Cell Value:")).not.toBeInTheDocument())}},y={args:{objectType:N,columnDefinitions:z,selectionMode:"multiple",selectedRows:[],orderBy:[{property:"fullName",direction:"asc"}],onRowClick:s(),onColumnHeaderClick:s(),onRowSelectionChanged:s(),onOrderByChanged:s(),onColumnVisibilityChanged:s(),onColumnsPinnedChanged:s(),onColumnResize:s(),onFocusedRowChanged:s(),onLoadedObjectsChanged:s()},parameters:{docs:{source:{code:`<ObjectTable
  objectType={Employee}
