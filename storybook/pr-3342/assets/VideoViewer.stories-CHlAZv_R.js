import{h as l,j as t}from"./iframe-DuVqCQ9Y.js";import{w as f}from"./withOsdkMetrics-D9ycNzlj.js";import{V as w}from"./VideoViewer-DR4NGFaS.js";import{p as h}from"./passthrough-6sm3BHV7.js";import"./preload-helper-Dp1pzeXC.js";import"./useRegisterUserAgent-DtBi-D8g.js";import"./index-DUsGWmvk.js";import"./useMediaContents-Bb53VyN1.js";import"./spin-DIKOrqY9.js";import"./svgIconContainer-CpDyVwKR.js";import"./error-glRmYmUa.js";const o=f(w,"VideoViewer"),{fn:V}=__STORYBOOK_MODULE_TEST__,v="./example.mp4";function k(e,p){return{fetchContents:()=>fetch(e),fetchMetadata:()=>Promise.resolve({path:p,sizeBytes:0,mediaType:"video/mp4"}),getMediaReference:()=>({mimeType:"video/mp4",reference:{type:"mediaSetViewItem",mediaSetViewItem:{mediaItemRid:"ri.mio.main.media-item.mock-video",mediaSetRid:"ri.mio.main.media-set.mock-set",mediaSetViewRid:"ri.mio.main.media-set-view.mock-view"}}})}}const S=k(v,"example.mp4"),b={title:"Beta/DocumentViewer/Renderers/VideoViewer",component:o,args:{media:S},render:e=>t.jsx("div",{style:{height:"400px",width:"600px"},children:t.jsx(o,{media:e.media,onError:e.onError})}),parameters:{controls:{expanded:!0},msw:{handlers:[l.get("*/example.mp4",()=>h())]}},argTypes:{media:{description:"The OSDK Media object to fetch video from",control:!1},className:{description:"Additional CSS class name for the root element",control:"text"},onError:{description:"Callback when the video fails to load",control:!1,table:{category:"Events"}}}},i={parameters:{docs:{source:{code:`import { VideoViewer } from "@osdk/react-components/experimental/video-viewer";
