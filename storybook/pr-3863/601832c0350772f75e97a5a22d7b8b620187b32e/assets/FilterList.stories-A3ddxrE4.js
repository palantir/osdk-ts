...
<FilterList
  ...
  filterDefinitions={filterDefinitions}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(Cn,{...t})};function En(t){const[n,i]=o.useState(void 0),[r,a]=o.useState(h),c=t.onFilterRemoved,d=o.useCallback(C=>{a(F=>F.filter(ae=>"key"in ae?ae.key!==C:!0)),c==null||c(C)},[c]),u=t.onReset,y=o.useCallback(()=>{a(h),u==null||u()},[u]),m=t.onFilterClauseChanged,f=o.useCallback(C=>{i(C),m==null||m(C)},[m]);return e.jsxs("div",{style:qt,children:[e.jsx("div",{style:Jt,children:e.jsx(s,{objectType:l,filterDefinitions:r,titleIcon:zt,...t,onReset:y,onFilterRemoved:d,onFilterClauseChanged:f})}),e.jsx("div",{style:E,children:e.jsx(Ht,{objectType:l,filter:n})})]})}const J={name:"Full Featured",args:{title:"Employee Filters",showResetButton:!0,showActiveFilterCount:!0,enableSorting:!0},parameters:{docs:{description:{story:"Demonstrates all filter list features together: collapse, reset, active count, sorting, removable filters, per-filter search, exclude toggle, and the emitted where clause driving an ObjectTable."},source:{code:`// All features combined: collapse, sort, search, exclude, remove, reset
...
<FilterList
  ...
  enableSorting={true}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(En,{...t})};function bn(t){const n=ie(),i=o.useMemo(()=>n(l),[n]),[r,a]=o.useState(void 0),c=o.useMemo(()=>[{type:"HAS_LINK",linkName:"lead",label:"Has Manager",filterState:{type:"hasLink",hasLink:!1}},{type:"LINKED_PROPERTY",linkName:"lead",reverseLinkName:"peeps",linkedPropertyKey:"department",linkedFilterComponent:"MULTI_SELECT",linkedFilterState:{type:"SELECT",selectedValues:[]},filterState:{type:"linkedProperty",linkedFilterState:{type:"SELECT",selectedValues:[]}},label:"Manager Department"}],[]),d=t.onFilterClauseChanged,u=o.useCallback(y=>{a(y),d==null||d(y)},[d]);return e.jsxs("div",{style:S,children:[e.jsx("div",{style:p,children:e.jsx(s,{objectType:l,objectSet:i,filterDefinitions:c,...t,onFilterClauseChanged:u})}),e.jsxs("div",{style:E,children:[e.jsx("strong",{children:"Filter Clause (JSON):"}),e.jsx("p",{children:"Note: LINKED_PROPERTY filter is not applied through where clause"}),e.jsx("pre",{style:g,children:r?JSON.stringify(r,null,2):"(no active filters)"})]})]})}const z={name:"Linked Property Filters",parameters:{docs:{description:{story:"Demonstrates filtering on properties of linked objects. HAS_LINK filters objects based on whether they have a linked object. LINKED_PROPERTY filters on a property of the linked object and exposes the same overflow (…) controls as direct property filters — the inline Keeping/Excluding dropdown and Clear all."},source:{code:`// HAS_LINK and LINKED_PROPERTY filter definitions
const filterDefinitions = [
  {
    type: "HAS_LINK",
    linkName: "lead",
...
}`,...(Te=(fe=M.parameters)==null?void 0:fe.docs)==null?void 0:Te.source}}};var he,Se,Ce;j.parameters={...j.parameters,docs:{...(he=j.parameters)==null?void 0:he.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(Ce=(Se=j.parameters)==null?void 0:Se.docs)==null?void 0:Ce.source}}};var Ee,be,ge;k.parameters={...k.parameters,docs:{...(Ee=k.parameters)==null?void 0:Ee.docs,source:{originalSource:`{
  args: {
    showResetButton: true
  },
  parameters: {
...
}`,...(Tt=(ft=K.parameters)==null?void 0:ft.docs)==null?void 0:Tt.source}}};var ht,St,Ct;q.parameters={...q.parameters,docs:{...(ht=q.parameters)==null?void 0:ht.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(Ct=(St=q.parameters)==null?void 0:St.docs)==null?void 0:Ct.source}}};var Et,bt,gt;J.parameters={...J.parameters,docs:{...(Et=J.parameters)==null?void 0:Et.docs,source:{originalSource:`{
  name: "Full Featured",
  args: {
    title: "Employee Filters",
    showResetButton: true,
