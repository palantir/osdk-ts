import{j as a,h as B}from"./iframe-CTWtvW7G.js";import{E as A,B as p,u as o,w as V}from"./ExcelViewer-DpoMvnvm.js";import{w as T}from"./withOsdkMetrics-B9XS-cmH.js";import{p as $}from"./passthrough-6sm3BHV7.js";import"./preload-helper-1oxodiua.js";import"./index-B5ZJn9Gm.js";import"./useMediaContents-BikMVlZy.js";import"./error-C-PnV0Ll.js";import"./svgIconContainer-BmXJ4UZQ.js";import"./spin-0T8XHhxE.js";const b=T(A,"ExcelViewer"),d={sheets:[{name:"Employees",rows:[["Name","Department","Title","Start Date","Salary"],["Alice Johnson","Engineering","Senior Engineer","2022-03-15","$145,000"],["Bob Smith","Marketing","Marketing Manager","2021-07-01","$120,000"],["Carol Davis","Engineering","Staff Engineer","2020-01-10","$165,000"],["Dave Wilson","Sales","Account Executive","2023-05-20","$95,000"],["Eve Brown","Engineering","Junior Engineer","2024-01-08","$90,000"]]},{name:"Departments",rows:[["Department","Head Count","Budget"],["Engineering","3","$400,000"],["Marketing","1","$120,000"],["Sales","1","$95,000"]]},{name:"Summary",rows:[["Metric","Value"],["Total Employees","5"],["Total Budget","$615,000"],["Average Salary","$123,000"]]}]},C="/osdk-ts/storybook/pr-3680/26581e34c61e34d92847106023944c2b4d8b772d/notional-excel-example.xlsx";function D(e,r){const t="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";return{fetchContents:()=>fetch(e),fetchMetadata:()=>Promise.resolve({path:r,sizeBytes:0,mediaType:t}),getMediaReference:()=>({mimeType:t,reference:{type:"mediaSetViewItem",mediaSetViewItem:{mediaItemRid:"ri.mio.main.media-item.mock-excel-file",mediaSetRid:"ri.mio.main.media-set.mock-set",mediaSetViewRid:"ri.mio.main.media-set-view.mock-view"}}})}}function P(){const e=o.book_new();for(const t of d.sheets){const s=o.aoa_to_sheet(t.rows);o.book_append_sheet(e,s,t.name)}const r=V(e,{type:"array",bookType:"xlsx"});return{fetchContents:()=>Promise.resolve(new Response(r,{headers:{"Content-Type":"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}})),fetchMetadata:()=>Promise.resolve({path:"report.xlsx",sizeBytes:r.byteLength,mediaType:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}),getMediaReference:()=>({mimeType:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",reference:{type:"mediaSetViewItem",mediaSetViewItem:{mediaItemRid:"ri.mio.main.media-item.mock-excel",mediaSetRid:"ri.mio.main.media-set.mock-set",mediaSetViewRid:"ri.mio.main.media-set-view.mock-view"}}})}}function R(e){const r=o.book_new();for(const l of e.sheets){const _=o.aoa_to_sheet(l.rows);o.book_append_sheet(r,_,l.name)}const t=V(r,{type:"array",bookType:"xlsx"}),s=t instanceof Uint8Array?t:new Uint8Array(t);return s.buffer.slice(s.byteOffset,s.byteOffset+s.byteLength)}const J={title:"Components/DocumentViewer/Renderers/ExcelViewer",component:p,tags:["beta"],args:{content:R(d)},render:e=>a.jsx("div",{style:{height:"500px"},children:a.jsx(p,{...e})}),parameters:{controls:{expanded:!0}},argTypes:{content:{description:"Raw .xlsx bytes to parse and display",control:!1},className:{description:"Additional CSS class name for the root element",control:"text"}}},n={args:{media:P()},render:e=>a.jsx("div",{style:{height:"500px"},children:a.jsx(b,{media:e.media})}),parameters:{docs:{source:{code:`import { ExcelViewer } from "@osdk/react-components/experimental/excel-viewer";
...
<BaseExcelViewer content={xlsxBytes} />`}}}},m={args:{content:R({sheets:[d.sheets[0]]})}},c={args:{media:D(C,"notional-excel-example.xlsx")},render:e=>a.jsx("div",{style:{height:"600px"},children:a.jsx(b,{media:e.media})}),parameters:{msw:{handlers:[B.get("*/notional-excel-example.xlsx",()=>$())]}}};var x,h,f;n.parameters={...n.parameters,docs:{...(x=n.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
...
}`,...(f=(h=n.parameters)==null?void 0:h.docs)==null?void 0:f.source}}};var w,g,u;i.parameters={...i.parameters,docs:{...(w=i.parameters)==null?void 0:w.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
