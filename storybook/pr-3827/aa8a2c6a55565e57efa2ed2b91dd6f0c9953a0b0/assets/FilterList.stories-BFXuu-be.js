...
/>`}}},render:({objectType:t,objectSet:n,...i})=>{const r=o.useMemo(()=>[R,A],[]);return e.jsx("div",{style:d,children:e.jsx(s,{objectType:a,filterDefinitions:r,...i})})}},j={parameters:{docs:{description:{story:"Repro for the integer-typed `NUMBER_RANGE` rounding fix. `employeeNumber` is an `integer` property, so histogram bucket boundaries — `(maxValue - minValue) / 20` — are usually fractional. Click any bar in the histogram. The Min/Max boxes must show whole integers (e.g. `657495073`), not fractional values (e.g. `657495073.4`)."},source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={[
    {
      type: "PROPERTY",
...
/>`}}},render:t=>e.jsx(Zt,{...t})},w={args:{title:"Employee Filters"},parameters:{docs:{source:{code:`<FilterList
  ...
  titleIcon={<svg>...</svg>}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:d,children:e.jsx(s,{objectType:a,filterDefinitions:E,titleIcon:Kt,...i})})};function en(t){const n=t.onReset,i=o.useCallback(()=>{console.log("Reset clicked"),n==null||n()},[n]);return e.jsx("div",{style:d,children:e.jsx(s,{objectType:a,filterDefinitions:E,...t,onReset:i})})}const P={args:{showResetButton:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  showResetButton={true}
...
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:d,children:e.jsx(s,{objectType:a,filterDefinitions:E,...i})})},I={args:{enableSorting:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  enableSorting={true}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:d,children:e.jsx(s,{objectType:a,filterDefinitions:E,...i})})};function tn(t){return e.jsx("div",{style:d,children:e.jsx(s,{objectType:a,filterDefinitions:E,...t})})}const N={args:{title:"Employee Filters",showActiveFilterCount:!0},parameters:{docs:{description:{story:"Click the collapse button to minimize the filter panel. Active filter count is shown in the collapsed state."},source:{code:`const [collapsed, setCollapsed] = useState(false);
...
<FilterList
  ...
  filterDefinitions={filterDefinitions}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(fn,{...t})};function Tn(t){const[n,i]=o.useState(void 0),[r,l]=o.useState(E),c=t.onFilterRemoved,p=o.useCallback(h=>{l(M=>M.filter(le=>"key"in le?le.key!==h:!0)),c==null||c(h)},[c]),u=t.onReset,y=o.useCallback(()=>{l(E),u==null||u()},[u]),m=t.onFilterClauseChanged,f=o.useCallback(h=>{i(h),m==null||m(h)},[m]);return e.jsxs("div",{style:Ut,children:[e.jsx("div",{style:Xt,children:e.jsx(s,{objectType:a,filterDefinitions:r,titleIcon:Kt,...t,onReset:y,onFilterRemoved:p,onFilterClauseChanged:f})}),e.jsx("div",{style:S,children:e.jsx(Bt,{objectType:a,filter:n})})]})}const J={name:"Full Featured",args:{title:"Employee Filters",showResetButton:!0,showActiveFilterCount:!0,enableSorting:!0},parameters:{docs:{description:{story:"Demonstrates all filter list features together: collapse, reset, active count, sorting, removable filters, per-filter search, exclude toggle, and the emitted where clause driving an ObjectTable."},source:{code:`// All features combined: collapse, sort, search, exclude, remove, reset
...
<FilterList
  ...
  enableSorting={true}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>{const[,n]=Yt(),i=t.onCollapsedChange,r=o.useCallback(l=>{n({collapsed:l}),i==null||i(l)},[n,i]);return e.jsx(Tn,{...t,onCollapsedChange:r})}};function Cn(t){const n=ne(),i=o.useMemo(()=>n(a),[n]),[r,l]=o.useState(void 0),c=o.useMemo(()=>[{type:"HAS_LINK",linkName:"lead",label:"Has Manager",filterState:{type:"hasLink",hasLink:!1}},{type:"LINKED_PROPERTY",linkName:"lead",reverseLinkName:"peeps",linkedPropertyKey:"department",filterComponent:"MULTI_SELECT",filterState:{type:"SELECT",selectedValues:[]},label:"Manager Department"}],[]),p=t.onFilterClauseChanged,u=o.useCallback(y=>{l(y),p==null||p(y)},[p]);return e.jsxs("div",{style:C,children:[e.jsx("div",{style:d,children:e.jsx(s,{objectType:a,objectSet:i,filterDefinitions:c,...t,onFilterClauseChanged:u})}),e.jsxs("div",{style:S,children:[e.jsx("strong",{children:"Filter Clause (JSON):"}),e.jsx("p",{children:"Note: LINKED_PROPERTY filter is not applied through where clause"}),e.jsx("pre",{style:g,children:r?JSON.stringify(r,null,2):"(no active filters)"})]})]})}const q={name:"Linked Property Filters",parameters:{docs:{description:{story:"Demonstrates filtering on properties of linked objects. HAS_LINK filters objects based on whether they have a linked object. LINKED_PROPERTY filters on a property of the linked object and exposes the same overflow (…) controls as direct property filters — the inline Keeping/Excluding dropdown and Clear all."},source:{code:`// HAS_LINK and LINKED_PROPERTY filter definitions
const filterDefinitions = [
  {
    type: "HAS_LINK",
    linkName: "lead",
...
<FilterList
  ...
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(Ln,{...t})},An={type:"PROPERTY",id:"department-multi",key:"department",label:"Department",filterComponent:"MULTI_SELECT",filterState:{type:"SELECT",selectedValues:[]}},Mn={type:"PROPERTY",id:"department-single",key:"department",label:"Department (single)",filterComponent:"SINGLE_SELECT",filterState:{type:"SELECT",selectedValues:[]}},Dn=[R,An,Mn,ie],Q={name:"No value rendering",parameters:{docs:{description:{story:"Empty/null filter values render via the canonical `<NoValueLabel />` component — italic, muted, with the literal text 'No value' — across listogram buckets, single-select dropdown options, multi-select dropdown options, and multi-select chips. The mock dataset includes one Employee with `department: \"\"` so the No value row is visible in the listogram."},source:{code:`// Empty/null values render via <NoValueLabel /> across every filter type.
<FilterList
  objectType={Employee}
  filterDefinitions={[
    {
...
/>`}}},render:()=>e.jsx("div",{style:d,children:e.jsx(s,{objectType:a,filterDefinitions:Dn})})},jn={type:"PROPERTY",id:"locationCity-single",key:"locationCity",label:"Location City (single)",filterComponent:"SINGLE_SELECT",filterState:{type:"SELECT",selectedValues:[]}},Fn={type:"LINKED_PROPERTY",linkName:"lead",reverseLinkName:"peeps",linkedPropertyKey:"department",filterComponent:"MULTI_SELECT",filterState:{type:"SELECT",selectedValues:[]},label:"Manager Department (linked multi)"},kn={type:"LINKED_PROPERTY",linkName:"lead",reverseLinkName:"peeps",linkedPropertyKey:"locationCity",filterComponent:"SINGLE_SELECT",filterState:{type:"SELECT",selectedValues:[]},label:"Manager City (linked single)"},On=new Map([["department",{type:"EXACT_MATCH",values:["Marketing","Research"]}],["jobTitle-multi",{type:"SELECT",selectedValues:["Marketing Manager","Chief Scientist"]}],["locationCity-single",{type:"SELECT",selectedValues:["Berlin"]}],["linkedProperty:lead:department",{type:"linkedProperty",linkedFilterState:{type:"SELECT",selectedValues:["Marketing","Research"]}}],["linkedProperty:lead:locationCity",{type:"linkedProperty",linkedFilterState:{type:"SELECT",selectedValues:["Berlin"]}}]]),wn=[R,oe,jn,Fn,kn];function Pn(t){const n=ne(),i=o.useMemo(()=>n(a),[n]),[r,l]=o.useState(void 0),c=o.useCallback(p=>{l(p)},[]);return e.jsxs("div",{style:C,children:[e.jsx("div",{style:d,children:e.jsx(s,{...t,objectType:a,objectSet:i,filterDefinitions:wn,initialFilterStates:On,onFilterClauseChanged:c})}),e.jsxs("div",{style:S,children:[e.jsx("h4",{children:"Active where clause"}),e.jsx("pre",{style:g,children:r?JSON.stringify(r,null,2):"(none)"})]})]})}const Z={name:"With initial filter states",parameters:{docs:{description:{story:"Pass `initialFilterStates` to hydrate filters from saved state (e.g. localStorage or URL params). Selections are restored on mount, including values that currently have zero matching rows — they appear with a count of 0 so users can see and clear them. Demonstrated across LISTOGRAM, MULTI_SELECT, SINGLE_SELECT, and LINKED_PROPERTY filters."},source:{code:`// "Research", "Chief Scientist", and "Berlin" are not in the current
...
<FilterList
  ...
  initialFilterStates={savedStates}
  showResetButton={true}
/>`}}},render:t=>e.jsx(Nn,{...t})};var pe,de,ue;D.parameters={...D.parameters,docs:{...(pe=D.parameters)==null?void 0:pe.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`<FilterList
...
}`,...(ue=(de=D.parameters)==null?void 0:de.docs)==null?void 0:ue.source}}};var me,ye,fe;j.parameters={...j.parameters,docs:{...(me=j.parameters)==null?void 0:me.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(fe=(ye=j.parameters)==null?void 0:ye.docs)==null?void 0:fe.source}}};var Te,Ce,he;F.parameters={...F.parameters,docs:{...(Te=F.parameters)==null?void 0:Te.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(he=(Ce=F.parameters)==null?void 0:Ce.docs)==null?void 0:he.source}}};var Ee,Se,be;k.parameters={...k.parameters,docs:{...(Ee=k.parameters)==null?void 0:Ee.docs,source:{originalSource:`{
  args: {
    showResetButton: true
  },
  parameters: {
...
}`,...(Me=(Ae=w.parameters)==null?void 0:Ae.docs)==null?void 0:Me.source}}};var De,je,Fe;P.parameters={...P.parameters,docs:{...(De=P.parameters)==null?void 0:De.docs,source:{originalSource:`{
  args: {
    showResetButton: true
  },
  parameters: {
...
}`,...(Fe=(je=P.parameters)==null?void 0:je.docs)==null?void 0:Fe.source}}};var ke,Oe,we;_.parameters={..._.parameters,docs:{...(ke=_.parameters)==null?void 0:ke.docs,source:{originalSource:`{
  args: {
    showActiveFilterCount: true
  },
  parameters: {
...
}`,...(Mt=(At=$.parameters)==null?void 0:At.docs)==null?void 0:Mt.source}}};var Dt,jt,Ft;Q.parameters={...Q.parameters,docs:{...(Dt=Q.parameters)==null?void 0:Dt.docs,source:{originalSource:`{
...
}`,...(Ft=(jt=Q.parameters)==null?void 0:jt.docs)==null?void 0:Ft.source}}};var kt,Ot,wt;Z.parameters={...Z.parameters,docs:{...(kt=Z.parameters)==null?void 0:kt.docs,source:{originalSource:`{
...
}`,...(Vt=(xt=te.parameters)==null?void 0:xt.docs)==null?void 0:Vt.source}}};const xi=["Default","IntegerNumberRangeRounding","WithObjectSet","AddFilterMode","WithAllFilterTypes","WithTitleAndIcon","WithResetButton","WithActiveFilterCount","WithSorting","CollapsiblePanel","KeywordSearch","WithColorMap","WithRenderValue","WithRenderValueAsReactNode","WithListogramDisplayModes","WithHiddenCounts","WithCheckbox","WithBelowFoldSelection","WithRemovableFilters","WithStaticValues","FullFeatured","WithLinkedPropertyFilters","CombinedWithObjectTable","WithCustomFilters","NoValueRendering","WithInitialFilterStates","WithResetButtonEmptyInitial","WithResetButtonNonEmptyInitial"];export{k as AddFilterMode,N as CollapsiblePanel,z as CombinedWithObjectTable,D as Default,J as FullFeatured,j as IntegerNumberRangeRounding,x as KeywordSearch,Q as NoValueRendering,_ as WithActiveFilterCount,O as WithAllFilterTypes,U as WithBelowFoldSelection,H as WithCheckbox,V as WithColorMap,$ as WithCustomFilters,W as WithHiddenCounts,Z as WithInitialFilterStates,q as WithLinkedPropertyFilters,G as WithListogramDisplayModes,F as WithObjectSet,X as WithRemovableFilters,B as WithRenderValue,Y as WithRenderValueAsReactNode,P as WithResetButton,ee as WithResetButtonEmptyInitial,te as WithResetButtonNonEmptyInitial,I as WithSorting,K as WithStaticValues,w as WithTitleAndIcon,xi as __namedExportsOrder,Ni as default};
