...
/>`}}},render:({objectType:t,objectSet:n,...i})=>{const r=l.useMemo(()=>[R,L],[]);return e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:r,...i})})}},D={parameters:{docs:{description:{story:"Repro for the integer-typed `NUMBER_RANGE` rounding fix. `employeeNumber` is an `integer` property, so histogram bucket boundaries — `(maxValue - minValue) / 20` — are usually fractional. Click any bar in the histogram. The Min/Max boxes must show whole integers (e.g. `657495073`), not fractional values (e.g. `657495073.4`)."},source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={[
    {
      type: "PROPERTY",
...
/>`}}},render:t=>e.jsx($t,{...t})};function Qt(t){const n=l.useMemo(()=>[R,re,{...Wt,isVisible:!1},{...Ht,isVisible:!1},{...ie,isVisible:!1},{...L,isVisible:!1}],[]);return e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:n,addFilterMode:"uncontrolled",...t})})}const k={args:{showResetButton:!0},parameters:{docs:{source:{code:`const filterDefinitions = [
  { type: "PROPERTY", key: "department", label: "Department", filterComponent: "LISTOGRAM", defaultFilterState: { type: "EXACT_MATCH", values: [] } },
  { type: "PROPERTY", key: "team", label: "Team", filterComponent: "LISTOGRAM", defaultFilterState: { type: "EXACT_MATCH", values: [] } },
...
/>`}}},render:t=>e.jsx(Qt,{...t})};function Zt(t){const[n,i]=l.useState(void 0),r=t.onFilterClauseChanged,o=l.useCallback(s=>{i(s),r==null||r(s)},[r]);return e.jsxs("div",{style:T,children:[e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:E,...t,filterClause:n,onFilterClauseChanged:o})}),e.jsxs("div",{style:S,children:[e.jsx("strong",{children:"Filter Clause (JSON):"}),e.jsx("pre",{style:g,children:n?JSON.stringify(n,null,2):"(no active filters)"})]})]})}const O={parameters:{docs:{description:{story:"All filter component types with a controlled where clause. Hover filter items to reveal search and exclude actions."},source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
...
/>`}}},render:t=>e.jsx(Zt,{...t})},w={args:{title:"Employee Filters"},parameters:{docs:{source:{code:`<FilterList
  ...
  titleIcon={<svg>...</svg>}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:E,titleIcon:Kt,...i})})};function en(t){const n=t.onReset,i=l.useCallback(()=>{console.log("Reset clicked"),n==null||n()},[n]);return e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:E,...t,onReset:i})})}const P={args:{showResetButton:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  showResetButton={true}
...
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:E,...i})})},I={args:{enableSorting:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  enableSorting={true}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:E,...i})})};function tn(t){return e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:E,...t})})}const N={args:{title:"Employee Filters",showActiveFilterCount:!0},parameters:{docs:{description:{story:"Click the collapse button to minimize the filter panel. Active filter count is shown in the collapsed state."},source:{code:`const [collapsed, setCollapsed] = useState(false);
...
<FilterList
  ...
  showActiveFilterCount={true}
/>`}}},render:t=>{const[,n]=Yt(),i=t.onCollapsedChange,r=l.useCallback(o=>{n({collapsed:o}),i==null||i(o)},[n,i]);return e.jsx(tn,{...t,onCollapsedChange:r})}},x={parameters:{docs:{source:{code:`const filterDefinitions = [
  { type: "KEYWORD_SEARCH", properties: ["fullName", "department", "jobTitle", "locationCity"], label: "Search" },
  { type: "PROPERTY", key: "department", label: "Department", filterComponent: "LISTOGRAM", defaultFilterState: { type: "EXACT_MATCH", values: [] } },
  { type: "PROPERTY", key: "locationCity", label: "Location City", filterComponent: "LISTOGRAM", defaultFilterState: { type: "EXACT_MATCH", values: [] } },
];

<FilterList objectType={Employee} filterDefinitions={filterDefinitions} />`}}},render:({objectType:t,objectSet:n,...i})=>{const r=l.useMemo(()=>[{type:"KEYWORD_SEARCH",properties:["fullName","department","jobTitle","locationCity"],label:"Search"},R,L],[]);return e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:r,...i})})}};function nn(t){const n=l.useMemo(()=>[{type:"PROPERTY",id:"department-no-color",key:"department",label:"Department (default colors)",filterComponent:"LISTOGRAM",defaultFilterState:{type:"EXACT_MATCH",values:[]}}],[]),i=l.useMemo(()=>[{type:"PROPERTY",id:"department-color",key:"department",label:"Department (custom colors)",filterComponent:"LISTOGRAM",defaultFilterState:{type:"EXACT_MATCH",values:[]},colorMap:{Marketing:"#e74c3c",Operations:"#2ecc71",Finance:"#3498db",Product:"#f39c12"}}],[]);return e.jsxs("div",{style:T,children:[e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:n,...t})}),e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:i,...t})})]})}const V={parameters:{docs:{source:{code:`// Without colorMap: all bars use the default theme color
...
<FilterList objectType={Employee} filterDefinitions={filterDefinitions} />`}}},render:t=>e.jsx(nn,{...t})},qt={Marketing:"Marketing Dept.",Operations:"Ops Team",Finance:"Finance & Accounting",Product:"Product Group"};function rn(t){const n=l.useMemo(()=>[{type:"PROPERTY",id:"department-default",key:"department",label:"Department (default)",filterComponent:"LISTOGRAM",defaultFilterState:{type:"EXACT_MATCH",values:[]}}],[]),i=l.useMemo(()=>[{type:"PROPERTY",id:"department-custom",key:"department",label:"Department (custom render)",filterComponent:"LISTOGRAM",defaultFilterState:{type:"EXACT_MATCH",values:[]},renderValue:r=>qt[r]??r},{type:"PROPERTY",id:"team-custom",key:"team",label:"Team (custom render)",filterComponent:"MULTI_SELECT",defaultFilterState:{type:"SELECT",selectedValues:[]},renderValue:r=>r.toUpperCase()}],[]);return e.jsxs("div",{style:T,children:[e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:n,...t})}),e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:i,...t})})]})}const B={parameters:{docs:{description:{story:"Use `renderValue` to customize how filter values are displayed and searched. The returned string replaces the raw value for display and search matching. Works with LISTOGRAM, MULTI_SELECT, and SINGLE_SELECT components."},source:{code:`const DEPARTMENT_LABELS = {
...
<FilterList objectType={Employee} filterDefinitions={filterDefinitions} />`}}},render:t=>e.jsx(cn,{...t})};function dn(t){const n=l.useMemo(()=>[{type:"PROPERTY",id:"dept-full",key:"department",label:"full: label + bar + count",filterComponent:"LISTOGRAM",defaultFilterState:{type:"EXACT_MATCH",values:[]},listogramConfig:{displayMode:"full"}}],[]),i=l.useMemo(()=>[{type:"PROPERTY",id:"dept-count",key:"department",label:"count: label + count (no bar)",filterComponent:"LISTOGRAM",defaultFilterState:{type:"EXACT_MATCH",values:[]},listogramConfig:{displayMode:"count"}}],[]),r=l.useMemo(()=>[{type:"PROPERTY",id:"dept-minimal",key:"department",label:"minimal: label only",filterComponent:"LISTOGRAM",defaultFilterState:{type:"EXACT_MATCH",values:[]},listogramConfig:{displayMode:"minimal"}}],[]);return e.jsxs("div",{style:T,children:[e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:n,...t})}),e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:i,...t})}),e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:r,...t})})]})}const G={parameters:{docs:{source:{code:`// listogramConfig.displayMode controls what each bucket row renders:
...
<div style={{ display: "flex", gap: 16 }}>
  ...
  />
</div>`}}},render:t=>e.jsx(dn,{...t})};function pn(t){const n=l.useMemo(()=>[{type:"PROPERTY",id:"dept-with-count",key:"department",label:"Department (counts visible)",filterComponent:"LISTOGRAM",defaultFilterState:{type:"EXACT_MATCH",values:[]}},{type:"PROPERTY",id:"team-with-count",key:"team",label:"Team (counts visible)",filterComponent:"MULTI_SELECT",defaultFilterState:{type:"SELECT",selectedValues:[]}}],[]),i=l.useMemo(()=>[{type:"PROPERTY",id:"dept-no-count",key:"department",label:"Department (counts hidden)",filterComponent:"LISTOGRAM",defaultFilterState:{type:"EXACT_MATCH",values:[]},showCount:!1},{type:"PROPERTY",id:"team-no-count",key:"team",label:"Team (counts hidden)",filterComponent:"MULTI_SELECT",defaultFilterState:{type:"SELECT",selectedValues:[]},showCount:!1}],[]);return e.jsxs("div",{style:T,children:[e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:n,...t})}),e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:i,...t})})]})}const W={parameters:{docs:{description:{story:"Use `showCount: false` on individual filter definitions to hide aggregation counts in LISTOGRAM and MULTI_SELECT inputs. Bar visualizations in LISTOGRAM are preserved."},source:{code:`// showCount defaults to true; set false to hide counts per filter
const filterDefinitions = [
  { ..., filterComponent: "LISTOGRAM", showCount: false },
  { ..., filterComponent: "MULTI_SELECT", showCount: false },
];

<FilterList objectType={Employee} filterDefinitions={filterDefinitions} />`}}},render:t=>e.jsx(pn,{...t})};function un(t){const n=l.useMemo(()=>[{type:"PROPERTY",id:"department-checkbox",key:"department",label:"Department",filterComponent:"LISTOGRAM",defaultFilterState:{type:"EXACT_MATCH",values:[]}},{type:"PROPERTY",id:"team-checkbox",key:"team",label:"Team",filterComponent:"LISTOGRAM",defaultFilterState:{type:"EXACT_MATCH",values:[]}}],[]);return e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:n,...t})})}const H={parameters:{docs:{description:{story:"Listogram rows always include a checkbox for multi-select. Selecting values checks the checkbox and highlights the row. Use the exclude toggle (three-dot menu) to invert selections."},source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={[
    { type: "PROPERTY", key: "department", label: "Department", filterComponent: "LISTOGRAM", defaultFilterState: { type: "EXACT_MATCH", values: [] } },
    { type: "PROPERTY", key: "team", label: "Team", filterComponent: "LISTOGRAM", defaultFilterState: { type: "EXACT_MATCH", values: [] } },
  ]}
/>`}}},render:t=>e.jsx(un,{...t}),play:async({canvasElement:t})=>{const n=Gt(t),i=["Engineering","Marketing","Design","Data","Finance"],r=()=>n.getAllByRole("button",{name:/^(Engineering|Marketing|Design|Data|Finance)\s+\d+/u}).map(o=>{const s=i.find(p=>{var c;return(c=o.textContent)==null?void 0:c.includes(p)});if(s==null)throw new Error(`Unable to identify department row from "${o.textContent}"`);return s});await n.findByRole("button",{name:"Marketing 4"}),await C(r()).toEqual(i),await v.click(n.getByRole("button",{name:"Marketing 4"})),await F(()=>C(n.getByRole("button",{name:"Marketing 4"})).toHaveAttribute("aria-pressed","true")),await C(r()).toEqual(i),await v.click(n.getByRole("button",{name:"Marketing 4"})),await F(()=>C(n.getByRole("button",{name:"Marketing 4"})).toHaveAttribute("aria-pressed","false")),await C(r()).toEqual(i)}};function mn(t){const n=l.useMemo(()=>[{type:"PROPERTY",id:"department-below-fold",key:"department",label:"Department",filterComponent:"LISTOGRAM",defaultFilterState:{type:"EXACT_MATCH",values:["Sales"]}}],[]);return e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:n,...t})})}const U={parameters:{docs:{description:{story:'A selected value that sorts below the collapsed fold stays visible, appended at the tail of the collapsed view rather than hoisted to the top. The "View all" toggle reveals the rest, and "View less" collapses back to this state.'},source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={[
    { type: "PROPERTY", key: "department", label: "Department", filterComponent: "LISTOGRAM", defaultFilterState: { type: "EXACT_MATCH", values: ["Sales"] } },
  ]}
/>`}}},render:t=>e.jsx(mn,{...t}),play:async({canvasElement:t})=>{const n=Gt(t),i=["Engineering","Marketing","Design","Data","Finance","Operations","People","Sales","Customer Success","Legal","Product"],r=/^(Engineering|Marketing|Design|Data|Finance|Operations|People|Sales|Customer Success|Legal|Product)\s+\d+/u,o=()=>n.getAllByRole("button",{name:r}).map(c=>{const f=i.find(m=>{var y;return(y=c.textContent)==null?void 0:y.includes(m)});if(f==null)throw new Error(`Unable to identify department row from "${c.textContent}"`);return f}),s=["Engineering","Marketing","Design","Data","Finance","Sales"],p=["Engineering","Marketing","Design","Data","Finance"];await n.findByRole("button",{name:"Marketing 4"}),await C(o()).toEqual(s),await C(n.getByRole("button",{name:"Sales 2"})).toHaveAttribute("aria-pressed","true"),await v.click(n.getByRole("button",{name:"Sales 2"})),await F(()=>C(o()).toEqual(p)),await C(n.queryByRole("button",{name:"Sales 2"})).toBeNull(),await v.click(n.getByRole("button",{name:/^View all \(\d+\)/u})),await n.findByRole("button",{name:"View less"}),await v.click(n.getByRole("button",{name:"Sales 2"})),await F(()=>C(n.getByRole("button",{name:"Sales 2"})).toHaveAttribute("aria-pressed","true")),await v.click(n.getByRole("button",{name:"View less"})),await n.findByRole("button",{name:/^View all \(\d+\)/u}),await C(n.queryByRole("button",{name:"View less"})).toBeNull(),await F(()=>C(o()).toEqual(s))}};function fn(t){const[n,i]=l.useState(E),r=t.onFilterRemoved,o=l.useCallback(s=>{i(p=>p.filter(c=>"key"in c?c.key!==s:!0)),r==null||r(s)},[r]);return e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:n,...t,onFilterRemoved:o})})}const X={name:"Removable Filters",args:{title:"Removable Filters",showActiveFilterCount:!0},parameters:{docs:{description:{story:"When `onFilterRemoved` is provided, each filter item shows a remove button (X) on hover. Clicking it removes the filter from the list."},source:{code:`const [definitions, setDefinitions] = useState(filterDefinitions);
...
/>`}}},render:t=>e.jsx(fn,{...t})};function yn(t){const[n,i]=l.useState(void 0),r=l.useMemo(()=>[{type:"STATIC_VALUES",key:"department",label:"Department (static)",filterComponent:"LISTOGRAM",values:["Marketing","Operations","Finance","Product"],defaultFilterState:{type:"EXACT_MATCH",values:[]},listogramConfig:{displayMode:"minimal"}},{type:"STATIC_VALUES",key:"locationCity",label:"Office Location",filterComponent:"SINGLE_SELECT",values:["New York","San Francisco","London","Tokyo"],defaultFilterState:{type:"SELECT",selectedValues:[]}},{type:"STATIC_VALUES",key:"team",label:"Team (multi-select)",filterComponent:"MULTI_SELECT",values:["Alpha","Beta","Gamma","Delta"],defaultFilterState:{type:"SELECT",selectedValues:[]}},{type:"STATIC_VALUES",id:"custom-status",key:"status",label:"Status (custom clause)",filterComponent:"LISTOGRAM",values:["Active","Inactive"],defaultFilterState:{type:"EXACT_MATCH",values:[]},listogramConfig:{displayMode:"minimal"},toWhereClause:p=>{if(p.type!=="EXACT_MATCH"||p.values.length===0)return;const c=p.values,f=c.includes("Active"),m=c.includes("Inactive");if(f&&m)return{$or:[{employeeStatus:"Active"},{employeeStatus:"Inactive"}]};if(f)return{employeeStatus:"Active"};if(m)return{employeeStatus:"Inactive"}}}],[]),o=t.onFilterClauseChanged,s=l.useCallback(p=>{i(p),o==null||o(p)},[o]);return e.jsxs("div",{style:T,children:[e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:r,...t,filterClause:n,onFilterClauseChanged:s})}),e.jsxs("div",{style:S,children:[e.jsx("strong",{children:"Filter Clause (JSON):"}),e.jsx("pre",{style:g,children:n?JSON.stringify(n,null,2):"(no active filters)"})]})]})}const K={parameters:{docs:{description:{story:"Use `STATIC_VALUES` filter definitions to provide a fixed list of values instead of fetching from OSDK aggregation. Supports LISTOGRAM, SINGLE_SELECT, MULTI_SELECT, and TEXT_TAGS components. Optionally provide a `toWhereClause` function for custom clause generation."},source:{code:`const filterDefinitions = [
  {
    type: "STATIC_VALUES",
    key: "department",
    label: "Department",
...
<FilterList
  ...
  filterClause={filterClause}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(yn,{...t})};function Cn(t){const[n,i]=l.useState(void 0),[r,o]=l.useState(E),s=t.onFilterRemoved,p=l.useCallback(h=>{o(A=>A.filter(oe=>"key"in oe?oe.key!==h:!0)),s==null||s(h)},[s]),c=t.onReset,f=l.useCallback(()=>{o(E),c==null||c()},[c]),m=t.onFilterClauseChanged,y=l.useCallback(h=>{i(h),m==null||m(h)},[m]);return e.jsxs("div",{style:Ut,children:[e.jsx("div",{style:Xt,children:e.jsx(d,{objectType:a,filterDefinitions:r,titleIcon:Kt,...t,onReset:f,onFilterRemoved:p,filterClause:n,onFilterClauseChanged:y})}),e.jsx("div",{style:S,children:e.jsx(Bt,{objectType:a,filter:n})})]})}const q={name:"Full Featured",args:{title:"Employee Filters",showResetButton:!0,showActiveFilterCount:!0,enableSorting:!0},parameters:{docs:{description:{story:"Demonstrates all filter list features together: collapse, reset, active count, sorting, removable filters, per-filter search, exclude toggle, and controlled where clause driving an ObjectTable."},source:{code:`// All features combined: collapse, sort, search, exclude, remove, reset
...
/>`}}},render:t=>e.jsx(Rn,{...t})};function vn({filterState:t,onFilterStateChanged:n}){const i=l.useCallback(o=>{const s=o.target.value;n({type:"custom",customState:{value:s}})},[n]),r=l.useCallback(()=>{n({type:"custom",customState:{value:""}})},[n]);return e.jsxs("div",{style:{padding:"12px 0",display:"flex",gap:"8px"},children:[e.jsx("input",{type:"text",value:t.customState.value,onChange:i,placeholder:"Enter name substring...",style:{flex:1,padding:"6px 8px",fontSize:"14px",border:"1px solid #ccc",borderRadius:"4px"}}),t.customState.value&&e.jsx("button",{onClick:r,style:{padding:"6px 12px",fontSize:"12px",backgroundColor:"#f5f5f5",border:"1px solid #ccc",borderRadius:"4px",cursor:"pointer"},children:"Clear"})]})}function Fn(t){const[n,i]=l.useState(void 0),r=l.useMemo(()=>[{type:"CUSTOM",key:"custom-name-contains",label:"Name Contains",filterComponent:"CUSTOM",defaultFilterState:{type:"custom",customState:{value:""}},renderInput:({filterState:p,onFilterStateChanged:c})=>e.jsx(vn,{filterState:p,onFilterStateChanged:c}),toWhereClause:p=>{var f;const c=(f=p.customState)==null?void 0:f.value;if(c)return{fullName:{$containsAnyTerm:c}}}}],[]),o=t.onFilterClauseChanged,s=l.useCallback(p=>{i(p),o==null||o(p)},[o]);return e.jsxs("div",{style:T,children:[e.jsx("div",{style:u,children:e.jsx(d,{objectType:a,filterDefinitions:r,...t,filterClause:n,onFilterClauseChanged:s})}),e.jsxs("div",{style:S,children:[e.jsx("strong",{children:"Filter Clause (JSON):"}),e.jsx("pre",{style:g,children:n?JSON.stringify(n,null,2):"(no active filters)"})]})]})}const $={name:"Custom Filters",parameters:{docs:{description:{story:"Custom filters provide full control over filtering logic and UI. The 'Name Contains' filter uses `renderInput` for a simple custom input. "},source:{code:`// Custom filter with renderInput
...
/>`}}},render:t=>e.jsx(Pn,{...t})},se=[R,le],_n=new Map([["department",{type:"EXACT_MATCH",values:["Engineering"]}],["jobTitle-multi",{type:"SELECT",selectedValues:["Software Engineer"]}]]);function ce(t){const n=[...t.keys()].sort(),i={};for(const r of n){const o=t.get(r);o!==void 0&&(i[r]=o)}return JSON.stringify(i,null,2)}function Jt({initialFilterStates:t,storyArgs:n}){const i=l.useMemo(()=>{const m=new Map;for(const y of se)y.type==="PROPERTY"&&y.filterState&&m.set(ae(y),y.filterState);if(t)for(const[y,h]of t)m.set(y,h);return m},[t]),[r,o]=l.useState(()=>new Map(i)),s=n.onFilterStateChanged,p=l.useCallback((m,y)=>{o(h=>{const A=new Map(h);return A.set(ae(m),y),A}),s==null||s(m,y)},[s]),c=n.onReset,f=l.useCallback(()=>{o(new Map(i)),c==null||c()},[c,i]);return e.jsxs("div",{style:T,children:[e.jsx("div",{style:u,children:e.jsx(d,{...n,objectType:a,filterDefinitions:se,initialFilterStates:t,showResetButton:!0,onFilterStateChanged:p,onReset:f})}),e.jsxs("div",{style:S,children:[e.jsx("h4",{children:"Filter state dump"}),e.jsx("pre",{"data-testid":"filter-state-dump",style:g,children:ce(r)}),e.jsx("h4",{children:"Initial snapshot"}),e.jsx("pre",{"data-testid":"filter-state-initial",style:g,children:ce(i)})]})]})}function In(t){return e.jsx(Jt,{storyArgs:t})}const ee={args:{showResetButton:!0},parameters:{docs:{description:{story:"Reset button is disabled-by-default until the user diverges from the initial (empty string) snapshot. After clicking reset the filter state returns to the initial snapshot and the button disables itself again."},source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  showResetButton={true}
...
}`,...(ue=(pe=M.parameters)==null?void 0:pe.docs)==null?void 0:ue.source}}};var me,fe,ye;D.parameters={...D.parameters,docs:{...(me=D.parameters)==null?void 0:me.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(ye=(fe=D.parameters)==null?void 0:fe.docs)==null?void 0:ye.source}}};var Ce,Te,he;j.parameters={...j.parameters,docs:{...(Ce=j.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(it=(nt=W.parameters)==null?void 0:nt.docs)==null?void 0:it.source}}};var rt,lt,ot;H.parameters={...H.parameters,docs:{...(rt=H.parameters)==null?void 0:rt.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(ot=(lt=H.parameters)==null?void 0:lt.docs)==null?void 0:ot.source}}};var at,st,ct;U.parameters={...U.parameters,docs:{...(at=U.parameters)==null?void 0:at.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(ut=(pt=X.parameters)==null?void 0:pt.docs)==null?void 0:ut.source}}};var mt,ft,yt;K.parameters={...K.parameters,docs:{...(mt=K.parameters)==null?void 0:mt.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(yt=(ft=K.parameters)==null?void 0:ft.docs)==null?void 0:yt.source}}};var Ct,Tt,ht;q.parameters={...q.parameters,docs:{...(Ct=q.parameters)==null?void 0:Ct.docs,source:{originalSource:`{
  name: "Full Featured",
  args: {
    title: "Employee Filters",
    showResetButton: true,
