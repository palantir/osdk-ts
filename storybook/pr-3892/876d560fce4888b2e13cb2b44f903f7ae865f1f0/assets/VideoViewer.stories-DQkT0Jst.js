import{h as f,j as t}from"./iframe-jCChBqpD.js";import{w as l}from"./withOsdkMetrics-CEFSBq5G.js";import{V as w}from"./VideoViewer-DHBmBNvI.js";import{p as h}from"./passthrough-6sm3BHV7.js";import"./preload-helper-BjtDmjUW.js";import"./index-BDYSe5T3.js";import"./useMediaContents-DRk7H66m.js";import"./spin-C4VFO2nd.js";import"./svgIconContainer-V036n2V3.js";import"./error-S_2dtwT6.js";const o=l(w,"VideoViewer"),{fn:V}=__STORYBOOK_MODULE_TEST__,v="/osdk-ts/storybook/pr-3892/876d560fce4888b2e13cb2b44f903f7ae865f1f0/example.mp4";function k(e,p){return{fetchContents:()=>fetch(e),fetchMetadata:()=>Promise.resolve({path:p,sizeBytes:0,mediaType:"video/mp4"}),getMediaReference:()=>({mimeType:"video/mp4",reference:{type:"mediaSetViewItem",mediaSetViewItem:{mediaItemRid:"ri.mio.main.media-item.mock-video",mediaSetRid:"ri.mio.main.media-set.mock-set",mediaSetViewRid:"ri.mio.main.media-set-view.mock-view"}}})}}const S=k(v,"example.mp4"),O={title:"Components/DocumentViewer/Renderers/VideoViewer",component:o,tags:["beta"],args:{media:S},render:e=>t.jsx("div",{style:{height:"400px",width:"600px"},children:t.jsx(o,{media:e.media,onError:e.onError})}),parameters:{controls:{expanded:!0},msw:{handlers:[f.get("*/example.mp4",()=>h())]}},argTypes:{media:{description:"The OSDK Media object to fetch video from",control:!1},className:{description:"Additional CSS class name for the root element",control:"text"},onError:{description:"Callback when the video fails to load",control:!1,table:{category:"Events"}}}},i={parameters:{docs:{source:{code:`import { VideoViewer } from "@osdk/react-components/experimental/video-viewer";
