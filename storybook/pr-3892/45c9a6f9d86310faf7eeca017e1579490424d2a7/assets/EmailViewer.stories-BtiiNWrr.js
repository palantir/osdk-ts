import{j as t}from"./iframe-BrG6cQfS.js";import{E as h,B as s}from"./EmailViewer-DIfm7J5j.js";import{w as u}from"./withOsdkMetrics-Dsha6ge2.js";import"./preload-helper-Bixkw_YY.js";import"./index-BEzPF5rE.js";import"./useMediaContents-DmuRlYmH.js";import"./spin-egny2WGL.js";import"./svgIconContainer-c7VzC2a1.js";import"./error-DOpFGD8C.js";const x=u(h,"EmailViewer"),w={subject:"Q3 Project Update - Action Items",from:{name:"Alice Johnson",address:"alice@example.com"},to:[{name:"Bob Smith",address:"bob@example.com"},{name:"Carol Davis",address:"carol@example.com"}],cc:[{name:"Dave Wilson",address:"dave@example.com"}],date:"2026-03-15T14:30:00Z",html:`
...
`;function v(e){return{fetchContents:()=>Promise.resolve(new Response(e)),fetchMetadata:()=>Promise.resolve({path:"email.eml",sizeBytes:e.length,mediaType:"message/rfc822"}),getMediaReference:()=>({mimeType:"message/rfc822",reference:{type:"mediaSetViewItem",mediaSetViewItem:{mediaItemRid:"ri.mio.main.media-item.mock-email",mediaSetRid:"ri.mio.main.media-set.mock-set",mediaSetViewRid:"ri.mio.main.media-set-view.mock-view"}}})}}const j={title:"Components/DocumentViewer/Renderers/EmailViewer",component:s,tags:["beta"],args:{email:w},render:e=>t.jsx("div",{style:{height:"500px"},children:t.jsx(s,{...e})}),parameters:{controls:{expanded:!0}},argTypes:{email:{description:"Parsed email data",control:!1},className:{description:"Additional CSS class name for the root element",control:"text"}}},a={args:{media:v(M)},render:e=>t.jsx("div",{style:{height:"500px"},children:t.jsx(x,{...e})}),parameters:{docs:{source:{code:`import { EmailViewer } from "@osdk/react-components/experimental/email-viewer";
...
}`,...(n=(m=a.parameters)==null?void 0:m.docs)==null?void 0:n.source}}};var l,c,d;i.parameters={...i.parameters,docs:{...(l=i.parameters)==null?void 0:l.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,...(d=(c=i.parameters)==null?void 0:c.docs)==null?void 0:d.source}}};var p,E,g;r.parameters={...r.parameters,docs:{...(p=r.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
