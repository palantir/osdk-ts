...
/>`}}},render:t=>e.jsx(zt,{...t})},k={args:{title:"Employee Filters"},parameters:{docs:{source:{code:`<FilterList
  ...
  titleIcon={<svg>...</svg>}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:u,children:e.jsx(a,{objectType:s,filterDefinitions:h,titleIcon:Gt,...i})})};function qt(t){const n=t.onReset,i=o.useCallback(()=>{console.log("Reset clicked"),n==null||n()},[n]);return e.jsx("div",{style:u,children:e.jsx(a,{objectType:s,filterDefinitions:h,...t,onReset:i})})}const O={args:{showResetButton:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  showResetButton={true}
  onReset={() => console.log("Reset clicked")}
/>`}}},render:t=>e.jsx(qt,{...t})},_={args:{showActiveFilterCount:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  showActiveFilterCount={true}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:u,children:e.jsx(a,{objectType:s,filterDefinitions:h,...i})})},I={args:{enableSorting:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  enableSorting={true}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:u,children:e.jsx(a,{objectType:s,filterDefinitions:h,...i})})};function $t(t){return e.jsx("div",{style:u,children:e.jsx(a,{objectType:s,filterDefinitions:h,...t})})}const P={args:{title:"Employee Filters",showActiveFilterCount:!0},parameters:{docs:{description:{story:"Click the collapse button to minimize the filter panel. Active filter count is shown in the collapsed state."},source:{code:`const [collapsed, setCollapsed] = useState(false);
...
<FilterList
  ...
  filterClause={filterClause}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(dn,{...t})};function pn(t){const[n,i]=o.useState(void 0),[r,l]=o.useState(h),c=t.onFilterRemoved,d=o.useCallback(T=>{l(L=>L.filter(ie=>"key"in ie?ie.key!==T:!0)),c==null||c(T)},[c]),p=t.onReset,f=o.useCallback(()=>{l(h),p==null||p()},[p]),m=t.onFilterClauseChanged,y=o.useCallback(T=>{i(T),m==null||m(T)},[m]);return e.jsxs("div",{style:Wt,children:[e.jsx("div",{style:Yt,children:e.jsx(a,{objectType:s,filterDefinitions:r,titleIcon:Gt,...t,onReset:f,onFilterRemoved:d,filterClause:n,onFilterClauseChanged:y})}),e.jsx("div",{style:S,children:e.jsx(xt,{objectType:s,filter:n})})]})}const U={name:"Full Featured",args:{title:"Employee Filters",showResetButton:!0,showActiveFilterCount:!0,enableSorting:!0},parameters:{docs:{description:{story:"Demonstrates all filter list features together: collapse, reset, active count, sorting, removable filters, per-filter search, exclude toggle, and controlled where clause driving an ObjectTable."},source:{code:`// All features combined: collapse, sort, search, exclude, remove, reset
...
<FilterList
  ...
  filterClause={filterClause}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(un,{...t})},mn={type:"PROPERTY",id:"combined-department",key:"department",label:"Department",filterComponent:"LISTOGRAM",filterState:{type:"EXACT_MATCH",values:[]}},fn={type:"PROPERTY",id:"combined-locationCity",key:"locationCity",label:"Location City",filterComponent:"MULTI_SELECT",filterState:{type:"SELECT",selectedValues:[]}},yn={type:"LINKED_PROPERTY",id:"combined-lead-name",linkName:"lead",reverseLinkName:"peeps",linkedPropertyKey:"fullName",linkedFilterComponent:"MULTI_SELECT",linkedFilterState:{type:"SELECT",selectedValues:[]},filterState:{type:"linkedProperty",linkedFilterState:{type:"SELECT",selectedValues:[]}},searchField:!1,label:"Manager Name"},Cn=[yn,mn,fn],Tn=[{locator:{type:"property",id:"fullName"}},{locator:{type:"property",id:"department"}},{locator:{type:"property",id:"locationCity"}},{locator:{type:"rdp",id:"managerName",creator:t=>t.pivotTo("lead").selectProperty("fullName")},renderHeader:()=>"Manager Name",renderCell:t=>"managerName"in t?e.jsx("span",{children:t.managerName}):e.jsx("span",{style:{color:"#999"},children:"No Manager"})}];function hn(t){const n=Z(),i=o.useMemo(()=>n(s),[n]),[r,l]=o.useState(void 0),[c,d]=o.useState(i),p=t.onFilterClauseChanged,f=o.useCallback(m=>{l(m),p==null||p(m)},[p]);return e.jsxs("div",{style:Wt,children:[e.jsx("div",{style:Yt,children:e.jsx(a,{...t,objectType:s,objectSet:i,filterDefinitions:Cn,filterClause:r,onFilterClauseChanged:f,onEffectiveObjectSet:d,showFilteredOutValues:!0})}),e.jsx("div",{style:S,children:e.jsx(xt,{objectType:s,objectSet:c,columnDefinitions:Tn})})]})}const K={name:"Combined with Object Table",parameters:{docs:{description:{story:'A linked filter (Manager Name) and direct property filters coexist in one FilterList alongside an ObjectTable. Pass the unfiltered scope as `objectSet`; FilterList applies the linked-filter narrowing internally and emits the fully-narrowed `ObjectSet` via `onEffectiveObjectSet` for the table. The table surfaces the linked manager via a derived-property `Manager Name` column (`pivotTo("lead").selectProperty("fullName")`). With `showFilteredOutValues`, direct-facet values absent under the active linked filter render as greyed-out count=0 filtered-out rows.'},source:{code:`const baseObjectSet = useMemo(() => client(Employee), [client]);
...
/>`}}},render:t=>e.jsx(hn,{...t})};function Sn({filterState:t,onFilterStateChanged:n}){const i=o.useCallback(l=>{const c=l.target.value;n({type:"custom",customState:{value:c}})},[n]),r=o.useCallback(()=>{n({type:"custom",customState:{value:""}})},[n]);return e.jsxs("div",{style:{padding:"12px 0",display:"flex",gap:"8px"},children:[e.jsx("input",{type:"text",value:t.customState.value,onChange:i,placeholder:"Enter name substring...",style:{flex:1,padding:"6px 8px",fontSize:"14px",border:"1px solid #ccc",borderRadius:"4px"}}),t.customState.value&&e.jsx("button",{onClick:r,style:{padding:"6px 12px",fontSize:"12px",backgroundColor:"#f5f5f5",border:"1px solid #ccc",borderRadius:"4px",cursor:"pointer"},children:"Clear"})]})}function En(t){const[n,i]=o.useState(void 0),r=o.useMemo(()=>[{type:"CUSTOM",key:"custom-name-contains",label:"Name Contains",filterComponent:"CUSTOM",filterState:{type:"custom",customState:{value:""}},renderInput:({filterState:d,onFilterStateChanged:p})=>e.jsx(Sn,{filterState:d,onFilterStateChanged:p}),toWhereClause:d=>{var f;const p=(f=d.customState)==null?void 0:f.value;if(p)return{fullName:{$containsAnyTerm:p}}}}],[]),l=t.onFilterClauseChanged,c=o.useCallback(d=>{i(d),l==null||l(d)},[l]);return e.jsxs("div",{style:C,children:[e.jsx("div",{style:u,children:e.jsx(a,{objectType:s,filterDefinitions:r,...t,filterClause:n,onFilterClauseChanged:c})}),e.jsxs("div",{style:S,children:[e.jsx("strong",{children:"Filter Clause (JSON):"}),e.jsx("pre",{style:b,children:n?JSON.stringify(n,null,2):"(no active filters)"})]})]})}const J={name:"Custom Filters",parameters:{docs:{description:{story:"Custom filters provide full control over filtering logic and UI. The 'Name Contains' filter uses `renderInput` for a simple custom input. "},source:{code:`// Custom filter with renderInput
...
<FilterList
  ...
  filterClause={filterClause}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(En,{...t})},bn={type:"PROPERTY",id:"department-multi",key:"department",label:"Department",filterComponent:"MULTI_SELECT",filterState:{type:"SELECT",selectedValues:[]}},gn={type:"PROPERTY",id:"department-single",key:"department",label:"Department (single)",filterComponent:"SINGLE_SELECT",filterState:{type:"SELECT",selectedValues:[]}},vn=[g,bn,gn,ee],z={name:"No value rendering",parameters:{docs:{description:{story:"Empty/null filter values render via the canonical `<NoValueLabel />` component — italic, muted, with the literal text 'No value' — across listogram buckets, single-select dropdown options, multi-select dropdown options, and multi-select chips. The mock dataset includes one Employee with `department: \"\"` so the No value row is visible in the listogram."}}},render:()=>e.jsx("div",{style:u,children:e.jsx(a,{objectType:s,filterDefinitions:vn})})},Rn={type:"PROPERTY",id:"locationCity-single",key:"locationCity",label:"Location City (single)",filterComponent:"SINGLE_SELECT",filterState:{type:"SELECT",selectedValues:[]}},Ln={type:"LINKED_PROPERTY",linkName:"lead",reverseLinkName:"peeps",linkedPropertyKey:"department",linkedFilterComponent:"MULTI_SELECT",linkedFilterState:{type:"SELECT",selectedValues:[]},filterState:{type:"linkedProperty",linkedFilterState:{type:"SELECT",selectedValues:[]}},label:"Manager Department (linked multi)"},An={type:"LINKED_PROPERTY",linkName:"lead",reverseLinkName:"peeps",linkedPropertyKey:"locationCity",linkedFilterComponent:"SINGLE_SELECT",linkedFilterState:{type:"SELECT",selectedValues:[]},filterState:{type:"linkedProperty",linkedFilterState:{type:"SELECT",selectedValues:[]}},label:"Manager City (linked single)"},Fn=new Map([["department",{type:"EXACT_MATCH",values:["Marketing","Research"]}],["jobTitle-multi",{type:"SELECT",selectedValues:["Marketing Manager","Chief Scientist"]}],["locationCity-single",{type:"SELECT",selectedValues:["Berlin"]}],["linkedProperty:lead:department",{type:"linkedProperty",linkedFilterState:{type:"SELECT",selectedValues:["Marketing","Research"]}}],["linkedProperty:lead:locationCity",{type:"linkedProperty",linkedFilterState:{type:"SELECT",selectedValues:["Berlin"]}}]]),jn=[g,ne,Rn,Ln,An];function Mn(t){const n=Z(),i=o.useMemo(()=>n(s),[n]),[r,l]=o.useState(void 0),c=o.useCallback(d=>{l(d)},[]);return e.jsxs("div",{style:C,children:[e.jsx("div",{style:u,children:e.jsx(a,{...t,objectType:s,objectSet:i,filterDefinitions:jn,initialFilterStates:Fn,onFilterClauseChanged:c})}),e.jsxs("div",{style:S,children:[e.jsx("h4",{children:"Active where clause"}),e.jsx("pre",{style:b,children:r?JSON.stringify(r,null,2):"(none)"})]})]})}const q={name:"With initial filter states",parameters:{docs:{description:{story:"Pass `initialFilterStates` to hydrate filters from saved state (e.g. localStorage or URL params). Selections are restored on mount, including values that currently have zero matching rows — they appear with a count of 0 so users can see and clear them. Demonstrated across LISTOGRAM, MULTI_SELECT, SINGLE_SELECT, and LINKED_PROPERTY filters."},source:{code:`// "Research", "Chief Scientist", and "Berlin" are not in the current
...
/>`}}},render:t=>e.jsx(Mn,{...t})},se=[g,ne],Dn=new Map([["department",{type:"EXACT_MATCH",values:["Engineering"]}],["jobTitle-multi",{type:"SELECT",selectedValues:["Software Engineer"]}]]);function ae(t){const n=[...t.keys()].sort(),i={};for(const r of n){const l=t.get(r);l!==void 0&&(i[r]=l)}return JSON.stringify(i,null,2)}function Bt({initialFilterStates:t,storyArgs:n}){const i=o.useMemo(()=>{const m=new Map;for(const y of se)y.type==="PROPERTY"&&y.filterState&&m.set(re(y),y.filterState);if(t)for(const[y,T]of t)m.set(y,T);return m},[t]),[r,l]=o.useState(()=>new Map(i)),c=n.onFilterStateChanged,d=o.useCallback((m,y)=>{l(T=>{const L=new Map(T);return L.set(re(m),y),L}),c==null||c(m,y)},[c]),p=n.onReset,f=o.useCallback(()=>{l(new Map(i)),p==null||p()},[p,i]);return e.jsxs("div",{style:C,children:[e.jsx("div",{style:u,children:e.jsx(a,{...n,objectType:s,filterDefinitions:se,initialFilterStates:t,showResetButton:!0,onFilterStateChanged:d,onReset:f})}),e.jsxs("div",{style:S,children:[e.jsx("h4",{children:"Filter state dump"}),e.jsx("pre",{"data-testid":"filter-state-dump",style:b,children:ae(r)}),e.jsx("h4",{children:"Initial snapshot"}),e.jsx("pre",{"data-testid":"filter-state-initial",style:b,children:ae(i)})]})]})}function kn(t){return e.jsx(Bt,{storyArgs:t})}const $={args:{showResetButton:!0},parameters:{docs:{description:{story:"Reset button is disabled-by-default until the user diverges from the initial (empty string) snapshot. After clicking reset the filter state returns to the initial snapshot and the button disables itself again."},source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  showResetButton={true}
/>`}}},render:t=>e.jsx(kn,{...t})};function On(t){return e.jsx(Bt,{storyArgs:t,initialFilterStates:Dn})}const Q={args:{showResetButton:!0},parameters:{docs:{description:{story:"Reset button stays disabled on mount even though there are active selections, because the live filter state matches the initial snapshot. Changing a selection enables the button; clicking it restores the initial snapshot, not an empty state."},source:{code:`const savedStates = new Map([
...
<FilterList
  ...
  initialFilterStates={savedStates}
  showResetButton={true}
/>`}}},render:t=>e.jsx(On,{...t})};var ce,de,pe;A.parameters={...A.parameters,docs:{...(ce=A.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`<FilterList
...
}`,...(Pe=(Ie=I.parameters)==null?void 0:Ie.docs)==null?void 0:Pe.source}}};var xe,Ne,we;P.parameters={...P.parameters,docs:{...(xe=P.parameters)==null?void 0:xe.docs,source:{originalSource:`{
  args: {
    title: "Employee Filters",
    showActiveFilterCount: true
  },
...
}`,...(we=(Ne=P.parameters)==null?void 0:Ne.docs)==null?void 0:we.source}}};var Ve,We,Ye;x.parameters={...x.parameters,docs:{...(Ve=x.parameters)==null?void 0:Ve.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`const filterDefinitions = [
...
}`,...(Ye=(We=x.parameters)==null?void 0:We.docs)==null?void 0:Ye.source}}};var Ge,He,Be;N.parameters={...N.parameters,docs:{...(Ge=N.parameters)==null?void 0:Ge.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,...(Be=(He=N.parameters)==null?void 0:He.docs)==null?void 0:Be.source}}};var Ue,Xe,Ke;w.parameters={...w.parameters,docs:{...(Ue=w.parameters)==null?void 0:Ue.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(Ke=(Xe=w.parameters)==null?void 0:Xe.docs)==null?void 0:Ke.source}}};var Je,ze,qe;V.parameters={...V.parameters,docs:{...(Je=V.parameters)==null?void 0:Je.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(qe=(ze=V.parameters)==null?void 0:ze.docs)==null?void 0:qe.source}}};var $e,Qe,Ze;W.parameters={...W.parameters,docs:{...($e=W.parameters)==null?void 0:$e.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,...(at=(st=H.parameters)==null?void 0:st.docs)==null?void 0:at.source}}};var ct,dt,pt;B.parameters={...B.parameters,docs:{...(ct=B.parameters)==null?void 0:ct.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(pt=(dt=B.parameters)==null?void 0:dt.docs)==null?void 0:pt.source}}};var ut,mt,ft;U.parameters={...U.parameters,docs:{...(ut=U.parameters)==null?void 0:ut.docs,source:{originalSource:`{
  name: "Full Featured",
  args: {
    title: "Employee Filters",
    showResetButton: true,
...
}`,...(ft=(mt=U.parameters)==null?void 0:mt.docs)==null?void 0:ft.source}}};var yt,Ct,Tt;X.parameters={...X.parameters,docs:{...(yt=X.parameters)==null?void 0:yt.docs,source:{originalSource:`{
...
}`,...(Tt=(Ct=X.parameters)==null?void 0:Ct.docs)==null?void 0:Tt.source}}};var ht,St,Et;K.parameters={...K.parameters,docs:{...(ht=K.parameters)==null?void 0:ht.docs,source:{originalSource:`{
...
}`,...(At=(Lt=z.parameters)==null?void 0:Lt.docs)==null?void 0:At.source}}};var Ft,jt,Mt;q.parameters={...q.parameters,docs:{...(Ft=q.parameters)==null?void 0:Ft.docs,source:{originalSource:`{
...
}`,...(Mt=(jt=q.parameters)==null?void 0:jt.docs)==null?void 0:Mt.source}}};var Dt,kt,Ot;$.parameters={...$.parameters,docs:{...(Dt=$.parameters)==null?void 0:Dt.docs,source:{originalSource:`{
  args: {
    showResetButton: true
  },
  parameters: {
...
}`,...(Ot=(kt=$.parameters)==null?void 0:kt.docs)==null?void 0:Ot.source}}};var _t,It,Pt;Q.parameters={...Q.parameters,docs:{...(_t=Q.parameters)==null?void 0:_t.docs,source:{originalSource:`{
  args: {
    showResetButton: true
  },
  parameters: {
...
}`,...(Pt=(It=Q.parameters)==null?void 0:It.docs)==null?void 0:Pt.source}}};const Oi=["Default","IntegerNumberRangeRounding","WithObjectSet","AddFilterMode","WithAllFilterTypes","WithTitleAndIcon","WithResetButton","WithActiveFilterCount","WithSorting","CollapsiblePanel","KeywordSearch","WithColorMap","WithRenderValue","WithRenderValueAsReactNode","WithListogramDisplayModes","WithHiddenCounts","WithCheckbox","WithRemovableFilters","WithStaticValues","FullFeatured","WithLinkedPropertyFilters","CombinedWithObjectTable","WithCustomFilters","NoValueRendering","WithInitialFilterStates","WithResetButtonEmptyInitial","WithResetButtonNonEmptyInitial"];export{M as AddFilterMode,P as CollapsiblePanel,K as CombinedWithObjectTable,A as Default,U as FullFeatured,F as IntegerNumberRangeRounding,x as KeywordSearch,z as NoValueRendering,_ as WithActiveFilterCount,D as WithAllFilterTypes,G as WithCheckbox,N as WithColorMap,J as WithCustomFilters,Y as WithHiddenCounts,q as WithInitialFilterStates,X as WithLinkedPropertyFilters,W as WithListogramDisplayModes,j as WithObjectSet,H as WithRemovableFilters,w as WithRenderValue,V as WithRenderValueAsReactNode,O as WithResetButton,$ as WithResetButtonEmptyInitial,Q as WithResetButtonNonEmptyInitial,I as WithSorting,B as WithStaticValues,k as WithTitleAndIcon,Oi as __namedExportsOrder,ki as default};
