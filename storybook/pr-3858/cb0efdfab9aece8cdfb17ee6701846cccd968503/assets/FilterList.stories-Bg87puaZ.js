...
/>`}}},render:({objectType:t,objectSet:n,...i})=>{const o=r.useMemo(()=>[ae],[]);return e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,filterDefinitions:o,...i})})}};function un(t){const n=re(),i=r.useMemo(()=>n(l).where({department:"Marketing"}),[n]),o=r.useMemo(()=>[ce,L],[]);return e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,objectSet:i,filterDefinitions:o,...t})})}const w={parameters:{docs:{description:{story:"Pass an `objectSet` prop to scope filter aggregations to a subset of objects. Here the object set is filtered to Marketing department employees, so the listogram counts reflect only that subset."},source:{code:`const client = useOsdkClient();
...
/>`}}},render:t=>e.jsx(un,{...t})};function mn(t){const n=r.useMemo(()=>[R,ce,{...nn,isVisible:!1},{...on,isVisible:!1},{...ae,isVisible:!1},{...L,isVisible:!1}],[]);return e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,filterDefinitions:n,addFilterMode:"uncontrolled",...t})})}const O={args:{showResetButton:!0},parameters:{docs:{source:{code:`const filterDefinitions = [
  { type: "PROPERTY", key: "department", label: "Department", filterComponent: "LISTOGRAM" },
  { type: "PROPERTY", key: "team", label: "Team", filterComponent: "LISTOGRAM" },
...
/>`}}},render:t=>e.jsx(mn,{...t})};function fn(t){const[n,i]=r.useState(void 0),o=t.onFilterClauseChanged,a=r.useCallback(c=>{i(c),o==null||o(c)},[o]);return e.jsxs("div",{style:b,children:[e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,filterDefinitions:S,...t,onFilterClauseChanged:a})}),e.jsxs("div",{style:g,children:[e.jsx("strong",{children:"Filter Clause (JSON):"}),e.jsx("pre",{style:C,children:n?JSON.stringify(n,null,2):"(no active filters)"})]})]})}const M={parameters:{docs:{description:{story:"All filter component types, with the emitted where clause shown as JSON. Hover filter items to reveal search and exclude actions."},source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(fn,{...t})},A={args:{title:"Employee Filters"},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  title="Employee Filters"
  titleIcon={<svg>...</svg>}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,filterDefinitions:S,titleIcon:ln,...i})})};function yn(t){const n=t.onReset,i=r.useCallback(()=>{console.log("Reset clicked"),n==null||n()},[n]);return e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,filterDefinitions:S,...t,onReset:i})})}const P={args:{showResetButton:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  showResetButton={true}
  onReset={() => console.log("Reset clicked")}
/>`}}},render:t=>e.jsx(yn,{...t})},x={args:{showActiveFilterCount:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  showActiveFilterCount={true}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,filterDefinitions:S,...i})})},I={args:{enableSorting:!0},parameters:{docs:{source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  enableSorting={true}
/>`}}},render:({objectType:t,objectSet:n,...i})=>e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,filterDefinitions:S,...i})})};function hn(t){return e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,filterDefinitions:S,...t})})}const N={args:{title:"Employee Filters",showActiveFilterCount:!0},parameters:{docs:{description:{story:"Click the collapse button to minimize the panel. Collapse is available by default and uncontrolled here — no state wiring required. Active filter count is shown in the collapsed state."},source:{code:`<FilterList
  objectType={Employee}
  filterDefinitions={filterDefinitions}
  title="Employee Filters"
  showActiveFilterCount={true}
/>`}}},render:t=>e.jsx(hn,{...t})};function bn(t){const[n,i]=r.useState(!1);return e.jsxs("div",{style:{display:"flex",gap:16,alignItems:"flex-start"},children:[e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,filterDefinitions:S,...t,collapsed:n,onCollapsedChange:i})}),e.jsx("button",{type:"button",onClick:()=>i(o=>!o),children:n?"Expand from outside":"Collapse from outside"})]})}const _={args:{title:"Employee Filters"},parameters:{docs:{description:{story:"Controlled mode: `collapsed` is the source of truth, so the panel only moves when the caller re-renders with a new value. The external button drives the same state as the header control."},source:{code:`const [collapsed, setCollapsed] = useState(false);
...
<FilterList
  ...
  filterDefinitions={filterDefinitions}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(wn,{...t})};function On(t){const[n,i]=r.useState(void 0),[o,a]=r.useState(S),c=t.onFilterRemoved,p=r.useCallback(T=>{a(j=>j.filter(pe=>"key"in pe?pe.key!==T:!0)),c==null||c(T)},[c]),u=t.onReset,f=r.useCallback(()=>{a(S),u==null||u()},[u]),m=t.onFilterClauseChanged,y=r.useCallback(T=>{i(T),m==null||m(T)},[m]);return e.jsxs("div",{style:rn,children:[e.jsx("div",{style:an,children:e.jsx(s,{objectType:l,filterDefinitions:o,titleIcon:ln,...t,onReset:f,onFilterRemoved:p,onFilterClauseChanged:y})}),e.jsx("div",{style:g,children:e.jsx(en,{objectType:l,filter:n})})]})}const J={name:"Full Featured",args:{title:"Employee Filters",showResetButton:!0,showActiveFilterCount:!0,enableSorting:!0},parameters:{docs:{description:{story:"Demonstrates all filter list features together: collapse, reset, active count, sorting, removable filters, per-filter search, exclude toggle, and the emitted where clause driving an ObjectTable."},source:{code:`// All features combined: collapse, sort, search, exclude, remove, reset
...
<FilterList
  ...
  enableSorting={true}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(On,{...t})};function Mn(t){const n=re(),i=r.useMemo(()=>n(l),[n]),[o,a]=r.useState(void 0),c=r.useMemo(()=>[{type:"HAS_LINK",linkName:"lead",label:"Has Manager"},{type:"LINKED_PROPERTY",linkName:"lead",reverseLinkName:"peeps",linkedPropertyKey:"department",filterComponent:"MULTI_SELECT",label:"Manager Department"}],[]),p=t.onFilterClauseChanged,u=r.useCallback(f=>{a(f),p==null||p(f)},[p]);return e.jsxs("div",{style:b,children:[e.jsx("div",{style:d,children:e.jsx(s,{objectType:l,objectSet:i,filterDefinitions:c,...t,onFilterClauseChanged:u})}),e.jsxs("div",{style:g,children:[e.jsx("strong",{children:"Filter Clause (JSON):"}),e.jsx("p",{children:"Note: LINKED_PROPERTY filter is not applied through where clause"}),e.jsx("pre",{style:C,children:o?JSON.stringify(o,null,2):"(no active filters)"})]})]})}const z={name:"Linked Property Filters",parameters:{docs:{description:{story:"Demonstrates filtering on properties of linked objects. HAS_LINK filters objects based on whether they have a linked object. LINKED_PROPERTY filters on a property of the linked object and exposes the same overflow (…) controls as direct property filters — the inline Keeping/Excluding dropdown and Clear all."},source:{code:`// HAS_LINK and LINKED_PROPERTY filter definitions
const filterDefinitions = [
  {
    type: "HAS_LINK",
    linkName: "lead",
...
<FilterList
  ...
  filterDefinitions={filterDefinitions}
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(Mn,{...t})},An={type:"PROPERTY",id:"combined-department",key:"department",label:"Department",filterComponent:"LISTOGRAM"},Pn={type:"PROPERTY",id:"combined-locationCity",key:"locationCity",label:"Location City",filterComponent:"MULTI_SELECT"},xn={type:"LINKED_PROPERTY",id:"combined-lead-name",linkName:"lead",reverseLinkName:"peeps",linkedPropertyKey:"fullName",filterComponent:"MULTI_SELECT",searchField:!1,label:"Manager Name"},In=[xn,An,Pn],Nn=[{locator:{type:"property",id:"fullName"}},{locator:{type:"property",id:"department"}},{locator:{type:"property",id:"locationCity"}},{locator:{type:"rdp",id:"managerName",creator:t=>t.pivotTo("lead").selectProperty("fullName")},renderHeader:()=>"Manager Name",renderCell:t=>"managerName"in t?e.jsx("span",{children:t.managerName}):e.jsx("span",{style:{color:"#999"},children:"No Manager"})}];function _n(t){const n=re(),i=r.useMemo(()=>n(l),[n]),[o,a]=r.useState(i);return e.jsxs("div",{style:rn,children:[e.jsx("div",{style:an,children:e.jsx(s,{...t,objectType:l,objectSet:i,filterDefinitions:In,onFilterClauseChanged:t.onFilterClauseChanged,onEffectiveObjectSet:a,showFilteredOutValues:!0})}),e.jsx("div",{style:g,children:e.jsx(en,{objectType:l,objectSet:o,columnDefinitions:Nn})})]})}const $={name:"Combined with Object Table",parameters:{docs:{description:{story:'A linked filter (Manager Name) and direct property filters coexist in one FilterList alongside an ObjectTable. Pass the unfiltered scope as `objectSet`; FilterList applies the linked-filter narrowing internally and emits the fully-narrowed `ObjectSet` via `onEffectiveObjectSet` for the table. The table surfaces the linked manager via a derived-property `Manager Name` column (`pivotTo("lead").selectProperty("fullName")`). With `showFilteredOutValues`, direct-facet values absent under the active linked filter render as greyed-out count=0 filtered-out rows.'},source:{code:`const baseObjectSet = useMemo(() => client(Employee), [client]);
...
<FilterList
  ...
  onFilterClauseChanged={setFilterClause}
/>`}}},render:t=>e.jsx(Yn,{...t})},Wn=[{value:"all",label:"All"},{value:"remote",label:"Remote"},{value:"onsite",label:"On-site"}];function Bn({filterState:t,onFilterStateChanged:n}){const i=t.customState.value;return e.jsxs("div",{children:[e.jsx("div",{style:{display:"flex",gap:4,marginBottom:6},children:Wn.map(o=>e.jsx("button",{type:"button","aria-pressed":i===o.value,style:{fontWeight:i===o.value?700:400},onClick:()=>n({type:"custom",customState:{value:o.value}}),children:o.label},o.value))}),e.jsxs("code",{style:{fontSize:11},children:["renderInput got: ",JSON.stringify(t)]})]})}function le(t){return{type:"CUSTOM",key:"remoteness",label:"Location",filterComponent:"CUSTOM",...t,renderInput:({filterState:n,onFilterStateChanged:i})=>e.jsx(Bn,{filterState:n,onFilterStateChanged:i}),toWhereClause:n=>{const i=n.customState.value;if(i==="remote")return{isRemote:!0};if(i==="onsite")return{isRemote:!1}}}}function se({heading:t,note:n,definition:i}){const[o,a]=r.useState(void 0),c=r.useMemo(()=>[i],[i]);return e.jsxs("div",{style:{width:300},children:[e.jsx("h4",{style:{marginBottom:2},children:t}),e.jsx("p",{style:{fontSize:11,marginTop:0,minHeight:32},children:n}),e.jsx(s,{objectType:l,filterDefinitions:c,showActiveFilterCount:!0,onFilterClauseChanged:a}),e.jsx("h5",{style:{marginBottom:2},children:"Where clause"}),e.jsx("pre",{style:C,children:o&&Object.keys(o).length>0?JSON.stringify(o):"(none)"})]})}function Vn(){return e.jsxs("div",{style:{display:"flex",gap:24},children:[e.jsx(se,{heading:"defaultFilterState",note:"The canonical spelling. Seeds the filter, so it applies on mount and counts as active.",definition:le({defaultFilterState:{type:"custom",customState:{value:"remote"}}})}),e.jsx(se,{heading:"filterState (deprecated)",note:"What existing definitions look like, since this field used to be required.",definition:le({filterState:{type:"custom",customState:{value:"remote"}}})}),e.jsx(se,{heading:"neither",note:"Only expressible once filterState stops being required. renderInput still needs a state object.",definition:le({})})]})}const Z={name:"Custom filter seeding",parameters:{docs:{description:{story:"Three `CUSTOM` definitions that differ only in which seed field is set, each with its own resulting where clause and active filter count. Compare the panels to see whether a given spelling only pre-fills the input or actually filters the object set. The third panel is the shape that becomes expressible once `filterState` is optional — `renderInput` reads `filterState.customState.value` without guarding, as a renderer written against the previously required field would."}}},render:()=>e.jsx(Vn,{})},Gn={type:"PROPERTY",id:"department-multi",key:"department",label:"Department",filterComponent:"MULTI_SELECT"},Un={type:"PROPERTY",id:"department-single",key:"department",label:"Department (single)",filterComponent:"SINGLE_SELECT"},Hn=[R,Gn,Un,ae],ee={name:"No value rendering",parameters:{docs:{description:{story:"Empty/null filter values render via the canonical `<NoValueLabel />` component — italic, muted, with the literal text 'No value' — across listogram buckets, single-select dropdown options, multi-select dropdown options, and multi-select chips. The mock dataset includes one Employee with `department: \"\"` so the No value row is visible in the listogram."},source:{code:`// Empty/null values render via <NoValueLabel /> across every filter type.
<FilterList
  objectType={Employee}
  filterDefinitions={[
    {
...
}`,...(Re=(Ee=w.parameters)==null?void 0:Ee.docs)==null?void 0:Re.source}}};var ve,Fe,Le;O.parameters={...O.parameters,docs:{...(ve=O.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  args: {
    showResetButton: true
  },
  parameters: {
...
}`,...(Le=(Fe=O.parameters)==null?void 0:Fe.docs)==null?void 0:Le.source}}};var je,De,ke;M.parameters={...M.parameters,docs:{...(je=M.parameters)==null?void 0:je.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(_e=(Ne=x.parameters)==null?void 0:Ne.docs)==null?void 0:_e.source}}};var Ye,We,Be;I.parameters={...I.parameters,docs:{...(Ye=I.parameters)==null?void 0:Ye.docs,source:{originalSource:`{
  args: {
    enableSorting: true
  },
  parameters: {
...
}`,...(Be=(We=I.parameters)==null?void 0:We.docs)==null?void 0:Be.source}}};var Ve,Ge,Ue;N.parameters={...N.parameters,docs:{...(Ve=N.parameters)==null?void 0:Ve.docs,source:{originalSource:`{
  args: {
    title: "Employee Filters",
    showActiveFilterCount: true
  },
...
}`,...(ze=(Je=Y.parameters)==null?void 0:Je.docs)==null?void 0:ze.source}}};var $e,Qe,Ze;W.parameters={...W.parameters,docs:{...($e=W.parameters)==null?void 0:$e.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,...(Ze=(Qe=W.parameters)==null?void 0:Qe.docs)==null?void 0:Ze.source}}};var et,tt,nt;B.parameters={...B.parameters,docs:{...(et=B.parameters)==null?void 0:et.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(nt=(tt=B.parameters)==null?void 0:tt.docs)==null?void 0:nt.source}}};var it,ot,rt;V.parameters={...V.parameters,docs:{...(it=V.parameters)==null?void 0:it.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(rt=(ot=V.parameters)==null?void 0:ot.docs)==null?void 0:rt.source}}};var at,lt,st;G.parameters={...G.parameters,docs:{...(at=G.parameters)==null?void 0:at.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,...(st=(lt=G.parameters)==null?void 0:lt.docs)==null?void 0:st.source}}};var ct,dt,pt;U.parameters={...U.parameters,docs:{...(ct=U.parameters)==null?void 0:ct.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(Rt=(Et=q.parameters)==null?void 0:Et.docs)==null?void 0:Rt.source}}};var vt,Ft,Lt;J.parameters={...J.parameters,docs:{...(vt=J.parameters)==null?void 0:vt.docs,source:{originalSource:`{
  name: "Full Featured",
  args: {
    title: "Employee Filters",
    showResetButton: true,
...
}`,...(Lt=(Ft=J.parameters)==null?void 0:Ft.docs)==null?void 0:Lt.source}}};var jt,Dt,kt;z.parameters={...z.parameters,docs:{...(jt=z.parameters)==null?void 0:jt.docs,source:{originalSource:`{
...
}`,...(_t=(Nt=Z.parameters)==null?void 0:Nt.docs)==null?void 0:_t.source}}};var Yt,Wt,Bt;ee.parameters={...ee.parameters,docs:{...(Yt=ee.parameters)==null?void 0:Yt.docs,source:{originalSource:`{
...
}`,...(Bt=(Wt=ee.parameters)==null?void 0:Wt.docs)==null?void 0:Bt.source}}};var Vt,Gt,Ut;te.parameters={...te.parameters,docs:{...(Vt=te.parameters)==null?void 0:Vt.docs,source:{originalSource:`{
...
}`,...(Zt=(Qt=oe.parameters)==null?void 0:Qt.docs)==null?void 0:Zt.source}}};const io=["Default","IntegerNumberRangeRounding","WithObjectSet","AddFilterMode","WithAllFilterTypes","WithTitleAndIcon","WithResetButton","WithActiveFilterCount","WithSorting","CollapsiblePanel","ControlledCollapse","KeywordSearch","WithColorMap","WithRenderValue","WithRenderValueAsReactNode","WithListogramDisplayModes","WithHiddenCounts","WithCheckbox","WithBelowFoldSelection","WithRemovableFilters","WithStaticValues","FullFeatured","WithLinkedPropertyFilters","CombinedWithObjectTable","WithCustomFilters","CustomFilterSeeding","NoValueRendering","WithDefaultFilterState","WithInitialFilterStates","WithResetButtonEmptyInitial","WithResetButtonNonEmptyInitial"];export{O as AddFilterMode,N as CollapsiblePanel,$ as CombinedWithObjectTable,_ as ControlledCollapse,Z as CustomFilterSeeding,D as Default,J as FullFeatured,k as IntegerNumberRangeRounding,Y as KeywordSearch,ee as NoValueRendering,x as WithActiveFilterCount,M as WithAllFilterTypes,K as WithBelowFoldSelection,H as WithCheckbox,W as WithColorMap,Q as WithCustomFilters,te as WithDefaultFilterState,U as WithHiddenCounts,ne as WithInitialFilterStates,z as WithLinkedPropertyFilters,G as WithListogramDisplayModes,w as WithObjectSet,X as WithRemovableFilters,B as WithRenderValue,V as WithRenderValueAsReactNode,P as WithResetButton,ie as WithResetButtonEmptyInitial,oe as WithResetButtonNonEmptyInitial,I as WithSorting,q as WithStaticValues,A as WithTitleAndIcon,io as __namedExportsOrder,no as default};
