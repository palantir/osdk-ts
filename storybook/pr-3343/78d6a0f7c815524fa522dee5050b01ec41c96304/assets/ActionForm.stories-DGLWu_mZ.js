import{R as f,O as $e,A as re,r as S,j as a,z as Qe,B as Ze,C as et}from"./iframe-CQsWIHX4.js";import{B as se,F as Y,S as X}from"./SubmissionOutputPanel-CPlldQLT.js";import{t as tt}from"./useEventCallback-5Uw0jOOe.js";import{a as nt}from"./assertUnreachable-tCT10eXl.js";import{u as ot}from"./makeExternalStore-DgmnuSMR.js";import{u as at}from"./toNumber-_MqBW0tU.js";import{w as it}from"./withOsdkMetrics-Dr0Jc4WU.js";import"./preload-helper-DeHQ25bj.js";import"./index-BZdihyUU.js";import"./InternalBackdrop-DVWpzKpj.js";import"./Button-Bo6XnFx1.js";import"./useBaseUiId-CJzjfth2.js";import"./composite-CEhoyh-F.js";import"./index-DeEfLW8W.js";import"./index-C95yrUQR.js";import"./index-DTvD48mG.js";import"./SkeletonBar-x9pMYkMS.js";import"./Tooltip-4WGyZxYS.js";import"./getDisabledMountTransitionStyles-CTMxiaXi.js";import"./ToolbarRootContext-DpcTF9uY.js";import"./PopoverPopup-CU1pE2G_.js";import"./info-sign-D43hX6NQ.js";import"./svgIconContainer-Dd6MU_-n.js";import"./cross-DCfjD-NF.js";import"./Input-DUNS0JHG.js";import"./useControlled-CxfZAwQ1.js";import"./chevron-up-DK9Rzehb.js";import"./chevron-down-DvHb1q_7.js";import"./Switch-tgNVIECi.js";import"./TimePicker-BqzVaGBp.js";import"./useValueChanged-K5xiKvco.js";import"./iconLoader-B-qZjccQ.js";import"./CompositeRoot-CCBbjY0H.js";import"./CompositeItem-C-Iymisy.js";import"./caret-down-BJBXE8n8.js";import"./CollapsiblePanel-BwxdrP1z.js";import"./error-WhfxxdpJ.js";import"./getPseudoElementBounds-CtMorKso.js";import"./small-cross-DpAyXmKA.js";import"./useOsdkClient-D0dCL2UR.js";import"./useRegisterUserAgent-CCrFfThV.js";function rt(t){const{observableClient:e,devtoolsEnabled:n}=f.useContext($e);ot(n,"useOsdkAction",t.apiName);const[o,s]=f.useState(),[T,l]=f.useState(),[c,h]=f.useState(!1),[y,b]=f.useState(!1),[N,Q]=f.useState(),m=f.useRef(null),I=f.useCallback(async function(i){try{if(y&&m.current&&(m.current.abort(),b(!1)),h(!0),s(void 0),Array.isArray(i)){const p=[],r=i.map(E=>{const{$optimisticUpdate:v,...Z}=E;return v&&p.push(v),Z}),w=await e.applyAction(t,r,{optimisticUpdate:E=>{for(const v of p)v==null||v(E)}});return l(w),w}else{const{$optimisticUpdate:p,...r}=i,w=await e.applyAction(t,r,{optimisticUpdate:p});return l(w),w}}catch(p){throw p instanceof re?s({actionValidation:p}):s({unknown:p}),p}finally{h(!1)}},[e,t,y]),A=f.useCallback(async function(i){var p;try{if(c)return;(p=m.current)==null||p.abort();const r=new AbortController;m.current=r,b(!0),s(void 0);const w=await e.validateAction(t,i);return r.signal.aborted?void 0:(Q(w),w)}catch(r){if(r instanceof Error&&r.name==="AbortError")return;throw r instanceof re?s({actionValidation:r}):s({unknown:r}),r}finally{b(!1)}},[e,t,c]);return f.useEffect(()=>()=>{var i;(i=m.current)==null||i.abort()},[]),f.useMemo(()=>({applyAction:I,validateAction:A,error:o,data:T,isPending:c,isValidating:y,validationResult:N}),[I,A,o,T,c,y,N])}function st(t,e){if(e!=null){if(t==null||typeof t=="object")return e;switch(t){case"string":case"marking":case"geohash":case"geoshape":case"objectType":return typeof e=="string"?e:String(e);case"integer":case"long":{const n=le(e);return n!=null?Math.trunc(n):void 0}case"double":return le(e);case"boolean":return typeof e=="boolean"?e:e==="true"?!0:e==="false"?!1:void 0;case"datetime":case"timestamp":return typeof e=="string"?Number.isNaN(Date.parse(e))?void 0:e:e instanceof Date?e.toISOString():void 0;case"attachment":case"mediaReference":return e;default:return e}}}function le(t){if(typeof t=="number")return t;if(typeof t=="string"){const e=t.trim();if(e==="")return;const n=Number(e);return Number.isNaN(n)?void 0:n}}function lt(t){return Object.entries(t.parameters).map(([e,n])=>ct(e,n))}function ct(t,e){const n={fieldKey:t,label:t,isRequired:!e.nullable,fieldType:e.type},o=e.type;if(typeof o=="object")switch(o.type){case"objectSet":return{...n,fieldComponent:"OBJECT_SET",fieldComponentProps:{value:null}};case"object":return{...n,fieldComponent:"OBJECT_SELECT",fieldComponentProps:{objectType:{type:"object",apiName:o.object}}};case"interface":case"struct":return{...n,fieldComponent:"UNSUPPORTED",fieldComponentProps:{}}}switch(o){case"string":return{...n,fieldComponent:"TEXT_INPUT",fieldComponentProps:{}};case"marking":case"geohash":case"geoshape":case"objectType":case"scenarioReference":return{...n,fieldComponent:"UNSUPPORTED",fieldComponentProps:{}};case"boolean":return{...n,fieldComponent:"RADIO_BUTTONS",fieldComponentProps:{options:[{label:"True",value:!0},{label:"False",value:!1}]}};case"integer":case"double":case"long":return{...n,fieldComponent:"NUMBER_INPUT",fieldComponentProps:{}};case"datetime":case"timestamp":return{...n,fieldComponent:"DATETIME_PICKER",fieldComponentProps:{}};case"attachment":case"mediaReference":return{...n,fieldComponent:"FILE_PICKER",fieldComponentProps:{}};default:return nt(o)}}function ee(){return ee=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var o in n)({}).hasOwnProperty.call(n,o)&&(t[o]=n[o])}return t},ee.apply(null,arguments)}const mt=[],pt=[],ut=tt(function({actionDefinition:t,formTitle:e,showFormTitle:n=!1,formFieldDefinitions:o,formState:s,onFormStateChange:T,isSubmitDisabled:l,onSubmit:c,onValidationResponse:h,onSuccess:y,onError:b}){const{applyAction:N,isPending:Q}=rt(t),{metadata:m,loading:I,error:A}=at(t);S.useEffect(function(){A!=null&&(b==null||b({type:"unknown",error:A}))},[A,b]);const i=m==null?void 0:m.parameters,p=S.useMemo(()=>o==null?null:o.map(d=>{var D;const{defaultValue:F,...g}=d;return{...g,fieldKey:String(d.fieldKey),fieldType:(D=i==null?void 0:i[String(d.fieldKey)])==null?void 0:D.type,fieldComponentProps:F===void 0?d.fieldComponentProps:{...d.fieldComponentProps,defaultValue:F}}}),[o,i]),r=S.useMemo(()=>p??(m!=null?lt(m):mt),[p,m]),w=S.useMemo(()=>r.length===0?pt:r.map(d=>({type:"field",definition:d})),[r]),E=S.useCallback(d=>{var g;const F={};for(const[D,ze]of Object.entries(d))F[D]=st((g=i==null?void 0:i[D])==null?void 0:g.type,ze);return F},[i]),v=S.useCallback(async d=>{const F=E(d);try{if(c!=null)await c(F,N);else{const g=await N(F);y==null||y(g)}}catch(g){b==null||b({type:"submission",error:g})}},[E,c,N,y,b]),Z=S.useCallback((d,F)=>{T==null||T(g=>({...g,[d]:F}))},[T]),ie={formTitle:n?e??(m==null?void 0:m.displayName)??t.apiName:void 0,formContent:w,onSubmit:v,isSubmitDisabled:l,isPending:Q,isLoading:I,onFieldValueChange:Z};return s==null?f.createElement(se,ie):f.createElement(se,ee({},ie,{formState:s}))}),J=it(ut,"ActionForm"),{expect:u,fn:P,userEvent:C,waitFor:R,within:x}=__STORYBOOK_MODULE_TEST__,Xe=Qe.actionDefinition,dt=Ze.actionDefinition,ft=et.actionDefinition,yt=1500,bt=[{fieldKey:"fullName",label:"Full name",fieldComponent:"TEXT_INPUT",defaultValue:"Grace Hopper",fieldComponentProps:{}},{fieldKey:"yearsExperience",label:"Years of experience",fieldComponent:"NUMBER_INPUT",defaultValue:42,fieldComponentProps:{min:0}},{fieldKey:"isRemote",label:"Remote employee",fieldComponent:"RADIO_BUTTONS",defaultValue:!0,fieldComponentProps:{options:[{label:"True",value:!0},{label:"False",value:!1}]}},{fieldKey:"isFullTime",label:"Employment type",fieldComponent:"DROPDOWN",defaultValue:!0,fieldComponentProps:{items:[!0,!1],itemToStringLabel:t=>t===!0?"Full-time":"Contractor",placeholder:"Select employment type"}}],ht=[{fieldKey:"fullName",label:"Employee legal name",fieldComponent:"TEXT_INPUT",helperText:"Use the name that should appear in HR records.",fieldComponentProps:{placeholder:"Ada Lovelace",minLength:2}},{fieldKey:"yearsExperience",label:"Relevant experience",fieldComponent:"NUMBER_INPUT",helperText:"Whole years only.",fieldComponentProps:{min:0,max:80}},{fieldKey:"isRemote",label:"Remote employee",fieldComponent:"SWITCH",helperText:"Turn on when the employee is not assigned to an office.",fieldComponentProps:{}},{fieldKey:"isFullTime",label:"Employment type",fieldComponent:"DROPDOWN",helperText:"Choose whether this employee is full-time or a contractor.",fieldComponentProps:{items:[!0,!1],itemToStringLabel:t=>t===!0?"Full-time":"Contractor",placeholder:"Select employment type"}}],B=P().mockName("onSuccess"),te=P().mockName("onError"),ne=P().mockName("onSubmit"),oe=P().mockName("onSubmit:slow"),ae=P().mockName("onSubmit:failure");function St(t){B(t)}function z(t,e){return e(t)}function Tt(t,e){return e(t)}function wt(t,e){return e(t)}const Ft=(t,e)=>(ne(t),z(t,e)),gt=async(t,e)=>(oe(t),await Je(yt),z(t,e)),Ct=async t=>{throw ae(t),await Je(300),new Error("Demo submission failed")};function Je(t){return new Promise(e=>setTimeout(e,t))}function $({applyStoryAction:t,onSubmit:e}){const[n,o]=S.useState({status:"idle"}),s=S.useCallback(async(l,c)=>{o({status:"submitting",submittedValues:l});try{let h;if(e==null){const y=await t(l,c);St(y),h=y}else h=await e(l,c);return o({status:"success",submittedValues:l,response:h}),h}catch(h){throw o({status:"error",submittedValues:l,error:h}),h}},[t,e]);return{handleStoryError:S.useCallback(l=>{o(c=>({...c,status:"error",error:l})),te(l)},[]),handleStorySubmit:s,submission:n}}function vt({formFieldDefinitions:t,formTitle:e,isSubmitDisabled:n,onSubmit:o,showFormTitle:s}){const{handleStoryError:T,handleStorySubmit:l,submission:c}=$({applyStoryAction:z,onSubmit:o});return a.jsx(Y,{output:a.jsx(X,{idleMessage:"Submit the form to see the action response.",snapshot:c}),children:a.jsx(J,{actionDefinition:Xe,formFieldDefinitions:t,formTitle:e,isSubmitDisabled:n,onError:T,onSubmit:l,showFormTitle:s})})}function Nt(){const{handleStoryError:t,handleStorySubmit:e,submission:n}=$({applyStoryAction:Tt});return a.jsx(Y,{output:a.jsx(X,{idleMessage:"Submit the form to see the action response.",snapshot:n}),children:a.jsx(J,{actionDefinition:dt,onError:t,onSubmit:e,showFormTitle:!0})})}function At(){const{handleStoryError:t,handleStorySubmit:e,submission:n}=$({applyStoryAction:wt});return a.jsx(Y,{output:a.jsx(X,{idleMessage:"Submit the form to see the action response.",snapshot:n}),children:a.jsx(J,{actionDefinition:ft,onError:t,onSubmit:e,showFormTitle:!0})})}const hn={title:"Components/ActionForm/Usage",component:vt,tags:["beta"],parameters:{controls:{expanded:!0},docs:{description:{component:"ActionForm fetches action metadata through @osdk/react, renders fields for each action parameter, validates user input, and submits through useOsdkAction."}}},argTypes:{formFieldDefinitions:{control:!1,description:"Complete replacement for generated fields. Include every action parameter that should appear in the form."},formTitle:{control:"text",description:"Optional title used when showFormTitle is true."},isSubmitDisabled:{control:"boolean",description:"Disables the submit button before validation runs."},onSubmit:{control:!1,table:{category:"Events"}},showFormTitle:{control:"boolean",description:"Shows the form title above the generated fields."}},args:{isSubmitDisabled:!1,showFormTitle:!1}},O={render:()=>a.jsx(Nt,{}),parameters:{docs:{description:{story:"Shows ActionForm's default behavior: it maps action metadata to generated field components when no formFieldDefinitions are provided."},source:{code:`import { ActionForm } from "@osdk/react-components/experimental";
...
}`,...(pe=(me=O.parameters)==null?void 0:me.docs)==null?void 0:pe.source}}};var ue,de,fe;U.parameters={...U.parameters,docs:{...(ue=U.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
