...
<BaseForm
  formContent={formContent}
  onSubmit={(formState) => console.log("Submitted:", formState)}
/>`}}},render:()=>t.jsx(ft,{})};function ft(){const n=Y(),o=l.useMemo(()=>n(z),[n]),a=l.useMemo(()=>[e({fieldKey:"name",fieldComponent:"TEXT_INPUT",label:"Name",isRequired:!0,fieldComponentProps:{placeholder:"Enter a name"}}),e({fieldKey:"employees",fieldComponent:"OBJECT_SET",label:"Employees",fieldComponentProps:{value:o}})],[o]);return t.jsx(p,{formContent:a,onSubmit:r})}const Ct=[e({fieldKey:"department",fieldComponent:"DROPDOWN",label:"Department (Select)",fieldComponentProps:{items:m,placeholder:"Select department..."}}),e({fieldKey:"team",fieldComponent:"DROPDOWN",label:"Team (Searchable)",fieldComponentProps:{items:m,isSearchable:!0,placeholder:"Search teams..."}})],_={args:{formContent:Ct,onSubmit:r},parameters:{docs:{source:{code:`const formContent = [
  {
    fieldKey: "department",
    fieldComponent: "DROPDOWN",
...
<BaseForm
  formContent={formContent}
  onSubmit={(formState) => console.log("Submitted:", formState)}
/>`}}}},bt=[e({fieldKey:"department",fieldComponent:"DROPDOWN",label:"Department (creatable)",fieldComponentProps:{items:m,createNewItemFromQuery:ee,createNewItemRenderer:n=>t.jsxs("span",{children:[t.jsx("strong",{children:"Add"}),' new department "',n,'"']}),placeholder:"Search or create a department..."}}),e({fieldKey:"tags",fieldComponent:"DROPDOWN",label:"Tags (creatable multi-select)",fieldComponentProps:{items:u,isMultiple:!0,createNewItemFromQuery:ee,placeholder:"Search or create tags..."}})],O={args:{formContent:bt,onSubmit:r},parameters:{docs:{description:{story:'Passing `createNewItemFromQuery` turns a dropdown into a creatable combobox: typing a value that matches no existing item offers a "Create …" option that commits the typed value (by click or by pressing Enter). Works for single-select and multi-select, where it behaves like a tag input. Pass `createNewItemRenderer` to customize the visible content of the "Create …" option (the accessible name stays the default).'},source:{code:`const coerceStringQuery = (query) => query.trim();
...
<BaseForm
  formContent={formContent}
  onSubmit={(formState) => console.log("Submitted:", formState)}
/>`}}}};function Kt(){const n=Y(),o=l.useMemo(()=>n(z).where({department:"Marketing"}),[n]),a=l.useMemo(()=>[e({fieldKey:"employee",fieldComponent:"OBJECT_SELECT",label:"Marketing employee",helperText:"This selector is scoped by an ObjectSet.",fieldComponentProps:{objectSet:o,placeholder:"Search Marketing employees…"}})],[o]);return t.jsx(p,{formContent:a,onSubmit:r})}const k={render:()=>t.jsx(Kt,{}),parameters:{docs:{source:{code:`function ScopedEmployeeForm() {
...
}`,...(ae=(re=C.parameters)==null?void 0:re.docs)==null?void 0:ae.source}}};var le,ie,se;S.parameters={...S.parameters,docs:{...(le=S.parameters)==null?void 0:le.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,...(Qe=(Je=_.parameters)==null?void 0:Je.docs)==null?void 0:Qe.source}}};var He,Ge,ze;K.parameters={...K.parameters,docs:{...(He=K.parameters)==null?void 0:He.docs,source:{originalSource:`{
  args: {
...
}`,...(ze=(Ge=K.parameters)==null?void 0:Ge.docs)==null?void 0:ze.source}}};var Ye,$e,Ze;O.parameters={...O.parameters,docs:{...(Ye=O.parameters)==null?void 0:Ye.docs,source:{originalSource:`{
  args: {
...
}`,...(Ze=($e=O.parameters)==null?void 0:$e.docs)==null?void 0:Ze.source}}};var en,nn,tn;x.parameters={...x.parameters,docs:{...(en=x.parameters)==null?void 0:en.docs,source:{originalSource:`{
  args: {
...
}`,...(tn=(nn=x.parameters)==null?void 0:nn.docs)==null?void 0:tn.source}}};var on,rn,an;U.parameters={...U.parameters,docs:{...(on=U.parameters)==null?void 0:on.docs,source:{originalSource:`{
  args: {
...
}`,...(an=(rn=U.parameters)==null?void 0:rn.docs)==null?void 0:an.source}}};var ln,sn,mn;w.parameters={...w.parameters,docs:{...(ln=w.parameters)==null?void 0:ln.docs,source:{originalSource:`{
