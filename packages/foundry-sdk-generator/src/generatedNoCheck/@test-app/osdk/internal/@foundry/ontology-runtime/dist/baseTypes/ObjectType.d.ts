import type { AllValueTypes as OG_AllValueTypes, AttachmentType as OG_AttachmentType, BaseType as OG_BaseType, BooleanType as OG_BooleanType, ByteType as OG_ByteType, DateType as OG_DateType, DecimalType as OG_DecimalType, DoubleType as OG_DoubleType, FloatType as OG_FloatType, GeoPointType as OG_GeoPointType, GeoShapeType as OG_GeoShapeType, IntegerType as OG_IntegerType, LongType as OG_LongType, ObjectType as OG_ObjectType, ObjectTypeProperties as OG_ObjectTypeProperties, OntologyType as OG_OntologyType, QueryBucketKeyType as OG_QueryBucketKeyType, QueryBucketRangeableType as OG_QueryBucketRangeableType, QueryBucketValueType as OG_QueryBucketValueType, ShortType as OG_ShortType, StringType as OG_StringType, StructField as OG_StructField, StructType as OG_StructType, TimestampType as OG_TimestampType } from '@osdk/legacy-client';
...
import type { ArrayType as OG_ArrayType, SetType as OG_SetType, TimeSeriesType as OG_TimeSeriesType } from '@osdk/legacy-client';
/** @deprecated submodule imports arent public api **/
...
/** @deprecated submodule imports arent public api **/
export type BaseObjectType<TOntologyObject extends OntologyObject = OntologyObject> = OG_BaseObjectType<TOntologyObject>;
...
/** @deprecated submodule imports arent public api **/
export type TwoDimensionalAggregationType<TGroupKey extends QueryBucketKeyType, TValue extends QueryBucketValueType> = OG_TwoDimensionalAggregationType<TGroupKey, TValue>;
import type { ThreeDimensionalAggregationType as OG_ThreeDimensionalAggregationType } from '@osdk/legacy-client';
/** @deprecated submodule imports arent public api **/
export type ThreeDimensionalAggregationType<TGroupKey extends QueryBucketKeyType, TSegmentKey extends QueryBucketKeyType, TValue extends QueryBucketValueType> = OG_ThreeDimensionalAggregationType<TGroupKey, TSegmentKey, TValue>;
