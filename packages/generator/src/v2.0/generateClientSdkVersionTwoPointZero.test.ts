...
describe("generator", () => {
  ...
  test("should be able to generate a project", async () => {
    ...
    expect(
      ...
      export interface SomeInterface extends $InterfaceDefinition<'SomeInterface'> {
        osdkMetadata: typeof $osdkMetadata;
        type: 'interface';
  ...
  it("does not throw an error if a namespace is provided that all top levels use", async () => {
    ...
    expect(tweakedFilesForSnapshotConsistency(helper.getFiles()))
      .toMatchInlineSnapshot(`
        ...
        export interface SomeInterface extends $InterfaceDefinition<'foo.bar.SomeInterface'> {
          osdkMetadata: typeof $osdkMetadata;
          type: 'interface';
        ...
        export interface Person extends $ObjectTypeDefinition<'foo.bar.Person'> {
          osdkMetadata: typeof $osdkMetadata;
          type: 'object';
        ...
        export interface Todo extends $ObjectTypeDefinition<'foo.bar.Todo'> {
          osdkMetadata: typeof $osdkMetadata;
          type: 'object';
