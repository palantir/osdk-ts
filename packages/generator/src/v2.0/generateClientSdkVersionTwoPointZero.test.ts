  ...
  test(
    ...
    async () => {
      ...
      expect(
        ...
        ",
          "/foo/UNSTABLE_DO_NOT_USE/ontology-metadata.d.cts": "import type { OntologyFullMetadata } from '@osdk/foundry.ontologies';

        declare const ontologyFullMetadata: OntologyFullMetadata;

        export = ontologyFullMetadata;
        ",
          "/foo/UNSTABLE_DO_NOT_USE/ontology-metadata.d.mts": "import type { OntologyFullMetadata } from '@osdk/foundry.ontologies';

        declare const ontologyFullMetadata: OntologyFullMetadata;

        export default ontologyFullMetadata;
        ",
          "/foo/UNSTABLE_DO_NOT_USE/ontology-metadata.d.ts": "import type { OntologyFullMetadata } from '@osdk/foundry.ontologies';

        declare const ontologyFullMetadata: OntologyFullMetadata;

        export = ontologyFullMetadata;
        ",
          "/foo/UNSTABLE_DO_NOT_USE/ontology-metadata.json": "{
            "ontology": {
                "rid": "ridHere",
                ...
                "foo.bar.markTodoCompleted": {
                    ...
                    "parameters": {
                        "object": {
                            ...
                            "dataType": {
                                "type": "object",
                                "objectApiName": "foo.bar.Todo",
                                "objectTypeApiName": "foo.bar.Todo"
                            },
                            "required": false,
                            "typeClasses": []
                        }
                    ...
                    "linkTypes": [
                        {
                            ...
                            "cardinality": "ONE",
                            "displayName": "Assignee",
                            "objectTypeApiName": "foo.bar.Person",
                            "status": "ACTIVE",
                            "foreignKeyPropertyApiName": "email",
                            "linkTypeRid": ""
                        }
