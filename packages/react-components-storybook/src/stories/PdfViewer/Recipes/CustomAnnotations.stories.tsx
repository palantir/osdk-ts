...
const CUSTOM_ANNOTATIONS: PdfAnnotation[] = [
  {
    ...
    type: "custom",
    page: 1,
    rect: { x: 100, y: 700, width: 120, height: 28 },
    label: "Key finding",
  ...
  },
  {
    ...
    type: "custom",
    page: 1,
    rect: { x: 450, y: 650, width: 24, height: 24 },
    label: "1",
  ...
  },
  {
    ...
    type: "custom",
    page: 1,
    rect: { x: 450, y: 550, width: 24, height: 24 },
    label: "2",
    render: (props) => <NumberBadge {...props} />,
  },
  {
    ...
    type: "highlight",
    page: 1,
    rect: { x: 100, y: 650, width: 300, height: 18 },
    label: "Standard highlight for comparison",
  },
];
