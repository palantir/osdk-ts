...
["src/widget.tsx.hbs", { type: "raw",  body: `import { \$Actions, \$Objects, \$Queries } from "{{osdkPackage}}";
import {
  Box,
  Button,
  Checkbox,
...
["vite.config.ts.hbs", { type: "raw",  body: `import foundryWidgetPlugin from "@osdk/widget.vite-plugin.unstable";
