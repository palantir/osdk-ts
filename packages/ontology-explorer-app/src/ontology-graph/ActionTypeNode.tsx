...
import type { ActionTypeNode as ActionTypeNodeType } from "./graphElements.js";

import styles from "./entityNode.module.scss";

export function ActionTypeNode(
  props: NodeProps<ActionTypeNodeType>,
): React.ReactElement {
  ...
  return (
    <div
      className={classNames(styles.node, styles.action, {
    ...
    >
      ...
      />
      <div className={styles.kind}>Action type</div>
      <div className={styles.header}>
        <Icon icon="lightning" size={14} className={styles.icon} />
      ...
      {info.loadState === "loaded" && (
        <div className={styles.footer}>
          ...
          <span className={styles.stat}>{info.operations.length} edits</span>
        </div>
      )}
