...
//
//   import { custom, initAliases } from "@osdk/functions/browser-aliases";
//
//   // Once at bootstrap. Reads the installer's resolved values on an installed
//   // site, and the author's declared defaults everywhere else.
//   await initAliases();
//
