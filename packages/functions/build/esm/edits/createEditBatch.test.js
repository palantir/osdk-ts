...
describe(createEditBatch, () => {
  ...
  it("collects all edits", () => {
    ...
    editBatch.update(taskInstance, {
      name: "My Very New Task Name"
    });
    editBatch.create(Task, {
      id: 0,
      name: "My Task Name"
    ...
    editBatch.link(taskInstance, "RP", {
      $apiName: "Person",
      $primaryKey: 2
    });
    editBatch.unlink({
...
//# sourceMappingURL=createEditBatch.test.js.map