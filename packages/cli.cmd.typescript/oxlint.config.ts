...
// Nested oxlint config for @osdk/cli.cmd.typescript. It inherits the whole repo ruleset by
...
export default defineConfig({
  ...
  rules: {
    "no-case-declarations": "off", // `case` blocks that declare without braces; the switches are intentional.
    "no-inner-declarations": "off", // A declaration nested in a block; intentional.
    "no-return-assign": "off", // An assignment inside a `return`; intentional.
