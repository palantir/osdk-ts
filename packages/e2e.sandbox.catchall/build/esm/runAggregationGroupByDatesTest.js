...
export async function runAggregationGroupByDatesTest() {
  ...
  const rangedTimestamps = await client(BuilderDeploymentState).aggregate({
    ...
    $groupBy: {
      currentTimestamp: {
        $ranges: [["2023-04-02T17:28:00Z", "2023-04-03T18:28:00Z"], ["2023-04-05T17:28:00Z", "2023-04-06T11:28:00Z"]]
      }
    }
  });
  console.log(groupedTimestamps[0].$group.currentTimestamp);
  console.log(groupedDates[0].$group.date);
  console.log(rangedTimestamps[0].$group.currentTimestamp.startValue, rangedTimestamps[0].$group.currentTimestamp.endValue, rangedTimestamps[0].$count);
  console.log(rangedDates[0].$group.date.startValue, rangedDates[0].$group.date.endValue, rangedDates[0].$count);
}
void runAggregationGroupByDatesTest();
//# sourceMappingURL=runAggregationGroupByDatesTest.js.map