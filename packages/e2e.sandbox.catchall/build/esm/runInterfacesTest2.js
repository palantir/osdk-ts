...
export async function runInterfacesTest2() {
  ...
  !(athletes.data.length > 0) ? process.env.NODE_ENV !== "production" ? invariant(false) : invariant(false) : void 0;
  ...
  !(athletesSelected.data.length > 0) ? process.env.NODE_ENV !== "production" ? invariant(false) : invariant(false) : void 0;
...
//# sourceMappingURL=runInterfacesTest2.js.map