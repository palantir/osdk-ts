...
export async function fetchEmployeePage(client) {
  const result = await client(Employee).fetchPage();
  expectType(""); // FIXME: this isn't strict enough of a check for below
  expectType(result.data[0].businessTitle);
...
//# sourceMappingURL=fetchEmployeePage.js.map