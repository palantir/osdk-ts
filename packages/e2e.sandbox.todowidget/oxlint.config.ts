...
// Nested oxlint config for @osdk/e2e.sandbox.todowidget. It inherits the whole repo ruleset by
...
export default defineConfig({
  ...
  rules: {
    ...
    "unicorn/relative-url-style": "off", // `new URL("./x", import.meta.url)` relative style; intentional.
  },
});
