...
import type {
  ...
  ResourceConstraintsConfig as _constraints_ResourceConstraintsConfig,
} from "../__components.js";

/**
 * Sets the specified resource constraints for the specified compass rid for queries ran by the specified
 * module group producer.
 */
export async function setResourceConstraintsConfig(
  ctx: ConjureContext,
