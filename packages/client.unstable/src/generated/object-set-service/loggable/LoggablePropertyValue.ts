...
import type { LoggableStructPropertyValue } from "./LoggableStructPropertyValue.js";
...
export interface LoggablePropertyValue_struct {
  type: "struct";
  struct: LoggableStructPropertyValue;
}
...
/**
 * See com.palantir.object.set.api.PropertyValue
 */
