 ...
 * It can be a literal, a reference to another property or an operation.
 */
export type TemplatedCalculatedPropertyDefinition =
  | TemplatedCalculatedPropertyDefinition_numeric
  | TemplatedCalculatedPropertyDefinition_datetime;
 ...
 * An operation on one or two property nodes of type datetime for the purposes of defining a derived property.
 */
export type TemplatedDateTimeOperation =
  | TemplatedDateTimeOperation_max
  | TemplatedDateTimeOperation_min;
 ...
 * A calculation node that is used to define a derived property via an operation which returns a date output.
 */
export type TemplatedDateTimeOutputCalculation =
  | TemplatedDateTimeOutputCalculation_literal
  | TemplatedDateTimeOutputCalculation_propertyIdentifier
  | TemplatedDateTimeOutputCalculation_operation;
 ...
 * returns a numeric output.
 */
export type TemplatedDateTimeToNumericCalculation =
  TemplatedDateTimeToNumericCalculation_extractDatePart;
...
export type TemplatedDerivedPropertyAggregation =
  | TemplatedDerivedPropertyAggregation_count
  | TemplatedDerivedPropertyAggregation_avg
  | TemplatedDerivedPropertyAggregation_max
  | TemplatedDerivedPropertyAggregation_min
  | TemplatedDerivedPropertyAggregation_sum
  | TemplatedDerivedPropertyAggregation_percentile
  | TemplatedDerivedPropertyAggregation_cardinality
  | TemplatedDerivedPropertyAggregation_exactCardinality
  | TemplatedDerivedPropertyAggregation_standardDeviation
  | TemplatedDerivedPropertyAggregation_variance
  | TemplatedDerivedPropertyAggregation_collectList
  | TemplatedDerivedPropertyAggregation_collectSet;
 ...
 * linked objects aggregation property or a calculated property.
 */
export type TemplatedDerivedPropertyDefinition =
  | TemplatedDerivedPropertyDefinition_nativeProperty
  | TemplatedDerivedPropertyDefinition_linkedObjectProperty
  | TemplatedDerivedPropertyDefinition_linkedObjectsAggregationProperty
  | TemplatedDerivedPropertyDefinition_calculatedProperty
  | TemplatedDerivedPropertyDefinition_linkedProperty
 ...
 * Union type for valid queries over geo shape properties.
 */
export type TemplatedGeoShapeQuery =
  | TemplatedGeoShapeQuery_geoBoundingBoxFilter
  | TemplatedGeoShapeQuery_geoPolygonFilter;
 ...
 * They are ephemeral and only exist for the lifetime of a request.
 */
export type TemplatedLegacyDerivedProperties = Record<
  PropertyTemplateId,
 ...
 * Links can be defined statically at write-time or dynamically as a result of a computation.
 */
export type TemplatedLinkDefinition =
  | TemplatedLinkDefinition_nativeLink
  | TemplatedLinkDefinition_methodLink;
 ...
 * An operation on one or two property nodes for the purposes of defining a derived property.
 */
export type TemplatedNumericOperation =
  | TemplatedNumericOperation_add
  | TemplatedNumericOperation_subtract
  | TemplatedNumericOperation_divide
  | TemplatedNumericOperation_multiply
  | TemplatedNumericOperation_negate
  | TemplatedNumericOperation_absolute
  | TemplatedNumericOperation_max
  | TemplatedNumericOperation_min;
 ...
 * A calculation node that is used to define a derived property via a numeric operation.
 */
export type TemplatedNumericOutputCalculation =
  | TemplatedNumericOutputCalculation_operation
  | TemplatedNumericOutputCalculation_literal
  | TemplatedNumericOutputCalculation_propertyId
  | TemplatedNumericOutputCalculation_property
  | TemplatedNumericOutputCalculation_fromDateTimeCalculation;
...
export type TemplatedObjectSet =
  | TemplatedObjectSet_base
  | TemplatedObjectSet_interfaceBase
  | TemplatedObjectSet_static
  | TemplatedObjectSet_referenced
  | TemplatedObjectSet_filtered
  | TemplatedObjectSet_intersected
  | TemplatedObjectSet_subtracted
  | TemplatedObjectSet_unioned
  | TemplatedObjectSet_searchAround
  | TemplatedObjectSet_softLinkSearchAround
  | TemplatedObjectSet_interfaceLinkSearchAround
  | TemplatedObjectSet_asType
  | TemplatedObjectSet_asBaseObjectTypes
  | TemplatedObjectSet_knn
  | TemplatedObjectSet_knnV2
  | TemplatedObjectSet_methodInput
 ...
 * Filter to be applied to an Object Set. Refer to documentation of a particular ObjectSetFilter for details.
 */
export type TemplatedObjectSetFilter =
  | TemplatedObjectSetFilter_or
  | TemplatedObjectSetFilter_and
  | TemplatedObjectSetFilter_not
  | TemplatedObjectSetFilter_range
  | TemplatedObjectSetFilter_wildcard
  | TemplatedObjectSetFilter_terms
  | TemplatedObjectSetFilter_exactMatch
  | TemplatedObjectSetFilter_phrase
  | TemplatedObjectSetFilter_prefixOnLastToken
  | TemplatedObjectSetFilter_geoBoundingBox
  | TemplatedObjectSetFilter_geoDistance
  | TemplatedObjectSetFilter_geoPolygon
  | TemplatedObjectSetFilter_geoShape
  | TemplatedObjectSetFilter_objectType
  | TemplatedObjectSetFilter_interfaceType
  | TemplatedObjectSetFilter_hasProperty
  | TemplatedObjectSetFilter_linkPresence
  | TemplatedObjectSetFilter_objectSetLink
  | TemplatedObjectSetFilter_objectSetInterfaceLink
  | TemplatedObjectSetFilter_multiMatch
  | TemplatedObjectSetFilter_relativeDateRange
  | TemplatedObjectSetFilter_relativeTimeRange
  | TemplatedObjectSetFilter_parameterizedRange
  | TemplatedObjectSetFilter_parameterizedWildcard
  | TemplatedObjectSetFilter_parameterizedTerms
  | TemplatedObjectSetFilter_parameterizedExactMatch
  | TemplatedObjectSetFilter_parameterizedPrefixOnLastToken
  | TemplatedObjectSetFilter_userContext;
 ...
 * Identifier of an object type or interface type.
 */
export type TemplatedObjectTypeOrInterfaceTypeIdentifier =
  | TemplatedObjectTypeOrInterfaceTypeIdentifier_objectTypeRid
  | TemplatedObjectTypeOrInterfaceTypeIdentifier_interfaceTypeRid;
 ...
 * Identifier of a property.
 */
export type TemplatedPropertyIdentifier =
  | TemplatedPropertyIdentifier_propertyId
  | TemplatedPropertyIdentifier_propertyApiName
  | TemplatedPropertyIdentifier_structFieldSelector
  | TemplatedPropertyIdentifier_titleProperty
  | TemplatedPropertyIdentifier_primaryKeyProperty;
 ...
 * Specification of a subset of properties to use.
 */
export type TemplatedPropertySet =
  | TemplatedPropertySet_propertyWhitelist
  | TemplatedPropertySet_allProperties;
 ...
 * Note: this is currently under development and is not supported!
 */
export type TemplatedRelationIdentifier =
  | TemplatedRelationIdentifier_relationId
  | TemplatedRelationIdentifier_interfaceLinkType;
 ...
 */
export type TemplatedUserContextValue =
  | TemplatedUserContextValue_multipassUserId
  | TemplatedUserContextValue_multipassAttribute;
