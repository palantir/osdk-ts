...
export interface CreateInstallationForBlockSetRequest {
  ...
  displayMetadata?: _api_BlockSetInstallationDisplayMetadata | null | undefined;
...
export interface ListInstallationsForEntityIdRequest {
  pageSize?: number | null | undefined;
  pageToken?: _api_BlockSetInstallationRid | null | undefined;
}
export interface ListInstallationsForEntityIdResponse {
  installations: Array<ManagedInstallation>;
  nextPageToken?: _api_BlockSetInstallationRid | null | undefined;
}
/**
...
export interface ManagedInstallationConfigurationV0Update {
  cbacMarkings?: Array<_api_MarkingId> | null | undefined;
  inputMapping: Record<
    _api_InputBlockSetShapeId,
    _api_ResolvedBlockSetInputShape
  >;
