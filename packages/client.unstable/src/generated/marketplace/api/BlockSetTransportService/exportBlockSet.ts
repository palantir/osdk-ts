...
import type {
  ...
  ExportBlockSetRequest as _api_ExportBlockSetRequest,
  MarketplaceRid as _api_MarketplaceRid,
} from "../__components.js";

/**
 * Streams the block set as a single archive in a standard layout.
 ...
 */
export async function exportBlockSet(
  ctx: ConjureContext,
  marketplaceRid: _api_MarketplaceRid,
  blockSetVersionId: _api_BlockSetVersionId,
  request: _api_ExportBlockSetRequest,
): Promise<string> {
  return conjureFetch(
    ctx,
    `/block-set-transport/${marketplaceRid}/version/${blockSetVersionId}`,
    "POST",
    request,
    undefined,
    undefined,
