...
import type {
  ...
  GenerateCompassLocationInputShapesResponse as _api_GenerateCompassLocationInputShapesResponse,
 ...
 * Throws `GenerateCompassLocationShapesFailed` if an unexpected error is encountered.
 */
