...
import type {
  ...
  InterfaceTypeReference as _api_InterfaceTypeReference,
  LocalizedTitleAndDescription as _api_LocalizedTitleAndDescription,
...
export interface DataType_interface {
  type: "interface";
  interface: InterfaceType;
}

export interface DataType_interfaceObjectSet {
  type: "interfaceObjectSet";
  interfaceObjectSet: InterfaceObjectSetType;
}
...
export interface DataType_typeReference {
  type: "typeReference";
...
export type ObjectPrimaryKey = Record<
  _api_ObjectTypePropertyReference,
  ObjectPrimaryKeyValue
>;

/**
 * Value in a primary key map, can contain arbitrary data
 */
export type ObjectPrimaryKeyValue = any;
...
/**
 * The safe-loggable unique identifier for a type reference.
 */
export type TypeIdentifier = string;

/**
 * A type which permits any type from a list of allowed types.
 */
