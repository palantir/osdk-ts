...
export type BaseType = BaseType_primitive | BaseType_array;
...
/**
 * Deprecated | Use ErrorSeverity instead
 */
export type BlockInstallValidationErrorType = "BLOCKING" | "NON_BLOCKING";
 ...
 * Constraints are measured for number of blocks, input shapes and output shapes.
 */
export interface BlockSetSizeLimitThresholdReached {
  blockLimitCount: BlockSizeLimitCount;
  inputShapeLimitCount: InputShapeSizeLimitCount;
  outputShapeLimitCount: OutputShapeSizeLimitCount;
...
export interface BlockSetVersionStatusResponseV2_idle {
  type: "idle";
  idle: IdleBlockSetVersionStatusResponse;
}

export interface BlockSetVersionStatusResponseV2_materializing {
  type: "materializing";
  materializing: MaterializingBlockSetVersionStatusResponse;
}
...
export interface BlockSetVersionStatusResponseV2_finalized {
  type: "finalized";
  finalized: FinalizingBlockSetVersionStatusResponse;
}
...
export interface BlockSetVersionValidationErrorDetail_blockSetShapeVersionSkew {
  type: "blockSetShapeVersionSkew";
  blockSetShapeVersionSkew: BlockSetShapeVersionSkewError;
}
...
export interface BlockSetVersionValidationErrorDetail_tooManyInputShapesForBlockSetError {
  ...
  tooManyInputShapesForBlockSetError: InputShapeSizeLimitCount;
}
...
export interface BlockSetVersionValidationErrorDetail_tooManyOutputShapesForBlockSetError {
  ...
  tooManyOutputShapesForBlockSetError: OutputShapeSizeLimitCount;
}
/**
...
export type BlockSetVersionValidationErrorDetail =
  ...
  | BlockSetVersionValidationErrorDetail_blockSetShapeVersionSkew
...
/**
 * The block set has too many blocks.
 */
...
export interface BlockSpecificCreateRequest_dataHealth {
  type: "dataHealth";
  dataHealth: DataHealthCreateBlockRequest;
}
...
export interface CreateBlockVersionErrors_errors {
  type: "errors";
  errors: Array<CreateBlockVersionError>;
}

export interface CreateBlockVersionErrors_insufficientPermissions {
  type: "insufficientPermissions";
  insufficientPermissions: Array<InsufficientPermissionsError>;
}
export type CreateBlockVersionErrors =
  | CreateBlockVersionErrors_errors
  | CreateBlockVersionErrors_insufficientPermissions;

export interface CreateBlockVersionErrorUnion_generic {
  type: "generic";
  generic: GenericCreateBlockVersionError;
}
export type CreateBlockVersionErrorUnion = CreateBlockVersionErrorUnion_generic;
...
export interface DataHealthCreateBlockRequest {
  checkRid: string;
}
 ...
 * job spec for the dataset. Currently, exactly one of `includeProducer` and `includeData` must be true.
 */
...
export interface ErrorGranularOutputSpecResult {
  blockType: BlockType;
  errors: CreateBlockVersionErrors;
}
...
export interface FinalizingBlockSetVersionStatusResponse {
}
...
export interface GenerateShapesError_unknownError {
  type: "unknownError";
  unknownError: UnknownGenerateShapesError;
}
...
export interface GenericBlockInstallServiceValidationError {
  args: Array<ErrorArg>;
  errorMessage: string;
  type: BlockInstallValidationErrorType;
}
/**
...
export interface GranularOutputSpecResult_materializing {
  type: "materializing";
  materializing: MaterializingGranularOutputSpecResult;
}
...
export interface IdleBlockSetVersionStatusResponse {
...
/**
 * The block set has too many input shapes. The number of shapes is summed accross all blocks.
 */
export interface InputShapeSizeLimitCount {
...
/**
 * MARKETPLACE_INSTALLATION will leads to a project where all edit permissions are disabled, PROJECT will lead to a regular project being created
 */
...
export interface MaterializingBlockSetVersionStatusResponse {
  currentUpdateId?:
    | UpdatePendingBlockSetVersionSpecsRequestId
    | null
    | undefined;
...
export interface MaterializingGranularOutputSpecResult {
}
...
/**
 * Maven Coordinate which will be used to identify the released products.
...
/**
 * The Ontology to install a block into. Right now this only contains an Ontology RID, but in the future we might
 * add things like branch etc.
 */
...
/**
 * The block set has too many output shapes. The number of shapes is summed accross all blocks.
 */
export interface OutputShapeSizeLimitCount {
...
/**
 * Maximum number of items to return in a single page. Serves as a hint to the server, which can serve more/fewer
 * results depending on what ends up being more efficient.
 */
...
export interface ResolvedInputShape_artifactsRepository {
  type: "artifactsRepository";
  artifactsRepository: RidResolvedInputShape;
}
...
export interface ResolvedInputShape_authoringRepository {
  type: "authoringRepository";
  authoringRepository: RidResolvedInputShape;
}
...
export interface ResolvedInputShape_blobsterResource {
  type: "blobsterResource";
  blobsterResource: RidResolvedInputShape;
}

export interface ResolvedInputShape_carbonWorkspace {
  type: "carbonWorkspace";
  carbonWorkspace: RidResolvedInputShape;
}

export interface ResolvedInputShape_cipherChannel {
  type: "cipherChannel";
  cipherChannel: RidResolvedInputShape;
}
...
export interface ResolvedInputShape_cipherLicenseV2 {
  type: "cipherLicenseV2";
  cipherLicenseV2: RidResolvedInputShape;
}
...
export interface ResolvedInputShape_compassResource {
  type: "compassResource";
  compassResource: RidResolvedInputShape;
}

export interface ResolvedInputShape_contourAnalysis {
  type: "contourAnalysis";
  contourAnalysis: RidResolvedInputShape;
}

export interface ResolvedInputShape_dataHealthCheckGroup {
  type: "dataHealthCheckGroup";
  dataHealthCheckGroup: RidResolvedInputShape;
}
...
export interface ResolvedInputShape_deployedApp {
  type: "deployedApp";
  deployedApp: RidResolvedInputShape;
}
...
export interface ResolvedInputShape_eddiePipeline {
  type: "eddiePipeline";
  eddiePipeline: RidResolvedInputShape;
}
...
export interface ResolvedInputShape_fusionDocument {
  type: "fusionDocument";
  fusionDocument: RidResolvedInputShape;
}
...
export interface ResolvedInputShape_slateApplication {
  type: "slateApplication";
  slateApplication: RidResolvedInputShape;
}
...
export interface ResolvedInputShape_taurusWorkflow {
  type: "taurusWorkflow";
  taurusWorkflow: RidResolvedInputShape;
}
...
export interface ResolvedInputShape_vectorWorkbook {
  type: "vectorWorkbook";
  vectorWorkbook: RidResolvedInputShape;
}
...
export interface ResolvedInputShape_workshopApplication {
  type: "workshopApplication";
  workshopApplication: RidResolvedInputShape;
}
...
export interface ResolvedOutputShape_artifactsRepository {
  type: "artifactsRepository";
  artifactsRepository: RidResolvedOutputShape;
}
...
export interface ResolvedOutputShape_authoringRepository {
  type: "authoringRepository";
  authoringRepository: RidResolvedOutputShape;
}
...
export interface ResolvedOutputShape_deployedApp {
  type: "deployedApp";
  deployedApp: RidResolvedOutputShape;
}
...
export interface ResolvedOutputShape_eddiePipeline {
  type: "eddiePipeline";
  eddiePipeline: RidResolvedOutputShape;
}

export interface ResolvedOutputShape_evaluationSuite {
  type: "evaluationSuite";
  evaluationSuite: RidResolvedOutputShape;
}
...
export interface ResolvedOutputShape_resourceUpdatesContent {
  type: "resourceUpdatesContent";
  resourceUpdatesContent: RidResolvedOutputShape;
}
...
export interface ResolvedOutputShape_slateApplication {
  type: "slateApplication";
  slateApplication: RidResolvedOutputShape;
}
...
export interface ResolvedOutputShape_taurusWorkflow {
  type: "taurusWorkflow";
  taurusWorkflow: RidResolvedOutputShape;
}
...
export interface ResolvedOutputShape_transformsJobSpec {
  type: "transformsJobSpec";
  transformsJobSpec: RidResolvedOutputShape;
}
...
export interface ResolvedOutputShape_workflowGraph {
  type: "workflowGraph";
  workflowGraph: RidResolvedOutputShape;
}

export interface ResolvedOutputShape_workshopApplication {
  type: "workshopApplication";
  workshopApplication: RidResolvedOutputShape;
}
/**
...
export interface RidResolvedInputShape {
  rid: string;
}
export interface RidResolvedOutputShape {
  rid: string;
}
...
/**
 * A list of categories and their tags on the store. Using lists here because we care about the ordering.
 * All categories are guaranteed to have unique RIDs and names.
 */
...
export interface TargetCompassInstallLocation {
  namespaceRid: NamespaceRid;
  projectRids: Record<NewBlockSetInstallationId, CompassFolderRid>;
}
 ...
 */
export type TargetEnvironment = "CLOUD" | "EDGE";
...
export interface UnknownGenerateShapesError {
}
...
export interface UnversionedBlock {
  blockId: BlockId;
}
