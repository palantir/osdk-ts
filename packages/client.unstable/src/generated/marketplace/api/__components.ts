...
export type AutomappingLevel =
  | AutomappingLevel_topLevel
  | AutomappingLevel_childLevel;
 ...
 */
export type BatchEditBlockSetVersionError =
  | BatchEditBlockSetVersionError_draftGroupNotEditable
  | BatchEditBlockSetVersionError_editPermissionDenied
  | BatchEditBlockSetVersionError_notFound
...
export type BlockInstallFunctionShapeError =
  ...
  | BlockInstallFunctionShapeError_doesNotSatisfyContractExpression
  ...
  | BlockInstallFunctionShapeError_outputTypeMismatch
...
export type BlockInstallPropertyTypeShapeError =
  ...
  | BlockInstallPropertyTypeShapeError_vectorTypeMismatchNonBlocking
...
export type BlockSetInstallationResolvedInputSourceV3 =
  | BlockSetInstallationResolvedInputSourceV3_externallyRecommendedOutput
  | BlockSetInstallationResolvedInputSourceV3_manuallyProvided
  | BlockSetInstallationResolvedInputSourceV3_fromDefault
  | BlockSetInstallationResolvedInputSourceV3_automapped;
...
export type BlockSetInstallValidationErrorDetailV2 =
  ...
  | BlockSetInstallValidationErrorDetailV2_incompatibleLinkedProduct
  ...
  | BlockSetInstallValidationErrorDetailV2_invalidLinkedProduct
 ...
 */
export type BlockSetProductGroupMemberVersionPolicy =
  | BlockSetProductGroupMemberVersionPolicy_latest
  | BlockSetProductGroupMemberVersionPolicy_pinnedVersion
  | BlockSetProductGroupMemberVersionPolicy_releaseChannel;
...
export type BlockSetVersionStatusResponse =
  ...
  | BlockSetVersionStatusResponse_idle
  | BlockSetVersionStatusResponse_materializing
  | BlockSetVersionStatusResponse_finalizing
  | BlockSetVersionStatusResponse_finalized
  | BlockSetVersionStatusResponse_aborted;
...
export type BlockSetVersionStatusV3 =
  | BlockSetVersionStatusV3_initializing
  | BlockSetVersionStatusV3_idle
  | BlockSetVersionStatusV3_processing
  | BlockSetVersionStatusV3_uploading
  | BlockSetVersionStatusV3_finalizing
  | BlockSetVersionStatusV3_finalized
  | BlockSetVersionStatusV3_aborted;
...
export type BlockSetVersionValidationErrorDetail =
  | BlockSetVersionValidationErrorDetail_blockTypesNotGenerallyAvailableForTargetEnvironment
  | BlockSetVersionValidationErrorDetail_duplicateOutputShapes
  | BlockSetVersionValidationErrorDetail_emptyOutputSpecs
  | BlockSetVersionValidationErrorDetail_emptyTitle
  ...
  | BlockSetVersionValidationErrorDetail_inputShapesNotMergeable
...
export type BlockSpecificConfiguration =
  ...
  | BlockSpecificConfiguration_artifactsPeerProducerProfile
  | BlockSpecificConfiguration_authoringRepository
  | BlockSpecificConfiguration_automation
  | BlockSpecificConfiguration_autopilotWorkbench
  ...
  | BlockSpecificConfiguration_foundryPeerProducerProfile
  | BlockSpecificConfiguration_functionConfigurations
  | BlockSpecificConfiguration_functionPackageConfiguration
  ...
  | BlockSpecificConfiguration_peerProfile
  ...
  | BlockSpecificConfiguration_savedSearchAroundV2
  ...
  | BlockSpecificConfiguration_storedProcedure
  ...
  | BlockSpecificConfiguration_versionedObjectSet
  ...
  | BlockSpecificConfiguration_workbenchTemplate
  | BlockSpecificConfiguration_workflowBuilderGraph
...
export type BlockSpecificCreateRequest =
  ...
  | BlockSpecificCreateRequest_artifactsPeerProducerProfile
  ...
  | BlockSpecificCreateRequest_autopilotWorkbench
  ...
  | BlockSpecificCreateRequest_contour
  ...
  | BlockSpecificCreateRequest_foundryPeerProducerProfile
  | BlockSpecificCreateRequest_functionConfigurations
  | BlockSpecificCreateRequest_functionPackageConfiguration
  ...
  | BlockSpecificCreateRequest_modelStudio
  ...
  | BlockSpecificCreateRequest_peerProfile
  ...
  | BlockSpecificCreateRequest_versionedObjectSet
...
export type BlockType =
  ...
  | "APP_CONFIG_GAIA"
  | "APP_CONFIG_TITANIUM"
  | "ARTIFACTS_PEER_PRODUCER_PROFILE"
 ...
 */
export type ContractExpressionIdentifier =
  | ContractExpressionIdentifier_and
  | ContractExpressionIdentifier_or
...
export type DatasourceLocator =
  ...
  | DatasourceLocator_directSource;
...
export type DatasourceLocatorIdentifier =
  ...
  | DatasourceLocatorIdentifier_directSource;
...
export type DocumentDecodeFormat =
  ...
  | DocumentDecodeFormat_doc
  | DocumentDecodeFormat_docx
  | DocumentDecodeFormat_rtf
...
export type DraftGroupStatus =
  | DraftGroupStatus_idle
  | DraftGroupStatus_processing
  | DraftGroupStatus_generatingRecommendations
  | DraftGroupStatus_error
  | DraftGroupStatus_finalizing
  | DraftGroupStatus_finalized;
...
export interface DuplicateOutputs {
  downstreamOverlappingRecommendations: Record<
...
export type EddieReplayOptionType =
  | "RESET_AND_REPLAY_FROM_OFFSET"
  | "RESET"
  | "ACKNOWLEDGE_STATE_BREAKS";
 ...
 */
export type EdgeMagritteSourceConfig = Record<
 ...
 */
export type EdgeMagritteTaskConfig = Record<
  EdgeMagritteConfigKey,
  EdgeMagritteConfigValue
>;
 ...
 * packaged.
 */
export type ExternalRecommendationMavenDependencyRequirement =
...
export type ExternalRecommendationSource =
  ...
  | ExternalRecommendationSource_ownedPending
  | ExternalRecommendationSource_otherStoreLocal
  | ExternalRecommendationSource_otherStoreRemote
...
export interface ExternalRecommendationV2 {
  ...
  mavenProductDependencyRequirement?:
...
export type FunctionApiName =
  | FunctionApiName_ontologyBound
  | FunctionApiName_global;
...
export type FunctionInputIdentifier =
  | FunctionInputIdentifier_rid
  | FunctionInputIdentifier_ridAndVersion
  | FunctionInputIdentifier_languageModelRid
  | FunctionInputIdentifier_staticInput;
...
export interface FunctionInputShape {
  about: LocalizedTitleAndDescription;
  contractRequirement?:
    | _api_function_contracts_ContractExpression
    | null
    | undefined;
...
export type FunctionOutputIdentifier =
  | FunctionOutputIdentifier_rid
  | FunctionOutputIdentifier_ridAndVersion;
...
export type FunctionOutputType =
  | FunctionOutputType_singleOutputType
  | FunctionOutputType_voidOutputType;
...
export type FunctionPackageConfigurationIdentifier =
  FunctionPackageConfigurationIdentifier_candidateFunction;
...
export type FunctionPackageShapeReference =
  FunctionPackageShapeReference_repository;
...
export type FunctionsApiStabilityConfiguration =
  | FunctionsApiStabilityConfiguration_deduplicate
  | FunctionsApiStabilityConfiguration_stable;
 ...
 */
export type FunctionVersionsConfiguration =
  | FunctionVersionsConfiguration_incrementMinor
  | FunctionVersionsConfiguration_preserve;
...
export type GenerateShapesError =
  ...
  | GenerateShapesError_interfaceActionTypeConstraintNotFound
...
export type InputEntityIdentifier =
  ...
  | InputEntityIdentifier_autopilotWorkbench
  ...
  | InputEntityIdentifier_contourRef
  ...
  | InputEntityIdentifier_functionVersionsConfiguration
  ...
  | InputEntityIdentifier_interfaceParameterConstraint
  ...
  | InputEntityIdentifier_modelStudio
  ...
  | InputEntityIdentifier_peerProducerProfile
  | InputEntityIdentifier_peerProfile
  | InputEntityIdentifier_peerProfileRemoteStrategy
  ...
  | InputEntityIdentifier_storedProcedure
  ...
  | InputEntityIdentifier_versionedObjectSet
  ...
  | InputEntityIdentifier_workbenchTemplate
  | InputEntityIdentifier_workflowBuilderGraph
  | InputEntityIdentifier_workflowGraph
  | InputEntityIdentifier_sqlWorksheet
...
export type InputShape =
  ...
  | InputShape_functionVersionsConfiguration
  | InputShape_functionsApiStabilityConfiguration
  ...
  | InputShape_interfaceActionTypeConstraint
  | InputShape_interfaceParameterConstraint
  ...
  | InputShape_peerProducerProfile
  | InputShape_peerProfile
  | InputShape_peerProfileRemoteStrategy
  | InputShape_property
  | InputShape_quiverDashboard
  | InputShape_schedule
  | InputShape_sharedPropertyType
  | InputShape_slateApplication
  | InputShape_storedProcedure
  ...
  | InputShape_workbenchTemplate
  | InputShape_workflowBuilderGraph
  | InputShape_workflowGraph
  | InputShape_sqlWorksheet
...
export type InputShapeResolver =
  ...
  | InputShapeResolver_valueTypePresetResolver;
...
export type InputShapeType =
  ...
  | "FUNCTION"
  | "FUNCTION_CONTRACT"
  | "FUNCTION_VERSIONS_CONFIGURATION"
  | "FUNCTIONS_API_STABILITY_CONFIGURATION"
  | "FUSION_DOCUMENT"
  | "GEOTIME_SERIES_INTEGRATION"
  | "INTERFACE_TYPE"
  | "INTERFACE_LINK_TYPE"
  | "INTERFACE_PROPERTY_TYPE"
  | "INTERFACE_ACTION_TYPE_CONSTRAINT"
  | "INTERFACE_PARAMETER_CONSTRAINT"
  | "INSTALL_PREFIX"
  | "LANGUAGE_MODEL"
  | "LINK_TYPE"
  | "LOGIC"
  ...
  | "PARAMETER"
  | "PEER_PRODUCER_PROFILE"
  | "PEER_PROFILE"
  | "PEER_PROFILE_REMOTE_STRATEGY"
  | "PROPERTY"
  | "QUIVER_DASHBOARD"
  | "SCHEDULE"
 ...
 */
export type InstallPrefixConfigurationEnum =
  | "DISPLAY_NAME_ONLY"
  | "DISPLAY_NAME_AND_API_NAME";
...
export type InstallShapeValidationError =
  ...
  | InstallShapeValidationError_expectedDefaultNotEqualToActualDefaultV2
  | InstallShapeValidationError_externalRecommendationsUsedForInputShapeWithMandatoryPresets
  | InstallShapeValidationError_filesDatasourceTypeNotSupported
  ...
  | InstallShapeValidationError_interfaceTypeMissingActionTypeConstraints
  ...
  | InstallShapeValidationError_interfaceActionTypeConstraintNotFound
  | InstallShapeValidationError_interfaceActionTypeConstraintShapeError
  ...
  | InstallShapeValidationError_sparkProfileFamilyMismatch
...
export type InstallValidationErrorDetail =
  ...
  | InstallValidationErrorDetail_serializable
...
export type InterfaceActionTypeConstraintIdentifier =
  InterfaceActionTypeConstraintIdentifier_rid;
...
export type InterfaceParameterConstraintIdentifier =
...
export type JobDraftOwnerValidationErrors =
  | JobDraftOwnerValidationErrors_validationErrors
  | JobDraftOwnerValidationErrors_validationSummary
  | JobDraftOwnerValidationErrors_validations;
...
export type JobDraftStatus =
  ...
  | JobDraftStatus_idle
  | JobDraftStatus_submittingJob
  | JobDraftStatus_submitted;
...
export type Model3dDecodeFormat =
  | Model3dDecodeFormat_las
  | Model3dDecodeFormat_ply
  | Model3dDecodeFormat_obj;
...
export interface OntologyCreateBlockRequest {
  ...
  interfaceImplementationsToExclude: Record<
    ObjectTypeRid,
    Array<InterfaceTypeRid>
  >;
  interfaceLinkImplementationsToExclude: Record<
    ObjectTypeRid,
    Array<ObjectTypeInterfaceLinkImplementation>
  >;
...
export type OutputEntityIdentifier =
  ...
  | OutputEntityIdentifier_autopilotWorkbench
  ...
  | OutputEntityIdentifier_contourRef
  ...
  | OutputEntityIdentifier_functionPackageConfiguration
  ...
  | OutputEntityIdentifier_interfaceActionTypeConstraint
  | OutputEntityIdentifier_interfaceParameterConstraint
  ...
  | OutputEntityIdentifier_modelStudio
  | OutputEntityIdentifier_modelStudioConfig
  ...
  | OutputEntityIdentifier_normalizationMaxClassification
  ...
  | OutputEntityIdentifier_peerProfile
  ...
  | OutputEntityIdentifier_versionedObjectSet
  ...
  | OutputEntityIdentifier_workbenchTemplate
  | OutputEntityIdentifier_workflowBuilderGraph
  | OutputEntityIdentifier_workflowGraph
  | OutputEntityIdentifier_sqlWorksheet
...
export type OutputShape =
  ...
  | OutputShape_autopilotWorkbench
  ...
  | OutputShape_functionPackageConfiguration
  ...
  | OutputShape_modelStudio
  | OutputShape_modelStudioConfig
  | OutputShape_model
  | OutputShape_monitor
  ...
  | OutputShape_normalizationMaxClassification
  ...
  | OutputShape_versionedObjectSet
  ...
  | OutputShape_workbenchTemplate
  | OutputShape_workflowBuilderGraph
  | OutputShape_workflowGraph
  | OutputShape_sqlWorksheet
...
export type OutputShapeType =
  ...
  | "NAMED_CREDENTIAL"
  | "NETWORK_EGRESS_POLICY"
  | "NORMALIZATION_MAX_CLASSIFICATION"
  | "NOTEPAD_DOCUMENT"
  | "NOTEPAD_TEMPLATE"
  | "NOTEPAD_TEMPLATE_PARAMETER"
  | "OBJECT_SET"
...
export type OutputSpecConfig =
  | OutputSpecConfig_appConfigConfig
  ...
  | OutputSpecConfig_contourConfig
...
export type PeerProfileRemoteStrategyType =
  | "SPECIFIC_REMOTE"
  | "MESH_ID"
  | "MESH_NODE_LABEL";
 ...
 */
export type ProductGroupMemberSpec =
  | ProductGroupMemberSpec_installation
...
export type ProductGroupValidationFindingDetail =
  | ProductGroupValidationFindingDetail_duplicateOutputs
  | ProductGroupValidationFindingDetail_incompatibleExternalRecommendationVersionRange
  | ProductGroupValidationFindingDetail_memberDependencyCycle
  | ProductGroupValidationFindingDetail_missingRecommendation
  | ProductGroupValidationFindingDetail_overlappingRecommendations
 ...
 */
export type ProductGroupValidationStatus =
  | ProductGroupValidationStatus_valid
  | ProductGroupValidationStatus_warn
  | ProductGroupValidationStatus_error;
...
export type ResolvedBlockSetInputOrRef =
  ...
  | ResolvedBlockSetInputOrRef_automapped;
...
export type ResolvedEddieReplayOption =
  ...
  | ResolvedEddieReplayOption_acknowledgeStateBreaks;
...
export type ResolvedFunctionPackageLocator =
  ResolvedFunctionPackageLocator_candidateFunction;
...
export type ResolvedInputShape =
  ...
  | ResolvedInputShape_autopilotWorkbench
  ...
  | ResolvedInputShape_functionVersionsConfiguration
  | ResolvedInputShape_functionsApiStabilityConfiguration
  ...
  | ResolvedInputShape_interfaceActionTypeConstraint
  | ResolvedInputShape_interfaceParameterConstraint
  ...
  | ResolvedInputShape_modelStudio
  ...
  | ResolvedInputShape_peerProducerProfile
  | ResolvedInputShape_peerProfile
  | ResolvedInputShape_peerProfileRemoteStrategy
  ...
  | ResolvedInputShape_storedProcedure
  ...
  | ResolvedInputShape_versionedObjectSet
  ...
  | ResolvedInputShape_workbenchTemplate
  | ResolvedInputShape_workflowBuilderGraph
  | ResolvedInputShape_workflowGraph
  | ResolvedInputShape_sqlWorksheet
...
export type ResolvedOutputShape =
  ...
  | ResolvedOutputShape_autopilotWorkbench
  ...
  | ResolvedOutputShape_contourRef
  ...
  | ResolvedOutputShape_functionPackageConfiguration
  ...
  | ResolvedOutputShape_interfaceActionTypeConstraint
  | ResolvedOutputShape_interfaceParameterConstraint
  ...
  | ResolvedOutputShape_modelStudio
  | ResolvedOutputShape_modelStudioConfig
  ...
  | ResolvedOutputShape_peerProducerProfile
  | ResolvedOutputShape_peerProfile
  ...
  | ResolvedOutputShape_versionedObjectSet
  ...
  | ResolvedOutputShape_workbenchTemplate
  | ResolvedOutputShape_workflowBuilderGraph
  | ResolvedOutputShape_workflowGraph
  | ResolvedOutputShape_sqlWorksheet
...
export type ResolvedPeerProfileRemoteStrategyShape =
  | ResolvedPeerProfileRemoteStrategyShape_specificRemote
  | ResolvedPeerProfileRemoteStrategyShape_meshId
  | ResolvedPeerProfileRemoteStrategyShape_meshNodeLabel;
...
export type SetProjectMutabilityAllowance =
 ...
 */
export type SetProjectMutabilityDisallowedRationale =
  | SetProjectMutabilityDisallowedRationale_permissionDenied
  | SetProjectMutabilityDisallowedRationale_resourceIsNotProject;
...
export type ShapeDisplayMetadata =
  ...
  | ShapeDisplayMetadata_autopilotWorkbench
  ...
  | ShapeDisplayMetadata_contourRef
  ...
  | ShapeDisplayMetadata_interfaceActionTypeConstraint
  | ShapeDisplayMetadata_interfaceParameterConstraint
  ...
  | ShapeDisplayMetadata_modelStudio
  ...
  | ShapeDisplayMetadata_storedProcedure
  ...
  | ShapeDisplayMetadata_versionedObjectSet
  ...
  | ShapeDisplayMetadata_workbenchTemplate
  | ShapeDisplayMetadata_workflowGraph
  | ShapeDisplayMetadata_sqlWorksheet
...
export type SparkProfileConstraint =
  | SparkProfileConstraint_allowedProfileNames
  | SparkProfileConstraint_profileFamily;
...
export type SparkProfileIdentifier =
  ...
  | SparkProfileIdentifier_nameConstrained;
...
export type SparkProfileIdentifierConstraint =
  | SparkProfileIdentifierConstraint_sameProfileFamily
...
export type StreamingVideoContainerFormat =
  | StreamingVideoContainerFormat_webm
 ...
 */
export type SupportedMarkingsTypeV2 =
  | "MANDATORY_NOT_ORGANIZATION"
  | "ORGANIZATION"
  | "CBAC";
...
export type UpdateDefaultInstallationSettingsRequest =
  | UpdateDefaultInstallationSettingsRequest_set
...
export type UpdateMarketplaceMetadataVersionRequest =
  | UpdateMarketplaceMetadataVersionRequest_set
  | UpdateMarketplaceMetadataVersionRequest_remove;
...
export type UpdatePackagingSettingsRequest =
  | UpdatePackagingSettingsRequest_set
  | UpdatePackagingSettingsRequest_remove;
...
export type UpdateVersionIncrementRequest =
  | UpdateVersionIncrementRequest_set
 ...
 */
export type ValueTypePresetResolver =
  | ValueTypePresetResolver_userManaged
