...
export interface GetInputsResponse {
  inputs: Record<InputShapeTitle, InstallationInput>;
}
export interface GetInstallationInputsRequest {
  preferApiNameResolution?: boolean | null | undefined;
}
export interface GetInstallationInputsResponse {
  inputs: Record<InputShapeTitle, InstallationInput>;
}
export type InputShapeTitle = string;
export type InstallationDisplayName = string;
export interface InstallationInput {
  currentValue: InstallationInputValue;
}
export interface InstallationInputValue_present {
  type: "present";
  present: SimpleResolvedInputShape;
}

export interface InstallationInputValue_unset {
  type: "unset";
  unset: UnsetInstallationInput;
}
export type InstallationInputValue =
  | InstallationInputValue_present
  | InstallationInputValue_unset;
...
export interface SimpleResolvedInputShape_installPrefix {
  type: "installPrefix";
  installPrefix: _api_ResolvedInstallPrefixShape;
}
...
export interface SimpleResolvedInputShape_eddieReplayOption {
  ...
  eddieReplayOption: _api_ResolvedEddieReplayOption;
}
export type SimpleResolvedInputShape =
  ...
  | SimpleResolvedInputShape_installPrefix
  ...
  | SimpleResolvedInputShape_eddieReplayOption;
