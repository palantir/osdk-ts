...
/**
 * Computes shape level diff between two versions of a block set with block set shape Ids.
 */
export async function computeBlockSetVersionsDiffV2(
  ...
  return conjureFetch(
    ctx,
    `/installation-app-service/installable/${marketplaceRid}/blockSet/version/diff/v2`,
    "POST",
