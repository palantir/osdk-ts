...
import type {
  ...
  GetInstallableBlockVersionResponse as _api_GetInstallableBlockVersionResponse,
  MarketplaceRid as _api_MarketplaceRid,
} from "../__components.js";

/**
 * Get the data for an installable version of a block.
 *
 ...
 */
export async function getInstallableBlockVersion(
  ctx: ConjureContext,
