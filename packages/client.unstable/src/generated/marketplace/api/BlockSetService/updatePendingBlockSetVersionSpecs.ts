...
/**
 * Updates the output specs in the pending block set version, overwrites the existing specs in the request.
 * The output specs will be used to generate shapes for the block set, this materialization happens
