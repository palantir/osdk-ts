...
import type {
  ...
  UpdatePendingInputShapeAboutRequest as _api_UpdatePendingInputShapeAboutRequest,
 ...
 * Throws `BlockSetInputShapesNotFound` if the specified input shape does not exist.
