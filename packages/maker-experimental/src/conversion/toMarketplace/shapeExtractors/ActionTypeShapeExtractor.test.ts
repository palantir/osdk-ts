...
describe(buildFunctionShape, () => {
  it("filters injected inputs and converts custom type definitions", () => {
    const discoveredFunction: IDiscoveredFunction = {
      locator: {
        type: "typescript",
        typescript: { functionName: "testFunction" },
      },
      inputs: [
        {
          name: "client",
          dataType: { type: "client", client: {} },
          required: true,
        },
        {
          name: "context",
          dataType: {
            ...
            anonymousCustomType: {
              fields: {
                ...
                durable: { type: "durableContext", durableContext: {} },
              },
            },
          },
          required: true,
    ...
    const shape = buildFunctionShape(
      "testFunction",
      discoveredFunction,
      createMockRidGenerator(),
      {
        objectTypeIds: { employee: "employee-block-id" },
        interfaceTypes: {},
        ...
        dataType: {
          ...
          anonymousCustomType: {
            fields: {
              employee: {
                type: "object",
                object: { objectTypeId: "employee-block-id" },
              },
            },
          },
        },
    ...
    expect(shape.output).toEqual({
      type: "singleOutputType",
      singleOutputType: {
        about: {
          fallbackTitle: "Function Output",
          fallbackDescription: "",
          localizedTitle: {},
    ...
    expect(shape.customTypes).toEqual({
      "custom-id": {
        id: "custom-id",
        fields: {
          employee: {
          ...
          label: {
            type: "optionalType",
            optionalType: {
              wrappedType: { type: "string", string: {} },
            },
          },
        },
      },
  ...
  it("converts void function outputs", () => {
    const shape = buildFunctionShape(
      "voidFunction",
      {
        locator: {
        ...
        customTypes: {},
      } as unknown as IDiscoveredFunction,
      createMockRidGenerator(),
      {
        objectTypeIds: {},
        interfaceTypes: {},
