...
Read the [contribution guidelines](https://github.com/palantir/osdk-ts/blob/main/packages/react/CONTRIBUTING.md) first, then [`AGENTS.md`](https://github.com/palantir/osdk-ts/blob/main/packages/react/AGENTS.md) for how those rules are applied when working in this package.
