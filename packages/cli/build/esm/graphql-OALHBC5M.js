...
function bt(e2) {
  ...
  return (n = t == null ? undefined : t.comments) == null ? undefined : n.some((r) => r.value.trim() === "prettier-ignore");
}
var Lt = {
  print: kt,
  massageAstNode: Le,
...
function Ue(e2) {
  let t = e2.filter(([r, i]) => i !== undefined), n = Math.max(...t.map(([r]) => r.length));
...
var W = class e extends Error {
  constructor(t, ...n) {
    ...
    super(t), this.name = "GraphQLError", this.path = T ?? undefined, this.originalError = h ?? undefined, this.nodes = Ye(Array.isArray(a) ? a : a ? [a] : undefined);
    let I = Ye((r = this.nodes) === null || r === undefined ? undefined : r.map((N) => N.loc).filter((N) => N != null));
    this.source = u ?? (I == null || (i = I[0]) === null || i === undefined ? undefined : i.source), this.positions = l ?? (I == null ? undefined : I.map((N) => N.start)), this.locations = l && u ? l.map((N) => B(u, N)) : I == null ? undefined : I.map((N) => B(N.source, N.start));
    let ie = Ve(h == null ? undefined : h.extensions) ? h == null ? undefined : h.extensions : undefined;
    this.extensions = (s = D ?? ie) !== null && s !== undefined ? s : /* @__PURE__ */ Object.create(null), Object.defineProperties(this, {
      message: {
        writable: true,
        enumerable: true
      },
...
function Ye(e2) {
  return e2 === undefined || e2.length === 0 ? undefined : e2;
}
function d(e2, t, n) {
...
function Je(e2) {
  ...
  for (let a = 0; a < e2.length; ++a) {
    var s;
    let u = e2[a], l = wt(u);
    l !== u.length && (r = (s = r) !== null && s !== undefined ? s : a, i = a, a !== 0 && l < n && (n = l));
  }
  return e2.map((a, u) => u === 0 ? a : a.slice(n)).slice((t = r) !== null && t !== undefined ? t : 0, i + 1);
}
function wt(e2) {
  let t = 0;
...
var He = globalThis.process && globalThis.process.env.NODE_ENV === "production" ? function(t, n) {
  ...
  if (typeof t == "object" && t !== null) {
    var r;
    let i = n.prototype[Symbol.toStringTag], s = Symbol.toStringTag in t ? t[Symbol.toStringTag] : (r = t.constructor) === null || r === undefined ? undefined : r.name;
    if (i === s) {
      let a = ee(t);
...
var me = class {
  ...
  parseVariableDefinition() {
    return this.node(this._lexer.token, {
      ...
      defaultValue: this.expectOptionalToken(o.EQUALS) ? this.parseConstValueLiteral() : undefined,
  ...
  parseField() {
    ...
    return this.expectOptionalToken(o.COLON) ? (r = n, i = this.parseName()) : i = n, this.node(t, {
      ...
      directives: this.parseDirectives(false),
      selectionSet: this.peek(o.BRACE_L) ? this.parseSelectionSet() : undefined
    });
  }
  parseArguments(t) {
  ...
  parseFragment() {
    ...
    return !n && this.peek(o.NAME) ? this.node(t, {
      ...
      typeCondition: n ? this.parseNamedType() : undefined,
      directives: this.parseDirectives(false),
      selectionSet: this.parseSelectionSet()
    });
  }
  ...
  advanceLexer() {
    ...
    if (t !== undefined && n.kind !== o.EOF && (++this._tokenCounter, this._tokenCounter > t)) throw d(this._lexer.source, n.start, `Document contains more that ${t} tokens. Parsing aborted.`);
  }
};
function ne(e2) {
  let t = e2.value;
...
function en(e2) {
  if ((e2 == null ? undefined : e2.name) === "GraphQLError") {
    let {
      message: t,
      locations: [n]
    } = e2;
...
//# sourceMappingURL=graphql-OALHBC5M.js.map
//# sourceMappingURL=graphql-OALHBC5M.js.map