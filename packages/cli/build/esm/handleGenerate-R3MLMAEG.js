...
// ../generator/build/esm/GenerateContext/EnhancedOntologyDefinition.js
init_esm_shims();

// ../generator/build/esm/GenerateContext/EnhancedAction.js
init_esm_shims();

// ../generator/build/esm/GenerateContext/EnhancedBase.js
init_esm_shims();
...
var EnhancedAction = class extends EnhancedBase {
  constructor(common2, raw) {
    super(common2, raw, raw.apiName, "./ontology/actions");
    this.raw = raw;
  }
  get description() {
...
// ../generator-converters/build/esm/index.js
init_esm_shims();
...
// ../generator-converters/build/esm/getEditedEntities.js
init_esm_shims();
...
function wireActionTypeV2ToSdkActionMetadata(input) {
  ...
  return {
    ...
    parameters: Object.fromEntries(Object.entries(input.parameters).map(([key2, value]) => [key2, wireActionParameterV2ToSdkParameterDefinition(value)])),
    displayName: input.displayName,
    description: input.description,
...
function createModifiedEntities(addedObjects, modifiedObjects) {
  const entities = {};
  for (const key2 of addedObjects) {
    entities[key2] = {
      created: true,
      modified: false
    };
  }
  for (const key2 of modifiedObjects) {
    if (entities[key2]) {
      entities[key2].modified = true;
    } else {
      entities[key2] = {
        created: false,
        modified: true
...
// ../generator-converters/build/esm/isNullableQueryDataType.js
init_esm_shims();
...
var EnhancedInterfaceType = class extends EnhancedBase {
  constructor(common2, raw) {
    super(common2, raw, raw.apiName, "./ontology/interfaces");
    this.raw = raw;
  }
...
// ../generator/build/esm/GenerateContext/EnhancedObjectType.js
init_esm_shims();
var EnhancedObjectType = class extends EnhancedBase {
  constructor(common2, raw) {
    super(common2, raw, raw.objectType.apiName, "./ontology/objects");
    this.raw = raw;
  }
  getDefinitionIdentifier(v2) {
    return v2 ? this.shortApiName : `${this.shortApiName}Def`;
...
// ../generator/build/esm/GenerateContext/EnhancedQuery.js
init_esm_shims();
var EnhancedQuery = class extends EnhancedBase {
  constructor(common2, raw) {
    super(common2, raw, raw.apiName, "./ontology/queries");
    this.raw = raw;
  }
  get description() {
    return this.raw.description;
...
// ../generator/build/esm/GenerateContext/EnhancedSharedPropertyType.js
init_esm_shims();
...
// ../generator/build/esm/GenerateContext/ForeignType.js
init_esm_shims();
...
// ../../node_modules/.pnpm/prettier@3.2.5/node_modules/prettier/doc.mjs
var doc_exports = {};
...
var VALID_OBJECT_DOC_TYPES = /* @__PURE__ */ new Set([DOC_TYPE_CURSOR, DOC_TYPE_INDENT, DOC_TYPE_ALIGN, DOC_TYPE_TRIM, DOC_TYPE_GROUP, DOC_TYPE_FILL, DOC_TYPE_IF_BREAK, DOC_TYPE_INDENT_IF_BREAK, DOC_TYPE_LINE_SUFFIX, DOC_TYPE_LINE_SUFFIX_BOUNDARY, DOC_TYPE_LINE, DOC_TYPE_LABEL, DOC_TYPE_BREAK_PARENT]);
...
var disjunctionListFormat = (list2) => new Intl.ListFormat("en-US", {
  type: "disjunction"
}).format(list2);
...
Expected it to be 'string' or 'object'.`;
  ...
  const EXPECTED_TYPE_VALUES = disjunctionListFormat([...VALID_OBJECT_DOC_TYPES].map((type22) => `'${type22}'`));
...
function printDocToString(doc, options8) {
  ...
  while (cmds.length > 0) {
    ...
    switch (get_doc_type_default(doc2)) {
      ...
      case DOC_TYPE_ARRAY:
        for (let i2 = doc2.length - 1; i2 >= 0; i2--) {
          cmds.push({
            ind,
            mode,
            doc: doc2[i2]
      ...
      case DOC_TYPE_ALIGN:
        cmds.push({
          ind: makeAlign(ind, doc2.n, options8),
          mode,
          doc: doc2.contents
        });
        break;
            ...
            if (!doc2.break && fits(next, cmds, rem, hasLineSuffix, groupModeMap)) {
              ...
              if (doc2.expandedStates) {
                ...
                if (doc2.break) {
                  ...
                  for (let i2 = 1; i2 < doc2.expandedStates.length + 1; i2++) {
                    if (i2 >= doc2.expandedStates.length) {
                      cmds.push({
                        ind,
                        mode: MODE_BREAK,
                        doc: mostExpanded
                      ...
                      const state = doc2.expandedStates[i2];
                      const cmd = {
                        ind,
                        mode: MODE_FLAT,
                        doc: state
...
var __require = /* @__PURE__ */ ((x) => typeof require2 !== "undefined" ? require2 : typeof Proxy !== "undefined" ? new Proxy(x, { get: (a, b) => (typeof require2 !== "undefined" ? require2 : a)[b] }) : x)(function(x) {
...
var __copyProps = (to, from, except, desc) => {
  if (from && typeof from === "object" || typeof from === "function") {
    for (let key2 of __getOwnPropNames(from)) if (!__hasOwnProp.call(to, key2) && key2 !== except) __defProp2(to, key2, { get: () => from[key2], enumerable: !(desc = __getOwnPropDesc(from, key2)) || desc.enumerable });
  }
  return to;
};
...
var require_path = __commonJS2({ "node_modules/fast-glob/out/utils/path.js"(exports) {
  ...
  function makeAbsolute(cwd, filepath) {
    return path132.resolve(cwd, filepath);
  }
...
var require_is_extglob = __commonJS2({ "node_modules/is-extglob/index.js"(exports, module) {
...
var require_is_glob = __commonJS2({ "node_modules/is-glob/index.js"(exports, module) {
...
var require_glob_parent = __commonJS2({ "node_modules/glob-parent/index.js"(exports, module) {
...
var require_utils = __commonJS2({ "node_modules/braces/lib/utils.js"(exports) {
...
var require_stringify = __commonJS2({ "node_modules/braces/lib/stringify.js"(exports, module) {
...
var require_is_number = __commonJS2({ "node_modules/is-number/index.js"(exports, module) {
...
var require_to_regex_range = __commonJS2({ "node_modules/to-regex-range/index.js"(exports, module) {
  ...
  function filterPatterns(arr, comparison, prefix2, intersection, options8) {
    let result = [];
    for (let ele of arr) {
      let { string } = ele;
...
var require_fill_range = __commonJS2({ "node_modules/fill-range/index.js"(exports, module) {
  ...
  var fill22 = (start, end, step, options8 = {}) => {
    ...
    if (typeof step === "function") {
      return fill22(start, end, 1, { transform: step });
    }
    if (isObject3(step)) {
      return fill22(start, end, 0, step);
    }
    let opts = { ...options8 };
    ...
    if (!isNumber(step)) {
      ...
      return fill22(start, end, 1, step);
    }
  ...
  module.exports = fill22;
} });
var require_compile = __commonJS2({ "node_modules/braces/lib/compile.js"(exports, module) {
  var fill22 = require_fill_range();
  var utils2 = require_utils();
  var compile = (ast, options8 = {}) => {
    let walk = (node, parent = {}) => {
      ...
      let prefix2 = options8.escapeInvalid === true ? "\\" : "";
      let output = "";
      if (node.isOpen === true) {
      ...
      if (node.nodes && node.ranges > 0) {
        ...
        let range = fill22(...args, { ...options8, wrap: false, toRegex: true });
        if (range.length !== 0) {
...
var require_expand = __commonJS2({ "node_modules/braces/lib/expand.js"(exports, module) {
  var fill22 = require_fill_range();
  ...
  var expand = (ast, options8 = {}) => {
    ...
    let walk = (node, parent = {}) => {
      ...
      if (node.nodes && node.ranges > 0) {
        ...
        let range = fill22(...args, options8);
        if (range.length === 0) {
...
var require_constants = __commonJS2({ "node_modules/braces/lib/constants.js"(exports, module) {
  module.exports = {
    MAX_LENGTH: 1024 * 64,
    // Digits
    CHAR_0: "0",
...
var require_parse = __commonJS2({ "node_modules/braces/lib/parse.js"(exports, module) {
  var stringify2 = require_stringify();
  var {
    MAX_LENGTH,
    CHAR_BACKSLASH,
  ...
  var parse6 = (input, options8 = {}) => {
    ...
    while (index < length) {
      ...
      if (value === CHAR_LEFT_CURLY_BRACE) {
        ...
        let brace = { type: "brace", open: true, close: false, dollar, depth, commas: 0, ranges: 0, nodes: [] };
        block = push2(brace);
        stack2.push(block);
...
var require_braces = __commonJS2({ "node_modules/braces/index.js"(exports, module) {
  var stringify2 = require_stringify();
...
var require_constants2 = __commonJS2({ "node_modules/picomatch/lib/constants.js"(exports, module) {
  var path132 = __require("path");
  var WIN_SLASH = "\\\\/";
  ...
  var STAR = `${QMARK}*?`;
  var POSIX_CHARS = { DOT_LITERAL, PLUS_LITERAL, QMARK_LITERAL, SLASH_LITERAL, ONE_CHAR, QMARK, END_ANCHOR, DOTS_SLASH, NO_DOT, NO_DOTS, NO_DOT_SLASH, NO_DOTS_SLASH, QMARK_NO_DOT, STAR, START_ANCHOR };
  var WINDOWS_CHARS = { ...POSIX_CHARS, SLASH_LITERAL: `[${WIN_SLASH}]`, QMARK: WIN_NO_SLASH, STAR: `${WIN_NO_SLASH}*?`, DOTS_SLASH: `${DOT_LITERAL}{1,2}(?:[${WIN_SLASH}]|$)`, NO_DOT: `(?!${DOT_LITERAL})`, NO_DOTS: `(?!(?:^|[${WIN_SLASH}])${DOT_LITERAL}{1,2}(?:[${WIN_SLASH}]|$))`, NO_DOT_SLASH: `(?!${DOT_LITERAL}{0,1}(?:[${WIN_SLASH}]|$))`, NO_DOTS_SLASH: `(?!${DOT_LITERAL}{1,2}(?:[${WIN_SLASH}]|$))`, QMARK_NO_DOT: `[^.${WIN_SLASH}]`, START_ANCHOR: `(?:^|[${WIN_SLASH}])`, END_ANCHOR: `(?:[${WIN_SLASH}]|$)` };
  ...
  module.exports = {
    ...
    */
    extglobChars(chars) {
      return { "!": { type: "negate", open: "(?:(?!(?:", close: `))${chars.STAR})` }, "?": { type: "qmark", open: "(?:", close: ")?" }, "+": { type: "plus", open: "(?:", close: ")+" }, "*": { type: "star", open: "(?:", close: ")*" }, "@": { type: "at", open: "(?:", close: ")" } };
    },
    /**
    * Create GLOB_CHARS
    */
...
var require_utils2 = __commonJS2({ "node_modules/picomatch/lib/utils.js"(exports) {
  var path132 = __require("path");
...
var require_scan = __commonJS2({ "node_modules/picomatch/lib/scan.js"(exports, module) {
  ...
  var scan = (input, options8) => {
    ...
    const state = { prefix: prefix2, input, start, base, glob, isBrace, isBracket, isGlob, isExtglob, isGlobstar, negated, negatedExtglob };
    if (opts.tokens === true) {
      state.maxDepth = 0;
...
var require_parse2 = __commonJS2({ "node_modules/picomatch/lib/parse.js"(exports, module) {
  ...
  var parse6 = (input, options8) => {
    ...
    if (opts.fastpaths !== false && !/(^[*!]|[/()[\]{}"])/.test(input)) {
      ...
      state.output = utils2.wrapOutput(output, state, options8);
      return state;
    }
    while (!eos()) {
      value = advance();
...
var require_picomatch = __commonJS2({ "node_modules/picomatch/lib/picomatch.js"(exports, module) {
  var path132 = __require("path");
  ...
  var picomatch = (glob, options8, returnState = false) => {
    ...
    const opts = options8 || {};
    const posix = utils2.isWindows(options8);
  ...
  picomatch.matchBase = (input, glob, options8, posix = utils2.isWindows(options8)) => {
    const regex = glob instanceof RegExp ? glob : picomatch.makeRe(glob, options8);
    return regex.test(path132.basename(input));
  };
...
var require_picomatch2 = __commonJS2({ "node_modules/picomatch/index.js"(exports, module) {
  module.exports = require_picomatch();
} });
var require_micromatch = __commonJS2({ "node_modules/micromatch/index.js"(exports, module) {
  var util2 = __require("util");
  var braces = require_braces();
  var picomatch = require_picomatch2();
  var utils2 = require_utils2();
  var isEmptyString = (val) => val === "" || val === "./";
  var micromatch2 = (list2, patterns, options8) => {
    ...
    for (let i2 = 0; i2 < patterns.length; i2++) {
      let isMatch = picomatch(String(patterns[i2]), { ...options8, onResult }, true);
  ...
  micromatch2.not = (list2, patterns, options8 = {}) => {
    ...
    let matches = new Set(micromatch2(list2, patterns, { ...options8, onResult }));
  ...
  micromatch2.some = (list2, patterns, options8) => {
  ...
  micromatch2.every = (list2, patterns, options8) => {
    let items = [].concat(list2);
    for (let pattern of [].concat(patterns)) {
      let isMatch = picomatch(String(pattern), options8);
  ...
  micromatch2.capture = (glob, input, options8) => {
    let posix = utils2.isWindows(options8);
...
var require_pattern = __commonJS2({ "node_modules/fast-glob/out/utils/pattern.js"(exports) {
  ...
  function isAffectDepthOfReadingPattern(pattern) {
    const basename = path132.basename(pattern);
...
var require_merge2 = __commonJS2({ "node_modules/merge2/index.js"(exports, module) {
...
var require_utils3 = __commonJS2({ "node_modules/fast-glob/out/utils/index.js"(exports) {
  ...
  var fs72 = require_fs();
  exports.fs = fs72;
  var path132 = require_path();
  exports.path = path132;
...
var require_tasks = __commonJS2({ "node_modules/fast-glob/out/managers/tasks.js"(exports) {
  ...
  function convertPatternGroupToTask(base, positive, negative, dynamic) {
    return { dynamic, positive, negative, base, patterns: [].concat(positive, negative.map(utils2.pattern.convertToNegativePattern)) };
  }
...
var require_async = __commonJS2({ "node_modules/@nodelib/fs.stat/out/providers/async.js"(exports) {
  ...
  function read3(path132, settings, callback) {
    settings.fs.lstat(path132, (lstatError, lstat) => {
      ...
      settings.fs.stat(path132, (statError, stat) => {
        if (statError !== null) {
...
var require_sync = __commonJS2({ "node_modules/@nodelib/fs.stat/out/providers/sync.js"(exports) {
  ...
  function read3(path132, settings) {
    ...
    try {
      const stat = settings.fs.statSync(path132);
      if (settings.markSymbolicLink) {
        stat.isSymbolicLink = () => true;
      }
      return stat;
...
var require_settings = __commonJS2({ "node_modules/@nodelib/fs.stat/out/settings.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  var fs72 = require_fs2();
  var Settings = class {
    constructor(_options = {}) {
      this._options = _options;
      this.followSymbolicLink = this._getValue(this._options.followSymbolicLink, true);
      this.fs = fs72.createFileSystemAdapter(this._options.fs);
...
var require_out = __commonJS2({ "node_modules/@nodelib/fs.stat/out/index.js"(exports) {
  ...
  function stat(path132, optionsOrSettingsOrCallback, callback) {
    if (typeof optionsOrSettingsOrCallback === "function") {
      async.read(path132, getSettings(), optionsOrSettingsOrCallback);
      return;
    }
    async.read(path132, getSettings(optionsOrSettingsOrCallback), callback);
  }
  exports.stat = stat;
  function statSync2(path132, optionsOrSettings) {
    const settings = getSettings(optionsOrSettings);
    return sync.read(path132, settings);
  }
...
var require_queue_microtask = __commonJS2({ "node_modules/queue-microtask/index.js"(exports, module) {
  var promise;
  module.exports = typeof queueMicrotask === "function" ? queueMicrotask.bind(typeof window !== "undefined" ? window : global) : (cb) => (promise || (promise = Promise.resolve())).then(cb).catch((err) => setTimeout(() => {
    throw err;
  }, 0));
} });
var require_run_parallel = __commonJS2({ "node_modules/run-parallel/index.js"(exports, module) {
...
var require_async2 = __commonJS2({ "node_modules/@nodelib/fs.scandir/out/providers/async.js"(exports) {
  ...
  function readdirWithFileTypes(directory, settings, callback) {
    settings.fs.readdir(directory, { withFileTypes: true }, (readdirError, dirents) => {
      ...
      const entries = dirents.map((dirent) => ({ dirent, name: dirent.name, path: common2.joinPathSegments(directory, dirent.name, settings.pathSegmentSeparator) }));
  ...
  function readdir(directory, settings, callback) {
    settings.fs.readdir(directory, (readdirError, names) => {
      ...
      const tasks = names.map((name) => {
        const path132 = common2.joinPathSegments(directory, name, settings.pathSegmentSeparator);
        return (done) => {
          fsStat.stat(path132, settings.fsStatSettings, (error, stats) => {
            if (error !== null) {
              done(error);
              return;
            }
            const entry = { name, path: path132, dirent: utils2.fs.createDirentFromStats(name, stats) };
            if (settings.stats) {
              entry.stats = stats;
            }
            done(null, entry);
...
var require_sync2 = __commonJS2({ "node_modules/@nodelib/fs.scandir/out/providers/sync.js"(exports) {
  ...
  function readdirWithFileTypes(directory, settings) {
    ...
    return dirents.map((dirent) => {
      const entry = { dirent, name: dirent.name, path: common2.joinPathSegments(directory, dirent.name, settings.pathSegmentSeparator) };
  ...
  function readdir(directory, settings) {
    ...
    return names.map((name) => {
      ...
      const entry = { name, path: entryPath, dirent: utils2.fs.createDirentFromStats(name, stats) };
      if (settings.stats) {
        entry.stats = stats;
      }
      return entry;
...
var require_settings2 = __commonJS2({ "node_modules/@nodelib/fs.scandir/out/settings.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  var path132 = __require("path");
  var fsStat = require_out();
  var fs72 = require_fs4();
  var Settings = class {
    constructor(_options = {}) {
      this._options = _options;
      this.followSymbolicLinks = this._getValue(this._options.followSymbolicLinks, false);
      this.fs = fs72.createFileSystemAdapter(this._options.fs);
      this.pathSegmentSeparator = this._getValue(this._options.pathSegmentSeparator, path132.sep);
...
var require_out2 = __commonJS2({ "node_modules/@nodelib/fs.scandir/out/index.js"(exports) {
  ...
  exports.Settings = settings_1.default;
  function scandir(path132, optionsOrSettingsOrCallback, callback) {
    if (typeof optionsOrSettingsOrCallback === "function") {
      async.read(path132, getSettings(), optionsOrSettingsOrCallback);
      return;
    }
  ...
  function scandirSync(path132, optionsOrSettings) {
    const settings = getSettings(optionsOrSettings);
    return sync.read(path132, settings);
  }
...
var require_reusify = __commonJS2({ "node_modules/reusify/reusify.js"(exports, module) {
  function reusify(Constructor) {
    ...
    return { get: get2, release };
  }
  module.exports = reusify;
} });
var require_queue = __commonJS2({ "node_modules/fastq/queue.js"(exports, module) {
  ...
  function fastqueue(context, worker, concurrency) {
    ...
    var self = { push: push2, drain: noop22, saturated: noop22, pause, paused: false, concurrency, running, resume, idle, length, getQueue, unshift, empty: noop22, kill, killAndDrain, error };
    return self;
    function running() {
      return _running;
    }
...
var require_reader = __commonJS2({ "node_modules/@nodelib/fs.walk/out/readers/reader.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
...
var require_async3 = __commonJS2({ "node_modules/@nodelib/fs.walk/out/readers/async.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
...
var require_async4 = __commonJS2({ "node_modules/@nodelib/fs.walk/out/providers/async.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
...
var require_stream2 = __commonJS2({ "node_modules/@nodelib/fs.walk/out/providers/stream.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  ...
  var StreamProvider = class {
    constructor(_root, _settings) {
      ...
      this._settings = _settings;
      this._reader = new async_1.default(this._root, this._settings);
      this._stream = new stream_1.Readable({ objectMode: true, read: () => {
      }, destroy: () => {
...
var require_sync3 = __commonJS2({ "node_modules/@nodelib/fs.walk/out/readers/sync.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  var fsScandir = require_out2();
  var common2 = require_common2();
  var reader_1 = require_reader();
...
var require_sync4 = __commonJS2({ "node_modules/@nodelib/fs.walk/out/providers/sync.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
...
var require_settings3 = __commonJS2({ "node_modules/@nodelib/fs.walk/out/settings.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  var path132 = __require("path");
  var fsScandir = require_out2();
  var Settings = class {
...
var require_reader2 = __commonJS2({ "node_modules/fast-glob/out/readers/reader.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  var path132 = __require("path");
  var fsStat = require_out();
  var utils2 = require_utils3();
  var Reader = class {
    constructor(_settings) {
      this._settings = _settings;
      this._fsStatSettings = new fsStat.Settings({ followSymbolicLink: this._settings.followSymbolicLinks, fs: this._settings.fs, throwErrorOnBrokenSymbolicLink: this._settings.followSymbolicLinks });
    }
    _getFullEntryPath(filepath) {
      return path132.resolve(this._settings.cwd, filepath);
    }
    _makeEntry(stats, pattern) {
      const entry = { name: pattern, path: pattern, dirent: utils2.fs.createDirentFromStats(pattern, stats) };
...
var require_stream3 = __commonJS2({ "node_modules/fast-glob/out/readers/stream.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  var stream_1 = __require("stream");
  var fsStat = require_out();
...
var require_async5 = __commonJS2({ "node_modules/fast-glob/out/readers/async.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  var fsWalk = require_out3();
  var reader_1 = require_reader2();
...
var require_matcher = __commonJS2({ "node_modules/fast-glob/out/providers/matchers/matcher.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  var utils2 = require_utils3();
  var Matcher = class {
    ...
    _fillStorage() {
      for (const pattern of this._patterns) {
        ...
        this._storage.push({ complete: sections.length <= 1, pattern, segments, sections });
      }
    }
    _getPatternSegments(pattern) {
      ...
      return parts.map((part) => {
        ...
        return { dynamic: true, pattern: part, patternRe: utils2.pattern.makeRe(part, this._micromatchOptions) };
      });
    }
...
var require_partial = __commonJS2({ "node_modules/fast-glob/out/providers/matchers/partial.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
...
var require_deep = __commonJS2({ "node_modules/fast-glob/out/providers/filters/deep.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  var utils2 = require_utils3();
...
var require_entry = __commonJS2({ "node_modules/fast-glob/out/providers/filters/entry.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  var utils2 = require_utils3();
...
var require_error = __commonJS2({ "node_modules/fast-glob/out/providers/filters/error.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  var utils2 = require_utils3();
...
var require_entry2 = __commonJS2({ "node_modules/fast-glob/out/providers/transformers/entry.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  var utils2 = require_utils3();
...
var require_provider = __commonJS2({ "node_modules/fast-glob/out/providers/provider.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  var path132 = __require("path");
  ...
  var Provider = class {
    ...
    _getRootDirectory(task) {
      return path132.resolve(this._settings.cwd, task.base);
    }
...
var require_async6 = __commonJS2({ "node_modules/fast-glob/out/providers/async.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
...
var require_stream4 = __commonJS2({ "node_modules/fast-glob/out/providers/stream.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  var stream_1 = __require("stream");
...
var require_sync5 = __commonJS2({ "node_modules/fast-glob/out/readers/sync.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  var fsStat = require_out();
  var fsWalk = require_out3();
  var reader_1 = require_reader2();
...
var require_sync6 = __commonJS2({ "node_modules/fast-glob/out/providers/sync.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
...
var require_settings4 = __commonJS2({ "node_modules/fast-glob/out/settings.js"(exports) {
  ...
  exports.DEFAULT_FILE_SYSTEM_ADAPTER = { lstat: fs72.lstat, lstatSync: fs72.lstatSync, stat: fs72.stat, statSync: fs72.statSync, readdir: fs72.readdir, readdirSync: fs72.readdirSync };
  var Settings = class {
    constructor(_options = {}) {
      this._options = _options;
...
var require_out4 = __commonJS2({ "node_modules/fast-glob/out/index.js"(exports, module) {
...
var require_constants4 = __commonJS2({ "node_modules/semver/internal/constants.js"(exports, module) {
  ...
  module.exports = { MAX_LENGTH, MAX_SAFE_COMPONENT_LENGTH, MAX_SAFE_BUILD_LENGTH, MAX_SAFE_INTEGER, RELEASE_TYPES, SEMVER_SPEC_VERSION, FLAG_INCLUDE_PRERELEASE: 1, FLAG_LOOSE: 2 };
} });
...
var require_pseudomap = __commonJS2({ "node_modules/pseudomap/pseudomap.js"(exports, module) {
  ...
  function PseudoMap(set3) {
    ...
    this.clear();
    if (set3) {
      if (set3 instanceof PseudoMap || typeof Map === "function" && set3 instanceof Map) set3.forEach(function(value, key2) {
        this.set(key2, value);
      }, this);
      else if (Array.isArray(set3)) set3.forEach(function(kv) {
        this.set(kv[0], kv[1]);
      }, this);
  ...
  PseudoMap.prototype.clear = function() {
    ...
    data.size = 0;
    Object.defineProperty(this, "_data", { value: data, enumerable: false, configurable: true, writable: false });
  };
  Object.defineProperty(PseudoMap.prototype, "size", { get: function() {
...
var require_map = __commonJS2({ "node_modules/pseudomap/map.js"(exports, module) {
...
var require_yallist = __commonJS2({ "node_modules/editorconfig/node_modules/yallist/yallist.js"(exports, module) {
...
var require_lru_cache = __commonJS2({ "node_modules/editorconfig/node_modules/lru-cache/index.js"(exports, module) {
  ...
  Object.defineProperty(LRUCache.prototype, "allowStale", { set: function(allowStale) {
    this[ALLOW_STALE] = !!allowStale;
  }, get: function() {
    return this[ALLOW_STALE];
  }, enumerable: true });
  Object.defineProperty(LRUCache.prototype, "maxAge", { set: function(mA) {
  ...
  Object.defineProperty(LRUCache.prototype, "lengthCalculator", { set: function(lC) {
    if (typeof lC !== "function") {
      lC = naiveLength;
    }
  ...
  Object.defineProperty(LRUCache.prototype, "length", { get: function() {
    return this[LENGTH];
  }, enumerable: true });
  Object.defineProperty(LRUCache.prototype, "itemCount", { get: function() {
  ...
  LRUCache.prototype.prune = function() {
    ...
    this[CACHE].forEach(function(value, key2) {
      get2(self, key2, false);
    });
  };
  function get2(self, key2, doUse) {
...
var require_sigmund = __commonJS2({ "node_modules/sigmund/sigmund.js"(exports, module) {
...
var require_fnmatch = __commonJS2({ "node_modules/editorconfig/src/lib/fnmatch.js"(exports, module) {
  ...
  function braceExpand(pattern, options8) {
    ...
    if (pattern.charAt(0) !== "{") {
      var prefix2 = null;
      for (var i2 = 0, l = pattern.length; i2 < l; i2++) {
        var c2 = pattern.charAt(i2);
        if (c2 === "\\") {
          escaping = !escaping;
        } else if (c2 === "{" && !escaping) {
          prefix2 = pattern.substr(0, i2);
          break;
        }
      }
      if (prefix2 === null) {
    ...
    if (numset) {
      ...
      for (var i2 = start; i2 != end + inc; i2 += inc) {
    ...
    var i2 = 1, depth = 1, set2 = [], member = "", escaping = false;
    function addMember() {
      set2.push(member);
      member = "";
    }
    FOR: for (i2 = 1, l = pattern.length; i2 < l; i2++) {
      var c2 = pattern.charAt(i2);
      if (escaping) {
        escaping = false;
        member += "\\" + c2;
    ...
    var suf = braceExpand(pattern.substr(i2), options8);
    ...
    var ret = [];
    for (var i2 = 0, l = set2.length; i2 < l; i2++) {
      for (var ii = 0, ll = suf.length; ii < ll; ii++) {
  ...
  function parse6(pattern, isSub) {
    ...
    for (var i2 = 0, len = pattern.length, c2; i2 < len && (c2 = pattern.charAt(i2)); i2++) {
      if (options8.debug) {
        console.error("%s	%s %s %j", pattern, i2, re, c2);
      }
      ...
      switch (c2) {
        ...
        case "!":
          if (options8.debug) {
            console.error("%s	%s %s %j <-- stateChar", pattern, i2, re, c2);
          }
          if (inClass) {
        ...
        case "(":
          ...
          plType = stateChar;
          patternListStack.push({ type: plType, start: i2 - 1, reStart: re.length });
          re += stateChar === "!" ? "(?:(?!" : "(?:";
          stateChar = false;
          continue;
        case ")":
  ...
  minimatch.match = function(list2, pattern, options8) {
    var mm = new Minimatch(pattern, options8);
    list2 = list2.filter(function(f) {
      return mm.match(f);
    });
    if (options8.nonull && !list2.length) {
      list2.push(pattern);
    }
    return list2;
  };
  ...
  Minimatch.prototype.matchOne = function(file, pattern, partial) {
    var options8 = this.options;
    if (options8.debug) {
      console.error("matchOne", { "this": this, file, pattern });
    }
    if (options8.matchBase && pattern.length === 1) {
      file = path132.basename(file.join("/")).split("/");
    }
    if (options8.debug) {
        ...
        WHILE: while (fr < fl) {
          ...
          if (this.matchOne(file.slice(fr), pattern.slice(pr), partial)) {
            ...
            if (swallowee === "." || swallowee === ".." || !options8.dot && swallowee.charAt(0) === ".") {
              if (options8.debug) console.error("dot detected!", file, fr, pattern, pr);
              break WHILE;
            }
            if (options8.debug) console.error("globstar swallow a segment, and continue");
            fr++;
          }
        }
        if (partial) {
...
var require_ini = __commonJS2({ "node_modules/editorconfig/src/lib/ini.js"(exports) {
  ...
  function parseSync(file) {
    return parseString(fs72.readFileSync(file, "utf8"));
  }
...
var require_src = __commonJS2({ "node_modules/editorconfig/src/index.js"(exports) {
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  var fs72 = __importStar(__require("fs"));
  var path132 = __importStar(__require("path"));
  var semver = { gte: require_gte() };
  ...
  var knownProps = { end_of_line: true, indent_style: true, indent_size: true, insert_final_newline: true, trim_trailing_whitespace: true, charset: true };
  ...
  function getConfigFileNames(filepath, options8) {
    var paths = [];
    do {
      filepath = path132.dirname(filepath);
      paths.push(path132.join(filepath, options8.config));
  ...
  function parseFromConfigs(configs, filepath, options8) {
    return processMatches(configs.reverse().reduce(function(matches, file) {
      var pathPrefix = path132.dirname(file.name);
    ...
    return __awaiter(this, undefined, undefined, function() {
      return __generator(this, function(_a) {
        return [2, Promise.all(filepaths.map(function(name) {
          return new Promise(function(resolve3) {
            fs72.readFile(name, "utf8", function(err, data) {
              resolve3({ name, contents: err ? "" : data });
            });
          });
        }))];
      });
  ...
  function readConfigFilesSync(filepaths) {
    ...
    filepaths.forEach(function(filepath) {
      try {
        file = fs72.readFileSync(filepath, "utf8");
      } catch (e) {
        file = "";
      }
...
var require_parser = __commonJS2({ "node_modules/@iarna/toml/lib/parser.js"(exports, module) {
...
var require_create_datetime = __commonJS2({ "node_modules/@iarna/toml/lib/create-datetime.js"(exports, module) {
...
var require_format_num = __commonJS2({ "node_modules/@iarna/toml/lib/format-num.js"(exports, module) {
...
var require_create_datetime_float = __commonJS2({ "node_modules/@iarna/toml/lib/create-datetime-float.js"(exports, module) {
...
var require_create_date = __commonJS2({ "node_modules/@iarna/toml/lib/create-date.js"(exports, module) {
  var f = require_format_num();
...
var require_create_time = __commonJS2({ "node_modules/@iarna/toml/lib/create-time.js"(exports, module) {
  var f = require_format_num();
...
var require_toml_parser = __commonJS2({ "node_modules/@iarna/toml/lib/toml-parser.js"(exports, module) {
  ...
  function Table() {
    return Object.defineProperties({}, { [_type]: { value: TABLE }, [_declared]: { value: false, writable: true } });
  }
  ...
  function InlineList(type2) {
    return Object.defineProperties([], { [_type]: { value: INLINE_LIST }, [_contentType]: { value: type2 } });
  }
  ...
  function Integer(value) {
    ...
    if (global.BigInt && !Number.isSafeInteger(num)) {
      ...
      return Object.defineProperties(new Number(num), { isNaN: { value: function() {
        return isNaN(this);
      } }, [_type]: { value: INTEGER }, [_inspect]: { value: () => `[Integer: ${value}]` } });
    }
  }
  ...
  function Float(value) {
    return Object.defineProperties(new Number(value), { [_type]: { value: FLOAT }, [_inspect]: { value: () => `[Float: ${value}]` } });
  }
...
var require_parse_pretty_error = __commonJS2({ "node_modules/@iarna/toml/parse-pretty-error.js"(exports, module) {
...
var require_parse_async = __commonJS2({ "node_modules/@iarna/toml/parse-async.js"(exports, module) {
...
var require_js_tokens = __commonJS2({ "node_modules/js-tokens/index.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
...
var require_identifier = __commonJS2({ "node_modules/@babel/helper-validator-identifier/lib/identifier.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
...
var require_keyword = __commonJS2({ "node_modules/@babel/helper-validator-identifier/lib/keyword.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
...
var require_lib = __commonJS2({ "node_modules/@babel/helper-validator-identifier/lib/index.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  Object.defineProperty(exports, "isIdentifierChar", { enumerable: true, get: function() {
    return _identifier.isIdentifierChar;
  } });
  Object.defineProperty(exports, "isIdentifierName", { enumerable: true, get: function() {
    return _identifier.isIdentifierName;
  } });
  Object.defineProperty(exports, "isIdentifierStart", { enumerable: true, get: function() {
    return _identifier.isIdentifierStart;
  } });
  Object.defineProperty(exports, "isKeyword", { enumerable: true, get: function() {
    return _keyword.isKeyword;
  } });
  Object.defineProperty(exports, "isReservedWord", { enumerable: true, get: function() {
    return _keyword.isReservedWord;
  } });
  Object.defineProperty(exports, "isStrictBindOnlyReservedWord", { enumerable: true, get: function() {
    return _keyword.isStrictBindOnlyReservedWord;
  } });
  Object.defineProperty(exports, "isStrictBindReservedWord", { enumerable: true, get: function() {
    return _keyword.isStrictBindReservedWord;
  } });
  Object.defineProperty(exports, "isStrictReservedWord", { enumerable: true, get: function() {
    return _keyword.isStrictReservedWord;
  } });
  var _identifier = require_identifier();
  var _keyword = require_keyword();
} });
var require_escape_string_regexp = __commonJS2({ "node_modules/@babel/code-frame/node_modules/escape-string-regexp/index.js"(exports, module) {
...
var require_color_name = __commonJS2({ "node_modules/color-name/index.js"(exports, module) {
...
var require_conversions = __commonJS2({ "node_modules/color-convert/conversions.js"(exports, module) {
...
var require_route = __commonJS2({ "node_modules/color-convert/route.js"(exports, module) {
  ...
  function wrapConversion(toModel, graph) {
    var path132 = [graph[toModel].parent, toModel];
...
var require_color_convert = __commonJS2({ "node_modules/color-convert/index.js"(exports, module) {
  var conversions = require_conversions();
...
var require_ansi_styles = __commonJS2({ "node_modules/@babel/code-frame/node_modules/ansi-styles/index.js"(exports, module) {
  ...
  function assembleStyles2() {
    ...
    for (const groupName of Object.keys(styles3)) {
      ...
      for (const styleName of Object.keys(group2)) {
        ...
        styles3[styleName] = { open: `\x1B[${style[0]}m`, close: `\x1B[${style[1]}m` };
        group2[styleName] = styles3[styleName];
        codes2.set(style[0], style[1]);
      }
      Object.defineProperty(styles3, groupName, { value: group2, enumerable: false });
      Object.defineProperty(styles3, "codes", { value: codes2, enumerable: false });
    }
    const ansi2ansi = (n) => n;
    const rgb2rgb = (r, g, b) => [r, g, b];
    styles3.color.close = "\x1B[39m";
    styles3.bgColor.close = "\x1B[49m";
    styles3.color.ansi = { ansi: wrapAnsi162(ansi2ansi, 0) };
    styles3.color.ansi256 = { ansi256: wrapAnsi2562(ansi2ansi, 0) };
    styles3.color.ansi16m = { rgb: wrapAnsi16m2(rgb2rgb, 0) };
    styles3.bgColor.ansi = { ansi: wrapAnsi162(ansi2ansi, 10) };
    styles3.bgColor.ansi256 = { ansi256: wrapAnsi2562(ansi2ansi, 10) };
    styles3.bgColor.ansi16m = { rgb: wrapAnsi16m2(rgb2rgb, 10) };
...
var require_has_flag = __commonJS2({ "node_modules/@babel/code-frame/node_modules/has-flag/index.js"(exports, module) {
  module.exports = (flag, argv) => {
    argv = argv || process.argv;
    const prefix2 = flag.startsWith("-") ? "" : flag.length === 1 ? "-" : "--";
    const pos2 = argv.indexOf(prefix2 + flag);
    const terminatorPos = argv.indexOf("--");
    return pos2 !== -1 && (terminatorPos === -1 ? true : pos2 < terminatorPos);
  };
} });
var require_supports_color = __commonJS2({ "node_modules/@babel/code-frame/node_modules/supports-color/index.js"(exports, module) {
  var os2 = __require("os");
...
var require_templates = __commonJS2({ "node_modules/@babel/code-frame/node_modules/chalk/templates.js"(exports, module) {
...
var require_chalk = __commonJS2({ "node_modules/@babel/code-frame/node_modules/chalk/index.js"(exports, module) {
  ...
  for (const model of Object.keys(ansiStyles2.color.ansi)) {
    ...
    styles3[model] = { get() {
      ...
      return function() {
        ...
        const codes2 = { open, close: ansiStyles2.color.close, closeRe: ansiStyles2.color.closeRe };
  ...
  for (const model of Object.keys(ansiStyles2.bgColor.ansi)) {
    ...
    styles3[bgModel] = { get() {
      ...
      return function() {
        ...
        const codes2 = { open, close: ansiStyles2.bgColor.close, closeRe: ansiStyles2.bgColor.closeRe };
        return build.call(this, this._styles ? this._styles.concat(codes2) : [codes2], this._empty, model);
      };
    } };
  }
...
var require_lib2 = __commonJS2({ "node_modules/@babel/highlight/lib/index.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  ...
  function getDefs(chalk2) {
    return { keyword: chalk2.cyan, capitalized: chalk2.yellow, jsxIdentifier: chalk2.yellow, punctuator: chalk2.yellow, number: chalk2.magenta, string: chalk2.green, regex: chalk2.magenta, comment: chalk2.grey, invalid: chalk2.white.bgRed.bold };
  }
  var NEWLINE = /\r\n|[\n\r\u2028\u2029]/;
  var BRACKET = /^[()[\]{}]$/;
  var tokenize;
  {
    ...
    tokenize = function* (text) {
      ...
      while (match = _jsTokens.default.exec(text)) {
        ...
        yield { type: getTokenType(token2, match.index, text), value: token2.value };
      }
    };
  }
  function highlightTokens(defs, text) {
    let highlighted = "";
    for (const { type: type2, value } of tokenize(text)) {
  ...
  function getChalk(forceColor) {
    if (forceColor) {
      ...
      (_chalkWithForcedColor = chalkWithForcedColor) != null ? _chalkWithForcedColor : chalkWithForcedColor = new _chalk.default.constructor({ enabled: true, level: 1 });
...
var require_lib3 = __commonJS2({ "node_modules/@babel/code-frame/lib/index.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  ...
  function getDefs(chalk2) {
    return { gutter: chalk2.grey, marker: chalk2.red.bold, message: chalk2.red.bold };
  }
  var NEWLINE = /\r\n|[\n\r\u2028\u2029]/;
...
var require_ignore = __commonJS2({ "node_modules/ignore/index.js"(exports, module) {
  ...
  var makeRegex = (pattern, ignoreCase) => {
    ...
    if (!source2) {
      source2 = REPLACERS.reduce((prev, current) => prev.replace(current[0], current[1].bind(pattern)), pattern);
  ...
  var checkPath = (path132, originalPath, doThrow) => {
    if (!isString(path132)) {
    ...
    if (checkPath.isNotRelative(path132)) {
      const r = "`path.relative()`d";
      return doThrow(`path should be a ${r} string, but got "${originalPath}"`, RangeError);
    }
    return true;
  };
  var isNotRelative = (path132) => REGEX_TEST_INVALID_PATH.test(path132);
  ...
  var Ignore = class {
    ...
    _testOne(path132, checkUnignored) {
      let ignored = false;
      let unignored = false;
      this._rules.forEach((rule) => {
        ...
        const matched = rule.regex.test(path132);
        if (matched) {
          ignored = !negative;
          unignored = negative;
        }
    ...
    _test(originalPath, cache3, checkUnignored, slices) {
      const path132 = originalPath && checkPath.convert(originalPath);
      checkPath(path132, originalPath, this._allowRelativePaths ? RETURN_FALSE : throwError2);
      return this._t(path132, cache3, checkUnignored, slices);
    }
    _t(path132, cache3, checkUnignored, slices) {
      if (path132 in cache3) {
        return cache3[path132];
      }
      if (!slices) {
        slices = path132.split(SLASH);
      }
      slices.pop();
      if (!slices.length) {
        return cache3[path132] = this._testOne(path132, checkUnignored);
      }
      const parent = this._t(slices.join(SLASH) + SLASH, cache3, checkUnignored, slices);
      return cache3[path132] = parent.ignored ? parent : this._testOne(path132, checkUnignored);
    }
    ignores(path132) {
      return this._test(path132, this._ignoreCache, false).ignored;
    }
    createFilter() {
      return (path132) => !this.ignores(path132);
    }
    filter(paths) {
    ...
    // @returns {TestResult}
    test(path132) {
      return this._test(path132, this._testCache, true);
    }
  };
  var factory = (options8) => new Ignore(options8);
  var isPathValid = (path132) => checkPath(path132 && checkPath.convert(path132), path132, RETURN_FALSE);
  ...
  if (
    ...
    checkPath.isNotRelative = (path132) => REGIX_IS_WINDOWS_PATH_ABSOLUTE.test(path132) || isNotRelative(path132);
  }
} });
var require_readlines = __commonJS2({ "node_modules/n-readlines/readlines.js"(exports, module) {
  var fs72 = __require("fs");
  var LineByLine = class {
    ...
    _readChunk(lineLeftovers) {
      ...
      do {
        ...
        bytesRead = fs72.readSync(this.fd, readBuffer, 0, this.options.readChunk, this.fdPosition);
...
var require_base = __commonJS2({ "node_modules/diff/lib/diff/base.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  ...
  function clonePath(path132) {
    return { newPos: path132.newPos, components: path132.components.slice(0) };
  }
} });
...
function assembleStyles() {
  ...
  for (const [groupName, group2] of Object.entries(styles)) {
    ...
    Object.defineProperty(styles, groupName, { value: group2, enumerable: false });
  }
  Object.defineProperty(styles, "codes", { value: codes2, enumerable: false });
  ...
  Object.defineProperties(styles, { rgbToAnsi256: { value(red, green, blue) {
    ...
    return result;
  }, enumerable: false }, rgbToAnsi: { value: (red, green, blue) => styles.ansi256ToAnsi(styles.rgbToAnsi256(red, green, blue)), enumerable: false }, hexToAnsi: { value: (hex) => styles.ansi256ToAnsi(styles.hexToAnsi256(hex)), enumerable: false } });
  return styles;
}
...
function createSupportsColor(stream, options8 = {}) {
  const level = _supportsColor(stream, { streamIsTTY: stream && stream.isTTY, ...options8 });
...
var commonDeprecatedHandler = (keyOrPair, redirectTo, { descriptor }) => {
  const messages2 = [`${source_default.yellow(typeof keyOrPair === "string" ? descriptor.key(keyOrPair) : descriptor.pair(keyOrPair))} is deprecated`];
  if (redirectTo) {
...
var commonInvalidHandler = (key2, value, utils2) => {
  const { text, list: list2 } = utils2.normalizeExpectedResult(utils2.schemas[key2].expected(utils2));
  const descriptions = [];
  if (text) {
    descriptions.push(getDescription(key2, value, text, utils2.descriptor));
  }
  if (list2) {
    descriptions.push([getDescription(key2, value, list2.title, utils2.descriptor)].concat(list2.values.map((valueDescription) => getListDescription(valueDescription, utils2.loggerPrintWidth))).join("\n"));
  }
  return chooseDescription(descriptions, utils2.loggerPrintWidth);
};
function getDescription(key2, value, expected, descriptor) {
  return [`Invalid ${source_default.red(descriptor.key(key2))} value.`, `Expected ${source_default.blue(expected)},`, `but received ${value === VALUE_NOT_EXIST ? source_default.gray("nothing") : source_default.red(descriptor.value(value))}.`].join(" ");
}
function getListDescription({ text, list: list2 }, printWidth) {
  const descriptions = [];
  if (text) {
    descriptions.push(`- ${source_default.blue(text)}`);
  }
  if (list2) {
    descriptions.push([`- ${source_default.blue(list2.title)}:`].concat(list2.values.map((valueDescription) => getListDescription(valueDescription, printWidth - INDENTATION.length).replace(/^|\n/g, `$&${INDENTATION}`))).join("\n"));
  }
...
var levenUnknownHandler = (key2, value, { descriptor, logger, schemas }) => {
  const messages2 = [`Ignored unknown option ${source_default.yellow(descriptor.pair({ key: key2, value }))}.`];
...
var ArraySchema = class extends Schema {
  ...
  expected(utils2) {
    const { text, list: list2 } = utils2.normalizeExpectedResult(this._valueSchema.expected(utils2));
    return { text: text && `an array of ${text}`, list: list2 && { title: `an array of the following values`, values: [{ list: list2 }] } };
  }
  validate(value, utils2) {
    if (!Array.isArray(value)) {
      return false;
  ...
  deprecated(value, utils2) {
    ...
    for (const subValue of value) {
      ...
      if (subDeprecatedResult !== false) {
        deprecatedResult.push(...subDeprecatedResult.map(({ value: deprecatedValue }) => ({ value: [deprecatedValue] })));
      }
    }
...
function normalizeExpectedResult(result) {
  ...
  return { text, list: { title: list2.title, values: list2.values.map(normalizeExpectedResult) } };
}
...
var ChoiceSchema = class extends Schema {
  ...
  expected({ descriptor }) {
    ...
    return { text: message, list: { title: "one of the following values", values: choiceDescriptions } };
  }
  validate(value) {
...
var Normalizer = class {
  constructor(schemas, opts) {
    ...
    this._utils = { descriptor, logger: (
      /* c8 ignore next */
      logger || { warn: () => {
      } }
    ), loggerPrintWidth, schemas: recordFromArray(schemas, "name"), normalizeDefaultResult, normalizeExpectedResult, normalizeDeprecatedResult, normalizeForwardResult, normalizeRedirectResult, normalizeValidateResult };
...
var errors_exports = {};
__export3(errors_exports, { ArgExpansionBailout: () => ArgExpansionBailout, ConfigError: () => ConfigError, UndefinedParserError: () => UndefinedParserError });
...
var import_micromatch = __toESM2(require_micromatch());
...
var toAbsolutePath = (value) => path9.resolve(toPath(value));
function* iterateDirectoryUp(from, to) {
  from = toAbsolutePath(from);
  const { root: root2 } = path9.parse(from);
  to = to ? toAbsolutePath(to) : root2;
  if (from !== to && !from.startsWith(to)) {
    return;
  }
  for (let directory = from; directory !== to; directory = path9.dirname(directory)) {
    yield directory;
  }
  yield to;
}
...
searchInDirectory_fn = async function(directory, shouldCache) {
  ...
  for (const name of __privateGet(this, _names)) {
    const fileOrDirectory = path9__default.join(directory, name);
...
var MARKERS = [".git", ".hg"];
var searcher;
var searchOptions = { names: MARKERS, filter: ({ path: directory }) => is_directory_default(directory, { allowSymlinks: false }) };
...
async function loadEditorconfigInternal(file, { shouldCache }) {
  const directory = path9__default.dirname(file);
...
function loadEditorconfig(file, { shouldCache }) {
  file = path9__default.resolve(file);
...
var import_parse_async = __toESM2(require_parse_async());
...
function makeSnippet(mark, options8) {
  ...
  for (i2 = 1; i2 <= options8.linesBefore; i2++) {
    if (foundLineNo - i2 < 0) break;
    line3 = getLine(mark.buffer, lineStarts[foundLineNo - i2], lineEnds[foundLineNo - i2], mark.position - (lineStarts[foundLineNo] - lineStarts[foundLineNo - i2]), maxLineLength);
  ...
  for (i2 = 1; i2 <= options8.linesAfter; i2++) {
...
function compileMap() {
  var result = { scalar: {}, sequence: {}, mapping: {}, fallback: {}, multi: { scalar: [], sequence: [], mapping: [], fallback: [] } }, index, length;
...
var schema = Schema$1;
var str = new type("tag:yaml.org,2002:str", { kind: "scalar", construct: function(data) {
  return data !== null ? data : "";
} });
var seq = new type("tag:yaml.org,2002:seq", { kind: "sequence", construct: function(data) {
  return data !== null ? data : [];
} });
var map = new type("tag:yaml.org,2002:map", { kind: "mapping", construct: function(data) {
  return data !== null ? data : {};
} });
...
var bool = new type("tag:yaml.org,2002:bool", { kind: "scalar", resolve: resolveYamlBoolean, construct: constructYamlBoolean, predicate: isBoolean, represent: { lowercase: function(object) {
...
var int = new type("tag:yaml.org,2002:int", { kind: "scalar", resolve: resolveYamlInteger, construct: constructYamlInteger, predicate: isInteger, represent: {
  binary: function(obj) {
...
var directiveHandlers = { YAML: function handleYamlDirective(state, name, args) {
...
function newToken(type2, value) {
  return { type: type2, value, line: line2, column };
}
function literal(s) {
  for (const c2 of s) {
    const p = peek();
...
var import_code_frame = __toESM2(require_lib3());
...
var CONFIG_FILE_NAMES = ["package.json", ".prettierrc", ".prettierrc.json", ".prettierrc.yaml", ".prettierrc.yml", ".prettierrc.json5", ".prettierrc.js", ".prettierrc.mjs", ".prettierrc.cjs", "prettier.config.js", "prettier.config.mjs", "prettier.config.cjs", ".prettierrc.toml"];
...
codes.ERR_INVALID_PACKAGE_CONFIG = createError(
  ...
  */
  (path132, base, message) => {
    return `Invalid package config ${path132}${base ? ` while importing ${base}` : ""}${message ? `. ${message}` : ""}`;
  },
  Error
);
...
codes.ERR_MODULE_NOT_FOUND = createError(
  ...
  */
  (path132, base, exactUrl = false) => {
    return `Cannot find ${exactUrl ? "module" : "package"} '${path132}' imported from ${base}`;
  },
  Error
);
...
codes.ERR_UNKNOWN_FILE_EXTENSION = createError(
  ...
  */
  (ext, path132) => {
    return `Unknown file extension "${ext}" for ${path132}`;
  },
  TypeError
);
...
function getPackageScopeConfig(resolved) {
  ...
  while (true) {
    ...
    const packageConfig = package_json_reader_default.read(fileURLToPath(packageJSONUrl), { specifier: resolved });
...
var { ERR_NETWORK_IMPORT_DISALLOWED, ERR_INVALID_MODULE_SPECIFIER, ERR_INVALID_PACKAGE_CONFIG: ERR_INVALID_PACKAGE_CONFIG2, ERR_INVALID_PACKAGE_TARGET, ERR_MODULE_NOT_FOUND, ERR_PACKAGE_IMPORT_NOT_DEFINED, ERR_PACKAGE_PATH_NOT_EXPORTED, ERR_UNSUPPORTED_DIR_IMPORT } = codes;
...
function emitInvalidSegmentDeprecation(target, request, match, packageJsonUrl, internal, base, isTarget) {
  ...
  process3.emitWarning(`Use of deprecated ${double ? "double slash" : "leading or trailing slash matching"} resolving "${target}" for module request "${request}" ${request === match ? "" : `matched to "${match}" `}in the "${internal ? "imports" : "exports"}" field module resolution of the package at ${pjsonPath}${base ? ` imported from ${fileURLToPath(base)}` : ""}.`, "DeprecationWarning", "DEP0166");
}
function emitLegacyIndexDeprecation(url2, packageJsonUrl, base, main) {
  ...
  const urlPath = fileURLToPath(url2.href);
  const pkgPath = fileURLToPath(new URL$1(".", packageJsonUrl));
  const basePath = fileURLToPath(base);
  if (!main) {
    process3.emitWarning(`No "main" or "exports" field defined in the package.json for ${pkgPath} resolving the main entry point "${urlPath.slice(pkgPath.length)}", imported from ${basePath}.
Default "index" lookups for the main are deprecated for ES modules.`, "DeprecationWarning", "DEP0151");
  } else if (path9__default.resolve(pkgPath, main) !== urlPath) {
    process3.emitWarning(`Package ${pkgPath} has a "main" field set to "${main}", excluding the full filename and extension to the resolved file at "${urlPath.slice(pkgPath.length)}", imported from ${basePath}.
 Automatic extension resolution of the "main" field is deprecated for ES modules.`, "DeprecationWarning", "DEP0151");
  }
}
function tryStatSync(path132) {
  try {
    return statSync(path132);
  } catch {
    return new Stats();
  }
}
...
function finalizeResolution(resolved, base, preserveSymlinks) {
  ...
  }
  {
    ...
    resolved = pathToFileURL(real + (filePath.endsWith(path9__default.sep) ? "/" : ""));
...
function resolvePackageTargetString(target, subpath, match, packageJsonUrl, base, pattern, internal, isPathMap, conditions) {
  ...
  if (pattern) {
    return new URL$1(RegExpPrototypeSymbolReplace.call(patternRegEx, resolved.href, () => subpath));
  }
  ...
  if (typeof target === "object" && target !== null) {
    ...
    while (++i2 < keys.length) {
      ...
      if (isArrayIndex(key2)) {
        throw new ERR_INVALID_PACKAGE_CONFIG2(fileURLToPath(packageJsonUrl), base, '"exports" cannot contain numeric property keys.');
      }
    }
    i2 = -1;
    while (++i2 < keys.length) {
...
function emitTrailingSlashPatternDeprecation(match, pjsonUrl, base) {
  ...
  process3.emitWarning(`Use of deprecated trailing slash pattern mapping "${match}" in the "exports" field module resolution of the package at ${pjsonPath}${base ? ` imported from ${fileURLToPath(base)}` : ""}. Mapping specifiers ending in "/" is no longer supported.`, "DeprecationWarning", "DEP0155");
}
...
function defaultResolve(specifier, context = {}) {
  ...
  const url2 = moduleResolve(specifier, new URL$1(parentURL), conditions);
  return {
...
function importFromFile(specifier, parent) {
  const url2 = resolve2(specifier, pathToFileURL(parent).href);
  return import(url2);
}
var import_from_file_default = importFromFile;
function requireFromFile(id, parent) {
  const require22 = createRequire(parent);
  return require22(id);
}
var require_from_file_default = requireFromFile;
var requireErrorCodesShouldBeIgnored = /* @__PURE__ */ new Set(["MODULE_NOT_FOUND", "ERR_REQUIRE_ESM", "ERR_PACKAGE_PATH_NOT_EXPORTED"]);
...
async function loadConfig(configFile) {
  const { base: fileName, ext: extension } = path9__default.parse(configFile);
  ...
  if (typeof config !== "object") {
    throw new TypeError(`Config is only allowed to be an object, but received ${typeof config} in "${configFile}"`);
  }
...
function loadPrettierConfig(configFile, { shouldCache }) {
  configFile = path9__default.resolve(configFile);
...
function searchPrettierConfig(startDirectory, options8 = {}) {
  startDirectory = startDirectory ? path9__default.resolve(startDirectory) : process.cwd();
...
async function resolveConfig(fileUrlOrPath, options8) {
  ...
  const [result, editorConfigured] = await Promise.all([loadPrettierConfig2(filePath, options8), loadEditorconfig2(filePath, options8)]);
  if (!result && !editorConfigured) {
    return null;
  }
  const merged = { ...editorConfigured, ...mergeOverrides(result, filePath) };
  if (Array.isArray(merged.plugins)) {
    merged.plugins = merged.plugins.map((value) => typeof value === "string" && value.startsWith(".") ? path9__default.resolve(path9__default.dirname(result.configFile), value) : value);
  }
  return merged;
}
...
function mergeOverrides(configResult, filePath) {
  ...
  if (filePath && overrides) {
    const relativeFilePath = path9__default.relative(path9__default.dirname(configFile), filePath);
...
var slash = path9__default.sep === "\\" ? (filePath) => string_replace_all_default2(
  /* isOptionalObject*/
  false,
  filePath,
  "\\",
...
function getRelativePath(file, ignoreFile) {
  ...
  const filePath = isUrl(file) ? url.fileURLToPath(file) : path9__default.resolve(file);
  return path9__default.relative(
    // If there's an ignore-path set, the filename must be relative to the
    // ignore path, not the current working directory.
    ignoreFilePath ? path9__default.dirname(ignoreFilePath) : process.cwd(),
    filePath
  );
}
...
var import_n_readlines = __toESM2(require_readlines());
...
async function getFileInfo(file, options8) {
  ...
  return { ignored, inferredParser: inferredParser ?? null };
}
...
function convertEndOfLineToChars2(value) {
  switch (value) {
    case "cr":
      return "\r";
    case "crlf":
...
function normalizeEndOfLine(text) {
  return string_replace_all_default2(
    /* isOptionalObject*/
    false,
    text,
    /\r\n?/g,
...
var DOC_TYPE_STRING2 = "string";
var DOC_TYPE_ARRAY2 = "array";
var DOC_TYPE_CURSOR2 = "cursor";
var DOC_TYPE_INDENT2 = "indent";
var DOC_TYPE_ALIGN2 = "align";
var DOC_TYPE_TRIM2 = "trim";
var DOC_TYPE_GROUP2 = "group";
var DOC_TYPE_FILL2 = "fill";
var DOC_TYPE_IF_BREAK2 = "if-break";
var DOC_TYPE_INDENT_IF_BREAK2 = "indent-if-break";
var DOC_TYPE_LINE_SUFFIX2 = "line-suffix";
var DOC_TYPE_LINE_SUFFIX_BOUNDARY2 = "line-suffix-boundary";
var DOC_TYPE_LINE2 = "line";
var DOC_TYPE_LABEL2 = "label";
var DOC_TYPE_BREAK_PARENT2 = "break-parent";
var VALID_OBJECT_DOC_TYPES2 = /* @__PURE__ */ new Set([DOC_TYPE_CURSOR2, DOC_TYPE_INDENT2, DOC_TYPE_ALIGN2, DOC_TYPE_TRIM2, DOC_TYPE_GROUP2, DOC_TYPE_FILL2, DOC_TYPE_IF_BREAK2, DOC_TYPE_INDENT_IF_BREAK2, DOC_TYPE_LINE_SUFFIX2, DOC_TYPE_LINE_SUFFIX_BOUNDARY2, DOC_TYPE_LINE2, DOC_TYPE_LABEL2, DOC_TYPE_BREAK_PARENT2]);
function getDocType2(doc2) {
  if (typeof doc2 === "string") {
    return DOC_TYPE_STRING2;
  }
  if (Array.isArray(doc2)) {
    return DOC_TYPE_ARRAY2;
  }
  if (!doc2) {
    return;
  }
  const { type: type2 } = doc2;
  if (VALID_OBJECT_DOC_TYPES2.has(type2)) {
    return type2;
  }
}
var get_doc_type_default2 = getDocType2;
var disjunctionListFormat2 = (list2) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(list2);
...
Expected it to be 'string' or 'object'.`;
  ...
  const EXPECTED_TYPE_VALUES = disjunctionListFormat2([...VALID_OBJECT_DOC_TYPES2].map((type3) => `'${type3}'`));
...
var InvalidDocError2 = class extends Error {
  name = "InvalidDocError";
  constructor(doc2) {
    super(getDocErrorMessage2(doc2));
    this.doc = doc2;
  }
};
var invalid_doc_error_default2 = InvalidDocError2;
var traverseDocOnExitStackMarker2 = {};
function traverseDoc2(doc2, onEnter, onExit, shouldTraverseConditionalGroups) {
  const docsStack = [doc2];
  while (docsStack.length > 0) {
    const doc3 = docsStack.pop();
    if (doc3 === traverseDocOnExitStackMarker2) {
      onExit(docsStack.pop());
      continue;
    }
    if (onExit) {
      docsStack.push(doc3, traverseDocOnExitStackMarker2);
    }
    const docType = get_doc_type_default2(doc3);
    if (!docType) {
    ...
    switch (docType) {
      case DOC_TYPE_ARRAY2:
      case DOC_TYPE_FILL2: {
        const parts = docType === DOC_TYPE_ARRAY2 ? doc3 : doc3.parts;
        for (let ic = parts.length, i2 = ic - 1; i2 >= 0; --i2) {
          docsStack.push(parts[i2]);
        }
        break;
      }
      case DOC_TYPE_IF_BREAK2:
        docsStack.push(doc3.flatContents, doc3.breakContents);
        break;
      case DOC_TYPE_GROUP2:
      ...
      case DOC_TYPE_INDENT2:
      case DOC_TYPE_INDENT_IF_BREAK2:
      case DOC_TYPE_LABEL2:
      case DOC_TYPE_LINE_SUFFIX2:
        docsStack.push(doc3.contents);
        break;
      case DOC_TYPE_STRING2:
      case DOC_TYPE_CURSOR2:
      case DOC_TYPE_TRIM2:
      case DOC_TYPE_LINE_SUFFIX_BOUNDARY2:
      case DOC_TYPE_LINE2:
      case DOC_TYPE_BREAK_PARENT2:
        break;
      default:
        throw new invalid_doc_error_default2(doc3);
    }
...
var traverse_doc_default2 = traverseDoc2;
function indent2(contents) {
  return { type: DOC_TYPE_INDENT2, contents };
}
function align2(widthOrString, contents) {
  return { type: DOC_TYPE_ALIGN2, contents, n: widthOrString };
}
function fill2(parts) {
  return { type: DOC_TYPE_FILL2, parts };
}
function lineSuffix2(contents) {
  return { type: DOC_TYPE_LINE_SUFFIX2, contents };
}
var breakParent2 = { type: DOC_TYPE_BREAK_PARENT2 };
var hardlineWithoutBreakParent2 = { type: DOC_TYPE_LINE2, hard: true };
var line22 = { type: DOC_TYPE_LINE2 };
var hardline2 = [hardlineWithoutBreakParent2, breakParent2];
var cursor2 = { type: DOC_TYPE_CURSOR2 };
function addAlignmentToDoc2(doc2, size, tabWidth) {
  let aligned = doc2;
  if (size > 0) {
    for (let i2 = 0; i2 < Math.floor(size / tabWidth); ++i2) {
      aligned = indent2(aligned);
    }
    aligned = align2(size % tabWidth, aligned);
    aligned = align2(Number.NEGATIVE_INFINITY, aligned);
  }
  return aligned;
}
function flattenDoc(doc2) {
  ...
  if (doc2.type === DOC_TYPE_IF_BREAK2) {
...
function printDocToDebug(doc2) {
  ...
  function printGroupId(id) {
    ...
    const prefix2 = id.description || "symbol";
    for (let counter = 0; ; counter++) {
      const key2 = prefix2 + (counter > 0 ? ` #${counter}` : "");
...
var _isNarrowWidth2 = (codePoint) => !(isFullWidth2(codePoint) || isWide2(codePoint));
var notAsciiRegex2 = /[^\x20-\x7F]/;
function getStringWidth2(text) {
  ...
  text = text.replace(emoji_regex_default2(), "  ");
  let width = 0;
  for (const character of text) {
    const codePoint = character.codePointAt(0);
    if (codePoint <= 31 || codePoint >= 127 && codePoint <= 159) {
    ...
    width += _isNarrowWidth2(codePoint) ? 1 : 2;
  }
  return width;
}
var get_string_width_default2 = getStringWidth2;
var getDocParts2 = (doc2) => {
  if (Array.isArray(doc2)) {
    return doc2;
  }
  if (doc2.type !== DOC_TYPE_FILL2) {
    throw new Error(`Expect doc to be 'array' or '${DOC_TYPE_FILL2}'.`);
  }
  return doc2.parts;
};
function mapDoc2(doc2, cb) {
  if (typeof doc2 === "string") {
    return cb(doc2);
  }
  const mapped = /* @__PURE__ */ new Map();
  ...
  function process4(doc3) {
    switch (get_doc_type_default2(doc3)) {
      case DOC_TYPE_ARRAY2:
        return cb(doc3.map(rec));
      case DOC_TYPE_FILL2:
        return cb({ ...doc3, parts: doc3.parts.map(rec) });
      case DOC_TYPE_IF_BREAK2:
        return cb({ ...doc3, breakContents: rec(doc3.breakContents), flatContents: rec(doc3.flatContents) });
      case DOC_TYPE_GROUP2: {
...
function breakParentGroup2(groupStack) {
  if (groupStack.length > 0) {
    const parentGroup = at_default2(
      /* isOptionalObject*/
      false,
      groupStack,
      -1
...
function propagateBreaks2(doc2) {
  const alreadyVisitedSet = /* @__PURE__ */ new Set();
  const groupStack = [];
  function propagateBreaksOnEnterFn(doc3) {
    if (doc3.type === DOC_TYPE_BREAK_PARENT2) {
      breakParentGroup2(groupStack);
    }
    if (doc3.type === DOC_TYPE_GROUP2) {
...
function stripTrailingHardlineFromParts2(parts) {
  parts = [...parts];
  while (parts.length >= 2 && at_default2(
    /* isOptionalObject*/
    false,
    parts,
    -2
  ).type === DOC_TYPE_LINE2 && at_default2(
    /* isOptionalObject*/
    false,
    parts,
    -1
  ).type === DOC_TYPE_BREAK_PARENT2) {
    parts.length -= 2;
  }
  if (parts.length > 0) {
    const lastPart = stripTrailingHardlineFromDoc2(at_default2(
      /* isOptionalObject*/
      false,
      parts,
      -1
...
function stripTrailingHardlineFromDoc2(doc2) {
  switch (get_doc_type_default2(doc2)) {
    case DOC_TYPE_ALIGN2:
    case DOC_TYPE_INDENT2:
    case DOC_TYPE_INDENT_IF_BREAK2:
    case DOC_TYPE_GROUP2:
    case DOC_TYPE_LINE_SUFFIX2:
    case DOC_TYPE_LABEL2: {
      const contents = stripTrailingHardlineFromDoc2(doc2.contents);
      return { ...doc2, contents };
    }
    case DOC_TYPE_IF_BREAK2:
      return { ...doc2, breakContents: stripTrailingHardlineFromDoc2(doc2.breakContents), flatContents: stripTrailingHardlineFromDoc2(doc2.flatContents) };
    case DOC_TYPE_FILL2:
      return { ...doc2, parts: stripTrailingHardlineFromParts2(doc2.parts) };
    case DOC_TYPE_ARRAY2:
      return stripTrailingHardlineFromParts2(doc2);
    case DOC_TYPE_STRING2:
      return doc2.replace(/[\n\r]*$/, "");
    case DOC_TYPE_CURSOR2:
    case DOC_TYPE_TRIM2:
    ...
    case DOC_TYPE_BREAK_PARENT2:
      break;
    default:
      throw new invalid_doc_error_default2(doc2);
  }
  return doc2;
}
function stripTrailingHardline2(doc2) {
  return stripTrailingHardlineFromDoc2(cleanDoc2(doc2));
}
function cleanDocFn2(doc2) {
  switch (get_doc_type_default2(doc2)) {
    case DOC_TYPE_FILL2:
    ...
    case DOC_TYPE_GROUP2:
      ...
      if (doc2.contents.type === DOC_TYPE_GROUP2 && doc2.contents.id === doc2.id && doc2.contents.break === doc2.break && doc2.contents.expandedStates === doc2.expandedStates) {
        return doc2.contents;
      }
      break;
    case DOC_TYPE_ALIGN2:
    ...
    case DOC_TYPE_ARRAY2: {
      ...
      for (const part of doc2) {
        ...
        const [currentPart, ...restParts] = Array.isArray(part) ? part : [part];
        if (typeof currentPart === "string" && typeof at_default2(
          /* isOptionalObject*/
          false,
          parts,
          -1
...
function cleanDoc2(doc2) {
  return mapDoc2(doc2, (currentDoc) => cleanDocFn2(currentDoc));
}
function inheritLabel(doc2, fn) {
  return doc2.type === DOC_TYPE_LABEL2 ? { ...doc2, contents: fn(doc2.contents) } : fn(doc2);
}
var MODE_BREAK2 = Symbol("MODE_BREAK");
var MODE_FLAT2 = Symbol("MODE_FLAT");
var CURSOR_PLACEHOLDER2 = Symbol("cursor");
function rootIndent2() {
  return { value: "", length: 0, queue: [] };
}
function makeIndent2(ind, options8) {
  return generateInd2(ind, { type: "indent" }, options8);
}
function makeAlign2(indent22, widthOrDoc, options8) {
  if (widthOrDoc === Number.NEGATIVE_INFINITY) {
    return indent22.root || rootIndent2();
  }
  if (widthOrDoc < 0) {
    return generateInd2(indent22, { type: "dedent" }, options8);
  }
  if (!widthOrDoc) {
    return indent22;
  }
  ...
  const alignType = typeof widthOrDoc === "string" ? "stringAlign" : "numberAlign";
  return generateInd2(indent22, { type: alignType, n: widthOrDoc }, options8);
}
function generateInd2(ind, newPart, options8) {
  const queue = newPart.type === "dedent" ? ind.queue.slice(0, -1) : [...ind.queue, newPart];
  let value = "";
  let length = 0;
  let lastTabs = 0;
...
function trim3(out) {
  ...
  if (trimCount > 0 || cursorCount > 0) {
    out.length = outIndex + 1;
    while (cursorCount-- > 0) {
      out.push(CURSOR_PLACEHOLDER2);
    }
  }
  return trimCount;
}
function fits2(next, restCommands, width, hasLineSuffix, groupModeMap, mustBeFlat) {
  if (width === Number.POSITIVE_INFINITY) {
    return true;
  }
  let restIdx = restCommands.length;
  ...
  while (width >= 0) {
    ...
    switch (get_doc_type_default2(doc2)) {
      case DOC_TYPE_STRING2:
        out.push(doc2);
        width -= get_string_width_default2(doc2);
        break;
      case DOC_TYPE_ARRAY2:
      case DOC_TYPE_FILL2: {
      ...
      case DOC_TYPE_GROUP2: {
        ...
        const groupMode = doc2.break ? MODE_BREAK2 : mode;
        const contents = doc2.expandedStates && groupMode === MODE_BREAK2 ? at_default2(
          /* isOptionalObject*/
          false,
          doc2.expandedStates,
          -1
      ...
      case DOC_TYPE_IF_BREAK2: {
        const groupMode = doc2.groupId ? groupModeMap[doc2.groupId] || MODE_FLAT2 : mode;
        const contents = groupMode === MODE_BREAK2 ? doc2.breakContents : doc2.flatContents;
        if (contents) {
...
function printDocToString2(doc2, options8) {
  const groupModeMap = {};
  const width = options8.printWidth;
  const newLine = convertEndOfLineToChars2(options8.endOfLine);
  let pos2 = 0;
  const cmds = [{ ind: rootIndent2(), mode: MODE_BREAK2, doc: doc2 }];
  const out = [];
  let shouldRemeasure = false;
  const lineSuffix22 = [];
  let printedCursorCount = 0;
  propagateBreaks2(doc2);
  while (cmds.length > 0) {
    const { ind, mode, doc: doc3 } = cmds.pop();
    switch (get_doc_type_default2(doc3)) {
      case DOC_TYPE_STRING2: {
        const formatted = newLine !== "\n" ? string_replace_all_default2(
          /* isOptionalObject*/
          false,
          doc3,
          "\n",
        ...
        out.push(formatted);
        if (cmds.length > 0) {
          pos2 += get_string_width_default2(formatted);
        }
        break;
      }
      case DOC_TYPE_ARRAY2:
      ...
      case DOC_TYPE_CURSOR2:
        ...
        break;
      case DOC_TYPE_INDENT2:
        cmds.push({ ind: makeIndent2(ind, options8), mode, doc: doc3.contents });
        break;
      case DOC_TYPE_ALIGN2:
        cmds.push({ ind: makeAlign2(ind, doc3.n, options8), mode, doc: doc3.contents });
        break;
      case DOC_TYPE_TRIM2:
        pos2 -= trim3(out);
        break;
      case DOC_TYPE_GROUP2:
        switch (mode) {
          case MODE_FLAT2:
            if (!shouldRemeasure) {
              cmds.push({ ind, mode: doc3.break ? MODE_BREAK2 : MODE_FLAT2, doc: doc3.contents });
              break;
            }
          case MODE_BREAK2: {
            shouldRemeasure = false;
            const next = { ind, mode: MODE_FLAT2, doc: doc3.contents };
            const rem = width - pos2;
            const hasLineSuffix = lineSuffix22.length > 0;
            if (!doc3.break && fits2(next, cmds, rem, hasLineSuffix, groupModeMap)) {
              cmds.push(next);
            } else {
              if (doc3.expandedStates) {
                const mostExpanded = at_default2(
                  /* isOptionalObject*/
                  false,
                  doc3.expandedStates,
                  -1
                ...
                if (doc3.break) {
                  cmds.push({ ind, mode: MODE_BREAK2, doc: mostExpanded });
                  break;
                } else {
                  for (let i2 = 1; i2 < doc3.expandedStates.length + 1; i2++) {
                    if (i2 >= doc3.expandedStates.length) {
                      ...
                      const cmd = { ind, mode: MODE_FLAT2, doc: state };
                      if (fits2(cmd, cmds, rem, hasLineSuffix, groupModeMap)) {
                        cmds.push(cmd);
                        break;
                      }
                    }
                ...
                cmds.push({ ind, mode: MODE_BREAK2, doc: doc3.contents });
              }
            }
            break;
          }
        ...
        if (doc3.id) {
          groupModeMap[doc3.id] = at_default2(
            /* isOptionalObject*/
            false,
            cmds,
            -1
      ...
      case DOC_TYPE_FILL2: {
        ...
        const [content, whitespace] = parts;
        const contentFlatCmd = { ind, mode: MODE_FLAT2, doc: content };
        const contentBreakCmd = { ind, mode: MODE_BREAK2, doc: content };
        const contentFits = fits2(contentFlatCmd, [], rem, lineSuffix22.length > 0, groupModeMap, true);
        if (parts.length === 1) {
          if (contentFits) {
            cmds.push(contentFlatCmd);
          } else {
        ...
        const whitespaceFlatCmd = { ind, mode: MODE_FLAT2, doc: whitespace };
        const whitespaceBreakCmd = { ind, mode: MODE_BREAK2, doc: whitespace };
        if (parts.length === 2) {
          if (contentFits) {
            cmds.push(whitespaceFlatCmd, contentFlatCmd);
          } else {
        ...
        const secondContent = parts[0];
        const firstAndSecondContentFlatCmd = { ind, mode: MODE_FLAT2, doc: [content, whitespace, secondContent] };
        const firstAndSecondContentFits = fits2(firstAndSecondContentFlatCmd, [], rem, lineSuffix22.length > 0, groupModeMap, true);
        if (firstAndSecondContentFits) {
          cmds.push(remainingCmd, whitespaceFlatCmd, contentFlatCmd);
        } else if (contentFits) {
          cmds.push(remainingCmd, whitespaceBreakCmd, contentFlatCmd);
      ...
      case DOC_TYPE_INDENT_IF_BREAK2: {
        ...
        if (groupMode === MODE_BREAK2) {
          const breakContents = doc3.type === DOC_TYPE_IF_BREAK2 ? doc3.breakContents : doc3.negate ? doc3.contents : indent2(doc3.contents);
          if (breakContents) {
            cmds.push({ ind, mode, doc: breakContents });
          }
        }
        if (groupMode === MODE_FLAT2) {
          const flatContents = doc3.type === DOC_TYPE_IF_BREAK2 ? doc3.flatContents : doc3.negate ? indent2(doc3.contents) : doc3.contents;
          if (flatContents) {
      ...
      case DOC_TYPE_LINE_SUFFIX2:
        lineSuffix22.push({ ind, mode, doc: doc3.contents });
        break;
      case DOC_TYPE_LINE_SUFFIX_BOUNDARY2:
        if (lineSuffix22.length > 0) {
          cmds.push({ ind, mode, doc: hardlineWithoutBreakParent2 });
        }
        break;
      case DOC_TYPE_LINE2:
        switch (mode) {
          ...
          case MODE_BREAK2:
            if (lineSuffix22.length > 0) {
              cmds.push({ ind, mode, doc: doc3 }, ...lineSuffix22.reverse());
              lineSuffix22.length = 0;
              break;
            }
            if (doc3.literal) {
  ...
  const cursorPlaceholderIndex = out.indexOf(CURSOR_PLACEHOLDER2);
  if (cursorPlaceholderIndex !== -1) {
    const otherCursorPlaceholderIndex = out.indexOf(CURSOR_PLACEHOLDER2, cursorPlaceholderIndex + 1);
    const beforeCursor = out.slice(0, cursorPlaceholderIndex).join("");
    const aroundCursor = out.slice(cursorPlaceholderIndex + 1, otherCursorPlaceholderIndex).join("");
    const afterCursor = out.slice(otherCursorPlaceholderIndex + 1).join("");
    return { formatted: beforeCursor + aroundCursor + afterCursor, cursorNodeStart: beforeCursor.length, cursorNodeText: aroundCursor };
  }
...
var _getNodeStackIndex;
var getNodeStackIndex_fn;
var _getAncestors;
var getAncestors_fn;
var AstPath = class {
  constructor(value) {
  ...
  /** @type {number | null} */
  get index() {
    return this.siblings === null ? null : at_default2(
      /* isOptionalObject*/
      false,
      this.stack,
      -2
  ...
  each(callback, ...names) {
    ...
    try {
      for (let i2 = 0; i2 < value.length; ++i2) {
        stack2.push(i2, value[i2]);
        callback(this, i2, value);
        stack2.length -= 2;
      }
    } finally {
      stack2.length = length;
  ...
  map(callback, ...names) {
    const result = [];
    this.each((path132, index, value) => {
      result[index] = callback(path132, index, value);
    }, ...names);
    return result;
  }
  /**
...
function skip(characters) {
  return (text, startIndex, options8) => {
    ...
    const { length } = text;
    let cursor22 = startIndex;
    while (cursor22 >= 0 && cursor22 < length) {
      const character = text.charAt(cursor22);
...
var nonTraversableKeys = /* @__PURE__ */ new Set(["tokens", "comments", "parent", "enclosingNode", "precedingNode", "followingNode"]);
...
function getSortedChildNodes(node, options8) {
  ...
  const { printer: { getCommentChildNodes, canAttachComment, getVisitorKeys: printerGetVisitorKeys }, locStart, locEnd } = options8;
  if (!canAttachComment) {
    return [];
  }
...
function attachComments(ast, options8) {
  ...
  const tiesToBreak = [];
  const { locStart, locEnd, printer: { experimentalFeatures: {
    // TODO: Make this as default behavior
    avoidAstMutation = false
  } = {}, handleComments = {} }, originalText: text } = options8;
  ...
  const decoratedComments = comments.map((comment, index) => ({ ...decorateComment(ast, comment, options8), comment, text, options: options8, ast, isLastComment: comments.length - 1 === index }));
  for (const [index, context] of decoratedComments.entries()) {
    const { comment, precedingNode, enclosingNode, followingNode, text: text2, options: options9, ast: ast2, isLastComment } = context;
...
function printComment(path132, options8) {
  const comment = path132.node;
  comment.printed = true;
  return options8.printer.printComment(path132, options8);
}
function printLeadingComment(path132, options8) {
  var _a;
  const comment = path132.node;
...
function printTrailingComment(path132, options8, previousComment) {
  var _a;
  const comment = path132.node;
...
function printCommentsSeparately(path132, options8) {
  ...
  path132.each(() => {
    ...
    if (leading) {
      leadingParts.push(printLeadingComment(path132, options8));
    } else if (trailing) {
      printedTrailingComment = printTrailingComment(path132, options8, printedTrailingComment);
      trailingParts.push(printedTrailingComment.doc);
    }
  }, "comments");
  return { leading: leadingParts, trailing: trailingParts };
}
function printComments(path132, doc2, options8) {
  const { leading, trailing } = printCommentsSeparately(path132, options8);
  if (!leading && !trailing) {
    return doc2;
  }
...
function ensureAllCommentsPrinted(options8) {
  const { [Symbol.for("comments")]: comments, [Symbol.for("printedComments")]: printedComments } = options8;
  for (const comment of comments) {
...
function getSupportInfo({ plugins = [], showDeprecated = false } = {}) {
  ...
  const options8 = [];
  for (const option of normalizeOptionSettings(Object.assign({}, ...plugins.map(({ options: options9 }) => options9), core_options_evaluate_default))) {
...
function normalizeOptions(options8, optionInfos, { logger = false, isCLI = false, passThrough = false, FlagSchema, descriptor } = {}) {
  if (isCLI) {
    if (!FlagSchema) {
...
function optionInfosToSchemas(optionInfos, { isCLI, FlagSchema }) {
  ...
  for (const optionInfo of optionInfos) {
    schemas.push(optionInfoToSchema(optionInfo, { isCLI, optionInfos, FlagSchema }));
...
function optionInfoToSchema(optionInfo, { isCLI, optionInfos, FlagSchema }) {
  ...
  if (isCLI && !optionInfo.array) {
    ...
    parameters.preprocess = (value, schema2, utils2) => schema2.preprocess(originalPreprocess(Array.isArray(value) ? at_default2(
      /* isOptionalObject*/
      false,
      value,
      -1
...
async function normalizeFormatOptions(options8, opts = {}) {
  ...
  return normalize_options_default(rawOptions, supportOptions, { passThrough: Object.keys(formatOptionsHiddenDefaults), ...opts });
}
var normalize_format_options_default = normalizeFormatOptions;
var import_code_frame2 = __toESM2(require_lib3());
...
async function printEmbeddedLanguages(path132, genericPrint, options8, printAstToDoc2, embeds) {
  const { embeddedLanguageFormatting, printer: { embed, hasPrettierIgnore = () => false, getVisitorKeys: printerGetVisitorKeys } } = options8;
  ...
  const getVisitorKeys = create_get_visitor_keys_function_default(embed.getVisitorKeys ?? printerGetVisitorKeys);
  const embedCallResults = [];
  recurse();
  const originalPathStack = path132.stack;
  for (const { print, node, pathStack } of embedCallResults) {
    try {
      path132.stack = pathStack;
      const doc2 = await print(textToDocForEmbed, genericPrint, path132, options8);
      if (doc2) {
  ...
  path132.stack = originalPathStack;
  function textToDocForEmbed(text, partialNextOptions) {
    return textToDoc(text, partialNextOptions, options8, printAstToDoc2);
  }
  function recurse() {
    const { node } = path132;
    if (node === null || typeof node !== "object" || hasPrettierIgnore(path132)) {
      return;
    }
    for (const key2 of getVisitorKeys(node)) {
      if (Array.isArray(node[key2])) {
        path132.each(recurse, key2);
      } else {
        path132.call(recurse, key2);
      }
    }
    const result = embed(path132, options8);
    if (!result) {
      return;
    }
    if (typeof result === "function") {
      embedCallResults.push({ print: result, node, pathStack: [...path132.stack] });
      return;
    }
...
async function textToDoc(text, partialNextOptions, parentOptions, printAstToDoc2) {
  const options8 = await normalize_format_options_default({ ...parentOptions, ...partialNextOptions, parentParser: parentOptions.parser, originalText: text }, { passThrough: true });
...
function printIgnored(path132, options8) {
...
async function printAstToDoc(ast, options8) {
  ...
  const path132 = new ast_path_default(ast);
  ...
  function mainPrint(selector, args) {
    ...
    if (Array.isArray(selector)) {
      return path132.call(() => mainPrintInternal(args), ...selector);
    }
    return path132.call(() => mainPrintInternal(args), selector);
  }
  function mainPrintInternal(args) {
    ...
    const doc3 = callPluginPrintFunction(path132, options8, mainPrint, args, embeds);
    if (shouldCache) {
...
function callPluginPrintFunction(path132, options8, printPath, args, embeds) {
  var _a;
  const { node } = path132;
  ...
  if ((_a = printer2.hasPrettierIgnore) == null ? undefined : _a.call(printer2, path132)) {
    ...
    doc2 = printer2.print(path132, options8, printPath, args);
  }
  if (node === options8.cursorNode) {
    doc2 = inheritLabel(doc2, (doc3) => [cursor2, doc3, cursor2]);
  }
  if (printer2.printComment && (!printer2.willPrintOwnComments || !printer2.willPrintOwnComments(path132, options8))) {
    doc2 = printComments(path132, doc2, options8);
  }
  return doc2;
}
async function prepareToPrint(ast, options8) {
  ...
  const { printer: { preprocess } } = options8;
...
function getCursorNode(ast, options8) {
  ...
  const getVisitorKeys = create_get_visitor_keys_function_default(options8.printer.getVisitorKeys);
  const nodeContainsCursor = (node) => locStart(node) <= cursorOffset && locEnd(node) >= cursorOffset;
  let cursorNode = ast;
  for (const node of getDescendants(ast, { getVisitorKeys, filter: nodeContainsCursor })) {
    cursorNode = node;
  }
  return cursorNode;
}
...
function massageAst(ast, options8) {
  const { printer: { massageAstNode: cleanFunction, getVisitorKeys: printerGetVisitorKeys } } = options8;
  if (!cleanFunction) {
    return ast;
  }
...
function calculateRange(text, opts, ast) {
  ...
  if (isJsonParser(opts)) {
    ...
    ({ startNode, endNode } = findSiblingAncestors(startNodeAndParents, endNodeAndParents, opts));
  }
  return { rangeStart: Math.min(locStart(startNode), locStart(endNode)), rangeEnd: Math.max(locEnd(startNode), locEnd(endNode)) };
}
var BOM = "\uFEFF";
...
async function coreFormat(originalText, opts, addAlignmentSize = 0) {
  ...
  if (addAlignmentSize > 0) {
    doc2 = addAlignmentToDoc2([hardline2, doc2], addAlignmentSize, opts.tabWidth);
  }
  ...
  if (opts.cursorOffset >= 0) {
    ...
    if (oldCursorNodeText === newCursorNodeText) {
      return { formatted: result.formatted, cursorOffset: newCursorNodeStart + cursorOffsetRelativeToOldCursorNode, comments };
    }
...
async function formatRange(originalText, opts) {
  ...
  if (opts.endOfLine !== "lf") {
    const eol = convertEndOfLineToChars2(opts.endOfLine);
    if (cursorOffset >= 0 && eol === "\r\n") {
      cursorOffset += countEndOfLineChars(formatted.slice(0, cursorOffset), "\n");
    }
    formatted = string_replace_all_default2(
      /* isOptionalObject*/
      false,
      formatted,
      "\n",
...
function normalizeInputAndOptions(text, options8) {
  ...
  return { hasBOM, text, options: normalizeIndexes(text, { ...options8, cursorOffset, rangeStart, rangeEnd, endOfLine }) };
}
...
async function formatWithCursor(originalText, originalOptions) {
  let { hasBOM, text, options: options8 } = normalizeInputAndOptions(originalText, await normalize_format_options_default(originalOptions));
  if (options8.rangeStart >= options8.rangeEnd && text !== "" || options8.requirePragma && !await hasPragma(text, options8)) {
    return { formatted: originalText, cursorOffset: originalOptions.cursorOffset, comments: [] };
  }
  let result;
...
async function parse5(originalText, originalOptions, devOptions) {
  const { text, options: options8 } = normalizeInputAndOptions(originalText, await normalize_format_options_default(originalOptions));
...
async function formatAst(ast, options8) {
  ...
  return printDocToString2(doc2, options8);
}
async function formatDoc(doc2, options8) {
  const text = printDocToDebug(doc2);
  const { formatted } = await formatWithCursor(text, { ...options8, parser: "__js_expression" });
  return formatted;
}
...
async function printDocToString22(doc2, options8) {
  return printDocToString2(doc2, await normalize_format_options_default(options8));
}
var option_categories_exports = {};
__export3(option_categories_exports, { CATEGORY_CONFIG: () => CATEGORY_CONFIG, CATEGORY_EDITOR: () => CATEGORY_EDITOR, CATEGORY_FORMAT: () => CATEGORY_FORMAT, CATEGORY_GLOBAL: () => CATEGORY_GLOBAL, CATEGORY_OTHER: () => CATEGORY_OTHER, CATEGORY_OUTPUT: () => CATEGORY_OUTPUT, CATEGORY_SPECIAL: () => CATEGORY_SPECIAL });
...
__export3(builtin_plugins_proxy_exports, { languages: () => languages, options: () => options7, parsers: () => parsers, printers: () => printers });
var languages_evaluate_default = [{ "linguistLanguageId": 50, "name": "CSS", "type": "markup", "tmScope": "source.css", "aceMode": "css", "codemirrorMode": "css", "codemirrorMimeType": "text/css", "color": "#563d7c", "extensions": [".css", ".wxss"], "parsers": ["css"], "vscodeLanguageIds": ["css"] }, { "linguistLanguageId": 262764437, "name": "PostCSS", "type": "markup", "color": "#dc3a0c", "tmScope": "source.postcss", "group": "CSS", "extensions": [".pcss", ".postcss"], "aceMode": "text", "parsers": ["css"], "vscodeLanguageIds": ["postcss"] }, { "linguistLanguageId": 198, "name": "Less", "type": "markup", "color": "#1d365d", "aliases": ["less-css"], "extensions": [".less"], "tmScope": "source.css.less", "aceMode": "less", "codemirrorMode": "css", "codemirrorMimeType": "text/css", "parsers": ["less"], "vscodeLanguageIds": ["less"] }, { "linguistLanguageId": 329, "name": "SCSS", "type": "markup", "color": "#c6538c", "tmScope": "source.css.scss", "aceMode": "scss", "codemirrorMode": "css", "codemirrorMimeType": "text/x-scss", "extensions": [".scss"], "parsers": ["scss"], "vscodeLanguageIds": ["scss"] }];
var common_options_evaluate_default = { "bracketSpacing": { "category": "Common", "type": "boolean", "default": true, "description": "Print spaces between brackets.", "oppositeDescription": "Do not print spaces between brackets." }, "singleQuote": { "category": "Common", "type": "boolean", "default": false, "description": "Use single quotes instead of double quotes." }, "proseWrap": { "category": "Common", "type": "choice", "default": "preserve", "description": "How to wrap prose.", "choices": [{ "value": "always", "description": "Wrap prose if it exceeds the print width." }, { "value": "never", "description": "Do not wrap prose." }, { "value": "preserve", "description": "Wrap prose as-is." }] }, "bracketSameLine": { "category": "Common", "type": "boolean", "default": false, "description": "Put > of opening tags on the last line instead of on a new line." }, "singleAttributePerLine": { "category": "Common", "type": "boolean", "default": false, "description": "Enforce single attribute per line in HTML, Vue and JSX." } };
var options = { singleQuote: common_options_evaluate_default.singleQuote };
var options_default = options;
var languages_evaluate_default2 = [{ "linguistLanguageId": 139, "name": "GraphQL", "type": "data", "color": "#e10098", "extensions": [".graphql", ".gql", ".graphqls"], "tmScope": "source.graphql", "aceMode": "text", "parsers": ["graphql"], "vscodeLanguageIds": ["graphql"] }];
var options2 = { bracketSpacing: common_options_evaluate_default.bracketSpacing };
var options_default2 = options2;
var languages_evaluate_default3 = [{ "linguistLanguageId": 155, "name": "Handlebars", "type": "markup", "color": "#f7931e", "aliases": ["hbs", "htmlbars"], "extensions": [".handlebars", ".hbs"], "tmScope": "text.html.handlebars", "aceMode": "handlebars", "parsers": ["glimmer"], "vscodeLanguageIds": ["handlebars"] }];
var languages_evaluate_default4 = [{ "linguistLanguageId": 146, "name": "Angular", "type": "markup", "tmScope": "text.html.basic", "aceMode": "html", "codemirrorMode": "htmlmixed", "codemirrorMimeType": "text/html", "color": "#e34c26", "aliases": ["xhtml"], "extensions": [".component.html"], "parsers": ["angular"], "vscodeLanguageIds": ["html"], "filenames": [] }, { "linguistLanguageId": 146, "name": "HTML", "type": "markup", "tmScope": "text.html.basic", "aceMode": "html", "codemirrorMode": "htmlmixed", "codemirrorMimeType": "text/html", "color": "#e34c26", "aliases": ["xhtml"], "extensions": [".html", ".hta", ".htm", ".html.hl", ".inc", ".xht", ".xhtml", ".mjml"], "parsers": ["html"], "vscodeLanguageIds": ["html"] }, { "linguistLanguageId": 146, "name": "Lightning Web Components", "type": "markup", "tmScope": "text.html.basic", "aceMode": "html", "codemirrorMode": "htmlmixed", "codemirrorMimeType": "text/html", "color": "#e34c26", "aliases": ["xhtml"], "extensions": [], "parsers": ["lwc"], "vscodeLanguageIds": ["html"], "filenames": [] }, { "linguistLanguageId": 391, "name": "Vue", "type": "markup", "color": "#41b883", "extensions": [".vue"], "tmScope": "text.html.vue", "aceMode": "html", "parsers": ["vue"], "vscodeLanguageIds": ["vue"] }];
...
var languages_evaluate_default7 = [{ "linguistLanguageId": 222, "name": "Markdown", "type": "prose", "color": "#083fa1", "aliases": ["md", "pandoc"], "aceMode": "markdown", "codemirrorMode": "gfm", "codemirrorMimeType": "text/x-gfm", "wrap": true, "extensions": [".md", ".livemd", ".markdown", ".mdown", ".mdwn", ".mkd", ".mkdn", ".mkdown", ".ronn", ".scd", ".workbook"], "filenames": ["contents.lr", "README"], "tmScope": "text.md", "parsers": ["markdown"], "vscodeLanguageIds": ["markdown"] }, { "linguistLanguageId": 222, "name": "MDX", "type": "prose", "color": "#083fa1", "aliases": ["md", "pandoc"], "aceMode": "markdown", "codemirrorMode": "gfm", "codemirrorMimeType": "text/x-gfm", "wrap": true, "extensions": [".mdx"], "filenames": [], "tmScope": "text.md", "parsers": ["mdx"], "vscodeLanguageIds": ["mdx"] }];
var options5 = { proseWrap: common_options_evaluate_default.proseWrap, singleQuote: common_options_evaluate_default.singleQuote };
...
var options6 = { bracketSpacing: common_options_evaluate_default.bracketSpacing, singleQuote: common_options_evaluate_default.singleQuote, proseWrap: common_options_evaluate_default.proseWrap };
...
function createParsersAndPrinters(modules) {
  ...
  for (const { importPlugin: importPlugin2, parsers: parserNames = [], printers: printerNames = [] } of modules) {
...
function importFromDirectory(specifier, directory) {
  return import_from_file_default(specifier, path9__default.join(directory, "noop.js"));
}
var import_from_directory_default = importFromDirectory;
async function importPlugin(name, cwd) {
  if (path9__default.isAbsolute(name)) {
    return import(pathToFileURL(name).href);
  }
  try {
    return await import(pathToFileURL(path9__default.resolve(name)).href);
  } catch {
...
function getMaxContinuousCount(text, searchString) {
  const results = text.match(new RegExp(`(${escapeStringRegexp(searchString)})+`, "g"));
  if (results === null) {
    return 0;
  }
...
function makeString(rawText, enclosingQuote, unescapeUnnecessaryEscapes) {
  ...
  const regex = /\\(.)|(["'])/gs;
  const raw = string_replace_all_default2(
    /* isOptionalObject*/
    false,
    rawText,
    regex,
...
function withPlugins(fn, optionsArgumentIndex = 1) {
  return async (...args) => {
    ...
    args[optionsArgumentIndex] = { ...options8, plugins: (await Promise.all([
...
async function format2(text, options8) {
  const { formatted } = await formatWithCursor2(text, { ...options8, cursorOffset: -1 });
  return formatted;
}
...
var sharedWithCli = { errors: errors_exports, optionCategories: option_categories_exports, createIsIgnoredFunction, formatOptionsHiddenDefaults, normalizeOptions: normalize_options_default, getSupportInfoWithoutPlugins: getSupportInfo, normalizeOptionSettings, vnopts: { ChoiceSchema, apiDescriptor }, fastGlob: import_fast_glob.default, utils: { isNonEmptyArray: is_non_empty_array_default, partition: partition_default, omit: object_omit_default }, mockable: mockable_default };
var debugApis = { parse: withPlugins(parse5), formatAST: withPlugins(formatAst), formatDoc: withPlugins(formatDoc), printToDoc: withPlugins(printToDoc), printDocToString: withPlugins(printDocToString22), mockable: mockable_default };

// ../generator/build/esm/util/test/formatTs.js
function formatTs(contents) {
  try {
    return format2(contents, {
      parser: "typescript",
      singleQuote: true,
      trailingComma: "all",
      tabWidth: 2,
...
async function generateOntologyMetadataFile({
  ...
  await fs9.writeFile(path9__default.join(outDir, "OntologyMetadata.ts"), await formatTs(`
...
// ../generator/build/esm/v2.0/generatePerActionDataFiles.js
init_esm_shims();

// ../generator/build/esm/shared/getObjectImports.js
init_esm_shims();
...
function stringify(obj, customizer = {}, separator = ",\n") {
  ...
  for (const key2 of sortedKeys) {
    ...
    const res = (customizer[key2] ?? customizer["*"] ?? defaultCustomizer)(value, (value2) => JSON.stringify(value2, null, 2), key2, defaultKeyFormatter);
    if (res) {
      if (typeof res === "string") {
        entries.push(`${defaultKeyFormatter(key2)}: ${res}`);
      } else {
...
// ../generator/build/esm/util/stringUnionFrom.js
init_esm_shims();
...
// ../generator/build/esm/v2.0/getDescriptionIfPresent.js
init_esm_shims();
        ...
        return `"${key2}": {
          ...
          type: (type2) => {
            if (typeof type2 === "string") {
              return JSON.stringify(type2);
            } else if (type2.type === "object") {
              const obj = enhancedOntology.requireObjectType(type2.object);
              return `ActionMetadata.DataType.Object<${obj.getImportedDefinitionIdentifier(true)}>`;
            } else if (type2.type === "objectSet") {
              const obj = enhancedOntology.requireObjectType(type2.objectSet);
              return `ActionMetadata.DataType.ObjectSet<${obj.getImportedDefinitionIdentifier(true)}>`;
            } else if (type2.type === "interface") {
              const obj = enhancedOntology.requireInterfaceType(type2.interface);
...
function maybeStripNamespace(type2, q) {
  if (type2.apiNamespace && q.startsWith(`${type2.apiNamespace}.`)) {
    return q.slice(type2.apiNamespace.length + 1);
  } else {
    return q;
  }
}
...
${stringify(definition.links, {
    "*": (definition2, _, key2) => {
      ...
      return [`readonly ${key2}`, `${definition2.multiplicity ? `${linkTarget}.ObjectSet` : `$SingleLinkAccessor<${linkTarget}>`}
          `];
    }
  })}
    }
...
function createPropertyKeys(type2) {
  const properties = Object.keys(type2.getCleanedUpDefinition(true).properties);
  return `export type PropertyKeys = ${properties.length === 0 ? "never" : properties.map((a) => maybeStripNamespace(type2, a)).map((a) => `"${a}"`).join("|")};`;
}
function remapStructType(structType) {
  let output = `{`;
  Object.entries(structType).map(([key2, value]) => output += `${key2}:$PropType[${JSON.stringify(value)}]|undefined;`);
  output += "}";
  return output;
}
...
// ../generator/build/esm/shared/getObjectTypesFromQueryDataType.js
init_esm_shims();
    ...
    "*": (parameter, formatter, apiName) => {
      ...
      return [`
        ...
        apiName
            ...
            ${getQueryParamType(ontology, wireQueryParameterV2ToQueryParameterDefinition({
    dataType: query.output
  }), "Result")}
        ` : `
        export type ReturnType = ${getQueryParamType(ontology, wireQueryParameterV2ToQueryParameterDefinition({
    dataType: query.output
  }), "Result")}
          `}
      }
...
function getQueryParamType(enhancedOntology, input, type2, isMapKey = false) {
  ...
  switch (input.type) {
    case "date":
      inner = `Query${type2}.PrimitiveType<${JSON.stringify("datetime")}>`;
      break;
    case "attachment":
    case "boolean":
    case "double":
...
// ../shared.client.impl/build/esm/createSharedClientContext.js
init_esm_shims();
...
async function generateFromLocalFile(args) {
  if (!fs8.existsSync(args.ontologyPath)) {
    consola.error(`Ontology file does not exist: ${args.ontologyPath}`);
    return false;
  }
  const ontology = JSON.parse(await fs8.promises.readFile(args.ontologyPath, "utf-8"));
...
async function generateFromStack(args) {
  ...
  const token2 = await invokeLoginFlow({
    clientId,
    foundryUrl,
    verbose: 0
  });
  const ctx = createSharedClientContext(args.foundryUrl, async () => token2.access_token, USER_AGENT);
  try {
    ...
    const ontologies = await OntologyV2_exports.list(ctx);
    if (args.ontologyRid) {
    ...
    if (ontologyWritePath) {
      fs8.writeFileSync(ontologyWritePath, JSON.stringify(ontology, null, 2));
    }
    return await generateClientSdk(ontology, args);
  } catch (e) {
...
async function generateClientSdk(ontology, args) {
  ...
  try {
    if (args.clean) {
      ...
      await fs8.promises.rm(args.outDir, {
        recursive: true,
        force: true
      });
    }
    if (!args.asPackage) {
      ...
      const packageJsonOriginal = JSON.parse(await fs8.promises.readFile(packageJsonPath, "utf-8"));
      const packageJson = JSON.parse(await fs8.promises.readFile(packageJsonPath, "utf-8"));
      ...
      for (const [type2, deps] of Object.entries(expectedDeps)) {
        if (!(type2 in packageJson)) {
          packageJson[type2] = deps;
        } else {
          Object.assign(packageJson[type2], deps);
        }
      }
      ...
      if (!(0, import_fast_deep_equal2.default)(packageJsonOriginal, packageJson)) {
        await fs8.promises.writeFile(packageJsonPath, JSON.stringify(packageJson, void 0, 2) + "\n");
      }
      return true;
    }
...
function updateVersionsIfTheyExist(packageJson, versions) {
  for (const d of ["dependencies", "devDependencies", "peerDependencies"]) {
    for (const [key2, value] of Object.entries(versions)) {
      if (packageJson?.[d]?.[key2]) {
        packageJson[d][key2] = value;
      }
    }
  }
}
async function getDependencyVersions() {
  ...
  const ourPackageJson = JSON.parse(await fs8.promises.readFile(ourPackageJsonPath, "utf-8"));
