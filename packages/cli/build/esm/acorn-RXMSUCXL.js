...
var Ge = Ee((Ys, Je) => {
  ...
  Object.defineProperty(Je.exports, "tokTypes", {
    get: function() {
      return Kt(undefined).tokTypes;
    },
    configurable: true,
    enumerable: true
  });
  function us(e, t) {
    let i = t.acorn || undefined, s = Kt(i), r = i.tokTypes, n = s.tokTypes, o = i.tokContexts, u = s.tokContexts.tc_oTag, h = s.tokContexts.tc_cTag, l = s.tokContexts.tc_expr, x = i.isNewLine, _ = i.isIdentifierStart, B = i.isIdentifierChar;
...
var S = function(t, i) {
  i === undefined && (i = {}), this.label = t, this.keyword = i.keyword, this.beforeExpr = !!i.beforeExpr, this.startsExpr = !!i.startsExpr, this.isLoop = !!i.isLoop, this.isAssign = !!i.isAssign, this.prefix = !!i.prefix, this.postfix = !!i.postfix, this.binop = i.binop || null, this.updateContext = null;
};
function I(e, t) {
  return new S(e, {
    beforeExpr: true,
...
var Oe = {};
function b(e, t) {
  return t === undefined && (t = {}), t.keyword = e, Oe[e] = new S(e, t);
}
var a = {
  num: new S("num", A),
...
f.parseBlock = function(e, t, i) {
  for (e === undefined && (e = true), t === undefined && (t = this.startNode()), t.body = [], this.expect(a.braceL), e && this.enterScope(0); this.type !== a.braceR; ) {
...
O.checkLValPattern = function(e, t, i) {
  switch (t === undefined && (t = le), e.type) {
    case "ObjectPattern":
      for (var s = 0, r = e.properties; s < r.length; s += 1) {
        var n = r[s];
...
y.parseFunctionBody = function(e, t, i, s) {
  ...
  if (r) e.body = this.parseMaybeAssign(s), e.expression = true, this.checkParams(e, false);
    ...
    var h = this.labels;
    this.labels = [], o && (this.strict = true), this.checkParams(e, !n && !o && !t && !i && this.isSimpleParamList(e.params)), this.strict && e.id && this.checkLValSimple(e.id, gt), e.body = this.parseBlock(false, undefined, o && !n), e.expression = false, this.adaptDirectivePrologue(e.body.body), this.labels = h;
  }
  this.exitScope();
};
...
M.prototype.current = function(t) {
  return t === undefined && (t = false), this.at(this.pos, t);
};
M.prototype.lookahead = function(t) {
  return t === undefined && (t = false), this.at(this.nextIndex(this.pos, t), t);
};
M.prototype.advance = function(t) {
  t === undefined && (t = false), this.pos = this.nextIndex(this.pos, t);
};
M.prototype.eat = function(t, i) {
  return i === undefined && (i = false), this.current(i) === t ? (this.advance(i), true) : false;
};
...
c.regexp_eatQuantifier = function(e, t) {
  return t === undefined && (t = false), this.regexp_eatQuantifierPrefix(e, t) ? (e.eat(63), true) : false;
};
...
v.skipBlockComment = function() {
  ...
  if (i === -1 && this.raise(this.pos - 2, "Unterminated comment"), this.pos = i + 2, this.options.locations) for (var s = undefined, r = t; (s = ut(this.input, r, this.pos)) > -1; ) ++this.curLine, r = this.lineStart = s;
...
v.readInt = function(e, t, i) {
  for (var s = this.options.ecmaVersion >= 12 && t === undefined, r = i && this.input.charCodeAt(this.pos) === 48, n = this.pos, o = 0, u = 0, h = 0, l = t ?? 1 / 0; h < l; ++h, ++this.pos) {
    var x = this.input.charCodeAt(this.pos), _ = undefined;
    if (s && x === 95) {
...
v.readNumber = function(e) {
  var t = this.pos;
  !e && this.readInt(10, undefined, true) === null && this.raise(t, "Invalid number");
...
function P(e) {
  var s, r, n;
  let t = ((s = e.range) == null ? undefined : s[0]) ?? e.start, i = (n = ((r = e.declaration) == null ? undefined : r.decorators) ?? e.decorators) == null ? undefined : n[0];
...
function fs(e) {
  let t = new Set(e);
  return (i) => t.has(i == null ? undefined : i.type);
}
var Xt = fs;
  ...
  if (e = Se(e, (r) => {
    ...
    switch (r.type) {
      ...
      case "ExportAllDeclaration":
        if (i === "meriyah" && ((n = r.exported) == null ? undefined : n.type) === "Identifier") {
          let {
            exported: o
          } = r, u = s.slice(P(o), j(o));
...
//# sourceMappingURL=acorn-RXMSUCXL.js.map
//# sourceMappingURL=acorn-RXMSUCXL.js.map