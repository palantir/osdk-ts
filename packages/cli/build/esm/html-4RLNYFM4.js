...
var un = ir;
function ci(t8) {
  return (t8 == null ? undefined : t8.type) === "front-matter";
}
var Re = ci;
...
function fn(t8, e) {
  ...
  return t8.find(({
    filenames: n
  }) => n == null ? undefined : n.some((s) => s.toLowerCase() === r)) ?? t8.find(({
    extensions: n
  }) => n == null ? undefined : n.some((s) => r.endsWith(s)));
}
function di(t8, e) {
  if (e) return t8.find(({
    name: r
    ...
    aliases: r
  }) => r == null ? undefined : r.includes(e)) ?? t8.find(({
    extensions: r
  }) => r == null ? undefined : r.includes(`.${e}`));
}
function Ci(t8, e) {
  let r = t8.plugins.flatMap((s) => s.languages ?? []), n = di(r, e.language) ?? fn(r, e.physicalFile) ?? fn(r, e.file) ?? (e.physicalFile, undefined);
...
function An(t8, e) {
  var s, i;
  let r = n();
  if (r && !t8.prev && (i = (s = t8.parent) == null ? undefined : s.tagDefinition) != null && i.ignoreFirstLf) return t8.type === "interpolation";
  return r;
  function n() {
...
function Di(t8) {
  var e;
  return (e = t8.children) == null ? undefined : e.some((r) => r.type !== "text");
}
function kn(t8) {
  if (t8) switch (t8) {
    case "module":
...
function Bn(t8, e) {
  ...
  if (((n = t8.prev) == null ? undefined : n.type) === "comment") {
...
function De(t8) {
  var e;
  return ((e = t8.lastChild) == null ? undefined : e.isTrailingSpaceSensitive) && !t8.lastChild.hasTrailingSpaces && !R(Dt(t8.lastChild)) && !Ce(t8);
}
function ve(t8) {
...
function ia(t8, e, r) {
  ...
  let s = ((m = n.prev) == null ? undefined : m.type) === "comment" && sa(n.prev.value), i = typeof s == "boolean" ? () => s : Array.isArray(s) ? (g) => s.includes(g.rawName) : () => false, a = t8.map(({
    node: g
...
function la(t8, e) {
  ...
  switch (r.type) {
    ...
    case "angularControlFlowBlockParameters":
      return ua.has(t8.parent.name) ? hn : undefined;
  }
}
var Jn = la;
var nt = null;
...
function os(t8) {
  var e, r;
  return !(((e = t8.next) == null ? undefined : e.type) === "angularControlFlowBlock" && (r = ss.get(t8.name)) != null && r.has(t8.next.name));
}
function ma(t8) {
  let {
    previous: e
  } = t8;
  return (e == null ? undefined : e.type) === "angularControlFlowBlock" && !Se(e) && !os(e);
}
function us(t8, e, r) {
...
`) {
  ...
  _consumeStartTag(e) {
    ...
    let o = this._peek.sourceSpan.fullStart, u = new f(e.sourceSpan.start, o, e.sourceSpan.fullStart), p = new f(e.sourceSpan.start, o, e.sourceSpan.fullStart), l = new f(e.sourceSpan.start.moveBy(1), e.sourceSpan.end), m = new G(i, s, [], u, p, undefined, l), g = this._getContainer();
  ...
  _consumeAttr(e) {
    ...
    let l = o && u && new f((s == null ? undefined : s.sourceSpan.start) ?? o.start, u, (s == null ? undefined : s.sourceSpan.fullStart) ?? o.fullStart);
    return new Vt(r, i, new f(e.sourceSpan.start, n, e.sourceSpan.fullStart), e.sourceSpan, l, a.length > 0 ? a : undefined, undefined);
  }
  _consumeBlockOpen(e) {
    let r = [];
...
function Hs(t8, e) {
  return Ge[e] !== undefined ? Ge[e] || t8 : /^#x[a-f0-9]+$/i.test(e) ? String.fromCodePoint(parseInt(e.slice(2), 16)) : /^#\d+$/.test(e) ? String.fromCodePoint(parseInt(e.slice(1), 10)) : t8;
}
...
var Zt = class t7 {
  ...
  get lastChild() {
    var e;
    return (e = this.children) == null ? undefined : e[this.children.length - 1];
  }
  get prev() {
    var e, r;
    return (r = (e = this.parent) == null ? undefined : e.children) == null ? undefined : r[this.parent.children.indexOf(this) - 1];
  }
  get next() {
    var e, r;
    return (r = (e = this.parent) == null ? undefined : e.children) == null ? undefined : r[this.parent.children.indexOf(this) + 1];
...
function js(t8, e, r) {
  let {
    ...
    getTagContentType: p ? (...c) => p(...c) ? N.RAW_TEXT : undefined : undefined,
    tokenizeAngularBlocks: n === "angular" ? true : undefined
  });
  if (n === "vue") {
...
function bo(t8, e) {
  ...
  let r = (n = t8.attrs.find((s) => s.name === "lang")) == null ? undefined : n.value;
  return !r || $e(e, {
    language: r
  }) === "html";
}
...
//# sourceMappingURL=html-4RLNYFM4.js.map
//# sourceMappingURL=html-4RLNYFM4.js.map