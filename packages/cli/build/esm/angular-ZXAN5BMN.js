...
var Se = class extends L {
  visit(e, t = null) {
    var s;
    return (s = e.visitThisReceiver) == null ? undefined : s.call(e, this, t);
  }
};
...
var B = class r extends A {
  ...
  visit(e, t = null) {
    return e.visitUnary !== undefined ? e.visitUnary(this, t) : e.visitBinary(this, t);
  }
};
...
var fe = class {
  ...
  splitInterpolation(e, t, s, n = F) {
    ...
    for (; d < e.length; ) if (y) {
      ...
      let k = ((g == null ? undefined : g.get(u)) ?? u) + S.length;
...
var U = class {
  ...
  span(e, t) {
    ...
    if (t !== undefined && t > this.currentEndIndex && (s = t), e > s) {
      let n = s;
      s = e, e = n;
    }
    return new P(e, s);
  ...
  parsePrimary() {
    ...
    if (this.consumeOptionalCharacter(40)) {
      ...
      if (this.next.isKeywordUndefined()) return this.advance(), new C(this.span(e), this.sourceSpan(e), undefined);
  ...
  switch (s) {
    ...
    case "SafeCall": {
      ...
      return a(p, {
        callee: x,
        arguments: c,
        optional: p === "OptionalCallExpression" ? o : undefined
      }, {
        start: E(x),
        end: r3.sourceSpan.end
      }, {
...
function We(r3) {
  var s, n, i;
  let e = ((s = r3.range) == null ? undefined : s[0]) ?? r3.start, t = (i = ((n = r3.declaration) == null ? undefined : n.decorators) ?? r3.decorators) == null ? undefined : i[0];
  return t ? Math.min(We(t), e) : e;
}
function Nt(r3) {
  var e;
  return ((e = r3.range) == null ? undefined : e[1]) ?? r3.end;
}
function Re(r3) {
  return {
    astFormat: "estree",
...
//# sourceMappingURL=angular-ZXAN5BMN.js.map
//# sourceMappingURL=angular-ZXAN5BMN.js.map