...
// ../../node_modules/.pnpm/prettier@3.2.5/node_modules/prettier/plugins/postcss.mjs
init_esm_shims();
...
var ue = (t, e, s) => (s = t != null ? ul(fl(t)) : {}, hl($r(s, "default", {
  value: t,
  enumerable: true
}) , t));
var On = y((pe) => {
...
var ut = y((pv, Ei) => {
  ...
  var at = class {
    constructor(e = {}) {
      this.raws = {}, this[Yt] = false, this[yc] = true;
...
var ne = y((mv, Li) => {
  var {
    isClean: Ci,
    my: Ai
  } = $t(), Oi = ct(), Ni = Oe(), bc = ut(), Pi, us, ls, Ri;
  function Ii(t) {
    return t.map((e) => (e.nodes && (e.nodes = Ii(e.nodes)), delete e.source, e));
  }
  function qi(t) {
    if (t[Ci] = false, t.proxyOf.nodes) for (let e of t.proxyOf.nodes) qi(e);
  }
  ...
  z.default = z;
  z.rebuild = (t) => {
    t.type === "atrule" ? Object.setPrototypeOf(t, ls.prototype) : t.type === "rule" ? Object.setPrototypeOf(t, us.prototype) : t.type === "decl" ? Object.setPrototypeOf(t, Oi.prototype) : t.type === "comment" ? Object.setPrototypeOf(t, Ni.prototype) : t.type === "root" && Object.setPrototypeOf(t, Ri.prototype), t[Ai] = true, t.nodes && t.nodes.forEach((e) => {
      z.rebuild(e);
    });
  };
});
...
var jt = y((_v, Qi) => {
  var Sc = ct(), Tc = Ht(), Cc = Oe(), Ac = Kt(), Oc = Pe(), Hi = Qt(), Ki = {
    empty: true,
    space: true
  };
  function Nc(t) {
  ...
  var fs = class {
    constructor(e) {
      this.input = e, this.root = new Oc(), this.current = this.root, this.spaces = "", this.semicolon = false, this.customProperty = false, this.createTokenizer(), this.root.source = {
        input: e,
        start: {
          column: 1,
          line: 1,
    ...
    decl(e, s) {
      ...
      this.init(r, e[0][2]);
      let n = e[e.length - 1];
      for (n[0] === ";" && (this.semicolon = true, e.pop()), r.source.end = this.getPosition(n[3] || n[2] || Nc(e)), r.source.end.offset++; e[0][0] !== "word"; ) e.length === 1 && this.unknownWord(e), r.raws.before += e.shift()[1];
    ...
    raw(e, s, r, n) {
      ...
      for (let l = 0; l < a; l += 1) i = r[l], o = i[0], o === "space" && l === a - 1 && !n ? c = false : o === "comment" ? (p = r[l - 1] ? r[l - 1][0] : "empty", f = r[l + 1] ? r[l + 1][0] : "empty", !Ki[p] && !Ki[f] ? u.slice(-1) === "," ? c = false : u += i[1] : c = false) : u += i[1];
      if (!c) {
...
var qe = y((Cv, so) => {
  var {
    ...
    nanoid: Dc
  } = Xi(), hs = is(), to = Wt(), Mc = ps(), ds = Symbol("fromOffsetCache"), Bc = !!(qc && Lc), ro = !!(ys && ms), Ie = class {
    constructor(e, s = {}) {
      if (e === null || typeof e > "u" || typeof e == "object" && !e.toString) throw new Error(`PostCSS received ${e} instead of CSS string`);
      if (this.css = e.toString(), this.css[0] === "\uFEFF" || this.css[0] === "\uFFFE" ? (this.hasBOM = true, this.css = this.css.slice(1)) : this.hasBOM = false, s.from && (!ro || /^\w+:\/\//.test(s.from) || ms(s.from) ? this.file = s.from : this.file = ys(s.from)), ro && Bc) {
    ...
    error(e, s, r, n = {}) {
      ...
      return u ? i = new to(e, u.endLine === undefined ? u.line : {
        column: u.column,
        line: u.line
      }, u.endLine === undefined ? u.column : {
        column: u.endColumn,
        line: u.endLine
      }, u.source, u.file, n.plugin) : i = new to(e, o === undefined ? s : {
        column: r,
        line: s
      }, o === undefined ? r : {
        column: a,
...
`);
    ...
    origin(e, s, r, n) {
      ...
      if (u.protocol === "file:") if (eo) c.file = eo(u);
    ...
    toJSON() {
      ...
      return this.map && (e.map = {
        ...this.map
      }, e.map.consumerCache && (e.map.consumerCache = undefined)), e;
    }
    get from() {
...
`));
        ...
        return this.inlineComment(i), n && (this.input = new zc(n), this.tokenizer = Wc(this.input)), true;
      } else if (t[1] === "/") {
...
var lo = y((Pv, uo) => {
  var Yc = /^#[0-9a-fA-F]{6}$|^#[0-9a-fA-F]{3}$/, Vc = /\.[0-9]/, Gc = (t) => {
    let [, e] = t, [s] = e;
    return (s === "." || s === "#") && Yc.test(e) === false && Vc.test(e) === false;
  };
  uo.exports = {
    isMixinToken: Gc
  };
...
var vo = y((Lv, wo) => {
  var Qc = Oe(), jc = jt(), {
    ...
    isMixinToken: Xc
  } = lo(), Zc = fo(), ef = yo(), tf = /(!\s*important)$/i;
...
var er = y((Yv, No) => {
  var uf = _s(), mt = class {
    constructor(e, s, r) {
      this.processor = e, this.messages = [], this.root = s, this.opts = r, this.css = undefined, this.map = undefined;
    }
    toString() {
      return this.css;
    }
...
var Es = y((Gv, qo) => {
  var {
    isClean: H,
    my: lf
  } = $t(), cf = vs(), ff = ot(), pf = ne(), hf = Zt(); xs(); var Po = er(), df = ht(), mf = Pe(), yf = {
    atrule: "AtRule",
    comment: "Comment",
    decl: "Declaration",
    document: "Document",
  ...
  function bs(t) {
    return t[H] = false, t.nodes && t.nodes.forEach((e) => bs(e)), t;
  }
  var ks = {}, oe = class t {
    constructor(e, s, r) {
      ...
      else if (s instanceof t || s instanceof Po) n = bs(s.root), s.map && (typeof r.map > "u" && (r.map = {}), r.map.inline || (r.map.inline = false), r.map.prev = s.map);
      else {
        let i = df;
    ...
    prepareVisitors() {
      ...
      for (let s of this.plugins) if (typeof s == "object") for (let r in s) {
        if (!gf[r] && /^[A-Z]/.test(r)) throw new Error(`Unknown event ${r} in ${s.postcssPlugin}. Try to update PostCSS (${this.processor.version} now).`);
        if (!wf[r]) if (typeof s[r] == "object") for (let n in s[r]) n === "*" ? e(s, r, s[r][n]) : e(s, r + "-" + n.toLowerCase(), s[r][n]);
    ...
    sync() {
      ...
      if (this.prepareVisitors(), this.hasListener) {
        let e = this.result.root;
        for (; !e[H]; ) e[H] = true, this.walkSync(e);
    ...
    visitTick(e) {
      ...
      for (; s.eventIndex < i.length; ) {
        ...
        if (s.eventIndex += 1, o === Le) {
          r.nodes && r.nodes.length && (r[H] = true, s.iterator = r.getIterator());
          return;
...
var Do = y((Kv, Lo) => {
  var vf = vs(), xf = ot(); xs(); var _f = ht(), bf = er(), gt = class {
    constructor(e, s, r) {
      s = s.toString(), this.stringified = false, this._processor = e, this._css = s, this._opts = r, this._map = undefined;
      let n, i = xf;
...
var Xo = y((Zv, Jo) => {
  ...
  Jo.exports = function(e, s = {}) {
    ...
    function F() {
      let T = 1, C = false, A = false;
      for (; T > 0; ) o += 1, r.length <= o && v("interpolation"), i = r.charCodeAt(o), l = r.charCodeAt(o + 1), C ? !A && i === C ? (C = false, A = false) : i === 92 ? A = !A : A && (A = false) : i === 39 || i === 34 ? C = i : i === 125 ? T -= 1 : i === 35 && l === 123 && (T += 1);
    }
    function K(T) {
      ...
      switch (i = r.charCodeAt(h), i) {
        ...
        case 40: {
          if (p = d.length ? d.pop()[1] : "", l = r.charCodeAt(h + 1), p === "url" && l !== 39 && l !== 34) {
            for (_ = 1, f = false, o = h + 1; o <= r.length - 1; ) {
...
var ea = y((ex, Zo) => {
  var {
    Comment: Hf
  } = tr(), Kf = jt(), Qf = Qo(), jf = Xo(), Cs = class extends Kf {
    atrule(e) {
      let s = e[1], r = e;
      for (; !this.tokenizer.endOfFile(); ) {
...
var Ps = y((Ns) => {
  ...
  function vt(t) {
    var e = this;
    this.constructor(t), this.nodes = t.nodes, this.after === undefined && (this.after = this.nodes.length > 0 ? this.nodes[this.nodes.length - 1].after : ""), this.before === undefined && (this.before = this.nodes.length > 0 ? this.nodes[0].before : ""), this.sourceIndex === undefined && (this.sourceIndex = this.before.length), this.nodes.forEach(function(s) {
      s.parent = e;
    });
  }
  ...
  vt.prototype.each = function() {
    for (var e = arguments.length <= 0 || arguments[0] === undefined ? function() {
...
var ua = y((xt) => {
  ...
  function aa(t) {
    var e = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1], s = [{
      mode: "normal",
      character: null
    ...
    for (var f = 0; f < c.length; f++) {
      var p = c[f];
      if ((p === "'" || p === '"') && (s[n].isCalculationEnabled === true ? (s.push({
        mode: "string",
  ...
  function Is(t) {
    var e = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1], s = [], r = 0, n = false, i = undefined;
    function o() {
      return {
        before: "",
        after: "",
    ...
    for (var a = 0; a < t.length; a++) {
      var u = t[a];
      n ? (i.value += u, (u === "{" || u === "(") && r++, (u === ")" || u === "}") && r--) : u.search(/\s/) !== -1 ? i.before += u : (u === "(" && (i.type = "media-feature-expression", r++), i.value = u, i.sourceIndex = e + a, n = true), n && r === 0 && (u === ")" || a === t.length - 1 || t[a + 1].search(/\s/) !== -1) && (["not", "only", "and"].indexOf(i.value) !== -1 && (i.type = "keyword"), i.type === "media-feature-expression" && (i.nodes = aa(i.value, i.sourceIndex)), s.push(Array.isArray(i.nodes) ? new Rs.default(i) : new ia.default(i)), i = o(), n = false);
    }
    for (var c = 0; c < s.length; c++) if (i = s[c], c > 0 && (s[c - 1].after = i.before), i.type === undefined) {
      if (c > 0) {
...
var we = y((ir, ya) => {
  ...
  var gp = function t(e, s) {
    ...
    function t() {
      ...
      var r = e.spaces;
      r = r === undefined ? {} : r;
      var n = r.before, i = n === undefined ? "" : n, o = r.after, a = o === undefined ? "" : o;
      this.spaces = {
        before: i,
        after: a
      };
    ...
    return t.prototype.remove = function() {
      ...
      var s = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}, r = gp(this);
...
var D = y((B) => {
  B.__esModule = true;
  B.TAG = "tag"; B.STRING = "string"; B.SELECTOR = "selector"; B.ROOT = "root"; B.PSEUDO = "pseudo"; B.NESTING = "nesting"; B.ID = "id"; B.COMMENT = "comment"; B.COMBINATOR = "combinator"; B.CLASS = "class"; B.ATTRIBUTE = "attribute"; B.UNIVERSAL = "universal";
});
var ar = y((or, ga) => {
  or.__esModule = true;
  ...
  var Ap = function(t) {
    ...
    return e.prototype.append = function(r) {
      ...
      r = this.index(r), this.at(r).parent = undefined, this.nodes.splice(r, 1);
      var n = undefined;
      ...
      if (this.indexes[n] = 0, !!this.length) {
        for (var i = undefined, o = undefined; this.indexes[n] < this.length && (i = this.indexes[n], o = r(this.at(i), i), o !== false); ) this.indexes[n] += 1;
...
var Za = y((Er, Xa) => {
  ...
  function Dd(t) {
    for (var e = [], s = t.css.valueOf(), r = undefined, n = undefined, i = undefined, o = undefined, a = undefined, u = undefined, c = undefined, f = undefined, p = undefined, l = undefined, g = undefined, x = s.length, h = -1, d = 1, m = 0, _ = function(v, R) {
      ...
      switch (r = s.charCodeAt(m), r === _t && (h = m, d += 1), r) {
        ...
        case Td:
          i = r === Va ? "'" : '"', n = m;
          do
            for (l = false, n = s.indexOf(i, n + 1), n === -1 && _("quote", i), g = n; s.charCodeAt(g - 1) === Us; ) g -= 1, l = !l;
          while (l);
...
var ru = y((Sr, tu) => {
  ...
  var vm = function() {
    function t(e) {
      wm(this, t), this.input = e, this.lossy = e.options.lossless === false, this.position = 0, this.root = new Yd.default();
    ...
    return t.prototype.attribute = function() {
      var s = "", r = undefined, n = this.currToken;
      ...
      if (o.length > 1 ? (o[0] === "" && (o[0] = true), a.attribute = this.parseValue(o[2]), a.namespace = this.parseNamespace(o[0])) : a.attribute = this.parseValue(i[0]), r = new im.default(a), i[2]) {
...
var nu = y((Tr, su) => {
  ...
  var Sm = function() {
    ...
    return t.prototype.process = function(s) {
      var r = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}, n = new bm.default({
        css: s,
        error: function(o) {
          throw new Error(o);
        },
...
var U = y((Nx, au) => {
  var Cm = Y(), Me = class extends Cm {
    ...
    removeChild(e) {
      e = this.index(e), this.nodes[e].parent = undefined, this.nodes.splice(e, 1);
      let s;
      for (let r in this.indexes) s = this.indexes[r], s >= e && (this.indexes[r] = s - 1);
      return this;
    }
    removeAll() {
      for (let e of this.nodes) e.parent = undefined;
      return this.nodes = [], this;
    }
    every(e) {
      return this.nodes.every(e);
    ...
    for (; u < i; ) {
      switch (p = n.charCodeAt(u), p === 10 && (o = u, a += 1), p) {
        ...
        case 34:
          g = p === 39 ? "'" : '"', l = u;
          do
            for (v = false, l = n.indexOf(g, l + 1), l === -1 && K("quote"), R = l; n.charCodeAt(R - 1) === 92; ) R -= 1, v = !v;
          while (v);
        ...
        default:
          if (p === 47 && (n.charCodeAt(u + 1) === 42 || s.loose && !f && n.charCodeAt(u + 1) === 47)) {
            if (n.charCodeAt(u + 1) === 42) l = n.indexOf("*/", u + 2) + 1, l === 0 && K("comment");
            else {
              let A = n.indexOf(`
`, u + 2);
              l = A !== -1 ? A - 1 : i;
...
`), h = x.length - 1, h > 0 ? (_ = a + h, w = l - x[h].length) : (_ = a, w = o), r.push(["comment", d, a, u - o, _, l - w, u]), o = w, a = _, u = l;
          } else if (p === 35 && !Qm.test(n.slice(u + 1, u + 2))) l = u + 1, r.push(["#", n.slice(u, l), a, u - o, a, l - o, u]), u = l - 1;
...
var Gu = y((jx, Vu) => {
  ...
  Vu.exports = class {
    ...
    comment() {
      ...
      this.options.loose && s.startsWith("//") && (s = s.substring(2), e = true), r = new ry({
        value: s,
        inline: e,
        source: {
          start: {
...
var Ge = "label";
var ke = "break-parent";
var bt = /* @__PURE__ */ new Set([$e, xe, _e, We, be, ee, le, ze, Ye, Ve, Q, Ge, ke]);
function ml(t) {
...
var an = '"';
function kl(t, e) {
  let s = e === true || e === St ? St : an, r = s === St ? an : St, n = 0, i = 0;
  for (let o of t) o === s ? n++ : o === r && i++;
  return n > i ? r : s;
}
var un = kl;
function El(t, e, s) {
  let r = e === '"' ? "'" : '"', i = E(false, t, /\\(.)|(["'])/gs, (o, a, u) => a === r ? a : u === e ? "\\" + u : u || (s && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/.test(a) ? a : "\\" + a));
  return e + i + e;
}
var ln = El;
function Sl(t, e) {
...
var Ee = Tl;
var Cl = /* @__PURE__ */ new Set(["raw", "raws", "sourceIndex", "source", "before", "after", "trailingComma", "spaces"]);
function fn(t, e, s) {
  if (Ee(t) && t.lang === "yaml" && delete e.value, t.type === "css-comment" && s.type === "css-root" && s.nodes.length > 0 && ((s.nodes[0] === t || Ee(s.nodes[0]) && s.nodes[1] === t) && (delete e.text, /^\*\s*@(?:format|prettier)\s*$/.test(t.text)) || s.type === "css-root" && G(false, s.nodes, -1) === t)) return null;
  if (t.type === "value-root" && delete e.text, (t.type === "media-query" || t.type === "media-query-list" || t.type === "media-feature-expression") && delete e.value, t.type === "css-rule" && delete e.params, t.type === "selector-combinator" && (e.value = E(false, e.value, /\s+/g, " ")), t.type === "media-feature" && (e.value = E(false, e.value, " ", "")), (t.type === "value-word" && (t.isColor && t.isHex || ["initial", "inherit", "unset", "revert"].includes(e.value.toLowerCase())) || t.type === "media-feature" || t.type === "selector-root-invalid" || t.type === "selector-pseudo") && (e.value = e.value.toLowerCase()), t.type === "css-decl" && (e.prop = e.prop.toLowerCase()), (t.type === "css-atrule" || t.type === "css-import") && (e.name = e.name.toLowerCase()), t.type === "value-number" && (e.unit = e.unit.toLowerCase()), t.type === "value-unknown" && (e.value = E(false, e.value, /;$/g, "")), (t.type === "media-feature" || t.type === "media-keyword" || t.type === "media-type" || t.type === "media-unknown" || t.type === "media-url" || t.type === "media-value" || t.type === "selector-attribute" || t.type === "selector-string" || t.type === "selector-class" || t.type === "selector-combinator" || t.type === "value-string") && e.value && (e.value = Al(e.value)), t.type === "selector-attribute" && (e.attribute = e.attribute.trim(), e.namespace && typeof e.namespace == "string" && (e.namespace = e.namespace.trim(), e.namespace.length === 0 && (e.namespace = true)), e.value && (e.value = E(false, e.value.trim(), /^["']|["']$/g, ""), delete e.quoted)), (t.type === "media-value" || t.type === "media-type" || t.type === "value-number" || t.type === "selector-root-invalid" || t.type === "selector-class" || t.type === "selector-combinator" || t.type === "selector-tag") && e.value && (e.value = E(false, e.value, /([\d+.e-]+)([a-z]*)/gi, (r, n, i) => {
    let o = Number(n);
...
function Al(t) {
  return E(false, E(false, t, "'", '"'), /\\([^\da-f])/gi, "$1");
}
var pn = fn;
async function Ol(t, e) {
  if (t.lang === "yaml") {
    let s = t.value.trim(), r = s ? await e(s, {
      parser: "yaml"
    }) : "";
...
function Je(t) {
  ...
  return je = Je.prototype = t ?? /* @__PURE__ */ Object.create(null), new Je();
}
var Nl = 10;
...
function xn(t, e) {
  var s, r, n;
  if (typeof ((r = (s = t.source) == null ? undefined : s.start) == null ? undefined : r.offset) == "number") return t.source.start.offset;
...
function Hr(t, e) {
  ...
  if (typeof ((r = (s = t.source) == null ? undefined : s.end) == null ? undefined : r.offset) == "number") return t.source.end.offset;
  if (t.source) {
    if (t.source.end) return Gr(t.source.end, e);
    if (te(t.nodes)) return Hr(G(false, t.nodes, -1), e);
  }
  return null;
}
function Kr(t, e) {
...
function Ll(t) {
  ...
  return typeof t.prop == "string" && (e += t.prop.length), t.type === "css-atrule" && typeof t.name == "string" && (e += 1 + t.name.length + t.raws.afterName.match(/^\s*:?\s*/)[0].length), t.type !== "css-atrule" && typeof ((s = t.raws) == null ? undefined : s.between) == "string" && (e += t.raws.between.length), e;
}
function bn(t) {
...
` || a === "\r") && (n && i.push([r, o]), e = "initial", n = false);
  ...
  for (let [o, a] of i) t = t.slice(0, o) + E(false, t.slice(o, a), /["'*]/g, " ") + t.slice(a);
  return t;
}
function N(t) {
  var e;
  return (e = t.source) == null ? undefined : e.startOffset;
}
function P(t) {
  var e;
  return (e = t.source) == null ? undefined : e.endOffset;
}
var re = ue(On());
function Vl(t) {
...
function In(t) {
  let {
    ...
    pragmas: r,
    comments: n
  } = Pn(t), i = (0, re.strip)(s), o = (0, re.print)({
    pragmas: {
      format: "",
      ...r
    },
...
function Dn(t) {
  var e, s;
  return (s = (e = t.findAncestor((r) => r.type === "css-decl")) == null ? undefined : e.prop) == null ? undefined : s.toLowerCase();
}
...
function Bn(t, e) {
  ...
  return ((r = s == null ? undefined : s.name) == null ? undefined : r.toLowerCase().endsWith("keyframes")) && ["from", "to"].includes(e.toLowerCase());
}
function se(t) {
...
function Se(t, e) {
  ...
  return ((r = s == null ? undefined : s.value) == null ? undefined : r.toLowerCase()) === e;
}
function Un(t) {
  var r;
  let e = t.findAncestor((n) => n.type === "css-rule"), s = (r = e == null ? undefined : e.raws) == null ? undefined : r.selector;
...
function Fn(t) {
  ...
  return e.groups[0].value === "url" && e.groups.length === 2 && ((s = t.findAncestor((r) => r.type === "css-atrule")) == null ? undefined : s.name) === "import";
}
function $n(t) {
...
function Nt(t, e) {
  var r;
  let s = (r = t.parent) == null ? undefined : r.nodes;
...
function jr(t) {
  var e;
  return ((e = t.raws) == null ? undefined : e.params) && /^\(\s*\)$/.test(t.raws.params);
}
function It(t) {
...
function jn(t, e) {
  return t.value === "$$" && t.type === "value-func" && (e == null ? undefined : e.type) === "value-word" && !e.raws.before;
}
function Jn(t) {
  var e, s;
  return ((e = t.value) == null ? undefined : e.type) === "value-root" && ((s = t.value.group) == null ? undefined : s.type) === "value-value" && t.prop.toLowerCase() === "composes";
}
function Xn(t) {
  var e, s, r;
  return ((r = (s = (e = t.value) == null ? undefined : e.group) == null ? undefined : s.group) == null ? undefined : r.type) === "value-paren_group" && t.value.group.group.open !== null && t.value.group.group.close !== null;
}
function de(t) {
  var e;
  return ((e = t.raws) == null ? undefined : e.before) === "";
}
function qt(t) {
  var e, s;
  return t.type === "value-comma_group" && ((s = (e = t.groups) == null ? undefined : e[1]) == null ? undefined : s.type) === "value-colon";
}
function Qr(t) {
  var e;
  return t.type === "value-paren_group" && ((e = t.groups) == null ? undefined : e[0]) && qt(t.groups[0]);
}
function Jr(t, e) {
  var i;
  ...
  return !!((i = n == null ? undefined : n.prop) != null && i.startsWith("$") || Qr(r) || r.type === "value-func");
}
function Xr(t) {
...
function Mt(t) {
  return (t == null ? undefined : t.type) === "value-colon";
}
function Zn(t, e) {
  if (!qt(e)) return false;
  let {
    groups: s
  } = e, r = s.indexOf(t);
  return r === -1 ? false : Mt(s[r + 1]);
}
function ei(t) {
  return t.value && ["not", "and", "or"].includes(t.value.toLowerCase());
}
function ti(t) {
  return t.type !== "value-func" ? false : Kl.has(t.value.toLowerCase());
}
function Ce(t) {
  return /\/\//.test(t.split(/[\n\r]/).pop());
}
function rt(t) {
  return (t == null ? undefined : t.type) === "value-atword" && t.value.startsWith("prettier-placeholder-");
}
function ri(t, e) {
  var s, r;
  if (((s = t.open) == null ? undefined : s.value) !== "(" || ((r = t.close) == null ? undefined : r.value) !== ")" || t.groups.some((n) => n.type !== "value-comma_group")) return false;
  if (e.type === "value-comma_group") {
    let n = e.groups.indexOf(t) - 1, i = e.groups[n];
    if ((i == null ? undefined : i.type) === "value-word" && i.value === "with") return true;
  }
  return false;
}
function st(t) {
  var e, s;
  return t.type === "value-paren_group" && ((e = t.open) == null ? undefined : e.value) === "(" && ((s = t.close) == null ? undefined : s.value) === ")";
}
function Jl(t, e, s) {
  var d;
  let {
    node: r
  } = t, n = t.parent, i = t.grandparent, o = Dn(t), a = o && n.type === "value-value" && (o === "grid" || o.startsWith("grid-template")), u = t.findAncestor((m) => m.type === "css-atrule"), c = u && et(u, e), f = r.groups.some((m) => Xr(m)), p = t.map(s, "groups"), l = [], g = Se(t, "url"), x = false, h = false;
  for (let m = 0; m < r.groups.length; ++m) {
    ...
    if (Te(t, "forward") && w.type === "value-word" && w.value && _ !== undefined && _.type === "value-word" && _.value === "as" && v.type === "value-operator" && v.value === "*" || !v || w.type === "value-word" && w.value.endsWith("-") && rt(v)) continue;
    if (w.type === "value-string" && w.quoted) {
      let A = w.value.lastIndexOf("#{"), ve = w.value.lastIndexOf("}");
      A !== -1 && ve !== -1 ? x = A > ve : A !== -1 ? x = true : ve !== -1 && (x = false);
    }
    ...
    let $ = (j(w) || he(w)) && m === 0 && (v.type === "value-number" || v.isHex) && i && ti(i) && !de(v), T = (R == null ? undefined : R.type) === "value-func" || R && tt(R) || w.type === "value-func" || tt(w), C = v.type === "value-func" || tt(v) || (_ == null ? undefined : _.type) === "value-func" || _ && tt(_);
    ...
    if (!(!(Pt(v) || Pt(w)) && !Se(t, "calc") && !$ && (Ze(v) && !T || Ze(w) && !C || j(v) && !T || j(w) && !C || he(v) || he(w)) && (de(v) || F && (!_ || _ && Rt(_)))) && !((e.parser === "scss" || e.parser === "less") && F && w.value === "-" && st(v) && P(w) === N(v.open) && v.open.value === "(")) {
      ...
      if (a) {
        w.source && v.source && w.source.start.line !== v.source.start.line ? (l.push(k), h = true) : l.push(" ");
        continue;
      }
      if (K) {
        l.push(" ");
      ...
      if ((v == null ? undefined : v.value) !== "..." && !(rt(w) && rt(v) && P(w) === N(v))) {
...
var ec = /[a-z]+/gi;
var tc = /[$@]?[_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/gi;
var rc = new RegExp(oi.source + `|(${tc.source})?(${Zl.source})(${ec.source})?`, "gi");
function W(t, e) {
  return E(false, t, oi, (s) => Tt(s, e));
}
function ai(t, e) {
  let s = e.singleQuote ? "'" : '"';
...
function me(t) {
  return E(false, t, rc, (e, s, r, n, i) => !r && n ? ts(n) + se(i || "") : e);
}
function ts(t) {
...
var li = ic;
function oc(t, e) {
  return e === false ? false : t.charAt(e) === "/" && t.charAt(e + 1) === "/" ? Ot(t, e) : e;
}
var ci = oc;
function ac(t, e) {
  let s = null, r = e;
  for (; r !== s; ) s = r, r = vn(t, r), r = li(t, r), r = At(t, r);
  return r = ci(t, r), r = Bt(t, r), r !== false && Ut(t, r);
}
var Ft = ac;
function uc({
  node: t,
...
function fi(t, e, s) {
  ...
  let o = t.map(({
    ...
    var _;
    let d = i[h];
    if (qt(g) && g.type === "value-comma_group" && g.groups && g.groups[0].type !== "value-paren_group" && ((_ = g.groups[2]) == null ? undefined : _.type) === "value-paren_group") {
      let w = nn(d.contents.contents);
      w[1] = L(w[1]), d = L(fe(d));
    }
    let m = [d, x ? lc(t, e) : ","];
    if (!x && g.type === "value-comma_group" && te(g.groups)) {
      let w = G(false, g.groups, -1);
      !w.source && w.close && (w = w.close), w.source && Ft(e.originalText, P(w)) && m.push(k);
    }
    return m;
  }, "groups"), a = Zn(r, n), u = ri(r, n), c = Jr(t, e), f = u || c && !a, p = u || a, l = L([r.open ? s("open") : "", q([M, V(O, o)]), M, r.close ? s("close") : ""], {
    shouldBreak: f
  });
  return p ? fe(l) : l;
}
...
function cc(t, e, s) {
  ...
  return t.each(() => {
    ...
    if ((i == null ? undefined : i.type) === "css-comment" && i.text.trim() === "prettier-ignore" ? r.push(e.originalText.slice(N(n), P(n))) : r.push(s()), t.isLast) return;
    let {
      next: o
    } = t;
...
function fc(t, e, s) {
  ...
  switch (r.type) {
    ...
    case "css-rule":
      return [s("selector"), r.important ? " !important" : "", r.nodes ? [((n = r.selector) == null ? undefined : n.type) === "selector-unknown" && Ce(r.selector.value) ? O : r.selector ? " " : "", "{", r.nodes.length > 0 ? q([k, Ae(t, e, s)]) : "", k, "}", zn(r) ? ";" : ""] : ";"];
    case "css-decl": {
      let f = t.parent, {
        between: p
      } = r.raws, l = p.trim(), g = l === ":", x = typeof r.value == "string" && /^ *$/.test(r.value), h = typeof r.value == "string" ? r.value : s("value");
      return h = Jn(r) ? on(h) : h, !g && Ce(l) && !((o = (i = r.value) == null ? undefined : i.group) != null && o.group && t.call(() => rs(t), "value", "group", "group")) && (h = q([k, fe(h)])), [E(false, r.raws.before, /[\s;]/g, ""), f.type === "css-atrule" && f.variable || Un(t) ? r.prop : se(r.prop), l.startsWith("//") ? " " : "", l, r.extend || x ? "" : " ", e.parser === "less" && r.extend && r.selector ? ["extend(", s("selector"), ")"] : "", h, r.raws.important ? r.raws.important.replace(/\s*!\s*important/i, " !important") : r.important ? " !important" : "", r.raws.scssDefault ? r.raws.scssDefault.replace(/\s*!default/i, " !default") : r.scssDefault ? " !default" : "", r.raws.scssGlobal ? r.raws.scssGlobal.replace(/\s*!global/i, " !global") : r.scssGlobal ? " !global" : "", r.nodes ? [" {", q([M, Ae(t, e, s)]), M, "}"] : Qn(r) && !f.raws.semicolon && e.originalText[P(r) - 1] !== ";" ? "" : e.__isHTMLStyleAttribute && Nt(t, r) ? Et(";") : ";"];
    }
    case "css-atrule": {
      ...
      let l = r.name === "import" && ((a = r.params) == null ? undefined : a.type) === "value-unknown" && r.params.value.endsWith(";");
    ...
    case "media-feature":
      return se(W(E(false, r.value, / +/g, " "), e));
    case "media-colon":
      return [r.value, " "];
    case "media-value":
      return me(W(r.value, e));
    case "media-keyword":
      return W(r.value, e);
    case "media-url":
      return W(E(false, E(false, r.value, /^url\(\s+/gi, "url("), /\s+\)$/g, ")"), e);
    case "media-unknown":
      return r.value;
    case "selector-root":
    ...
    case "selector-string":
      return W(r.value, e);
    case "selector-tag":
      return [r.namespace ? [r.namespace === true ? "" : r.namespace.trim(), "|"] : "", ((u = t.previous) == null ? undefined : u.type) === "selector-nesting" ? r.value : me(Bn(t, r.value) ? r.value.toLowerCase() : r.value)];
    case "selector-id":
      return ["#", r.value];
    case "selector-class":
      return [".", me(W(r.value, e))];
    case "selector-attribute":
      return ["[", r.namespace ? [r.namespace === true ? "" : r.namespace.trim(), "|"] : "", r.attribute.trim(), r.operator ?? "", r.value ? ai(W(r.value.trim(), e), e) : "", r.insensitive ? " i" : "", "]"];
    ...
    case "selector-unknown": {
      ...
      let l = t.grandparent;
      if (p.type === "value-paren_group" && (l == null ? undefined : l.type) === "value-func" && l.value === "selector") {
    ...
    case "value-colon": {
      ...
      return [r.value, typeof (f == null ? undefined : f.value) == "string" && f.value.endsWith("\\") || Se(t, "url") ? "" : O];
    }
    case "value-string":
...
var Qu = gy;
function wy(t, e) {
  return !!(e.parser === "scss" && (t == null ? undefined : t.type) === "word" && t.value.startsWith("$"));
}
var ju = wy;
function vy(t, e) {
  var u;
  ...
  for (let c = 0; c < s.length; ++c) {
    ...
    if (e.parser === "scss" && f.type === "number" && f.unit === ".." && f.value.endsWith(".") && (f.value = f.value.slice(0, -1), f.unit = "..."), f.type === "func" && f.value === "selector" && (f.group.groups = [Z(Ur(t).text.slice(f.group.open.sourceIndex + 1, f.group.close.sourceIndex))]), f.type === "func" && f.value === "url") {
      let p = ((u = f.group) == null ? undefined : u.groups) ?? [], l = [];
  ...
  if (t && typeof t == "object") {
    ...
    if (t.raws ?? (t.raws = {}), t.type === "css-decl" && typeof t.prop == "string" && t.prop.startsWith("--") && typeof t.value == "string" && t.value.startsWith("{")) {
      ...
      if (t.value.trimEnd().endsWith("}")) {
        let u = e.originalText.slice(0, t.source.start.offset), c = "a".repeat(t.prop.length) + e.originalText.slice(t.source.start.offset + t.prop.length, t.source.end.offset), f = E(false, u, /[^\n]/g, " ") + c, p;
        ...
        ((s = l == null ? undefined : l.nodes) == null ? undefined : s.length) === 1 && l.nodes[0].type === "css-rule" && (a = l.nodes[0].nodes);
      }
      return a ? t.value = {
        type: "css-rule",
        nodes: a
    ...
    let o = "";
    if (typeof t.params == "string" && (o = t.raws.params ? t.raws.params.scss ?? t.raws.params.raw : t.params, t.raws.afterName && t.raws.afterName.trim().length > 0 && (o = t.raws.afterName + o), t.raws.between && t.raws.between.trim().length > 0 && (o = o + t.raws.between), o = o.trim(), t.raws.params = o), n.trim().length > 0) return n.startsWith("@") && n.endsWith(":") ? t : t.mixin ? (t.selector = ae(n, e), t) : (el(t, e) && (t.isSCSSNesterProperty = true), t.selector = Z(n), t);
    if (i.length > 0) {
      let a = i.match(Ey);
      a && (i = i.slice(0, a.index), t.scssDefault = true, a[0].trim() !== "!default" && (t.raws.scssDefault = a[0]));
      let u = i.match(Sy);
      if (u && (i = i.slice(0, u.index), t.scssGlobal = true, u[0].trim() !== "!global" && (t.raws.scssGlobal = u[0])), i.startsWith("progid:")) return {
        type: "value-unknown",
        value: i
      };
      t.value = ae(i, e);
    ...
    if (e.parser === "less" && t.type === "css-decl" && i.startsWith("extend(") && (t.extend || (t.extend = t.raws.between === ":"), t.extend && !t.selector && (delete t.value, t.selector = Z(i.slice(7, -1)))), t.type === "css-atrule") {
      ...
      if (e.parser === "less") {
        ...
        if (!["page", "nest", "keyframes"].includes(t.name) && ((r = t.params) == null ? undefined : r[0]) === ":") {
          t.variable = true;
    ...
    if (t.type === "css-atrule" && o.length > 0) {
      let {
        name: a
      } = t, u = t.name.toLowerCase();
      return a === "warn" || a === "error" ? (t.params = {
        type: "media-unknown",
        value: o
      }, t) : a === "extend" || a === "nest" ? (t.selector = Z(o), delete t.params, t) : a === "at-root" ? (/^\(\s*(?:without|with)\s*:.+\)$/s.test(o) ? t.params = ae(o, e) : (t.selector = Z(o), delete t.params), t) : Zu(u) ? (t.import = true, delete t.filename, t.params = ae(o, e), t) : ["namespace", "supports", "if", "else", "for", "each", "while", "debug", "mixin", "include", "function", "return", "define-mixin", "add-mixin"].includes(a) ? (o = o.replace(/(\$\S+?)(\s+)?\.{3}/, "$1...$2"), o = o.replace(/^(?!if)(\S+)(\s+)\(/, "$1($2"), t.value = ae(o, e), delete t.params, t) : ["media", "custom-media"].includes(u) ? o.includes("#{") ? {
        type: "media-unknown",
        value: o
...
function Qs(t, e, s) {
  ...
  try {
    ...
    throw typeof c != "number" ? o : sa(`${a}: ${u}`, {
      loc: {
        start: {
          line: c,
          column: f
...
export { P_ as default, hi as languages, mi as options, Js as parsers, Oy as printers };
//# sourceMappingURL=postcss-A2ITI5N4.js.map
//# sourceMappingURL=postcss-A2ITI5N4.js.map