...
var Ga = (e, t, r) => (r = e != null ? Ma(Ja(e)) : {}, Na(On(r, "default", {
  value: e,
  enumerable: true
}) , e));
var Ys = (e, t, r) => {
...
var it = (e, t, r) => (Ys(e, t, "read from private field"), t.get(e));
var Xs = (e, t, r) => {
  if (t.has(e)) throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(e) : t.set(e, r);
};
var Vs = (e, t, r, n) => (Ys(e, t, "write to private field"), t.set(e, r), r);
var yi = Wa((Pt) => {
...
var Ot = to;
function ro(e, t) {
  return t === false ? false : e.charAt(t) === "/" && e.charAt(t + 1) === "/" ? nu(e, t) : t;
}
var vt = ro;
function no(e, t) {
  let r = null, n = t;
  for (; n !== r; ) r = n, n = ru(e, n), n = Ot(e, n), n = Je(e, n);
  return n = vt(e, n), n = qe(e, n), n !== false && Z(e, n);
}
var _t = no;
function so(e) {
...
var hr = uo;
function io(e, t, r) {
  let n = t === '"' ? "'" : '"', u = H(false, e, /\\(.)|(["'])/gs, (i, a, o) => a === n ? a : o === t ? "\\" + o : o || (r && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/.test(a) ? a : "\\" + a));
  return t + u + t;
}
var uu = io;
function ao(e, t) {
...
var mu = M(["ExportDefaultDeclaration", "DeclareExportDeclaration", "ExportNamedDeclaration", "ExportAllDeclaration", "DeclareExportAllDeclaration"]);
var G = M(["ArrayExpression", "TupleExpression"]);
var se = M(["ObjectExpression", "RecordExpression"]);
function Pe(e) {
...
var Du = M(["Identifier", "ThisExpression", "Super", "PrivateName", "PrivateIdentifier", "Import"]);
var Le = M(["ObjectTypeAnnotation", "TSTypeLiteral", "TSMappedType"]);
var Mt = M(["FunctionExpression", "ArrowFunctionExpression"]);
function Co(e) {
...
function Fu(e, {
  ...
  if (!q(e)) return false;
  let r = e, n = 0;
  for (; q(r) && n++ <= t; ) if (!Rn(r.property) || (r = r.object, A(r))) return false;
  return Rn(r);
}
function Rn(e) {
  return A(e) ? false : rr(e) || Du(e);
}
function Nn(e, t = 5) {
  return Cu(e, t) <= t;
}
...
function nr(e, t) {
  ...
  if (A(e)) return false;
  let n = r * ho;
  if (e.type === "ThisExpression" || e.type === "Identifier" && e.name.length <= n || qn(e) && !A(e.argument)) return true;
...
function Or(e) {
  if (!A(e)) return false;
  let t = v(false, ot(e, x.Dangling), -1);
  return t && !ee(t);
}
function Au(e) {
  ...
  for (let r of e) if (Mt(r)) {
    ...
    for (let n of ae(r)) if (Mt(n)) return true;
  }
  return false;
}
function vr(e) {
...
function be(e, t = 2) {
  ...
  if (rr(e) || Du(e) || e.type === "ArgumentPlaceholder") return true;
...
`)) && e.expressions.every(r);
  ...
  return q(e) ? be(e.object, t) && be(e.property, t) : e.type === "UnaryExpression" && So.has(e.operator) || e.type === "UpdateExpression" ? be(e.argument, t) : false;
}
function De(e) {
  var t;
...
var We = M(["UnionTypeAnnotation", "TSUnionType"]);
var _r = M(["IntersectionTypeAnnotation", "TSIntersectionType"]);
...
var Oe = "label";
var ve = "break-parent";
var Mr = /* @__PURE__ */ new Set([tt, Ge, Ue, rt, pe, de, xe, Ye, Xe, Ve, ce, Oe, ve]);
function Po(e) {
...
function Oo(e) {
  if (e.type === pe && e.break || e.type === ce && e.hard || e.type === ve) return true;
}
function re(e) {
  return wu(e, Oo, false);
}
function Lu(e) {
  if (e.length > 0) {
    let t = v(false, e, -1);
...
function Mo(e) {
  if (e.type === ce) return true;
}
function vu(e) {
  return wu(e, Mo, false);
}
function or(e, t) {
  return e.type === Oe ? {
    ...e,
...
function oe(e, t) {
  t.leading = true, t.trailing = false, zn(e, t);
}
function he(e, t, r) {
  t.leading = false, t.trailing = false, r && (t.marker = r), zn(e, t);
}
function K(e, t) {
  t.leading = false, t.trailing = true, zn(e, t);
}
function qo(e, t) {
  let r = null, n = t;
...
function Vo({
  ...
  return t && ju(e) ? (oe(t, e), true) : false;
}
function Zn({
  comment: e,
  precedingNode: t,
  ...
  return n.type === "BlockStatement" ? (bt(n, e), true) : n.type === "IfStatement" ? (Qn(n.consequent, e), true) : r.consequent === n ? (oe(n, e), true) : false;
}
function es({
  comment: e,
  precedingNode: t,
...
function Ko({
  ...
  return Ce(r) && r.shorthand && r.key === t && r.value.type === "AssignmentPattern" ? (K(r.value.left, e), true) : false;
}
...
function qu({
  ...
  if (zo.has(r == null ? undefined : r.type)) {
    ...
    if (n) {
      ...
      for (let s of ["implements", "extends", "mixins"]) if (r[s] && n === r[s][0]) return t && (t === r.id || t === r.typeParameters || t === r.superClass) ? K(t, e) : he(r, e, s), true;
    }
  }
  return false;
}
...
function np({
  ...
  return w(r) && t && r.callee === t && r.arguments.length > 0 ? (oe(r.arguments[0], e), true) : false;
}
function sp({
  comment: e,
  precedingNode: t,
  ...
  return We(r) ? (ir(e) && (n.prettierIgnore = true, e.unignore = true), t ? (K(t, e), true) : false) : (We(n) && ir(e) && (n.types[0].prettierIgnore = true, e.unignore = true), false);
}
function up({
  comment: e,
  enclosingNode: t
}) {
  return Ce(t) ? (oe(t, e), true) : false;
}
function rs({
  comment: e,
  enclosingNode: t,
...
function Dp({
  ...
  return !t || t.type !== "SwitchCase" || t.test || !r || r !== t.consequent[0] ? false : (r.type === "BlockStatement" && Rt(e) ? bt(r, e) : he(t, e), true);
}
function yp({
  comment: e,
  precedingNode: t,
  ...
  return We(t) && ((r.type === "TSArrayType" || r.type === "ArrayTypeAnnotation") && !n || _r(r)) ? (K(v(false, t.types, -1), e), true) : false;
}
function fp({
  comment: e,
  enclosingNode: t,
...
var ut = Symbol("MODE_FLAT");
var pr = Symbol("cursor");
function $u() {
  return {
    value: "",
    length: 0,
  ...
  for (; r >= 0; ) {
    ...
    switch (nt(m)) {
      ...
      case pe: {
        ...
        let y = m.break ? Se : p, c = m.expandedStates && y === Se ? v(false, m.expandedStates, -1) : m.contents;
        a.push({
          mode: y,
          doc: c
        });
...
function Nr(e, t) {
  let r = {}, n = t.printWidth, s = Vu(t.endOfLine), u = 0, i = [{
    ind: $u(),
    mode: Se,
    doc: e
  }], a = [], o = false, p = [], m = 0;
...
`, s) : l;
        ...
        switch (f) {
          ...
          case Se: {
            ...
            if (!l.break && Wr(h, i, g, S, r)) i.push(h);
              ...
              let B = v(false, l.expandedStates, -1);
              if (l.break) {
                i.push({
                  ind: c,
                  mode: Se,
      ...
      case de: {
        ...
        Wr({
          ...
          mode: ut,
          doc: [S, B, X]
        }, [], h, p.length > 0, r, true) ? i.push(Fe, T, O) : _ ? i.push(Fe, W, O) : i.push(Fe, W, R);
        break;
      }
      case xe:
      case Ye: {
...
function Ur(e, t) {
  return ct(e, (r) => typeof r == "string" ? t ? H(false, r, /(\\*)`/g, "$1$1\\`") : as(r) : r);
}
function as(e) {
...
async function Pp(e, t, r) {
  let {
    node: n
  } = r, s = n.quasis.map((m) => m.value.raw), u = 0, i = s.reduce((m, y, c) => c === 0 ? y : m + "@prettier-placeholder-" + u++ + "-id" + y, ""), a = await e(i, {
    parser: "scss"
  }), o = Gt(r, t), p = kp(a, o);
...
async function vp(e, t, r) {
  let {
    node: n
  } = r, s = n.quasis.length, u = Gt(r, t), i = [];
  for (let a = 0; a < s; a++) {
...
`), f = c.length, l = u[a], h = f > 2 && c[0].trim() === "" && c[1].trim() === "", g = f > 2 && c[f - 1].trim() === "" && c[f - 2].trim() === "", S = c.every((O) => /^\s*(?:#[^\n\r]*)?$/.test(O));
    ...
    S ? B = _p(c) : B = await e(y, {
      parser: "graphql"
    }), B ? (B = Ur(B, false), !p && h && i.push(""), i.push(B), !m && g && i.push("")) : !p && !m && h && i.push(""), l && i.push(l);
  }
  return ["`", E([C, P(C, i)]), C, "`"];
}
function _p(e) {
...
async function si(e, t, r, n, s) {
  ...
  ps = ps + 1 >>> 0;
  let a = (S) => `PRETTIER_HTML_PLACEHOLDER_${S}_${i}_IN_JS`, o = u.quasis.map((S, B, O) => B === O.length - 1 ? S.value.cooked : S.value.cooked + a(B)).join(""), p = Gt(n, r), m = new RegExp(a("(\\d+)"), "g"), y = 0, c = await t(o, {
    parser: e,
    __onHtmlRoot(S) {
      y = S.children.length;
    }
    ...
    for (let R = 0; R < O.length; R++) {
      let _ = O[R];
      if (R % 2 === 0) {
        _ && (_ = as(_), s.__embeddedInHtml && (_ = H(false, _, /<\/(?=script\b)/gi, "<\\/")), B.push(_));
        continue;
      }
      let T = Number(_);
      B.push(p[T]);
...
async function Np(e, t, r) {
  let {
    node: n
  } = r, s = H(false, n.quasis[0].value.raw, /((?:\\\\)*)\\`/g, (o, p) => "\\".repeat(p.length / 2) + "`"), u = Gp(s), i = u !== "";
...
function Xp(e) {
  ...
  let r;
  for (let n of [ri, ni, ui, ii]) if (r = n(e), !!r) return t.quasis.length === 1 && t.quasis[0].value.raw.trim() === "" ? "``" : async (...s) => {
    let u = await r(...s);
    return u && st({
      embed: true,
      ...u.label
...
function Ei(e) {
  let {
    ...
    pragmas: n,
    comments: s
  } = sc(e), u = (0, At.strip)(r), i = (0, At.print)({
    pragmas: {
      format: "",
      ...n
    },
...
function cs(e, t) {
  ...
  if (t.__isInHtmlInterpolation && !t.bracketSpacing && pc(r) && cr(e)) return true;
    ...
    case "LogicalExpression":
      switch (s.type) {
        ...
        case "BinaryExpression": {
          ...
          return g > l || n === "right" && g === l || g === l && !sr(h, c) ? true : g < l && c === "%" ? h === "+" || h === "-" : !!Tu(h);
        }
        default:
          return false;
      }
...
function Ci(e, t) {
  ...
  return r.type === "FunctionExpression" || r.type === "ClassExpression" ? n.type === "ExportDefaultDeclaration" || !cs(e, t) : !jt(r) || n.type !== "ExportDefaultDeclaration" && cs(e, t) ? false : e.call(() => Ci(e, t), ...Ir(r));
}
function cc(e) {
  let {
    node: t,
...
var fs = class {
  ...
  hasTrailingWhitespace(t) {
    return it(this, Me).has(v(false, t, -1));
  }
  trimStart(t) {
    let r = this.getLeadingWhitespaceCount(t);
    return t.slice(r);
...
function fc(e, t, r) {
  ...
  for (; l.length > 0 && Es(v(false, l, -1)); ) l.pop();
...
function Ac(e, t, r) {
  ...
  if (s.push(r("name")), n.value) {
    let u;
    if (te(n.value)) {
      let i = De(n.value), a = H(false, H(false, i.slice(1, -1), "&apos;", "'"), "&quot;", '"'), o = hr(a, t.jsxSingleQuote);
      a = o === '"' ? H(false, a, '"', "&quot;") : H(false, a, "'", "&apos;"), u = e.call(() => le(e, Ie(o + a + o), t), "value");
    } else u = r("value");
    s.push("=", u);
  }
  return s;
...
function gc(e, t, r) {
  let n = e.attributes.length > 0 && A(v(false, e.attributes, -1), x.Trailing);
...
function Sc(e, t) {
  let {
    node: r
  } = e, n = A(r), s = A(r, x.Line), u = r.type === "JSXOpeningFragment";
...
function Fs(e, t, r, n, s) {
  ...
  if (!me(u)) return [D(t())];
  let i = [];
  sr(u.operator, u.left.operator) ? i = e.call((g) => Fs(g, t, r, true, s), "left") : i.push(D(t("left")));
  ...
  let {
    parent: c
  } = e, f = A(u.left, x.Trailing | x.Line), l = f || !(s && u.type === "LogicalExpression") && c.type !== u.type && u.left.type !== u.type && u.right.type !== u.type;
  if (i.push(o ? "" : " ", l ? D(y, {
    shouldBreak: f
  }) : y), n && A(u)) {
    let g = Nt(le(e, i, r));
...
function Ut(e) {
  return e.type !== "LogicalExpression" ? false : !!(se(e.right) && e.right.properties.length > 0 || G(e.right) && e.right.elements.length > 0 || U(e.right));
}
  ...
  if (n.type.startsWith("NG")) switch (n.type) {
    ...
    case "NGMicrosyntaxKeyedExpression": {
      let {
        index: s,
        parent: u
      } = e, i = Bi(e) || (s === 1 && (n.key.name === "then" || n.key.name === "else" || n.key.name === "as") || (s === 2 || s === 3) && (n.key.name === "else" && u.body[s - 1].type === "NGMicrosyntaxKeyedExpression" && u.body[s - 1].key.name === "then" || n.key.name === "track")) && u.body[0].type === "NGMicrosyntaxExpression";
...
function Mc(e, t, r) {
  ...
  ur(e, ({
    ...
    let l = r();
    f === i || (fe(c, t) ? (u = true, l = [l, ",", C, C]) : l = [l, ",", d]), a.push(l);
  });
...
function mr(e, t = false) {
  return se(e) && (e.properties.length > 0 || A(e)) || G(e) && (e.elements.length > 0 || A(e)) || e.type === "TSTypeAssertion" && mr(e.expression) || Ae(e) && mr(e.expression) || e.type === "FunctionExpression" || e.type === "ArrowFunctionExpression" && (!e.returnType || !e.returnType.typeAnnotation || e.returnType.typeAnnotation.type !== "TSTypeReference" || qc(e.body)) && (e.body.type === "BlockStatement" || e.body.type === "ArrowFunctionExpression" && mr(e.body, true) || se(e.body) || G(e.body) || !t && (w(e.body) || e.body.type === "ConditionalExpression") || U(e.body)) || e.type === "DoExpression" || e.type === "ModuleExpression";
}
function jc(e, t, r) {
  var u, i;
  let n = v(false, e, -1);
...
function Rc(e) {
  ...
  let [t, r] = e;
  return t.type === "ModuleExpression" && Wc(r) ? true : !A(t) && (t.type === "FunctionExpression" || t.type === "ArrowFunctionExpression" && t.body.type === "BlockStatement") && r.type !== "FunctionExpression" && r.type !== "ArrowFunctionExpression" && r.type !== "ConditionalExpression" && wi(r) && !mr(r);
}
function wi(e) {
  var t;
...
function vi(e, t, r) {
  ...
  let {
    parent: n
  } = e, s = !n || n.type === "ExpressionStatement", u = [];
  function i(k) {
    let {
      originalText: N
    } = t, Q = lt(N, I(k));
    return N.charAt(Q) === ")" ? Q !== false && _t(N, Q + 1) : fe(k, t);
  }
  function a(k) {
    let {
      node: N
  ...
  for (; y < u.length; ++y) {
    ...
    (w(u[y].node) || u[y].node.type === "ImportExpression") && (c = true), m.push(u[y]), A(u[y].node, x.Trailing) && (p.push(m), m = [], c = false);
  }
  m.length > 0 && p.push(m);
  function f(k) {
    return /^[A-Z]|^[$_]+$/.test(k);
  ...
  if (p.length <= _ && !W && !p.some((k) => v(false, k, -1).hasTrailingEmptyLine)) return vr(e) ? R : D(R);
  let Fe = v(false, p[g ? 1 : 0], -1).node, X = !w(Fe) && i(Fe), ue = [S(p[0]), g ? p.slice(1, 2).map(S) : "", X ? C : "", B(p.slice(g ? 2 : 1))], z = u.map(({
    node: k
  }) => k).filter(w);
  function wt() {
    let k = v(false, v(false, p, -1), -1).node, N = v(false, O, -1);
...
function zr(e, t, r) {
  ...
  let {
    node: n,
    parent: s
  } = e, u = n.type === "NewExpression", i = n.type === "ImportExpression", a = V(e), o = ae(n), p = o.length === 1 && wr(o[0], t.originalText);
...
function qi(e, t, r, n = false) {
  ...
  if (w(s)) {
    if ((i = zr(e, t, r).label) != null && i.memberChain) return false;
    let o = ae(s);
    return !(o.length === 0 || o.length === 1 && nr(o[0], t)) || el(s, r) ? false : e.call(u, "callee");
  }
  return q(s) ? e.call(u, "object") : n && (s.type === "Identifier" || s.type === "ThisExpression");
}
function Zc(e, t, r) {
  return Ce(e) ? (t = Nt(t), typeof t == "string" && Ze(t) < r.tabWidth + 3) : false;
}
function el(e, t) {
  let r = tl(e);
  if (L(r)) {
    ...
    if (r.length === 1) {
      let s = r[0];
      if (We(s) || _r(s) || s.type === "TSTypeLiteral" || s.type === "ObjectTypeAnnotation") return true;
    }
...
var il = M(["ObjectTypeAnnotation", "TSTypeLiteral", "GenericTypeAnnotation", "TSTypeReference"]);
function al(e) {
  let {
    types: t
  } = e;
  if (t.some((n) => A(n))) return false;
  let r = t.find((n) => il(n));
  return r ? t.every((n) => n === r || ul(n)) : false;
}
function gs(e) {
  return Jt(e) || Le(e) ? true : We(e) ? al(e) : false;
}
function Ni(e, t, r) {
  let n = t.semi ? ";" : "", {
    node: s
  } = e, u = [ne(e), "opaque type ", r("id"), r("typeParameters")];
...
function en(e, t, r) {
  ...
  return D(e.map(({
    ...
    if (s) return o;
    let p = Le(i), m = Le(u);
    return m && p ? [" & ", n ? E(o) : o] : !m && !p ? E([" &", d, o]) : (a > 1 && (n = true), [" & ", a > 1 ? E(o) : o]);
  }, "types"));
}
function tn(e, t, r) {
  let {
...
function Y(e, t, r = "typeAnnotation") {
  ...
  if (n.type === "TSTypeAnnotation" || n.type === "TypeAnnotation") {
    let u = e.call(Gi, r);
    (u === "=>" || u === ":" && A(n, x.Leading)) && (s = true), pl.add(n);
  }
  return s ? [" ", t(r)] : t(r);
}
...
var El = ({
  ...
  key: t,
  parent: r
}) => t === "value" && e.type === "FunctionExpression" && (r.type === "ObjectMethod" || r.type === "ClassMethod" || r.type === "ClassPrivateMethod" || r.type === "MethodDefinition" || r.type === "TSAbstractMethodDefinition" || r.type === "TSDeclareMethod" || r.type === "Property" && ht(r));
function En(e, t, r, n) {
  ...
  if ((s.type === "FunctionDeclaration" || s.type === "FunctionExpression") && n != null && n.expandLastArg) {
    ...
    w(m) && (ae(m).length > 1 || $(s).every((y) => y.type === "Identifier" && !y.typeAnnotation)) && (u = true);
  }
...
function Fn(e, t, r) {
  let {
    node: n
  } = e, s = Dt(e, r, t), u = An(e, r), i = Wi(n), a = kt(n, u), o = [ze(e, t, r), D([i ? D(s, {
    shouldBreak: true
  }) : a ? D(s) : s, u])];
...
function Cl(e, t) {
  if (we(e.originalText, t) || A(t, x.Leading, (r) => Te(e.originalText, j(r), I(r))) && !U(t)) return true;
  if (jt(t)) {
    let r = t, n;
    for (; n = lu(r); ) if (r = n, we(e.originalText, r)) return true;
  }
  return false;
}
...
function zi(e, t, r, n = {}) {
  ...
  let m = !we(t.originalText, p) && (Ki(p) || dl(p, u, t) || !a && Hi(p)), y = e.key === "callee" && pt(e.parent), c = Symbol("arrow-chain"), f = Tl(e, n, {
    signatureDocs: s,
    shouldBreak: a
  }), l, h = false;
  return o && (y || n.assignmentLayout) && (h = true, l = n.assignmentLayout === "chain-tail-arrow-chain" || y && !m), u = xl(e, t, n, {
    bodyDoc: u,
    bodyComments: i,
    functionBody: p,
...
function xl(e, t, r, {
  ...
  let {
    node: a,
    parent: o
  } = e, p = r.expandLastArg && ye(t, "all") ? b(",") : "", m = (r.expandLastArg || o.type === "JSXExpressionContainer") && !A(a) ? F : "";
...
function fr(e, t, r, n) {
  let {
    node: s
  } = e, u = [], i = Qi(false, s[n], (a) => a.type !== "EmptyStatement");
  return e.each(({
    node: a
  }) => {
...
function ea(e, t, r) {
  let {
    node: n
  } = e, s = Te(t.originalText, j(n), j(n.typeParameter));
...
function xn(e, t, r) {
  let {
    node: n,
    parent: s
  } = e, u = [n.type === "TSTypeParameter" && n.const ? "const " : ""], i = n.type === "TSTypeParameter" ? r("name") : n.name;
...
function gn(e, t, r) {
  let {
    node: n
  } = e, s = [ne(e), Yt(e), "class"], u = A(n.id, x.Trailing) || A(n.typeParameters, x.Trailing) || A(n.superClass) || L(n.extends) || L(n.mixins) || L(n.implements), i = [], a = [];
...
function ua(e, t) {
  if (t.semi || Ls(e, t) || Os(e, t)) return false;
  let {
    node: r,
    key: n,
    parent: s
...
function ia(e, t) {
  ...
  return Be(e, t) ? true : jt(r) ? e.call(() => ia(e, t), ...Ir(r)) : false;
}
function Ls({
  node: e,
  parent: t
...
function bn(e, t, r) {
  let {
    node: n
  } = e, s = [Pi(e, t, r), ne(e), "export", Da(n) ? " default" : ""], {
    declaration: u,
    exported: i
  } = n;
...
function Ea(e, t) {
  return e.type !== "ImportDeclaration" || L(e.specifiers) || e.importKind === "type" ? true : Fr(t, j(e), j(e.source)).trimEnd().endsWith("from");
}
function Ml(e, t) {
  var n, s;
...
function Ca(e, t, r) {
  let {
    ...
    type: s
  } = n, u = s.startsWith("Import"), i = u ? "imported" : "local", a = u ? "local" : "exported", o = n[i], p = n[a], m = "", y = "";
  return s === "ExportNamespaceSpecifier" || s === "ImportNamespaceSpecifier" ? m = "*" : o && (m = r(i)), p && !jl(n) && (y = r(a)), [vs(s === "ImportSpecifier" ? n.importKind : n.exportKind, false), m, m && y ? " as " : "", y];
}
function jl(e) {
  ...
  if (t.type !== r.type || !iu(t, r)) return false;
...
function Tt(e, t, r) {
  ...
  let n = t.semi ? ";" : "", {
    node: s
  } = e, u = s.type === "ObjectTypeAnnotation", i = s.type === "TSEnumDeclaration" || s.type === "EnumBooleanBody" || s.type === "EnumNumberBody" || s.type === "EnumStringBody" || s.type === "EnumSymbolBody", a = [s.type === "TSTypeLiteral" || i ? "members" : s.type === "TSInterfaceBody" ? "body" : "properties"];
  u && a.push("indexers", "callProperties", "internalSlots");
  let o = a.flatMap((T) => e.map(({
    node: W
  }) => ({
    node: W,
    printed: r(),
  ...
  if (s.inexact || s.hasUnknownMembers) {
    ...
    if (A(s, x.Dangling)) {
      let W = A(s, x.Line);
      T = [J(e, t), W || Z(t.originalText, I(v(false, ot(s), -1))) ? C : d, "..."];
    } else T = ["..."];
    S.push([...g, ...T]);
  }
...
function Jl(e, t, r) {
  let {
    node: n
  } = e, s = n.type === "ConditionalExpression", u = s ? "alternate" : "falseType", {
    parent: i
  } = e, a = s ? r("test") : [r("checkType"), " ", "extends", " ", r("extendsType")];
...
function Wl(e) {
  ...
  return n === t ? false : r[ql.get(r.type)] === n;
}
function Aa(e, t, r) {
  let {
    node: n
  } = e, s = n.type === "ConditionalExpression", u = s ? "consequent" : "trueType", i = s ? "alternate" : "falseType", a = s ? ["test"] : ["checkType", "extendsType"], o = n[u], p = n[i], m = [], y = false, {
    parent: c
  } = e, f = c.type === n.type && a.some((X) => c[X] === n), l = c.type === n.type && !f, h, g, S = 0;
  do
  ...
  let R = [u, i, ...a].some((X) => A(n[X], (ue) => ee(ue) && Te(t.originalText, j(ue), I(ue)))), _ = (X) => c === B ? D(X, {
    shouldBreak: R
  }) : R ? [X, Ee] : X, T = !y && (q(c) || c.type === "NGPipeExpression" && c.left === n) && !c.computed, W = Wl(e), Fe = _([Jl(e, t, r), l ? m : E(m), s && T && !W ? F : ""]);
...
function $t(e, t, r, n) {
  ...
  let {
    node: s
  } = e, u = s.type === "ConditionalExpression", i = s.type === "TSConditionalType" || s.type === "ConditionalTypeAnnotation", a = u ? "consequent" : "trueType", o = u ? "alternate" : "falseType", p = u ? ["test"] : ["checkType", "extendsType"], m = s[a], y = s[o], c = p.map((Re) => s[Re]), {
    parent: f
  } = e, l = f.type === s.type, h = l && p.some((Re) => f[Re] === s), g = l && f[o] === s, S = m.type === s.type, B = y.type === s.type, O = B || g, R = t.tabWidth > 2 || t.useTabs, _, T, W = 0;
  do
  ...
  let Ns = Symbol("test"), wa = Symbol("consequent"), Ar = Symbol("test-and-consequent"), Oa = u ? [js(r("test")), s.test.type === "ConditionalExpression" ? Ee : ""] : [r("checkType"), " ", "extends", " ", s.extendsType.type === "TSConditionalType" || s.extendsType.type === "ConditionalTypeAnnotation" || s.extendsType.type === "TSMappedType" ? r("extendsType") : D(js(r("extendsType")))], Gs = D([Oa, " ?"], {
    id: Ns
  }), va = r(a), dr = E([S || z && (U(m) || l || O) ? C : d, Ws, va]), _a = xt ? D([Gs, O ? dr : b(dr, D(dr, {
    id: wa
  }), {
    groupId: Ns
  })], {
    id: Ar
  }) : [Gs, dr], wn = r(o), Us = je ? b(wn, Rr(js(wn)), {
    groupId: Ar
  }) : wn, zt = [_a, Kt.length > 0 ? [E([C, Kt]), C] : B ? C : je ? b(d, " ", {
    groupId: Ar
...
function da(e, t, r, n) {
  ...
  switch (s.type) {
    ...
    case "SwitchStatement":
      return [D(["switch (", E([F, r("discriminant")]), F, ")"]), " {", s.cases.length > 0 ? E([C, P(C, e.map(({
        node: a,
        isLast: o
      }) => [r(), !o && fe(a, t) ? C : ""], "cases"))]) : "", C, "}"];
    case "SwitchCase": {
...
function ha(e, t, r) {
  ...
  switch (n.type) {
    ...
    case "TSMethodSignature": {
      ...
      let o = Dt(e, r, t, false, true), p = n.returnType ? "returnType" : "typeAnnotation", m = n[p], y = m ? Y(e, r, p) : "", c = kt(n, y);
    ...
    case "TSImportEqualsDeclaration":
      return [n.isExport ? "export " : "", "import ", _s(n, false), r("id"), " = ", r("moduleReference"), t.semi ? ";" : ""];
...
//# sourceMappingURL=estree-CSIG7D6Y.js.map
//# sourceMappingURL=estree-CSIG7D6Y.js.map