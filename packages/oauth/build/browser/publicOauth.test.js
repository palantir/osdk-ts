...
describe(createPublicOauthClient, () => {
  ...
  describe.each([{
    ...
    it("calls common with expected values", () => {
      ...
      }), commonJs.createAuthorizationServer(clientArgs.ctxPath ?? "/multipass", clientArgs.foundryUrl), expect.any(Function), expect.anything(), expect.any(Function), undefined);
    });
    describe.each([{
      localStorage: {
