...
// return null to reject a hover (nothing selectable); swap this to change modes
export type TargetResolver = (hostFiber: Fiber) => Fiber | null;

// "generic" = any component; "ontology" = only OSDK-connected. sugar over resolveTarget
export type InspectMode = "generic" | "ontology";

export interface InspectorBannerConfig {
  message?: string;
  exitKeyLabel?: string;
  exitHintText?: string;
}
