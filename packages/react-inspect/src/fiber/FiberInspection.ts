...
import type { ContextDependency, Fiber, SourceLocation } from "./types.js";
...
// memoized values of every context this fiber (and its alternate) consumes
export function getContextValues(fiber: Fiber): unknown[] {
  return safeFiberOperation(
    () => {
      const values: unknown[] = [];
      const fibersToCheck: Fiber[] = fiber.alternate
