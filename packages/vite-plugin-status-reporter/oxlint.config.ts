...
// Nested oxlint config for @osdk/vite-plugin-status-reporter. It inherits the whole repo ruleset by
...
export default defineConfig({
  ...
  rules: {
    "promise/no-multiple-resolved": "off", // A promise executor with more than one resolve path; intentional.
  },
});
