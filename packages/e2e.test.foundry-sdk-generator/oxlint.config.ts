...
// Nested oxlint config for @osdk/e2e.test.foundry-sdk-generator. It inherits the whole repo ruleset by
...
export default defineConfig({
  ...
  rules: {
    ...
    "unicorn/require-module-specifiers": "off", // Requires explicit named specifiers on an import; a source rewrite.
  },
});
