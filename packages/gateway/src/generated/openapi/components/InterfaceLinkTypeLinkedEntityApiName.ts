...
export interface InterfaceLinkTypeLinkedEntityApiName_ObjectTypeApiName
  extends LinkedObjectTypeApiName
{
  type: "objectTypeApiName";
}

export type InterfaceLinkTypeLinkedEntityApiName =
  | InterfaceLinkTypeLinkedEntityApiName_InterfaceTypeApiName
  | InterfaceLinkTypeLinkedEntityApiName_ObjectTypeApiName;
