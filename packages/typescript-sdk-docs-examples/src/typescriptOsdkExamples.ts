    ...
    "2.0.0": {
      "examples": {
        ...
        "loadGeotimeSeriesPointsSnippet": {
          "filePath":
            "examples/typescript/2.0.0/loadGeotimeSeriesPointsSnippet.ts",
          "code": "// Upgrade to 2.1 for official support",
        },
        "loadRelativeGeotimeSeriesPointsSnippet": {
          "filePath":
            "examples/typescript/2.0.0/loadRelativeGeotimeSeriesPointsSnippet.ts",
          "code": "// Upgrade to 2.1 for official support",
        },
        "loadAbsoluteGeotimeSeriesPointsSnippet": {
          "filePath":
            "examples/typescript/2.0.0/loadAbsoluteGeotimeSeriesPointsSnippet.ts",
          "code": "// Upgrade to 2.1 for official support",
        },
        "loadGeotimeSeriesLastPointSnippet": {
          "filePath":
            "examples/typescript/2.0.0/loadGeotimeSeriesLastPointSnippet.ts",
          "code": "// Upgrade to 2.1 for official support",
        },
        ...
        "subscribeToObjectSetInstructions": {
          "filePath":
            "examples/typescript/2.0.0/subscribeToObjectSetInstructions.ts",
          "code": "// Upgrade to 2.1 for official support",
        },
        "uploadMedia": {
