  ...
  "versions": {
    "2.0.0": {
      "examples": {
        ...
        "loadObjectPageGuide": {
          "filePath": "examples/typescript/2.0.0/loadObjectPageGuide.ts",
        ...
        "approximateDistinctAggregationTemplate": {
          "filePath": "examples/typescript/2.0.0/approximateDistinctAggregationTemplate.ts",
        ...
        "exactDistinctAggregationTemplate": {
          "filePath": "examples/typescript/2.0.0/exactDistinctAggregationTemplate.ts",
        ...
        "durationGroupByTemplate_#durationText": {
          "filePath": "examples/typescript/2.0.0/durationGroupByTemplate_#durationText.ts",
        ...
        "applyAction_#hasAttachmentProperty": {
          "filePath": "examples/typescript/2.0.0/applyAction_#hasAttachmentProperty.ts",
          "code": "// Edit this import if your client location differs\nimport { client } from \"./client\";\nimport type { Osdk } from \"@osdk/client\";\nimport { documentEquipment, type Equipment } from \"../../../generatedNoCheck\";\n\nasync function callActionWithAttachmentLoaded(objectTypeWithAttachement: Osdk.Instance<Equipment>) {\n    const attachment = objectTypeWithAttachement.invoice?.rid;\n    const result = await client(documentEquipment).applyAction(\n        {\n            \"equipmentId\": \"mac-1234\", \n            documentFile: attachment\n        },\n        {\n        $returnEdits: true,\n        }\n    );\n    if (result.type === \"edits\") {\n        // use the result object to report back on action results\n    }\n}"
        },
        "applyAction_^hasAttachmentProperty": {
          "filePath": "examples/typescript/2.0.0/applyAction_^hasAttachmentProperty.ts",
        ...
        "applyAction_#hasAttachmentUpload": {
          "filePath": "examples/typescript/2.0.0/applyAction_#hasAttachmentUpload.ts",
        ...
        "applyAction_#actionParameterSampleValuesV2": {
          "filePath": "examples/typescript/2.0.0/applyAction_#actionParameterSampleValuesV2.ts",
          "code": "// Edit this import if your client location differs\nimport { client } from \"./client\";\nimport { documentEquipment } from \"../../../generatedNoCheck\";\n\n    const result = await client(documentEquipment).applyAction(\n        {\n            \"equipmentId\": \"mac-1234\", \n            \"documentType\": \"active\"\n        },\n        {\n            $returnEdits: true,\n        }\n    );\n    if (result.type === \"edits\") {\n        // use the result object to report back on action results\n    }"
        },
        "applyAction_^last": {
        ...
        "batchApplyAction_#hasAttachmentProperty": {
          "filePath": "examples/typescript/2.0.0/batchApplyAction_#hasAttachmentProperty.ts",
        ...
        "batchApplyAction_#hasAttachmentUpload": {
          "filePath": "examples/typescript/2.0.0/batchApplyAction_#hasAttachmentUpload.ts",
          "code": "// Edit this import if your client location differs\nimport { client } from \"./client\";\nimport type { AttachmentUpload } from \"@osdk/api\";\nimport { createAttachmentUpload } from \"@osdk/client\";\nimport { documentEquipment } from \"../../../generatedNoCheck\";\n\nasync function callActionWithAttachmentUpload() {\n    async function uploadMyFile() {\n        const file = await fetch(\"file.json\");\n        const blob = await file.blob();\n        return createAttachmentUpload(blob, \"myFile\");\n    }\n    const attachment: AttachmentUpload = await uploadMyFile();\n    const result = await client(documentEquipment).batchApplyAction([\n            {\n                \"equipmentId\": \"mac-1234\", \n                documentFile: attachment\n            },\n            {\n                \"equipmentId\": \"mac-1234\", \n                documentFile: attachment\n            },\n        ],\n        {\n        $returnEdits: true,\n        }\n    );\n    if (result.type === \"edits\") {\n        // use the result object to report back on action results\n    }\n}"
        },
        "batchApplyAction_^hasAttachmentUpload": {
          "filePath": "examples/typescript/2.0.0/batchApplyAction_^hasAttachmentUpload.ts",
        ...
        "batchApplyAction_#hasParameters": {
          "filePath": "examples/typescript/2.0.0/batchApplyAction_#hasParameters.ts",
          "code": "// Edit this import if your client location differs\nimport { client } from \"./client\";\nimport { documentEquipment } from \"../../../generatedNoCheck\";\n\n    const result = await client(documentEquipment).batchApplyAction([\n            {\n                \"equipmentId\": \"mac-1234\", \n                \"documentType\": \"active\"\n            },\n            {\n                \"equipmentId\": \"mac-1234\", \n                \"documentType\": \"active\"\n            },\n        ],\n        {\n            $returnEdits: true,\n        }\n    );\n    if (result.type === \"edits\") {\n        // use the result object to report back on action results\n    }"
        },
        "batchApplyAction_^hasParameters": {
          "filePath": "examples/typescript/2.0.0/batchApplyAction_^hasParameters.ts",
        ...
        "batchApplyAction_#actionParameterSampleValuesV2": {
          "filePath": "examples/typescript/2.0.0/batchApplyAction_#actionParameterSampleValuesV2.ts",
          "code": "// Edit this import if your client location differs\nimport { client } from \"./client\";\nimport { documentEquipment } from \"../../../generatedNoCheck\";\n\n    const result = await client(documentEquipment).batchApplyAction([\n            {\n                \"equipmentId\": \"mac-1234\", \n                \"documentType\": \"active\"\n            },\n            {\n                \"equipmentId\": \"mac-1234\", \n                \"documentType\": \"active\"\n            },\n        ],\n        {\n            $returnEdits: true,\n        }\n    );\n    if (result.type === \"edits\") {\n        // use the result object to report back on action results\n    }"
        },
        ...
        "executeFunction_#hasAttachmentUpload": {
          "filePath": "examples/typescript/2.0.0/executeFunction_#hasAttachmentUpload.ts",
        ...
        "stringStartsWithTemplate_#hasStructSubProperty": {
          "filePath": "examples/typescript/2.0.0/stringStartsWithTemplate_#hasStructSubProperty.ts",
        ...
        "containsAllTermsInOrderTemplate_#hasStructSubProperty": {
          "filePath": "examples/typescript/2.0.0/containsAllTermsInOrderTemplate_#hasStructSubProperty.ts",
        ...
        "containsAnyTermTemplate_#hasStructSubProperty": {
          "filePath": "examples/typescript/2.0.0/containsAnyTermTemplate_#hasStructSubProperty.ts",
        ...
        "containsAllTermsTemplate_#hasStructSubProperty": {
          "filePath": "examples/typescript/2.0.0/containsAllTermsTemplate_#hasStructSubProperty.ts",
        ...
        "equalityTemplate_#hasStructSubProperty": {
          "filePath": "examples/typescript/2.0.0/equalityTemplate_#hasStructSubProperty.ts",
        ...
        "inFilterTemplate_#hasStructSubProperty": {
          "filePath": "examples/typescript/2.0.0/inFilterTemplate_#hasStructSubProperty.ts",
        ...
        "nullTemplate_#hasStructSubProperty": {
          "filePath": "examples/typescript/2.0.0/nullTemplate_#hasStructSubProperty.ts",
          "code": "import { Employee } from \"../../../generatedNoCheck\";\n// Edit this import if your client location differs\nimport { client } from \"./client\";\n\nconst EmployeeObjectSet = client(Employee)\n    .where({\n        contactInfo: { entrance: { $isNull: true }}\n    });"
        },
        "nullTemplate_^hasStructSubProperty": {
          "filePath": "examples/typescript/2.0.0/nullTemplate_^hasStructSubProperty.ts",
          "code": "import { Office } from \"../../../generatedNoCheck\";\n// Edit this import if your client location differs\nimport { client } from \"./client\";\n\nconst OfficeObjectSet = client(Office)\n    .where({\n        entrance: { $isNull: true }\n    });"
        },
        "rangeTemplate_#hasStructSubProperty": {
          "filePath": "examples/typescript/2.0.0/rangeTemplate_#hasStructSubProperty.ts",
        ...
        "withinDistanceTemplate_#hasStructSubProperty": {
          "filePath": "examples/typescript/2.0.0/withinDistanceTemplate_#hasStructSubProperty.ts",
        ...
        "withinBoundingBoxTemplate_#hasStructSubProperty": {
          "filePath": "examples/typescript/2.0.0/withinBoundingBoxTemplate_#hasStructSubProperty.ts",
        ...
        "withinPolygonTemplate_#hasStructSubProperty": {
          "filePath": "examples/typescript/2.0.0/withinPolygonTemplate_#hasStructSubProperty.ts",
        ...
        "intersectsPolygonTemplate_#hasStructSubProperty": {
          "filePath": "examples/typescript/2.0.0/intersectsPolygonTemplate_#hasStructSubProperty.ts",
        ...
        "intersectsBboxTemplate_#hasStructSubProperty": {
          "filePath": "examples/typescript/2.0.0/intersectsBboxTemplate_#hasStructSubProperty.ts",
        ...
        "loadOrderedInterfacesReference": {
          "filePath": "examples/typescript/2.0.0/loadOrderedInterfacesReference.ts",
        ...
        "loadTimeSeriesPointsSnippet": {
          "filePath": "examples/typescript/2.0.0/loadTimeSeriesPointsSnippet.ts",
          "code": "import type { Osdk } from \"@osdk/client\";\nimport { type Employee } from \"../../../generatedNoCheck\";\n\nfunction getAllTimeSeriesPoints(obj: Osdk.Instance<Employee>) {\n    return obj.employeeStatus?.getAllPoints();\n}"
        },
        "loadRelativeTimeSeriesPointsSnippet": {
          "filePath": "examples/typescript/2.0.0/loadRelativeTimeSeriesPointsSnippet.ts",
        ...
        "loadAbsoluteTimeSeriesPointsSnippet": {
          "filePath": "examples/typescript/2.0.0/loadAbsoluteTimeSeriesPointsSnippet.ts",
        ...
        "loadTimeSeriesFirstPointSnippet": {
          "filePath": "examples/typescript/2.0.0/loadTimeSeriesFirstPointSnippet.ts",
        ...
        "loadTimeSeriesLastPointSnippet": {
          "filePath": "examples/typescript/2.0.0/loadTimeSeriesLastPointSnippet.ts",
        ...
        "loadGeotimeSeriesPointsSnippet": {
          "filePath": "examples/typescript/2.0.0/loadGeotimeSeriesPointsSnippet.ts",
          "code": "// Upgrade to 2.1 for official support"
        },
        "loadRelativeGeotimeSeriesPointsSnippet": {
          "filePath": "examples/typescript/2.0.0/loadRelativeGeotimeSeriesPointsSnippet.ts",
          "code": "// Upgrade to 2.1 for official support"
        },
        "loadAbsoluteGeotimeSeriesPointsSnippet": {
          "filePath": "examples/typescript/2.0.0/loadAbsoluteGeotimeSeriesPointsSnippet.ts",
          "code": "// Upgrade to 2.1 for official support"
        },
        "loadGeotimeSeriesLastPointSnippet": {
          "filePath": "examples/typescript/2.0.0/loadGeotimeSeriesLastPointSnippet.ts",
          "code": "// Upgrade to 2.1 for official support"
        },
        ...
        "loadInterfaceMetadataSnippet": {
          "filePath": "examples/typescript/2.0.0/loadInterfaceMetadataSnippet.ts",
          "code": "import { HasAddress } from \"../../../generatedNoCheck\";\n// Edit this import if your client location differs\nimport { client } from \"./client\";\n\nconst interfaceTypeMetadata = await client.fetchMetadata(HasAddress);\n\nconst implementingObjectTypes = interfaceTypeMetadata.implementedBy;\nconst interfaceRid = interfaceTypeMetadata.rid;"
        },
        "subscribeToObjectSetInstructions": {
          "filePath": "examples/typescript/2.0.0/subscribeToObjectSetInstructions.ts",
          "code": "// Upgrade to 2.1 for official support"
        },
        "uploadMedia": {
          "filePath": "examples/typescript/2.0.0/uploadMedia.ts",
          "code": "// Upgrade to 2.1 for official support"
        },
        "readMedia": {
          "filePath": "examples/typescript/2.0.0/readMedia.ts",
          "code": "// Upgrade to 2.1 for official support"
        },
        ...
        "derivedPropertyApproximateDistinctAggregation": {
          "filePath": "examples/typescript/2.0.0/derivedPropertyApproximateDistinctAggregation.ts",
        ...
        "derivedPropertyExactDistinctAggregation": {
          "filePath": "examples/typescript/2.0.0/derivedPropertyExactDistinctAggregation.ts",
          "code": "import { Employee } from \"../../../generatedNoCheck\";\n// Edit this import if your client location differs\nimport { client } from \"./client\";\n\nconst sumEmployee = await client(Employee)\n    .withProperties({\n      \"newPropertyName\": (baseObjectSet) =>\n        baseObjectSet.pivotTo(\"assignedEquipment\").aggregate(\"purchasePrice:exactDistinct\")\n    }).fetchPage();"
        },
        "derivedPropertyCollectToListAggregation": {
          "filePath": "examples/typescript/2.0.0/derivedPropertyCollectToListAggregation.ts",
        ...
        "derivedPropertyCollectToSetAggregation": {
          "filePath": "examples/typescript/2.0.0/derivedPropertyCollectToSetAggregation.ts",
        ...
        "derivedPropertyCountAggregation": {
          "filePath": "examples/typescript/2.0.0/derivedPropertyCountAggregation.ts",
          "code": "import { Employee } from \"../../../generatedNoCheck\";\n// Edit this import if your client location differs\nimport { client } from \"./client\";\n\nconst sumEmployee = await client(Employee)\n    .withProperties({\n      \"newPropertyName\": (baseObjectSet) =>\n        baseObjectSet.pivotTo(\"assignedEquipment\").aggregate(\"$count\")\n    }).fetchPage();"
        },
        "derivedPropertySelectPropertyAggregation": {
          "filePath": "examples/typescript/2.0.0/derivedPropertySelectPropertyAggregation.ts",
          "code": "import { Employee } from \"../../../generatedNoCheck\";\n// Edit this import if your client location differs\nimport { client } from \"./client\";\n\nconst sumEmployee = await client(Employee)\n    .withProperties({\n      \"newPropertyName\": (baseObjectSet) =>\n        baseObjectSet.pivotTo(\"lead\").selectProperty(\"fullName\")\n    }).fetchPage();"
        },
        "derivedPropertyApproximatePercentileAggregation": {
          "filePath": "examples/typescript/2.0.0/derivedPropertyApproximatePercentileAggregation.ts",
        ...
        "derivedPropertyNumericAggregation": {
          "filePath": "examples/typescript/2.0.0/derivedPropertyNumericAggregation.ts",
        ...
        "objectSetOperationsSubtract": {
          "filePath": "examples/typescript/2.0.0/objectSetOperationsSubtract.ts",
        ...
        "objectSetOperationsIntersect": {
          "filePath": "examples/typescript/2.0.0/objectSetOperationsIntersect.ts",
