...
describe("buildWhereClause", () => {
  ...
  it("builds $in clause for CHECKBOX_LIST", () => {
    const definitions = [
      createPropertyFilterDef("name", "CHECKBOX_LIST", createCheckboxListState(["a", "b"])),
    ];
  ...
  it("wraps with $not when CHECKBOX_LIST isExcluding", () => {
    const definitions = [
      createPropertyFilterDef("name", "CHECKBOX_LIST", createCheckboxListState(["a"], { isExcluding: true })),
    ];
    const filterStates = new Map<string, FilterState>([
  ...
  it("builds $containsAnyTerm for CONTAINS_TEXT", () => {
    const definitions = [
      createPropertyFilterDef("name", "CONTAINS_TEXT", createContainsTextState("test")),
    ];
    const filterStates = new Map<string, FilterState>([
  ...
  it("builds $gte for NUMBER_RANGE min", () => {
    const definitions = [
      createPropertyFilterDef("age", "NUMBER_RANGE", createNumberRangeState(18, undefined)),
    ];
    const filterStates = new Map<string, FilterState>([
  ...
  it("builds $and for NUMBER_RANGE min+max", () => {
    const definitions = [
      createPropertyFilterDef("age", "NUMBER_RANGE", createNumberRangeState(18, 65)),
    ];
    const filterStates = new Map<string, FilterState>([
  ...
  it("includes $isNull with $or when includeNull", () => {
    const definitions = [
      createPropertyFilterDef("age", "NUMBER_RANGE", createNumberRangeState(18, undefined, { includeNull: true })),
    ];
    const filterStates = new Map<string, FilterState>([
  ...
  it("builds date comparison for DATE_RANGE", () => {
    ...
    const definitions = [
      createPropertyFilterDef("createdAt", "DATE_RANGE", createDateRangeState(minDate, maxDate)),
    ];
    const filterStates = new Map<string, FilterState>([
  ...
  it("combines multiple filters with $and", () => {
    const definitions = [
      createPropertyFilterDef("name", "CHECKBOX_LIST", createCheckboxListState(["John"])),
      createPropertyFilterDef("active", "TOGGLE", createToggleState(true)),
    ];
    const filterStates = new Map<string, FilterState>([
