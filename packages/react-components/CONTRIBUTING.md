...
7. **Reuse before writing.** Check Blueprint Core, Datetime, and Select before creating UI. Keep OSDK components for domain behavior rather than wrapping Blueprint only to rename props or restyle it.
...
- **UI primitives** come directly from Blueprint and are not re-exported by this package
