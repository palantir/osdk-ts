...
| `labels`                   | `Partial<FilterListLabels>`                                                          | Overrides for the filter list's user-facing strings. Provide any subset; unset keys fall back to the built-in English defaults. Use this to localize the filter list or adjust wording. See `FilterListLabels`. Defaults to `undefined (built-in English strings)`.                                                                                                                                                                                             |
