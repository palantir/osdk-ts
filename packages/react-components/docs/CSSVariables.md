...
| `--osdk-input-focus-shadow-error`  | `0 0 0 var(--osdk-emphasis-focus-width) color-mix(in srgb, var(--osdk-input-border-color-error) 75%, transparent)` | Danger focus shadow                          |
