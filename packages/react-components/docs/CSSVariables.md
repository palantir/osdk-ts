...
| `--osdk-filter-item-header-action-bg-active`     | `var(--osdk-surface-background-color-default-active)` | Action button background when pressed (mouse-down) or toggled on |
...
| `--osdk-filter-item-exclude-dropdown-trigger-font-weight-active` | `var(--osdk-filter-item-exclude-dropdown-trigger-font-weight)` | Dropdown trigger font weight in selected (Excluding) state                               |
| `--osdk-filter-item-exclude-dropdown-trigger-bg-active`          | `transparent`                                                  | Dropdown trigger background in selected (Excluding) state                                |
| `--osdk-filter-item-exclude-dropdown-trigger-indicator-active`   | `none`                                                         | Dropdown trigger inset indicator in selected (Excluding) state (no underline by default) |
