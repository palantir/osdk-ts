...
// Nested oxlint config for @osdk/shared.test. It inherits the whole repo ruleset by
...
export default defineConfig({
  ...
  rules: {
    ...
    "typescript/prefer-function-type": "off", // A single-call-signature interface vs a function type; stylistic.
