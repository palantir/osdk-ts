...
export const ObjectTypesV2 = [employeeObjectType, objectTypeWithAllPropertyTypes, objectTypeWithTimestampPrimaryKey, officeObjectType, equipmentObjectType];
export const taskObjectType = {
  apiName: "Task",
  displayName: "Task",
...
export const BGaoNflPlayerObjectType = {
