...
import { employee1 as employee_John_50030, employee2 as employee_Jane_50031, employee3, employee4withDerived, employee50050, employeePassesStrict, nycOffice, objectWithAllPropertyTypes1, objectWithAllPropertyTypesEmptyEntries, travisPlayer } from "./objects.js";
...
export class LegacyFauxFoundry extends FauxFoundry {
  constructor(baseUrl = "https://stack.palantir.com/") {
    super(baseUrl, defaultOntologyMetadata);

    //
    // Setup the ontology
    //
    const legacyFullOntology = this.getDefaultOntology();
    ...
    //
    const legacyFauxDataStore = this.getDefaultDataStore();
    ...
    legacyFauxDataStore.registerLink(employee_John_50030, "lead", employee_Jane_50031, "peeps");
    legacyFauxDataStore.registerLink(employee3, "lead", employee_Jane_50031, "peeps");
    !(legacyFauxDataStore.getLinksOrThrow("Employee", employee_Jane_50031.__primaryKey, "peeps").length === 2) ? process.env.NODE_ENV !== "production" ? invariant(false) : invariant(false) : void 0;
  }
}
//# sourceMappingURL=LegacyFauxFoundry.js.map