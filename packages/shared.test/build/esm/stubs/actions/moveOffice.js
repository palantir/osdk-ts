...
export const moveOfficeImpl = (batch, payload) => {
  // we are only setting capacity because we don't have a way to go from address
  // to gps coord
  batch.modifyObject(officeObjectType.apiName, payload.parameters.officeId, {
    capacity: payload.parameters.newCapacity
  });
};
