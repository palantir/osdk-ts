...
export declare namespace promoteEmployeeObject {
	...
	interface Signatures {
		...
		*/
		...
		batchApplyAction<
			P extends ReadonlyArray<promoteEmployeeObject.Params>,
...
export declare const promoteEmployeeObject: promoteEmployeeObject;
