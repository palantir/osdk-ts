...
export declare namespace deleteFooInterface {
	...
	interface Signatures {
		applyAction<
			P extends deleteFooInterface.Params,
			OP extends ApplyActionOptions
		>(args: P, options?: OP): Promise<ActionReturnTypeForOptions<OP>>;
		batchApplyAction<
			P extends ReadonlyArray<deleteFooInterface.Params>,
...
export declare const deleteFooInterface: deleteFooInterface;
