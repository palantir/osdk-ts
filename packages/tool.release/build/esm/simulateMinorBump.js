...
export function simulateMinorBump() {
  ...
  fs.readdirSync(packagesDir).forEach(folder => {
    ...
    if (fs.existsSync(packageJsonPath)) {
      ...
      const changesetFileName = `${packageJson.name.replace("/", "-")}-simulatedRelease.md`;
      const changesetFile = path.join(changesetsDir, changesetFileName);
...
//# sourceMappingURL=simulateMinorBump.js.map