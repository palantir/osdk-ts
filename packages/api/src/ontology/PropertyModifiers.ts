...
/** For array of structs with main value, get the struct with only main value fields */
...
> =
  & {
    [P in K & PropsWithOnlyMainValue<Q>]?: "applyMainValue";
  }
  & {
    [P in K & PropsWithOnlyReducers<Q>]?: "applyReducers";
  }
  & {
    [P in K & PropsWithBoth<Q>]?:
      | "applyMainValue"
      | "applyReducers"
...
/**
 * Apply modifiers to transform property types.
 * This is used to compute the resulting property types when modifiers are applied.
 */
