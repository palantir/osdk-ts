...
/**
 * Implementation of ShapeBuilder that accumulates type information.
 */
...
/**
 * Internal state for ShapeLinkBuilder.
 */
...
/**
 * Implementation of ShapeLinkBuilder for creating derived links.
 */
...
> implements ShapeLinkBuilder<SOURCE, CURRENT> {
  ...
  /**
   * Internal method to convert the builder state to an ObjectSetDef.
   */
...
/**
 * Creates a new ShapeLinkBuilder for the given source type.
 */
