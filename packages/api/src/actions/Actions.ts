...
export namespace ActionParam {
  ...
  /**
   * Helper type for an action parameter of type `scenarioReference`. Accepts a `ScenarioClient` (the value
   * returned by `withScenario` / `createScenario` in `@osdk/client/unstable-do-not-use`). Structurally typed as
