...
/** A struct-typed action parameter with a nullable field — it may be omitted or passed as null. */
declare const actionParam_structType_nullableField: ActionParam.StructType<{
  name: "string";
