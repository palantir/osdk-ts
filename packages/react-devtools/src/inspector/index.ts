...
// Hooks
export { useAnimatedBounds } from "./hooks/use-animated-bounds.js";

// Controller
export { createInspectorController } from "./inspector-controller.js";
...
export {
  ...
  OFFSCREEN_POSITION,
} from "./utils/label-positioning.js";
