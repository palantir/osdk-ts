import { BucketValue } from '../aggregations/index.cjs';
...
/** @deprecated submodule imports aren't public api **/
export type NestedBucket<TGroupKey, TSegmentKey, TValue extends BucketValue> = OG_NestedBucket<TGroupKey, TSegmentKey, TValue>;
import type { TwoDimensionalAggregation as OG_TwoDimensionalAggregation } from '@osdk/legacy-client';
/** @deprecated submodule imports aren't public api **/
export type TwoDimensionalAggregation<TGroupKey extends QueryBucketKey, TValue extends BucketValue = number> = OG_TwoDimensionalAggregation<TGroupKey, TValue>;
import type { ThreeDimensionalAggregation as OG_ThreeDimensionalAggregation } from '@osdk/legacy-client';
/** @deprecated submodule imports aren't public api **/
export type ThreeDimensionalAggregation<TGroupKey extends QueryBucketKey, TSegmentKey extends QueryBucketKey, TValue extends BucketValue = number> = OG_ThreeDimensionalAggregation<TGroupKey, TSegmentKey, TValue>;
