...
var legacy_client_star = require('@osdk/legacy-client');
...
var legacy_client_star__namespace = /*#__PURE__*/_interopNamespace(legacy_client_star);
...
__reExport(generatedNoCheck_exports, legacy_client_star__namespace);
...
var FoundryClient = class extends legacy_client_star.BaseFoundryClient {
  constructor(options) {
...
exports.PublicClientAuth = export_PublicClientAuth;
