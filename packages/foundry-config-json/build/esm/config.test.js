...
describe("loadFoundryConfig - site", () => {
  ...
  it("should throw an error if autoVersion type isn't allowed", async () => {
    ...
    await expect(loadFoundryConfig("site")).rejects.toThrow("The configuration file /path/foundry.config.json does not match");
  });
  it("should throw an error if autoVersion type is missing", async () => {
    ...
    await expect(loadFoundryConfig("site")).rejects.toThrow("The configuration file /path/foundry.config.json does not match the expected schema: data/site/autoVersion must match exactly one schema in oneOf");
  });
  it("should throw an error if uploadOnly isn't a boolean", async () => {
    ...
    await expect(loadFoundryConfig("site")).rejects.toThrow("The configuration file /path/foundry.config.json does not match the expected schema: data/site/uploadOnly must be boolean");
  });
  it("should throw an error if the configuration file cannot be read", async () => {
    ...
    await expect(loadFoundryConfig("site")).rejects.toThrow("Couldn't read or parse config");
  });
  ...
  it("should throw if config file extension isn't supported", async () => {
    ...
    await expect(loadFoundryConfig("site")).rejects.toThrow("Unsupported file extension:");
  });
});
