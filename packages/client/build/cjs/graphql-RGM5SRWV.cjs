...
function getLocation(source, position) {
  ...
  for (const match of source.body.matchAll(LineRegExp)) {
    typeof match.index === "number" || (process.env.NODE_ENV !== "production" ? invariant(false) : invariant(false) );
...
function isPunctuatorTokenKind(kind) {
  return kind === exports.TokenKind.BANG || kind === exports.TokenKind.DOLLAR || kind === exports.TokenKind.AMP || kind === exports.TokenKind.PAREN_L || kind === exports.TokenKind.PAREN_R || kind === exports.TokenKind.SPREAD || kind === exports.TokenKind.COLON || kind === exports.TokenKind.EQUALS || kind === exports.TokenKind.AT || kind === exports.TokenKind.BRACKET_L || kind === exports.TokenKind.BRACKET_R || kind === exports.TokenKind.BRACE_L || kind === exports.TokenKind.PIPE || kind === exports.TokenKind.BRACE_R;
}
...
function readComment(lexer, start) {
  ...
  return createToken(lexer, exports.TokenKind.COMMENT, start, position, body.slice(start + 1, position));
}
function readNumber(lexer, start, firstCode) {
  ...
  return createToken(lexer, isFloat ? exports.TokenKind.FLOAT : exports.TokenKind.INT, start, position, body.slice(start, position));
}
...
function readName(lexer, start) {
  ...
  return createToken(lexer, exports.TokenKind.NAME, start, position, body.slice(start, position));
}
...
var Parser = class {
  ...
  parseDocument() {
    return this.node(this._lexer.token, {
      ...
      definitions: this.many(exports.TokenKind.SOF, this.parseDefinition, exports.TokenKind.EOF)
    });
  }
  /**
   * Definition :
  ...
  parseVariableDefinitions() {
    return this.optionalMany(exports.TokenKind.PAREN_L, this.parseVariableDefinition, exports.TokenKind.PAREN_R);
  }
  /**
  ...
  parseSelectionSet() {
    return this.node(this._lexer.token, {
      ...
      selections: this.many(exports.TokenKind.BRACE_L, this.parseSelection, exports.TokenKind.BRACE_R)
    });
  }
  /**
   * Selection :
   ...
   */
  parseSelection() {
    return this.peek(exports.TokenKind.SPREAD) ? this.parseFragment() : this.parseField();
  }
  /**
   * Field : Alias? Name Arguments? Directives? SelectionSet?
   *
  ...
  parseSchemaDefinition() {
    ...
    const operationTypes = this.many(exports.TokenKind.BRACE_L, this.parseOperationTypeDefinition, exports.TokenKind.BRACE_R);
    return this.node(start, {
  ...
  parseImplementsInterfaces() {
    return this.expectOptionalKeyword("implements") ? this.delimitedMany(exports.TokenKind.AMP, this.parseNamedType) : [];
  }
  /**
   * ```
  ...
  parseFieldsDefinition() {
    return this.optionalMany(exports.TokenKind.BRACE_L, this.parseFieldDefinition, exports.TokenKind.BRACE_R);
  }
  /**
   * FieldDefinition :
   ...
   */
  parseArgumentDefs() {
    return this.optionalMany(exports.TokenKind.PAREN_L, this.parseInputValueDef, exports.TokenKind.PAREN_R);
  }
  /**
  ...
  parseUnionMemberTypes() {
    return this.expectOptionalToken(exports.TokenKind.EQUALS) ? this.delimitedMany(exports.TokenKind.PIPE, this.parseNamedType) : [];
  }
  /**
   * EnumTypeDefinition :
  ...
  parseEnumValuesDefinition() {
    return this.optionalMany(exports.TokenKind.BRACE_L, this.parseEnumValueDefinition, exports.TokenKind.BRACE_R);
  }
  /**
  ...
  parseInputFieldsDefinition() {
    return this.optionalMany(exports.TokenKind.BRACE_L, this.parseInputValueDef, exports.TokenKind.BRACE_R);
  }
  /**
   * TypeSystemExtension :
   *   - SchemaExtension
  ...
  parseSchemaExtension() {
    ...
    this.expectKeyword("schema");
    const directives = this.parseConstDirectives();
    const operationTypes = this.optionalMany(exports.TokenKind.BRACE_L, this.parseOperationTypeDefinition, exports.TokenKind.BRACE_R);
  ...
  parseDirectiveLocation() {
    const start = this._lexer.token;
    const name = this.parseName();
    if (Object.prototype.hasOwnProperty.call(exports.DirectiveLocation, name.value)) {
      return name;
    }
...
var GraphQLIncludeDirective = new GraphQLDirective({
  ...
  locations: [exports.DirectiveLocation.FIELD, exports.DirectiveLocation.FRAGMENT_SPREAD, exports.DirectiveLocation.INLINE_FRAGMENT],
  args: {
    if: {
...
var GraphQLDeprecatedDirective = new GraphQLDirective({
  ...
  locations: [exports.DirectiveLocation.FIELD_DEFINITION, exports.DirectiveLocation.ARGUMENT_DEFINITION, exports.DirectiveLocation.INPUT_FIELD_DEFINITION, exports.DirectiveLocation.ENUM_VALUE],
  args: {
    reason: {
      type: GraphQLString,
  ...
  fields: () => ({
    kind: {
      ...
      resolve(type) {
        ...
        process.env.NODE_ENV !== "production" ? invariant(false, `Unexpected type: "${inspect(type)}".`) : invariant(false) ;
      }
    },
    name: {
      type: GraphQLString,
...
function isExecutableDefinitionNode(node) {
  return node.kind === exports.Kind.OPERATION_DEFINITION || node.kind === exports.Kind.FRAGMENT_DEFINITION;
}
function isSelectionNode(node) {
  return node.kind === exports.Kind.FIELD || node.kind === exports.Kind.FRAGMENT_SPREAD || node.kind === exports.Kind.INLINE_FRAGMENT;
}
function isValueNode(node) {
  return node.kind === exports.Kind.VARIABLE || node.kind === exports.Kind.INT || node.kind === exports.Kind.FLOAT || node.kind === exports.Kind.STRING || node.kind === exports.Kind.BOOLEAN || node.kind === exports.Kind.NULL || node.kind === exports.Kind.ENUM || node.kind === exports.Kind.LIST || node.kind === exports.Kind.OBJECT;
}
function isConstValueNode(node) {
  return isValueNode(node) && (node.kind === exports.Kind.LIST ? node.values.some(isConstValueNode) : node.kind === exports.Kind.OBJECT ? node.fields.some((field) => isConstValueNode(field.value)) : node.kind !== exports.Kind.VARIABLE);
}
function isTypeNode(node) {
  return node.kind === exports.Kind.NAMED_TYPE || node.kind === exports.Kind.LIST_TYPE || node.kind === exports.Kind.NON_NULL_TYPE;
}
function isTypeSystemDefinitionNode(node) {
  return node.kind === exports.Kind.SCHEMA_DEFINITION || isTypeDefinitionNode(node) || node.kind === exports.Kind.DIRECTIVE_DEFINITION;
}
function isTypeDefinitionNode(node) {
  return node.kind === exports.Kind.SCALAR_TYPE_DEFINITION || node.kind === exports.Kind.OBJECT_TYPE_DEFINITION || node.kind === exports.Kind.INTERFACE_TYPE_DEFINITION || node.kind === exports.Kind.UNION_TYPE_DEFINITION || node.kind === exports.Kind.ENUM_TYPE_DEFINITION || node.kind === exports.Kind.INPUT_OBJECT_TYPE_DEFINITION;
}
function isTypeSystemExtensionNode(node) {
  return node.kind === exports.Kind.SCHEMA_EXTENSION || isTypeExtensionNode(node);
}
function isTypeExtensionNode(node) {
  return node.kind === exports.Kind.SCALAR_TYPE_EXTENSION || node.kind === exports.Kind.OBJECT_TYPE_EXTENSION || node.kind === exports.Kind.INTERFACE_TYPE_EXTENSION || node.kind === exports.Kind.UNION_TYPE_EXTENSION || node.kind === exports.Kind.ENUM_TYPE_EXTENSION || node.kind === exports.Kind.INPUT_OBJECT_TYPE_EXTENSION;
}
    ...
    Document(node) {
      for (const definition of node.definitions) {
        if (!isExecutableDefinitionNode(definition)) {
          const defName = definition.kind === exports.Kind.SCHEMA_DEFINITION || definition.kind === exports.Kind.SCHEMA_EXTENSION ? "schema" : '"' + definition.name.value + '"';
...
function getDirectiveLocationForASTPath(ancestors) {
  ...
  "kind" in appliedTo || (process.env.NODE_ENV !== "production" ? invariant(false) : invariant(false) );
...
function LoneAnonymousOperationRule(context) {
  ...
  return {
    Document(node) {
      operationCount = node.definitions.filter((definition) => definition.kind === exports.Kind.OPERATION_DEFINITION).length;
    },
...
function UniqueDirectivesPerLocationRule(context) {
  ...
  return {
    ...
    enter(node) {
      ...
      let seenDirectives;
      if (node.kind === exports.Kind.SCHEMA_DEFINITION || node.kind === exports.Kind.SCHEMA_EXTENSION) {
  ...
  return {
    ObjectValue: {
      ...
      leave() {
        ...
        prevKnownNames || (process.env.NODE_ENV !== "production" ? invariant(false) : invariant(false) );
...
// ../../node_modules/.pnpm/graphql@16.8.1/node_modules/graphql/jsutils/promiseForObject.mjs
...
// ../../node_modules/.pnpm/graphql@16.8.1/node_modules/graphql/jsutils/promiseReduce.mjs
...
function completeValue(exeContext, returnType, fieldNodes, info, path, result) {
  ...
  process.env.NODE_ENV !== "production" ? invariant(false, "Cannot complete value of unexpected output type: " + inspect(returnType)) : invariant(false) ;
}
    ...
    Argument(node) {
      ...
      if (argDef && deprecationReason != null) {
        ...
        if (directiveDef != null) {
          ...
          const parentType = context.getParentType();
          const fieldDef = context.getFieldDef();
          parentType != null && fieldDef != null || (process.env.NODE_ENV !== "production" ? invariant(false) : invariant(false) );
...
function introspectionFromSchema(schema, options) {
  ...
  !result.errors && result.data || (process.env.NODE_ENV !== "production" ? invariant(false) : invariant(false) );
  return result.data;
}
...
function buildClientSchema(introspection, options) {
  ...
  function buildImplementationsList(implementingIntrospection) {
    if (implementingIntrospection.interfaces === null && implementingIntrospection.kind === exports.TypeKind.INTERFACE) {
      return [];
    }
...
function extendSchemaImpl(schemaConfig, documentAST, options) {
  ...
  for (const def of documentAST.definitions) {
    if (def.kind === exports.Kind.SCHEMA_DEFINITION) {
      schemaDef = def;
    } else if (def.kind === exports.Kind.SCHEMA_EXTENSION) {
    ...
    } else if (def.kind === exports.Kind.DIRECTIVE_DEFINITION) {
...
function separateOperations(documentAST) {
  ...
  for (const operation of operations) {
    ...
    separatedDocumentASTs[operationName] = {
      kind: exports.Kind.DOCUMENT,
      definitions: documentAST.definitions.filter((node) => node === operation || node.kind === exports.Kind.FRAGMENT_DEFINITION && dependencies.has(node.name.value))
    };
  }
...
// ../../node_modules/.pnpm/graphql@16.8.1/node_modules/graphql/utilities/assertValidName.mjs
...
function stringifyValue2(value, type) {
  ...
  ast != null || (process.env.NODE_ENV !== "production" ? invariant(false) : invariant(false) );
