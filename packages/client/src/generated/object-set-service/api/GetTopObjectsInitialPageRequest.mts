...
import type { DerivedProperties } from "./DerivedProperties.mjs";
...
import type { ReferenceSigningOptions } from "./ReferenceSigningOptions.mjs";
import type { ResponseOptions } from "./ResponseOptions.mjs";
import type { ResultOrdering } from "./ResultOrdering.mjs";

export interface GetTopObjectsInitialPageRequest {
  objectSet: ObjectSet;
  objectSetContext: ObjectSetContext;
  runtimeDerivedProperties: Map<ObjectTypeId, DerivedProperties>;
