...
import type { LinkTypeMetadata } from "./LinkTypeMetadata.mjs";
...
export interface ManyToManyLinkDefinition {
  ...
  objectTypeAPrimaryKeyPropertyMapping: Map<PropertyTypeRid, PropertyTypeRid>;
  objectTypeBPrimaryKeyPropertyMapping: Map<PropertyTypeRid, PropertyTypeRid>;
}
