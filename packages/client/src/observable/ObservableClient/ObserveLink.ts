...
export namespace ObserveLinks {
  ...
  >
     ...
     *
     * Setting this explicitly gives the query its own cache entry, separate
     * from queries that leave it unset. Optimistic updates are not applied to
     * that entry; it refreshes once the action completes.
     */
