...
export interface Queries {
   ...
   * @returns number
   */
  addOne(params: { n: number }): Promise<Result<QueryResponse<number>, QueryError>>;
  ...
  }): Promise<Result<QueryResponse<{ firstName: string; lastName: string; age?: number }>, QueryError>>;
   ...
   */
  twoDimensionalAggregationFunction(): Promise<
    Result<QueryResponse<TwoDimensionalAggregation<string, number>>, QueryError>
  >;

  /**
   * @returns ThreeDimensionalAggregation<string,Range<Timestamp>,number>
   */
  threeDimensionalAggregationFunction(): Promise<
    Result<QueryResponse<ThreeDimensionalAggregation<string, Range<Timestamp>, number>>, QueryError>
  >;
}
