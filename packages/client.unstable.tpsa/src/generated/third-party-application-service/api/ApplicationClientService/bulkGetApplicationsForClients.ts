...
import type {
  BulkGetApplicationsForClientsRequest
    as _api_BulkGetApplicationsForClientsRequest,
  BulkGetApplicationsForClientsResponse
    as _api_BulkGetApplicationsForClientsResponse,
...
export async function bulkGetApplicationsForClients(
  ctx: ConjureContext,
  request: _api_BulkGetApplicationsForClientsRequest,
): Promise<_api_BulkGetApplicationsForClientsResponse> {
  return conjureFetch(
    ctx,
