...
/**
 * Get the latest SDK version for an application that matches the requested SDK type and SDK generation status.
 *
...
): Promise<_api_ApplicationSdk | null | undefined> {
  return conjureFetch(
    ctx,
    `/application-sdks/${applicationRid}/latest`,
    "GET",
    undefined,
    { sdkType, sdkStatus },
  );
