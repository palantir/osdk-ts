...
import type {
  ...
  ApplicationSdkPageToken as _api_ApplicationSdkPageToken,
  ListApplicationSdksResponse as _api_ListApplicationSdksResponse,
...
export async function listSdks(
  ...
  pageToken: _api_ApplicationSdkPageToken | null | undefined,
): Promise<_api_ListApplicationSdksResponse> {
  return conjureFetch(
    ctx,
