...
import type {
  BulkGetApplicationsRequest as _api_BulkGetApplicationsRequest,
  BulkGetApplicationsResponse as _api_BulkGetApplicationsResponse,
...
export async function bulkGetApplications(
  ctx: ConjureContext,
  request: _api_BulkGetApplicationsRequest,
): Promise<_api_BulkGetApplicationsResponse> {
