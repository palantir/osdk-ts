...
export declare namespace createOsdkTestObject {
	...
	interface Signatures {
		applyAction<
			P extends createOsdkTestObject.Params,
			OP extends ApplyActionOptions
		>(args: P, options?: OP): Promise<ActionReturnTypeForOptions<OP>>;
		batchApplyAction<
			P extends ReadonlyArray<createOsdkTestObject.Params>,
...
export declare const createOsdkTestObject: createOsdkTestObject;
