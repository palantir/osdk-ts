...
export declare namespace createStructPersonOpiTeam {
	...
	interface Signatures {
		...
		*/
		applyAction<
			P extends createStructPersonOpiTeam.Params,
			OP extends ApplyActionOptions
		>(args: P, options?: OP): Promise<ActionReturnTypeForOptions<OP>>;
		batchApplyAction<
			P extends ReadonlyArray<createStructPersonOpiTeam.Params>,
...
export declare const createStructPersonOpiTeam: createStructPersonOpiTeam;
