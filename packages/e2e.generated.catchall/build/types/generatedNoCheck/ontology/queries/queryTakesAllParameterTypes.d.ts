...
export declare namespace queryTakesAllParameterTypes {
	interface Signature {
		/**
...
export interface queryTakesAllParameterTypes extends QueryDefinition<queryTakesAllParameterTypes.Signature>, VersionBound<$ExpectedClientVersion> {
...
export declare const queryTakesAllParameterTypes: queryTakesAllParameterTypes;
