...
// Nested oxlint config for @osdk/e2e.sandbox.officeassignment. It inherits the whole repo ruleset by
...
export default defineConfig({
  ...
  rules: {
    "palantir-header/header": "off", // License headers are not required on sandbox/demo source (matches prior ESLint).
    "jsx-a11y/control-has-associated-label": "off", // Sandbox/demo UI without full accessibility labelling.
    "oxc/no-accumulating-spread": "off", // A spread in a reduce accumulator; intentional in demo code.
