import type {
  ...
  ActionParameterObjectTypeNotFound as OG_ActionParameterObjectTypeNotFound,
  ActionTypeNotFound as OG_ActionTypeNotFound,
  ActionValidationFailed as OG_ActionValidationFailed,
  AggregationGroupCountExceededLimit as OG_AggregationGroupCountExceededLimit,
  ApplyActionFailed as OG_ApplyActionFailed,
  AttachmentNotFound as OG_AttachmentNotFound,
  AttachmentSizeExceededLimit as OG_AttachmentSizeExceededLimit,
  CompositePrimaryKeyNotSupported as OG_CompositePrimaryKeyNotSupported,
  DuplicateOrderBy as OG_DuplicateOrderBy,
  FunctionEncounteredUserFacingError as OG_FunctionEncounteredUserFacingError,
  FunctionExecutionTimedOut as OG_FunctionExecutionTimedOut,
  FunctionInvalidInput as OG_FunctionInvalidInput,
  InvalidAggregationRange as OG_InvalidAggregationRange,
  InvalidAggregationRangePropertyType as OG_InvalidAggregationRangePropertyType,
  InvalidAggregationRangeValue as OG_InvalidAggregationRangeValue,
  InvalidContentLength as OG_InvalidContentLength,
  InvalidContentType as OG_InvalidContentType,
  InvalidFields as OG_InvalidFields,
  InvalidGroupId as OG_InvalidGroupId,
  InvalidParameterValue as OG_InvalidParameterValue,
  InvalidPropertyFilterValue as OG_InvalidPropertyFilterValue,
  InvalidPropertyFiltersCombination as OG_InvalidPropertyFiltersCombination,
  InvalidPropertyValue as OG_InvalidPropertyValue,
  InvalidRangeQuery as OG_InvalidRangeQuery,
  InvalidSortOrder as OG_InvalidSortOrder,
  InvalidSortType as OG_InvalidSortType,
  InvalidUserId as OG_InvalidUserId,
  LinkTypeNotFound as OG_LinkTypeNotFound,
  LinkedObjectNotFound as OG_LinkedObjectNotFound,
  MalformedPropertyFilters as OG_MalformedPropertyFilters,
  MissingParameter as OG_MissingParameter,
  MultipleGroupByOnFieldNotSupported as OG_MultipleGroupByOnFieldNotSupported,
  ObjectNotFound as OG_ObjectNotFound,
  ObjectTypeNotFound as OG_ObjectTypeNotFound,
  ObjectTypeNotSynced as OG_ObjectTypeNotSynced,
  ObjectsExceededLimit as OG_ObjectsExceededLimit,
  OntologyEditsExceededLimit as OG_OntologyEditsExceededLimit,
  OntologyNotFound as OG_OntologyNotFound,
  OntologySyncing as OG_OntologySyncing,
  ParameterObjectNotFound as OG_ParameterObjectNotFound,
  ParameterObjectSetRidNotFound as OG_ParameterObjectSetRidNotFound,
  ParameterTypeNotSupported as OG_ParameterTypeNotSupported,
  ParametersNotFound as OG_ParametersNotFound,
  PermissionDenied as OG_PermissionDenied,
  PropertiesNotFilterable as OG_PropertiesNotFilterable,
  PropertiesNotFound as OG_PropertiesNotFound,
  PropertiesNotSearchable as OG_PropertiesNotSearchable,
  PropertiesNotSortable as OG_PropertiesNotSortable,
  PropertyApiNameNotFound as OG_PropertyApiNameNotFound,
  PropertyBaseTypeNotSupported as OG_PropertyBaseTypeNotSupported,
  PropertyFiltersNotSupported as OG_PropertyFiltersNotSupported,
  PropertyTypesSearchNotSupported as OG_PropertyTypesSearchNotSupported,
  QueryDepthExceededLimit as OG_QueryDepthExceededLimit,
  QueryEncounteredUserFacingError as OG_QueryEncounteredUserFacingError,
  QueryMemoryExceededLimit as OG_QueryMemoryExceededLimit,
  QueryNotFound as OG_QueryNotFound,
  QueryTimeExceededLimit as OG_QueryTimeExceededLimit,
  Unauthorized as OG_Unauthorized,
