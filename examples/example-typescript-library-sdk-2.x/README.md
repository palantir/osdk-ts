...
This project was generated with [`@osdk/create-app`](https://www.npmjs.com/package/@osdk/create-app) from the `typescript-library` template. It is built against a locally generated SDK and a non-existent Foundry stack, so it is intended for reference purposes only.
...
```
npm create @osdk/app@latest -- --template typescript-library
```
